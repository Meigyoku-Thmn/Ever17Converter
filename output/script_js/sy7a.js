...
in the core of my body.`;
   `I felt a dull, severe fatigue sweep over 
me...I was only half-conscious.`;
   `Exhaustion...I had reached my limit.`;
   `But I tried to keep my energy 
...
showTextbox();
text(() => {
   `The memory of that pledge remained stark in my 
mind.`;
   Kid`"Uh, Sora...?"`;
...
text(() => {
   ...
   `Sora, who had no dimensional limits, had 
removed herself from our field of vision.`;
   `Now then...`;
   `Before continuing, I went to set the coffee 
machine to make fresh coffee.`;
   Kid`"You? You're drinking coffee, right?"`;
   You`"........."`;
   `Ignoring her lack of response, I set it to 
prepare two cups.`;
...
showTextbox();
text(() => {
   You(Y7A004)`"How dare you say that...like you know how 
this feels."`;
   Kid`"........."`;
...
this place...somehow."`;
   ...
   You(Y7A009)`"How are you going to keep it? Do you have 
...
what you've taught me."`;
   ...
   `A child is born in innocence...gains knowledge 
through the years...only to forget it all when 
it is old...and dies. `;
   `Over the previous seven days, my life had been 
filled with things that I had learned.`;
   `From amnesia and emptiness my life began.`;
   `But looking back over the last seven days, 
...
but to gain something you must lose something.`;
   ...
   `Even though I had lost much...I had also 
gained...`;
...
showTextbox();
text(() => {
   You(Y7A014)`"So you're saying, that we live only to get 
hurt?"`;
   Kid`"........."`;
...
text(() => {
   You(Y7A020)`"Stop it..."`;
   You(Y7A021)`"Would you stop with the stupid, two-bit 
sermon... "`;
...
text(() => {
   ...
   You(Y7A024)`"All this time, the mother who I thought 
...
teacher... "`;
   ...
   Kid`"And..."`;
   You`"......"`;
   `I walked back to the coffee machine and poured 
two cups of coffee.`;
...
you what it is."`;
   `I added milk and sugar and carried the two 
cups over.`;
   Kid`"There you go."`;
...
text(() => {
   ...
   `She had a clear gentle smile, like the sun 
...
showTextbox();
text(() => {
   `I called Sora back into the room. All 
survivors remaining inside the park were 
now present.`;
   `The three of us began to discuss new 
strategies.`;
   `The walls of LeMU would only hold two more 
hours at most.`;
   `Our last possible escape route had been shut 
off, filling with floodwater just a few hours 
earlier.`;
   `All hope of communicating with the outside was 
gone.`;
   `The situation had become so desperate that I 
could no longer expect You or Sora to find an 
escape route.`;
   You(Y7A037)`"Isn't there anything we can do...?"`;
   `You lifted the coffee cup to her lips as she 
spoke.`;
   `Her cup now contained only black coffee. 
She had refilled it herself.`;
   `Watching her drink I went to take a sip from 
my own cup, but found it empty.`;
   `To pour myself more, I walked back to the 
coffee machine.`;
   `The machine...was an interesting contraption 
with a lower chamber containing boiling water 
heated from an alcohol lamp.`;
   `The steam from the boiling water was siphoned 
...
straight down from the floating island?"`;
   ...
   Sora(Y7A039)`"No, but I was able to drain it yesterday 
so..."`;
   Sora(Y7A040)`"When the flooding started, the watertight 
doors in the emergency stairwell automatically 
closed."`;
   Sora(Y7A041)`"Therefore, the emergency stairs did not allow 
water in after it had finished draining."`;
   Sora(Y7A042)`"It was thanks to the safety doors closing 
...
water!"`;
   You(Y7A053)`"Well, how do you expect to reach the 
...
way to 'Staircase A.'"`;
   You(Y7A055)`"You say it as if it is the easiest thing 
in the world, but... there's no way we can 
do it if you ask me."`;
   Kid`"We can do it!"`;
   You(Y7A056)`"Yeah, how?"`;
   You(Y7A057)`"First of all, there isn't anywhere to drain 
the floodwater in 'Corridor C.'"`;
   Kid`"But there IS a place."`;
   Kid`"The dry area in Sector 4."`;
   You(Y7A058)`"*sigh*... Are you really that dumb?"`;
   You(Y7A059)`"Water only flows from high to low with the 
help of gravity."`;
   You(Y7A060)`"This is the third time you've made me say 
that."`;
   Kid`"I know, I know."`;
   You(Y7A061)`"So why do you keep up this stupid argument..."`;
   You(Y7A062)`"What? Are you thinking about scooping out all 
...
showTextbox();
text(() => {
   You(Y7A064)`"Kid...can I ask you one simple little 
question?"`;
   Kid`"Sure."`;
   You(Y7A065)`"Wouldn't doing that put this Security Office 
...
showTextbox();
text(() => {
   You(Y7A066)`"*sigh*...I should have noticed the warning 
signs..."`;
...
text(() => {
   ...
   `I found a bucket and a clear plastic hose, and 
drilled a hole in the bucket.`;
   `Sticking the hose into the hole, I used duct 
tape to wrap and seal it.`;
   `I then hunted up two more buckets.`;
   `With the goods in hand, I returned to the 
Security Office.`;
...
idea."`;
   You(Y7A073)`"I don't get it. What does that thing have 
...
stairs, right?"`;
   ...
   You(Y7A078)`"I think you said...'We're going to release 
...
showTextbox();
text(() => {
   `Next, I began to pour water into the top 
...
showTextbox();
text(() => {
   `Next, the water from the top bucket flowed 
...
text(() => {
   ...
   `Except for a negligible amount left in the 
...
without any cracks or damage...?"`;
   You(Y7A080)`"So an enormous amount of water is going to 
flow into Corridor C?"`;
   Kid`"And then, what next?"`;
   You(Y7A081)`"The water accumulated in Corridor C will 
drain into the dry area in Sector 4?"`;
   Kid`"And then what will happen?"`;
   You(Y7A082)`"Probably something like your experiment just 
now..."`;
   You(Y7A083)`"All the water in Corridor C, as well as 
...
text(() => {
   You(Y7A085)`"Sure."`;
   `According to the color-coded map on the 
...
C had changed to green.`;
   ...
   Sora(Y7A086)`"There is very little time left before the 
...
text(() => {
   ...
   Sora`"........."`;
   Kid`"...What?"`;
   Sora(Y7A089)`"Have you forgotten? I am an RSD-generated 
image.... I'm just a computer program."`;
   Kid`"........."`;
   Sora(Y7A090)`"I am not able to join you."`;
   Sora(Y7A091)`"So I wanted to say goodbye and wish you the 
best of luck."`;
   Kid`"Sora..."`;
...
text(() => {
   ...
   Sora(Y7A093)`"And even if I accompanied you as far as the 
floating island, we would eventually have to 
say goodbye there."`;
   Sora(Y7A094)`"In my case, the parting comes a little 
earlier than with everyone else."`;
   Kid`"But..."`;
   Sora(Y7A095)`"Kid, think about it like this. When you go to 
visit a friend's house..."`;
   Sora(Y7A096)`"When it's time to leave, the friend may see 
...
text(() => {
   Sora(Y7A099)`"Yes."`;
   Sora(Y7A100)`"I am here, and I am also elsewhere at the 
same time."`;
   Sora(Y7A101)`"Even if the 'me' here disappears, the 'me' 
there will still go on existing."`;
   Kid`"Don't talk about disappearing."`;
   Sora(Y7A102)`"Heh, heh. This is merely an example, you see."`;
   Sora(Y7A103)`"Don't worry. I'm sure that, yourself, 
You and I will meet again."`;
   ...
   `Looking over Sora's shoulder at the monitor, I 
...
showTextbox();
text(() => {
   `You and I opened the Security Room doors and 
exited into the corridor.`;
   `Giving a wave to the smiling Sora as she saw 
...
showTextbox();
text(() => {
   `We then walked down Corridor C, which was no 
longer flooded.`;
...
showTextbox();
text(() => {
   You(Y7A108)`"Don't be stupid...Sora doesn't plan to 
sacrifice herself."`;
...
showTextbox();
text(() => {
   You(Y7A111)`"Anyway, what you're worried about isn't going 
to happen to her."`;
...
showTextbox();
text(() => {
   You(Y7A113)`"Listen, this is what I heard from Mayo, 
but..."`;
   You(Y7A114)`"Before, when she was hacking the source data, 
Mayo said she rewrote one line of code."`;
   You(Y7A115)`"In Sora's programming there is a priority 
...
showTextbox();
text(() => {
   `At last we arrived at the door leading to the 
emergency stairs.`;
...
as a bell.`;
   ...
   `Turning on her heels, Coco ran off in the 
other direction.`;
   ...
   You(Y7A122)`"You're just imagining things! Forget about 
it!"`;
...
showTextbox();
text(() => {
   `Tearing myself away from You's grasp, I ran 
after the girl.`;
   `You came dashing after me.`;
   `Through the voice alternator came Sora's 
warning voice.`;
   Sora(Y7A124)`"The pressure on the partitions has increased 
beyond their limit!"`;
   Sora(Y7A125)`"You must return quickly!"`;
   Kid`"No way!"`;
   You(Y7A126)`"How long!? How much longer will they hold?"`;
   Sora(Y7A127)`"10 to 15 minutes!"`;
   Sora(Y7A128)`"But there is no way to be sure. The wall 
...
showTextbox();
text(() => {
   `The main building lights flickered and went 
out, but were replaced by dim emergency lights.`;
   `With the help of the pale lights I kept up 
chase.`;
...
showTextbox();
text(() => {
   `I ran to the end of the narrow corridor, in 
...
showTextbox();
text(() => {
   Append`As if being absorbed into the door, the girl 
disappeared...`;
...
text(() => {
   ...
   `Coming back to myself, I tried to open the 
door to HIMMEL.`;
   `But the door wouldn't budge.`;
   Kid`"Sora! Open this door!"`;
   Sora(Y7A131)`"That is impossible. That door is out of 
my jurisdiction."`;
...
gush in.`;
   Sora(Y7A132)`"Less than five minutes left! They won't hold 
much longer!"`;
   Announcement(Y7A133)`"Emergency warning...all patrons in the 
park...and all staff...are advised to evacuate 
immediately."`;
   Announcement(Y7A134)`"Five minutes...until...implosion."`;
   `The announcement repeated itself in German, 
French, and Japanese.`;
...
showTextbox();
text(() => {
   `I pounded fiercely against the door again with 
my clinched fists.`;
   `But no matter how hard I tried, it was in vain.`;
   `(Is she just...just my imagination?)`;
   `(...if I keep this up, what's going to happen 
to You...?)`;
   `I thought that You would die if I don't do 
something!`;
   Kid`"........."`;
...
text(() => {
   ...
   `Splashing through the water as it gushed like 
...
showTextbox();
text(() => {
   `Bounding up the emergency stairs, we reached 
Zweite Stock.`;
...
text(() => {
   ...
   `We applied our strength together and pushed 
...
showTextbox();
text(() => {
   `Closing the door tightly, we then headed up 
the long set of stairs.`;
   Announcement(Y7A141)`"One minute...until...implosion."`;
   `In the distance the sign read Erste boden. 
First floor!`;
   `Just 50 more feet!`;
...
text(() => {
   ...
   `The darkness was pierced by a ferocious 
sound...`;
   `Like the roar of a dragon.`;
   `Or possibly...the last agonizing cry before 
death.`;
...
text(() => {
   ...
   `The morning sun stained the sky, land and 
ocean...`;
   `It was the first time we had laid eyes on the 
...
showTextbox();
text(() => {
   `In the distance, Sara and Takeshi played 
together.`;
   `It appeared as if they were pretending to 
swordfight with a couple of sticks.`;
   `Apparently, Takeshi had been routed by Sara's 
sword.`;
   `I gazed dreamily at the two as they played.`;
   `Tsugumi was nowhere to be seen. After the 
...
text(() => {
   ...
   `It was her first time to see the sun in seven 
days.`;
   `Long shadows, from her figure and mine, 
cast at length behind us.`;
   `Yes, we had successfully escaped from that 
water entrenched labyrinth.`;
   ...
   `You kept her gaze on the rising sun as she 
answered.`;
   `The first one...`;
   `...To protect her.`;
   `And the second?`;
   You(Y7A148)`"The thing that reminds you about life, sugar 
in coffee."`;
   Kid`"Ah...that..."`;
   You(Y7A149)`"The thing that life depends on, didn't you 
say?"`;
   Kid`"Uh, huh."`;
   You(Y7A150)`"You promised to tell me."`;
   Kid`"Okay, in that case let me ask you. What are 
some things on which life depends?"`;
   You(Y7A151)`"Water, air, food, housing, 
clothing...money..."`;
   Kid`"Okay, what else?"`;
...
text(() => {
   ...
   `From You's long hair I could smell her 
fragrance.`;
   `The fragrance of sunlight.`;
   You(Y7A036)`"It is sweet...isn't it."`;
   `The sun, my sun, which was clear and fresh, 
flowing with brilliance...`;
   `Tinged with sweetness the smell of spring 
