...
showTextbox();
text(() => {
   Append`And the whale
floating in the darkness...${wait(30)}${noWait}`;

});
bgload_keepFg({ name: `BG36A1`, transition: 20 });
showTextbox();
text(() => {
   Append`The Jellyfish
Gondola...${wait(30)}${noWait}`;
...
text(() => {
   //??
   Unk(S1A013)`"What's the matter? Your head hurts,
right?"`;
   Kid`"Yeah..."`;
   //??
   Unk(S1A014)`"Then if you don't take these...the pain
won't go away."`;
   Kid`"..."`;
...
text(() => {
   ...
   //??
   Unk(S1A019)`"But that's okay. This medicine isn't bitter 
at all."`;
   //??
   Unk(S1A020)`"It's more than not bitter. It's got a mellow, 
...
the mouth without an aftertaste..."`;
   ...
   //??
   Unk(S1A022)`"If you REALLY can't drink it then I can give 
...
showTextbox();
text(() => {
   `${voice(S1A023)}"It's probably just mild barotrauma,
or decompression sickness."`;
   //??
   Unk(S1A024)`"It happens a lot to visitors..."`;
   //??
   Unk(S1A025)`"They just feel ill all of the sudden
...
pillow.`;
   //??
   Unk(S1A026)`"It's a bit of a stretch coming down
here anyway."`;
   //??
   Unk(S1A027)`"People with no experience just jumping to 6 
atmospheres for long periods of time. Sheesh."`;
   //??
   Unk(S1A028)`"The air pressure in the earth's atmosphere is 
made for people to live comfortably."`;
   //??
   Unk(S1A029)`"Of course people are going to have bad 
reactions to breathing air this thick."`;
   //??
   Unk(S1A030)`"Air and first love - both should be light.
No doubt about that."`;
   //??
   Unk(S1A031)`"Coffee and your first TIME...
...
text(() => {
   ...
   //??
   Unk(S1A036)`"While you were asleep it seems that there 
...
text(() => {
   ...
   //??
   Unk(S1A038)`"Anyway, for now just rest and don't worry 
about anything. Okay?"`;
...
infirmary...right?"`;
   //??
   Unk(S1A041)`"You passed out all of the sudden at the 
...
showTextbox();
text(() => {
   You(S1A049)`"What are you doing? This is no time to be 
sleeping!"`;
...
showTextbox();
text(() => {
   You(S1A052)`"I dunno, but...anyway, we've gotta escape 
out of here!"`;
...
showTextbox();
text(() => {
   You(S1A060)`"Anyway, there is no time to think about 
it now."`;
...
text(() => {
   ...
   You(S1A067)`"There are emergency stairs that 
run along it." `;
...
showTextbox();
text(() => {
   You(S1A070)`"It'll open! It'll open for sure! I'll make 
it open!"`;
...
showTextbox();
text(() => {
   You(S1A071)`"Well, don't just stand there. Get over here 
and help me!"`;
...
showTextbox();
text(() => {
   You(S1A098)`"You...well, you seem more like the type that 
...
text(() => {
   ...
   You(S1A100)`"If you really did save us, I suppose 
I should thank you."`;
...
showTextbox();
text(() => {
   You(S1A104)`"You take everything so seriously.... 
...
text(() => {
   You(S1A106)`"Yeah..."`;
   You(S1A107)`"You never know when there might be another 
flooding..."`;
...
text(() => {
   You(S1A108)`"Hey."`;
   You(S1A109)`"That reminds me, I haven't even asked 
your name yet?"`;
   Kid`"...Huh?"`;
...
showTextbox();
text(() => {
   You(S1A117)`"Hey, next time you decide to go and keel 
over, can you do it somewhere a little 
closer to this room?"`;
   You(S1A118)`"Because it was really a pain hauling you 
...
showTextbox();
text(() => {
   You(S1A119)`"Oh, it's alright. You don't have to 
apologize..."`;
...
showTextbox();
text(() => {
   You(S1A123)`"You don't have to try to force yourself to 
remember!"`;
   Kid`"..."`;
   You(S1A124)`"I don't want you getting like you did 
before...alright?"`;
...
text(() => {
   ...
   You(S1A126)`"So just calm down...I want you to relax and 
answer them."`;
...
text(() => {
   ...
   You(S1A133)`"If you can't remember, then you can't 
...
text(() => {
   ...
   You(S1A135)`"So you don't remember your name, age or 
birthday, right?"`;
...
text(() => {
   ...
   You(S1A137)`"If not those, then how about your family, 
friends...or anything..."`;
   Kid`"..."`;
...
hand back.`;
   You(S1A141)`"I don't think that amnesia is all that 
uncommon."`;
   Kid`"Amnesia...?"`;
...
showTextbox();
text(() => {
   You(S1A142)`"You don't have any memory, so that's memory 
loss or amnesia, right? Of course it is."`;
   You(S1A143)`"I wonder what caused it..."`;
   You(S1A144)`"The air pressure change...or maybe you hit 
your head somewhere..."`;
...
showTextbox();
text(() => {
   You(S1A146)`"Like riding a crazy ride and maybe you 
...
text(() => {
   ...
   You(S1A148)`"It's probably just temporary. It'll 
come back "`;
   Kid`"Think so?"`;
...
text(() => {
   You(S1A149)`"For sure!"`;
   You(S1A150)`"Of course if you were in a major accident 
...
text(() => {
   ...
   You(S1A153)`"I could sing you a lullaby and tuck you in, 
but..."`;
...
text(() => {
   ...
   You(S1A158)`"Not even. I mean we haven't even hit Erste 
...
How deep is it?"`;
   You(S1A159)`"Let's see...Zweite stock is 102 feet deep, 
so..."`;
   You(S1A160)`"Around 90 feet, give or take I guess..."`;
   You(S1A161)`"We've only climbed around 12 or 15 feet on 
these stairs."`;
   `90 feet deep...`;
...
text(() => {
   ...
   Kid`"...Huh?"`;
   You(S1A167)`"So what're you gonna do? 
...
showTextbox();
text(() => {
   You(S1A172)`"Nothing's wrong with it...but you miss 
out...somehow."`;
   Kid`"........."`;
...
showTextbox();
text(() => {
   You(S1A175)`"You just were talking about how the 
watertight doors started closing 
all of the sudden, right?"`;
   Kid`"Yeah."`;
   You(S1A176)`"That means that the doors closed 
automatically..."`;
   Kid`"Closed automatically?"`;
   You(S1A177)`"LeMMIH detected flooding and automatically 
shut the doors in the areas that were in 
danger."`;
   Kid`"Uh...what's 'LeMMIH?'"`;
   You(S1A178)`"That's what we call the main computer that 
...
showTextbox();
text(() => {
   You(S1A180)`"This...was probably closed by 'LeMMIH' 
as well."`;
   Kid`"I see..."`;
