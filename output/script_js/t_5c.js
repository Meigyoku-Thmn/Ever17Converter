...
text(() => {
   ...
   `I made enough sandwiches for everyone and 
passed them out.`;
...
showTextbox();
text(() => {
   `We gathered on the circular stage in the 
...
showTextbox();
text(() => {
   `At a wave of Sora's hand, a gentle rain 
...
showTextbox();
text(() => {
   `Smiling, Sora stared at the fresh flowers and 
...
text(() => {
   ...
   `I didn't want to think she was just 
pretending for our benefit.`;
   `But...`;
   `Was she really smiling because she wanted to, 
or was she just trying to cheer us up?`;
   `'We don't need to try to help Sora, she will 
save herself.'`;
...
showTextbox();
text(() => {
   `I wondered how long I could watch the little 
peaceful world she had created.`;
   `How long could I keep looking at her smiling 
face?`;
...
showTextbox();
text(() => {
   `Then again there were others here too - one of 
...
showTextbox();
text(() => {
   You(T5C002)`"Would you be so kind as to make another one 
and bring it here....? Pretty pleeeeaaase?"`;
   `She called out to me in a voice that seemed 
just a little TOO sweet.`;
   `It seemed to me that she had been crying 
...
showTextbox();
text(() => {
   You(T5C004)`"Just as long as you realize who's in charge. 
Oh, ho, ho, ho, ho..."`;
...
text(() => {
   ...
   `Still I was irritated somehow, as I waited 
for the cold oil to heat up again.`;
   `I anxiously fidgeted as I waited.`;
   `The wire basket struck the frying pan with a 
clang.`;
...
text(() => {
   ...
   Tsugumi(T5C006)`"I'd like to ask for another one, if that's 
okay."`;
   Takeshi`"GEEEZ!"`;
...
text(() => {
   ...
   `Trying to shake off my frustration, I 
replied...`;
...
showTextbox();
text(() => {
   `Tsugumi grabbed on to Coco's hand and started 
walking slowly away.`;
...
showTextbox();
text(() => {
   `It didn't seem like she cared about my 
troubles...`;
   `Every time we met I never know how to 
react....and it bothered me some.`;
   `Had she totally forgotten about the events of 
the other night? I had to wonder.`;
   `(Well, if she doesn't care, then I suppose 
that's best...)`;
   `The Tsugumi before me then seemed like she 
...
showTextbox();
text(() => {
   Coco(T5C026)`"And guess what? You wanna know what? I had a 
dream last night!"`;
...
showTextbox();
text(() => {
   Coco(T5C030)`"And the whale was like totally bouncing all 
over the place..."`;
   Coco(T5C031)`"I just kept hopping and jumping....!"`;
   Coco(T5C032)`"And we were in outer space going to this 
...
showTextbox();
text(() => {
   `Tsugumi listened to Coco's nonsense with a 
smile on her face.`;
...
text(() => {
   ...
   `I went into the rest area and You was 
...
text(() => {
   ...
   You(T5C043)`"It's just that you're so slow that I was 
...
showTextbox();
text(() => {
   `Tsugumi and Coco had already finished theirs, 
...
showTextbox();
text(() => {
   `I headed over to the circle in the center of 
the room.`;
   Takeshi`"Here. It's the Tanaka special. Take it!"`;
   `I got up on the round dais, and threw the 
...
text(() => {
   `Splat.`;
   `The package flew over You's knees and landed 
...
showTextbox();
text(() => {
   You(T5C046)`"W-well, you're the one who threw it all of a 
sudden!"`;
...
text(() => {
   ...
   `Grumbling to herself she undid the string 
around the wrapping.`;
...
text(() => {
   You(T5C049)`"Ah!"`;
   `You looked at the contents, and puffed up 
again, `;
...
text(() => {
   ...
   `We carried on needling each other like this 
for a while...`;
...
showTextbox();
text(() => {
   `When suddenly someone came up and stood in 
front of You and me.`;
...
showTextbox();
text(() => {
   `The Kid was staring at both of us with a 
leaden gaze.`;
...
text(() => {
   ...
   `The Kid held an unopened fried chicken 
...
heat it up again for you?"`;
   `I put out my hand.`;
   `But he pulled the sandwich close to himself 
...
text(() => {
   ...
   `The wrapping paper burst and sauce flew every 
which way.`;
   `It got on his clothes as well, but he didn't 
seem to notice.`;
...
showTextbox();
text(() => {
   `Threw it with all of his might against the 
water on the ground.`;
   Takeshi`"W-what!?"`;
...
text(() => {
   Kid`"......."`;
   `His shoulders trembling, the Kid kept his 
face down.`;
...
showTextbox();
text(() => {
   `The kid kicked at the thin layer of water at 
his feet.`;
   `Everyone looked at him at once.`;
   Kid(T5C058)`"I can't stand it anymore!"`;
   Kid(T5C059)`"I don't want any more fried chicken 
sandwiches!"`;
...
text(() => {
   ...
   Kid(T5C065)`"There isn't any proof that anyone is going 
to save us!"`;
...
text(() => {
   ...
   `But not finding any direction to launch it, he 
lowered it again.`;
...
text(() => {
   Pipi(PIPI_06)`"....*whine*..."`;
   `Everyone tried to keep their eyes from 
meeting. `;
   `It seemed like they were afraid of what we 
might see...`;
   `They tried desperately to avert their gazes.`;
   `Nobody moved.`;
   `People pressed their lips firmly together and 
dared not speak.`;
   Takeshi`"St..."`;
...
text(() => {
   `BOOOOooom!!`;
   `A loud metallic sound echoed throughout the 
room.`;
...
text(() => {
   ...
   `Everyone staggered slightly and struggled to 
...
showTextbox();
text(() => {
   `Just then the Kid knocked the sandwich out of 
You's hand.`;
   `She hadn't even taken a bite out of her 
'Tanaka Special'......`;
...
showTextbox();
text(() => {
   `It fell into the water with a splash, and sank 
slowly.`;
   You(T5C075)`".........!!"`;
...
text(() => {
   ...
   `I went over and grabbed onto the Kid and 
raised my hand!`;
...
text(() => {
   ...
   `I let go of the Kid's collar, and he backed 
away slowly.`;
...
showTextbox();
text(() => {
   `The Kid looked up at me all hunched up and 
trembling.`;
   `I was disappointed in myself for having tried 
...
text(() => {
   ...
   `Tsugumi took a step forward and stared at the 
kid.`;
...
showTextbox();
text(() => {
   `Softly she approached the Kid one step at a 
time.`;
   `Everyone was so caught off guard that they 
...
text(() => {
   ...
   Kid(T5C106)`"..........u."`;
   `He tried to say something, but no words would 
...
text(() => {
   ...
   Kid(T5C108)`"...Ugh..."`;
   `The Kid tried to nod, but his head wouldn't 
budge.`;
...
showTextbox();
text(() => {
   `The Kid broke down in tears, and fell to floor 
covered in water.`;
   Kid(T5C122)`"Aaaagh......"`;
...
showTextbox();
text(() => {
   `You, suddenly spurred into action, ran over 
...
showTextbox();
text(() => {
   `Sora looked down and covered her face with 
her hands. She was trembling.`;
   `Coco and Pipi were staring at everyone, 
speechless.`;
...
text(() => {
   Takeshi`"Tsu-Tsugumi...!?"`;
   `Not knowing what else to say, I just stood 
there.`;
...
showTextbox();
text(() => {
   `But I couldn't read what she was thinking 
from her expression.`;
...
showTextbox();
text(() => {
   `Seeing that I was confused, Tsugumi ran over 
to me.`;
...
text(() => {
   ...
   `She had grabbed my ear and mercilessly 
tugged...`;
...
text(() => {
   ...
   `She kept a firm grip on me and kept pulling, 
...
Pleeeasee."`;
   ...
   `She wouldn't let go no matter how I pleaded, 
...
showTextbox();
text(() => {
   `And when we finally made it to the 2nd floor, 
...
text(() => {
   ...
   `She pinched the bridge of her nose, and shook 
her head.`;
...
showTextbox();
text(() => {
   `Tsugumi turned and she started walking away 
from me.`;
...
text(() => {
   ...
   `I hurried over to her and insisted that she 
answer me.`;
...
showTextbox();
text(() => {
   Tsugumi(T5C134)`"No, it's not like that...you don't understand 
anything."`;
...
showTextbox();
text(() => {
   `And throwing back her shoulders, she picked 
up her pace.`;
...
showTextbox();
text(() => {
   Tsugumi(T5C136)`"It's a stupid question, but I'll answer it 
for you anyway."`;
   Takeshi`"O-okay..."`;
...
text(() => {
   ...
   `The gondola zipped into the tube, and out 
into the ocean.`;
...
text(() => {
   `Bam!`;
   `Tsugumi pounded the shell of the jellyfish 
with her fist.`;
   `Her expression was one of annoyance again.`;
   `The gondola swayed slightly, as it moved 
forward slowly.`;
...
text(() => {
   ...
   Tsugumi(T5C144)`"You say, 'You're one of us, so you should 
cooperate'?'"`;
   Tsugumi(T5C145)`"And that's how you keep pushing him to agree 
with you, and buy into all your fake ideals."`;
   Tsugumi(T5C146)`"I can't believe how irresponsible you can 
be..."`;
   Tsugumi(T5C147)`"Who the hell do you think you are?"`;
   Tsugumi(T5C148)`"You've really got some nerve talking like 
that..."`;
...
in your heart, and you know that!"`;
   ...
   Tsugumi(T5C152)`"You're wrong...you're the one who isn't being 
yourself!"`;
...
text(() => {
   ...
   `She hesitated a bit, but soon came to sit 
next to me.`;
...
thinking."`;
   ...
   `Tsugumi didn't try to shake off my hand, but 
just sat there.`;
   Tsugumi(T5C156)`"That's right..."`;
   Tsugumi(T5C157)`"You had made me 'one of the gang,' hadn't 
you...?"`;
   Takeshi`"........."`;
   Tsugumi(T5C158)`"If you want to know, then here goes."`;
   Tsugumi(T5C159)`"I'll tell you.... It's because in the end, 
I've become 'Your Friend.'"`;
   Takeshi`"....."`;
   Takeshi`"Why do you have to say it like that! You're 
not still..."`;
   `Tsugumi thrust her hand into her pocket and 
took something out.`;
...
you should be careful with him."`;
   ...
   `He twitched his nose and looked up at both of 
our faces inquisitively.`;
   `Tsugumi stroked Chami softly with the tip of 
her finger.`;
...
showTextbox();
text(() => {
   Tsugumi(T5C165)`"Heeey Takeshi, do you know what will happen 
if I go like THIS?"`;
   Takeshi`"!?"`;
   `Tsugumi...`;
   `Grasped both of her hands tightly together.`;
   `In between the cracks of her fingers, I could 
see Chami's soft, warm-looking gray fur.`;
   `Soon, his body disappeared entirely in her 
hands.`;
   ...
   `Chami, who only the tip of his nose was 
...
There's one for you!!"`;
   ...
   `The space between her fingers got smaller and 
smaller.`;
...
this...Chami's going to..."`;
   ...
   `At the end I thought he even let out a small 
breath.`;
...
showTextbox();
text(() => {
   `Tsugumi crushed her hands together with all 
of her might.`;
   `They pressed together.`;
   `Her hands were shaking with the effort.`;
   `From the cracks of her fingers, red droplets 
started to fall.`;
...
text(() => {
   ...
   `Probably all of the bones in his body were 
broken.`;
   `All of the blood had probably been squeezed 
from his body.`;
   `He probably hadn't had anytime to wonder, it 
had happened so fast...`;
   ...
   `But...`;
   `Tsugumi...`;
   `Was crying, and her lips trembled as she bit 
down on them.`;
...
text(() => {
   ...
   `His movements were stiff, and barely visible 
and...`;
   `Extremely slow, but...`;
   `He was actually moving.`;
   `His heart had started beating again, he had 
started thinking again, breathing again.`;
   `He shook himself off slightly...`;
   `Fluttered his ears...`;
   `And twitched his nose.`;
   `He got up on shaking legs and even tried to 
stand.`;
   `However...`;
...
text(() => {
   ...
   Takeshi`"........."`;
   `Our gondola at Qualle had already passed the 
entrance to the ride twice, and was just 
starting to make its third pass.`;
   `One pass really wasn't that long.`;
   `All together we had only been on it between 
just over 10 minutes.`;
   `In that brief time, he had returned to normal 
...
text(() => {
   Tsugumi(T5C180)`"He's..."`;
   `Tsugumi was petting Chami softly again with 
...
showTextbox();
text(() => {
   Tsugumi(T5C186)`"The first time I tried to pet him, he got 
spooked."`;
   Tsugumi(T5C187)`"He bit my finger, and my blood got all over 
him..."`;
...
text(() => {
   ...
   `Or what she had told me about the virus 
earlier.`;
   `Or what had happened right in front of me 
then.`;
...
text(() => {
   ...
   Tsugumi(T5C200)`"'It's 'enough to be alive' - you're the one 
who said that!"`;
   Tsugumi(T5C201)`"So how about it! You saw what happened 
right!?"`;
   Tsugumi(T5C202)`"You saw what happened to Chami, right? What 
I did to him?.... You SAW it Takeshi!"`;
   Tsugumi(T5C203)`"And you can say it's 'enough to still be 
alive'...? Well it isn't."`;
   Tsugumi(T5C204)`"It isn't. No matter what you say...!"`;
   Tsugumi(T5C205)`"I won't believe it!"`;
   Tsugumi(T5C206)`"It isn't enough to just have life...you 
can't say that's living!"`;
   ...
   `Like raindrops falling one by one onto the 
...
text(() => {
   ...
   Takeshi`"........."`;
   Tsugumi(T5C215)`"In the beginning there were said to be only 
...
text(() => {
   ...
   Tsugumi(T5C218)`"I was 12 at the time, and my family went to 
America because of my father's job."`;
   Tsugumi(T5C219)`"A friend of mine then..."`;
   Tsugumi(T5C220)`"Julia..."`;
   Tsugumi(T5C221)`"She and I were the same age and she had to 
go to the hospital."`;
   Tsugumi(T5C222)`"They said it was a terminal disease..."`;
   Tsugumi(T5C223)`"She had leukemia.... and was transferred 
back and forth to different places, but 
nobody could help her...."`;
   Tsugumi(T5C224)`"But I kept going to see her. To keep up her 
spirits."`;
   Tsugumi(T5C225)`"Watching her smiling face, I couldn't 
believe that she didn't have long to live."`;
   Tsugumi(T5C226)`"I thought there would be a miracle..."`;
   Tsugumi(T5C227)`"I thought if I prayed enough, she'd get 
better..."`;
   Tsugumi(T5C228)`"If I cared enough, her pain and suffering 
would be less."`;
...
showTextbox();
text(() => {
   Tsugumi(T5C233)`"Right after I left the hospital, I got hit 
by a semi-trailer."`;
   Tsugumi(T5C234)`"Broken bones throughout my body, torn muscles 
...
text(() => {
   ...
   `You don't know?`;
   `Ha, ha, ha...I don't know why, but I don't 
know.`;
...
text(() => {
   ...
   Tsugumi(T5C242)`"I was pretty sure it was somewhere in 
America."`;
...
text(() => {
   `Who are you?`;
   `I'm the physician who will be attending to 
you. `;
   `Physician? Oh, you mean you're a doctor.`;
   `Yes. I'm going to find a cure for your 
sickness and make you all better.`;
   `Cure me? ...I got in an accident, and got 
hurt...`;
   `No. It's a little different than that.`;
   `....Different?`;
   `You have a new disease. One that we've never 
seen before.`;
...
text(() => {
   ...
   Tsugumi(T5C249)`"But by the time I woke up...no, probably 
before I got in the accident."`;
   Tsugumi(T5C250)`"I was already in the process of becoming 
'immortal.'"`;
...
showTextbox();
text(() => {
   `Alright, I'd like to take a little of your 
blood.`;
   `Why?`;
   `Well, it's for research, to find a way to 
cure you, of course.`;
   `Research?`;
...
showTextbox();
text(() => {
   Tsugumi(T5C251)`"They came to take blood samples again and 
again."`;
   Tsugumi(T5C252)`"I didn't think much about it at the time. 
Why they would do that..."`;
   Tsugumi(T5C253)`"The doctors kept telling me, 'It's so we can 
...
text(() => {
   ...
   Tsugumi(T5C255)`"'You are going to have many tragedies in your 
life.'"`;
   Tsugumi(T5C256)`"'But I don't want you to be sad.'"`;
   Tsugumi(T5C257)`"'The first one in five years, then three 
years later, then another three years...'"`;

});
showTextbox();
text(() => {
   Tsugumi(T5C258)`"'But you're going to...live through all of 
them.'"`;
   Tsugumi(T5C259)`"That's pretty much what he told me."`;
   Tsugumi(T5C260)`"It didn't take long for me to understand 
...
showTextbox();
text(() => {
   `Tsugumi, take a look, there's a cat and mouse 
over there.`;
   `Oh yeah. They're so cute...`;
   `I wonder why they're in a place like this?`;
   `Yeah...Those cages are so small, it looks 
painful...`;
...
text(() => {
   ...
   `Everyone be careful! Whatever you do don't 
let them bite you!`;
...
text(() => {
   ...
   `You opened up those cages so fast, you 
surprised me.`;
   `They caught all of the animals again.`;
   `Yeah, they're right back where they were 
before.`;
...
text(() => {
   ...
   Tsugumi(T5C262)`"I began to understand bit by bit, that I 
...
research facility."`;
   ...
   Tsugumi(T5C265)`"And there were hardly ever any new 
patients..."`;
...
text(() => {
   ...
   `...I don't know...`;
   `Hmmm. But they shouldn't have been kept in 
such a cramped space anyway.`;
   `...Yeah...`;
   `Maybe the researchers thought the same thing 
...
showTextbox();
text(() => {
   `It's no good. We still haven't been able to 
discover the reason or mechanism behind it.`;
   `It happened right in front of me, but I still 
can't believe it.`;
   `The only explanation I can come up with is 
genetic transfer....It goes against 
everything we know about science.`;
   `They withstood up to 4 splicings. I think 
maybe they could take 8...`;
   `Let's keep testing.`;
   `No, if we continue...`;
   `There is no mistaking it they're still alive. 
They might still even react at 16...`;
   `But, they're not...!`;
   `These aren't living creatures anymore...is 
that what you want to say?`;
   `........`;
   `Perhaps...that way of thinking might have been 
...
text(() => {
   ...
   `.........`;
   `The cover is locked.... Umph... I can't get 
it off.`;
   `.........`;
   `Huh? What?`;
   `.........`;
...
showTextbox();
text(() => {
   Tsugumi(T5C267)`"That's what it was like for eight years, day 
in and day out."`;
   ...
   Tsugumi(T5C272)`"I was being forced to do all of these tests 
and experiments."`;
   Tsugumi(T5C273)`"And they just used me like some tool."`;
   Tsugumi(T5C274)`"I stopped being able to feel pain, or to 
suffer."`;
   Tsugumi(T5C275)`"When I went back to bed, all I could do is 
cry."`;
   Tsugumi(T5C276)`"Then one day the kid next to me didn't come 
back."`;
   Tsugumi`"........."`;
...
to say anything more."`;
   `Tsugumi was stroking Chami with a trembling 
fingers.`;
   ...
   `Spend eight years trapped in a research 
facility...`;
   `I couldn't imagine how it must have been to go 
through that.`;
   Tsugumi(T5C279)`"I hate it..."`;
   Tsugumi(T5C280)`"And I hate myself for talking about it..."`;
   Tsugumi(T5C281)`"It's funny, isn't it..."`;
   Tsugumi(T5C282)`"Whenever I'm with you, I find myself talking 
...
text(() => {
   ...
   Tsugumi(T5C287)`"You don't just take back what you say. Not 
that easily...!"`;
   Tsugumi(T5C288)`"You want irresponsible, THAT's 
irresponsible...!"`;
   Takeshi`".........!!"`;
   `I didn't know what to tell her.`;
   Tsugumi(T5C289)`"You're just like them."`;
   Tsugumi(T5C290)`"You don't understand anything..."`;
   Tsugumi(T5C291)`"You throw around words like 'friend' without 
really meaning it."`;
   Tsugumi(T5C292)`"You don't understand anything about how I'm 
feeling."`;
   Tsugumi(T5C293)`"You don't understand anything about what the 
Kid's feeling!"`;
   Takeshi`"........."`;
   `She was making me feel it had been a mistake 
to say, 'I'd been wrong.'`;
   `No...that wasn't it either.`;
   `The truth was...`;
   `There was no such thing as right and wrong.`;
   Tsugumi(T5C294)`"'People who are alive, should live as long 
as they can,' you said that didn't you...?"`;
   Tsugumi(T5C295)`"I'll survive."`;
   Tsugumi(T5C296)`"I'll probably die many times more and I'll 
still be alive."`;
   Tsugumi(T5C297)`"Chami here too..."`;
   Tsugumi(T5C298)`"But Takeshi, can you say that you're really 
alive right now?"`;
   Tsugumi(T5C299)`"Are you REALLY there, in front of me now?"`;
   Takeshi`"........."`;
   Tsugumi(T5C300)`"...What's wrong?"`;
   Tsugumi(T5C301)`"You said...you'd accept everything I had to 
say, right...?"`;
...
text(() => {
   ...
   `I had no idea how many times we'd passed by 
Qualle.`;
...
showTextbox();
text(() => {
   `I stuck out my hand to grab her but she 
...
text(() => {
   ...
   `The jellyfish I was riding on started moving 
again.`;
...
text(() => {
   ...
   `When I passed under the shadow of the 
