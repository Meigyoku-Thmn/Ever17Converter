...
showTextbox();
text(() => {
   `You, who had been talking with Sora earlier, 
...
showTextbox();
text(() => {
   `The Kid, Coco, and Pipi where chasing each 
...
showTextbox();
text(() => {
   `After having a good stretch, I watched Coco 
and the others play.`;
...
running around and around.`;
   `I seemed to be making more effort than they 
...
text(() => {
   `(Phew, what a sight...)`;
   `It looked like fun, but I quickly gave up any 
idea of joining in.`;
   `And at any rate...Tsugumi had yet to make an 
appearance this morning.`;
   `Just in case, I had left a sandwich for her at 
the kiosk.`;
   `(I don't know if she'll actually eat it or 
not...)`;
...
showTextbox();
text(() => {
   `She had confided her secrets to me on the 
Jellyfish Gondola.`;
   `Virus carrier.`;
...
text(() => {
   ...
   `She had told me while we were on the Jellyfish 
Gondola...`;
   `"Kill me"...`;
   `I couldn't.`;
   `There was no possible way I could do such a 
thing.`;
   `But still...`;
...
showTextbox();
text(() => {
   `I glanced up and noticed Coco and the others 
had stopped playing.`;
...
showTextbox();
text(() => {
   `With a worried look on his face, the Kid was 
...
showTextbox();
text(() => {
   `In the middle of the rest area stood four 
...
text(() => {
   ...
   `...With a heave, she began to climb up the 
side.`;
...
text(() => {
   `(...??)`;
   `It was an odd sight.`;
   `I ran to the Kid, as he stood frozen watching 
her.`;
...
text(() => {
   ...
   `Stumbling as she mounted the pedestal, Coco 
...
text(() => {
   Coco(T5B003)`"Yahoo!"`;
   Coco(T5B004)`"Wow, all I did was stand a little higher, 
and everything looks all different."`;
   Coco(T5B005)`"Let's see...to be exact, 27 inches higher, 
don't you think?"`;
   `Perched on top of the pedestal, Coco said this 
...
showTextbox();
text(() => {
   Coco(T5B009)`"This area right here looks like it's missing 
something."`;
...
text(() => {
   ...
   `Coco stroked the statue's back sympathetically 
with her tiny hand.`;
...
text(() => {
   ...
   `Uttering a stream of nonsense, Coco suddenly 
...
text(() => {
   ...
   `And then, another one appeared in her left 
hand.`;
...
showTextbox();
text(() => {
   `But before I could ask her anything, Coco was 
gripping two screwdrivers...`;
   `And then...`;
   `...Into the back of the statue...`;
   `...she began to carve the stone using the tip 
of the screwdriver....`;
...
text(() => {
   ...
   `Cut, cut.`;
   `Cut, cut, carve, carve...`;
   `And within moments, the back of the statue was 
covered with gashes.`;
   Takeshi`"...????"`;
   `It was incomprehensible.`;
   `I just couldn't understand it.`;
   `First she says the back looks "lonely", and 
then she starts gouging it.`;
   `For a while the Kid and I just gazed at her 
...
text(() => {
   ...
   `She worked with great dexterity, using a 
screwdriver in each hand.`;
   `The tips of the drivers dug into the stone 
screeching and forming tiny grooves.`;
   Kid(T5B028)`"Sad?"`;
   Coco(T5B029)`"Well, nobody's coming to rescue us, right? 
We've been abandoned."`;
   Coco(T5B030)`"So what harm is there in wrecking the place a 
little?"`;
   Kid`"........."`;
   Takeshi`"........."`;
...
showTextbox();
text(() => {
   `One of the shapes had a particularly large 
head.`;
...
text(() => {
   ...
   Coco(T5B036)`"For Tsugumi, it's important to make her look 
really cool..."`;
...
text(() => {
   ...
   Coco(T5B039)`"Sora is pretty, which makes her hard to 
draw..."`;
...
text(() => {
   ...
   `Singing a cute little song, Coco continued to 
carve.`;
   `She seemed entirely absorbed by what she was 
doing.`;
   `Somehow, I could relate to her desire to throw 
herself into something...`;
   Kid(T5B041)`"That's destroying private property...it's 
vandalism."`;
...
showTextbox();
text(() => {
   `Because of her unsteady position on the 
...
showTextbox();
text(() => {
   `Without hesitating, the Kid jumped forward, 
steadying her body.`;
   `He grabbed her by the hips, to prevent her 
...
text(() => {
   ...
   Coco(T5B052)`"You can carve a picture of yourself and 
Nakkyu here..."`;
   Coco(T5B053)`"And then I was thinking of carving Takepyon 
over here."`;
...
text(() => {
   ...
   `Energized by Coco's enthusiasm, the Kid took 
the screwdriver.`;
...
text(() => {
   ...
   `I was about to stretch my hands toward her but 
the Kid stopped me.`;
...
text(() => {
   ...
   `While embracing the statue in a hug, Coco and 
the Kid steadied each other.`;
   `And using their free hands, they both began 
carving shapes.`;
...
showTextbox();
text(() => {
   `The statue stood there in silence without 
...
showTextbox();
text(() => {
   `The statue didn't say a word, only stood 
...
showTextbox();
text(() => {
   `What was left in stone was the carved images 
...
text(() => {
   `That afternoon -`;
   `After a light lunch, I looked around but 
couldn't find You anywhere.`;
   Kid(T5B060)`"Looking for You? She ate lunch and then went 
to the Security Office in Zweite stock."`;
   ...
   Kid(T5B063)`"If you really want to know, why don't you go 
ask her yourself?"`;
   Takeshi`"Yeah, I guess you're right..."`;
   Coco(T5B064)`"What about Sora, where'd she go?"`;
   Kid(T5B065)`"She's still in the Control Room. I spoke to 
her through the terminal intercom, but she 
seemed really busy."`;
   `As usual, Tsugumi was nowhere to be seen...but 
the sandwich I left at the kiosk was gone...`;
   `Come to think of it, neither You, Sora nor 
...
text(() => {
   ...
   `At any rate, I figured I would go search for 
them.`;
...
text(() => {
   ...
   `I pushed the button to open the door and it 
slid open.`;
...
text(() => {
   ...
   `(That's strange...)`;
   `I wonder if this means she finished checking 
the sensor data.`;
   `But if that was the case, I thought she would 
report back to us?`;
   `(Sora...where are you?)`;
   Takeshi`"Hey, So—ra—." `;
   `I expected to find her hiding in the corner 
somewhere...`;
   `I called out for her again, but still got no 
response.`;
   `Next, I touched the terminal.`;
   `Although I didn't know how to operate it, it 
...
showTextbox();
text(() => {
   `A map of LeMU data suddenly appeared on the 
LeMMIH monitor.`;
...
showTextbox();
text(() => {
   `Turning down a corridor after climbing the 
...
text(() => {
   `(Huh....!?)`;
   `The door abruptly opened in my face, and a 
...
showTextbox();
text(() => {
   `In a flash the figure was gone, without even 
seeming to notice me.`;
   `(...Who was that??)`;
   `I whipped around quickly, trying to see who 
the person was.`;
...
text(() => {
   ...
   `The events of from the night before popped 
into my mind.`;
   `(I could stop her, but then what...?)`;
   `In the meantime, all I could see was Tsugumi's 
back fading further away.`;
   Takeshi`"Hey! Wait up! Where you going?"`;
   `Barely getting the words out, I dashed after 
her.`;
...
showTextbox();
text(() => {
   `I ran up a corridor, and hurriedly climbed the 
stairs.`;
...
showTextbox();
text(() => {
   `But the sound of her feet faded down the end 
of the emergency corridor.`;
   `Her figure had already rounded the corner out 
of sight.`;
   Takeshi`"Tsu—gu—mi...!"`;
   `I was out of breath.`;
   `I had run about 30 yards, but...`;
   Takeshi`"Damn it, Tsugumi, you sure are fast!!"`;
   `I grumbled after her, although she was now 
well out of earshot.`;
   `It didn't feel like I could catch up with her 
at all.`;
...
text(() => {
   `(But still...)`;
   `(She's still a little slower than when she 
pulled me away from the flood at the aquarium.)`;
   ...
   `Annoyed that I was out of breath, I continued 
after Tsugumi.`;
...
showTextbox();
text(() => {
   `The sound of her feet was only barely 
...
text(() => {
   ...
   `It seemed that instead of going to the third 
...
showTextbox();
text(() => {
   `Without further recourse, I gave up and walked 
...
text(() => {
   Takeshi`"Hey!! Tsugumi—!!"`;
   `I called her name without much hope, but there 
was no answer.`;
   `In the end it seemed Tsugumi hadn't noticed.`;
   `It hadn't seemed that she was trying to avoid 
me...`;
...
showTextbox();
text(() => {
   `Giving up, I went back down the stairs and 
returned to the corridor.`;
   `I decided to stop by the nearby Security 
Office.`;
...
showTextbox();
text(() => {
   `Climbing the stairs, I headed toward the 
...
showTextbox();
text(() => {
   `And as usual, the room smelled faintly of 
smoke.`;
...
text(() => {
   ...
   `Noticing me enter, You turned toward me from 
the console. `;
...
showTextbox();
text(() => {
   `I only said it in jest, but You looked 
slightly offended.`;
   You(T5B067)`"No way...how could you ask..."`;
   You(T5B068)`"You know the rules...no smoking until you're 
legal."`;
   You(T5B069)`"You can joke if you want, but I can't believe 
you'd say that."`;
...
showTextbox();
text(() => {
   You(T5B070)`"I mean, just take a look at my fresh silky 
skin!"`;
...
showTextbox();
text(() => {
   You(T5B072)`"This is the kind of beauty that's impossible 
...
showTextbox();
text(() => {
   You(T5B077)`"So tell me, Takeshi, what exactly did the Kid 
say?"`;
...
showTextbox();
text(() => {
   You(T5B078)`"Well in that case, guess I'll let you in on 
it."`;
...
text(() => {
   ...
   You(T5B080)`"I have been researching stuff about LeMU for 
quite a while now."`;
   ...
   `It must have been the first day I came to this 
place.`;
   `When You startled me by suddenly starting up 
...
showTextbox();
text(() => {
   `Eyeing the monitor, she hit some more keys and 
entered a code.`;
...
showTextbox();
text(() => {
   You(T5B084)`"If I just had the password, I could access 
all the data inside LeMMIH."`;
   You(T5B085)`"Normally, all the data concerning LeMMIH's 
system has security protection."`;
   You(T5B086)`"And of course the personal data of the 
development staff as well."`;
   You(T5B087)`"And so I'm hunting for the key to unlock that 
...
showTextbox();
text(() => {
   `Taking her eyes off the console, she looked at 
me.`;
...
LeMMIH system, won't she be affected?"`;
   You(T5B091)`"Hmm...yes..."`;
   You(T5B092)`"Naturally, if the protection is removed, Sora 
...
showTextbox();
text(() => {
   You(T5B093)`"Um Takeshiiiii...? Did you just think of 
something kinky?"`;
   Takeshi`"Me...?"`;
   You(T5B094)`"When I say naked, I don't mean Sora's image 
will be nude!"`;
...
showTextbox();
text(() => {
   You(T5B095)`"Yeah, sure... You seem pretty suspect to 
me..."`;
   You(T5B096)`"I don't really care, but..."`;
   Takeshi`"........."`;
   You(T5B097)`"Sora won't become 'nude'...but all her 
...
showTextbox();
text(() => {
   You(T5B102)`"We don't need to save Sora, she's saved 
already."`;
   Takeshi`"How's that?"`;
   You(T5B103)`"The fact is, Sora doesn't actually reside in 
LeMU."`;
   You(T5B104)`"More precisely, the brains of Sora reside in 
a super computer on Insel null."`;
   You(T5B105)`"Are you following me?"`;
   Takeshi`"........."`;
   You(T5B106)`"Meaning, that even if LeMU sinks, floods or 
explodes, Sora won't be damaged at all."`;
   You(T5B107)`"Because, she's not even here."`;
   You(T5B108)`"She really lives above the ocean."`;
   You(T5B109)`"So from our point of view...just like her 
name means in Japanese, 'Sora' is in the 
'Sky'."`;
   `With that, You pointed her finger towards the 
ceiling.`;
...
showTextbox();
text(() => {
   You(T5B111)`"Come on, Takeshi. You think it's strange, 
too, right?"`;
   You(T5B112)`"Sora said that thanks to the maintenance 
program, communication functions were 
optimized..."`;
   You(T5B113)`"In order to perform periodic maintenance, the 
master supercomputer on Insel Null has to be 
linked with LeMMIH here."`;
   You(T5B114)`"And since she said the maintenance checked 
out fine, that means..."`;
   You(T5B115)`"There might be a data communication link up 
...
showTextbox();
text(() => {
   You(T5B116)`"What I'm going to say is only speculation, 
but..."`;
   `You furrowed her brows together.`;
   You(T5B117)`"I think it's possible that someone is 
...
text(() => {
   ...
   You(T5B119)`"On the one hand, someone might have created a 
program to orchestrate the whole thing, 
including keeping Sora silent."`;
   You(T5B120)`"Or it could be that, Sora may not be 
...
showTextbox();
text(() => {
   You(T5B121)`"But for now, I don't know if it is true or 
not."`;
   You(T5B122)`"Whether my suspicions are correct, or all 
just a big misunderstanding......?"`;
   You(T5B123)`"Anyway, I can worry about that after I've 
...
showTextbox();
text(() => {
   You(T5B124)`"For now I'm just trying to access the 
supercomputer on Insel null from this console."`;

});
showTextbox();
text(() => {
   You(T5B125)`"I don't know whether I can even gain access, 
...
showTextbox();
text(() => {
   You(T5B127)`" I'm not one to go around blabbing secrets, 
and to tell the truth I'm not interested."`;
   You(T5B128)`"So don't worry, I've no intention of going 
...
text(() => {
   ...
   You(T5B134)`"But once I break this security code, I'll 
...
showTextbox();
text(() => {
   You(T5B135)`"Anyway, I'm trying to access LeMMIH's system 
core from this console."`;
   You(T5B136)`"Whether it's possible to gain access or not, 
...
text(() => {
   ...
   You(T5B139)`"Cracking the security protection is going to 
be a real pain. This stubborn code!"`;
   You(T5B140)`"So what exactly awaits hidden inside? ...It's 
...
showTextbox();
text(() => {
   You(T5B141)`"Until I can get inside, it's the same as not 
knowing a thing."`;
...
text(() => {
   ...
   `You gave me a smile.`;
   `She then popped her neck and rotated her stiff 
shoulders.`;
...
text(() => {
   ...
   You(T5B145)`"Okay."`;
   `Turning her back to me, You began to peck at 
the keyboard.`;
...
text(() => {
   ...
   `Without stopping her hands, she muttered 
quietly.`;
   You(T5B147)`"My mother used to tell me all about my 
father's habits..."`;
   You(T5B148)`"So I know there are clues to be found..."`;
   You(T5B149)`"Decoding something as inorganic as a computer 
program is possible because..."`;
   ...
   `Without saying a word, I slipped out of the 
Security Office.`;
...
text(() => {
   ...
   `If so...`;
   `No matter whether LeMU is crushed or not, 
she'd still be okay...`;
   `"Tell me Takeshi, after you escape from here 
safely, what's the first thing you want to do?"`;
   `......`;
   `Were her words just a flimsy attempt at 
compassion?`;
   `'I feel like I've gained an new perspective on 
human life.'`;
   `'Come on everybody! Believe in tomorrow, so 
you can live today...'`;
   `Were these words just robotic, programmed 
phrases...?`;
   `Simple utterances encoded to pacify and 
comfort humans...?`;
   `Suddenly, I felt a distance between Sora's 
