...
showTextbox();
text(() => {
   `There were still fish flopping around on the floor, but the water had receded a while earlier.`;
...
text(() => {
   //Park staff
   Park_staff(T1A034)`"This sector has been confirmed drained free of water..."`;
   //Park staff
   Park_staff(T1A035)`"However, 30 percent of the facility is already..."`;
...
text(() => {
   //Park staff
   Park_staff(T1A036)`"Believed to be submerged or completely flooded..."`;
...
text(() => {
   ...
   Takeshi`"It's no good blaming someone that works here like you, but..."`;
   Takeshi`"How could this happen? I want an explanation!"`;
   Takeshi`"I came here with my friends and just missed taking the elevator..."`;
...
text(() => {
   ...
   Takeshi`"I don't think that this is any one person's fault."`;
   Takeshi`"But why has this happened?"`;
   Takeshi`"That's...the issue."`;
   Takeshi`"Sorry. I'm just a little aggravated. I didn't mean to take it out on you..."`;
   //Park staff
...
text(() => {
   ...
   Takeshi`"I'm glad to be safe, but more important than that right now is who are you guys?"`;
   Takeshi`"The chick in black ran like something bionic..."`;
   Takeshi`"When the glass broke, that attendant was right next to it. But she took off at warp speed..."`;
   Takeshi`"What's up with that?"`;
   Takeshi`"And don't tell me that this is part of the this theme park atmosphere?"`;
...
text(() => {
   ...
   `The park employee was bowing so low that her head approached the floor.`;
   `For some reason her clothes were completely dry.`;
...
showTextbox();
text(() => {
   Girl(T1B000)`"It doesn't do us any good just standing around here, can you show us the way?"`;
   //Park staff
   Park_staff(T1B001)`"Certainly. There is a relatively safe place nearby. I will take you there..."`;
   `(RELATIVELY safe...?)`;
...
text(() => {
   ...
   Takeshi`"It doesn't have to be right now, but Coco, will you tell me a joke later? I'm really in the mood for one."`;
...
text(() => {
   Kid(T1B013)`"......"`;
   `The other person was the kid I helped to the infirmary.`;
...
showTextbox();
text(() => {
   Sora(T1B017)`"Well, the communication lines are down.... I've been investigating ways to restore our connection, but is going to take some time."`;
...
text(() => {
   //Park staff
   Park_staff(T1B018)`"In that case, let's go to the Central Control Room. We can monitor things in detail from there, right?"`;

});
fgload({ id: 2, name: `SO13ADM`, x: 512, useAnim: true });
showTextbox();
text(() => {
   Sora(T1B019)`"That sounds good. I wish I were more useful..."`;
   //Park staff
...
text(() => {
   ...
   //Park staff
   Park_staff(T1B021)`"We're going down to Dritte stock - the third floor underwater."`;
   //Park staff
...
showTextbox();
text(() => {
   `We took an emergency corridor behind one of the attractions.`;
   `It looked like there were a number of these narrow corridors above and below other corridors and rooms.`;
   `I figured that they were probably used as shortcuts by employees as well.`;
...
showTextbox();
text(() => {
   You(T1B024)`"You Tanaka. My real name is really a lot longer, but just call me You. What's your name?"`;
   Takeshi`"I'm Takeshi."`;
...
text(() => {
   ...
   `Me, Coco, You, Sora, the Kid, the girl in black - six of us total...`;

});
bgload({ name: `BG27A3`, transition: 20 });
showTextbox();
text(() => {
   `We arrived at Dritte stock, the third floor underwater.`;

});
bgload({ name: `BG25A3`, transition: 20 });
showTextbox();
text(() => {
   `We used the ladder in the emergency corridor to descend to another corridor and turned around the corner.`;
...
showTextbox();
text(() => {
   You(T1B026)`"What do you think? Can you learn anything from the computers here?"`;
   Sora(T1B027)`"Let's see. It looks like directly accessing it would be the fastest route."`;
...
showTextbox();
text(() => {
   Takeshi`"Hey...you can operate these computers without even touching them?"`;
   Takeshi`"I've got the latest cell phone and it's gotta touch panel."`;
...
text(() => {
   ...
   Takeshi`"Huh? Oh, it means that even if the battery dies, if you walk around with it or shake it, it will recharge itself. It takes a while though."`;
...
text(() => {
   ...
   Takeshi`"The harder you shake it, the more it lights up."`;
   `The lamp flickered.`;
   `I didn't know if she was having fun or what, but Coco kept up her maraca act for a while.`;

});
removeFG({ id: 1, useAnim: true });
showTextbox();
text(() => {
   `It looked like the PDA wasn't broken. All I had to do was wait and it would probably work again.`;
   `It seemed the professional diving waterproof specifications it had boasted were actually true.`;
   Sora`"........"`;
...
text(() => {
   ...
   `It looked like her hands weren't even touching the keyboard. I figured that was my imagination.`;
...
text(() => {
   ...
   `Sora said it in businesslike manner. She seemed done with the computer.`;
   `Everyone looked at her.`;
   Sora(T1B032)`"Everyone, please be calm."`;
   `As she said that, I notice she looked a little pale.`;
   `The room went quiet as the focus shifted to her.`;
...
text(() => {
   ...
   Sora(T1B034)`"The whole floor is flooded, except for one segment of stairs,"`;
   You(T1B035)`"Flooded? The whole first floor?"`;
   Sora(T1B036)`"Yeah. All of the partitions have dropped and it isn't possible to get through any of its corridors"`;
   ...
   Sora(T1B040)`"The watertight doors did not close in time and Sector 3 is completely flooded."`;

});
bgload({ name: `MAP03A`, transition: 20 });
showTextbox();
text(() => {
   Sora(T1B041)`"All other sectors on the other floors are currently fine."`;
   Sora(T1B042)`"However, some rooms do have water from the flood we just experienced."`;
   Sora(T1B043)`"Currently the bilge pumps are functioning, but it will take a lot of time for the water to completely drain."`;
   You(T1B044)`"Bilge pumps?"`;
   Coco(T1B045)`"Does that mean that we have electricity?"`;
   Sora(T1B046)`"Let's see..."`;
   Sora(T1B901)`"Some parts of the electric system, including the elevator are not functioning.`;
   Sora(T1B902)`The cause of this is unclear, but it would seem that circuit damage in each section is playing a role."`;
   Sora(T1B048)`"That is another reason that I was not able to survey the situation adequately before."`;
   ...
   Sora(T1B049)`"However the generator is functioning normally and supplying power."`;
   Sora(T1B050)`"So as long as the generator is operating as well as the circuitry, the water should be cleared with time."`;
   Sora(T1B051)`"Incidentally, the internal air pressure of the complex is 1 atmosphere."`;
   Sora(T1B052)`"The air is 22 percent oxygen, 75 percent nitrogen, 3 percent helium and the temperatures is 24 degrees Celsius..."`;
   Girl(T1B053)`"So, what you're basically saying is, we're safe for a while, right?"`;
   Sora(T1B054)`"I'm sorry. That is correct..."`;
   Sora(T1B055)`"Everyone, we will be forced to wait inside the complex for a while."`;
...
text(() => {
   ...
   Sora(T1B057)`"I am continuously sending out a request for assistance. However..."`;
   Sora(T1B058)`"Right now there is no guarantee that it will reach anyone."`;
   Sora(T1B059)`"All communication lines to Insel null, including the emergency ones, have been physically severed and are unusable."`;
   Sora(T1B060)`"I have also been attempting to make contact via a seafloor cable network, using sonar..."`;
   Sora(T1B061)`"Right now I cannot estimate when the network will be back online."`;
   Takeshi`"So we're like little kids lost smack in the middle of the ocean and nobody can hear our SOS..."`;
   Sora(T1B062)`"Exactly."`;
...
text(() => {
   ...
   `There was every reason for everyone to get depressed.`;
   `I sighed....`;
...
text(() => {
   ...
   `One of the group was determined to dispel the gloomy atmosphere.`;
   `You spoke so fast it was almost scary.`;
   You(T1B064)`"I'm a first year student at Kyumeikan Girl's College and I work here part-time. My name is Yubiseiharukana Tanaka. I will be your guide until the rescue team comes."`;
...
text(() => {
   ...
   You(T1B067)`"I work here part-time and only over the holidays."`;

});
fgload({ id: 1, name: `YU02BDM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T1B068)`"Well, I'm kind of new to this whole tour thing, but I will be leading the tour..."`;
...
showTextbox();
text(() => {
   You(T1B072)`"That's why I said you can call me You. The long name is a pain, isn't it?"`;
...
text(() => {
   ...
   `Boy was she full of energy. Leave it to elementary school kids...`;
...
text(() => {
   ...
   `I wondered if maybe there wasn't enough oxygen in the room...`;
...
text(() => {
   Girl`"..."`;
   `The girl in the black clothes gave our upbeat companions a cool stare.`;
...
text(() => {
   ...
   Takeshi`"...What?"`;
   Tsugumi(T1B097)`"If you had tumbled there, you would have been in the way."`;
...
text(() => {
   ...
   Takeshi`"But how about being a little more friendly? We're going to have to put up with each other until we get outta here."`;
   Tsugumi(T1B100)`"Why?"`;
   Tsugumi(T1B101)`"I don't know any of you. We just happen to all be here together."`;
   Tsugumi(T1B102)`"That's right we don't have any connection to each other..."`;
...
text(() => {
   ...
   `In my mind, I retracted my earlier thoughts about her being cute.`;
...
showTextbox();
text(() => {
   `I walked away from Tsugumi and she looked away from me.`;
...
showTextbox();
text(() => {
   `You, who was totally in control of the situation, turned to Sora who was working on the computer.`;
   Sora(T1B106)`"Oh, you mean me?"`;
   `Sora took her hands from the machine and came towards us as if she were gliding.`;

});
fgload({ id: 1, name: `SO01ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Sora(T1B107)`"Pardon me for the belated introduction. I am Sora Akanegasaki. I am a system engineer in LeMU's Development Division."`;
...
text(() => {
   ...
   `Actually, it had been bothering me since before...`;
   ...
   Takeshi`"...I'm Takeshi Kuranari. I'm 20 years old and a junior in college. Thanks."`;
...
showTextbox();
text(() => {
   Takeshi`"Assistant chief...so you're pretty high up then?"`;
   Sora(T1B111)`"Only in name, I'm really just an assistant. It's no big deal."`;
   Takeshi`"But, hey, Sora weren't you up at the gate above ground?"`;
   Takeshi`"You were giving some kind of explanation at the entrance, right? I only heard half of it, but..."`;
...
showTextbox();
text(() => {
   Coco(T1B112)`"Oh, you might be right. Are you the girl from before?"`;
...
showTextbox();
text(() => {
   Sora(T1B114)`"We are short of people here. From time to time I do that kind of work."`;
   `Sora smiled.`;
...
text(() => {
   ...
   `It took a little effort, but the atmosphere finally loosened up.`;
...
showTextbox();
text(() => {
   You(T1B120)`"Now that we have just started having so much fun, it's time to say good-bye—"`;
...
text(() => {
   ...
   `He'd been quiet the whole time, trying to stay out of the way and mostly kept to the corner of the room.`;
...
text(() => {
   `Amnesia:${wait(30)}`;
   `Refers to memories lost for a certain period of time. It is more common with new memories than with old memories.${wait(30)}`;
   `During the period of memory loss, if the person has no memories at all, it is called 'complete amnesia,' but in instances in which some memories can be recalled it is called 'partial amnesia.'`;
   fadeClearPage();
});
hideTextbox();
showTextbox();
text(() => {
   `Generally, amnesia results from trauma to the head, epileptic seizures, mental diseases and disorders that manifest themselves as memory impairments.${wait(30)}`;
   `When a person has trouble recollecting events prior to the impairment, this is called retrograde amnesia. An instance in which memory impairment is significant and continues after consciousness is restored is known as 'anterograde amnesia.'`;
   fadeClearPage();
});
hideTextbox();
showTextbox();
text(() => {
   `Amnesia caused by inherent mental factors is referred to as 'organic amnesia,' while that induced by psychological stress is typically known as 'psychogenic amnesia,' 'hysterical amnesia' being the most typical example.${wait(30)}`;
   `This is an affliction in which the victim often cannot recall knowledge relating to his or her personal history, such as one's name, history family or friends...${wait(30)}`;
   `And is often a reaction to incidents too hard to endure, which incite an unconscious desire to escape, forget or repress these experiences or events.`;
   fadeClearPage();
});
hideTextbox();
showTextbox();
text(() => {
   `Symptoms do not manifest in any particular way physically, and a person's brain functioning remains normal.${wait(30)}`;
   `People found wandering in this state are often taken in or seek help from authorities, such as the police.`;
   fadeClearPage();
});
hideTextbox();
showTextbox();
...
showTextbox();
text(() => {
   `This is especially seen in individuals with demonstrative personalities or pathological tendencies to lie.${wait(30)}`;
   `Normally in a few days or months, or with the help of hypnosis or shock therapy, the memories should return.${wait(30)}`;
   `Complete amnesia can be spurred by retrograde life amnesia. Memories are usually restored gradually beginning with older ones and treatment methods include psychiatric care, and hypnosis both narcotic and naturally induced.`;
   fadeClearPage();
});
hideTextbox();
hideTextbox();
...
text(() => {
   ...
   Sora(T1B138)`"You might have bumped your head severely somewhere."`;
   Takeshi`"Yeah, you coulda taken a tumble...like when trying to escape."`;
...
showTextbox();
text(() => {
   `Coco was playing rock, paper, scissors with her dog, Pipi....`;
...
text(() => {
   ...
   `Thankfully at least the electric drink dispenser was working.`;
   `Each person poured the drink they wanted in a paper cup.`;
...
showTextbox();
text(() => {
   You(T1B144)`"For now, let's just make a toast and a prayer to everyone's safety!"`;
...
text(() => {
   ...
   `'Hey, kid, don't you know anything about before?'`;
   `'Not even something personal about yourself?'`;
   `'What do I know...Oh!'`;
   `'I know...I'm kinda thirsty.'`;
   `That was the reason.`;
   `But reason aside, we needed a breather, so the timing was good.`;
   Takeshi`"Hey, Sora, what about you? Don't you wanna drink?"`;
...
text(() => {
   ...
   Takeshi`"Well, how about taking a load off? You been standing the whole time."`;
...
text(() => {
   `Sure...I thought.`;
   `Sora seemed older than me. She seemed polite and serious.`;
   `She seemed the typical, Japanese woman.`;
   `'Prim and proper' could be one way of describing Sora.`;
   `I looked around at my surroundings.`;
   `You was next to the kid and chatting with him.`;
   `Sometimes he would laugh or shake his head weakly.`;
   `I could overhear bits of their conversation. They were talking about his memory.`;
   You(T1B149)`"It's not that out of the ordinary."`;
   You(T1B150)`"You'll be fine. It'll fix itself in time."`;
   `It looked like the two of them were drinking orange juice.`;
   `Tsugumi was a way off from everyone and looking into the distance.`;
   `I had no idea what she was drinking.`;
   `I didn't have any idea what she was thinking either.`;
   `After agonizing over whether to drink apple juice or cocoa, Coco finally decided on both.`;
   `But she proceeded to forget about her drink immediately and Coco took a hold of Pipi's front legs and started dancing around.`;
   `It was a cute scene...`;
   `After things had calmed down, You and everyone gathered in front of the kiosk.`;

});
fgload({ id: 1, name: `YU01BDM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T1B151)`"For a while, it looks like we are going to have to spend sometime in LeMU. So there are a few things I would like to go over."`;
...
showTextbox();
text(() => {
   Sora(T1B154)`"You, would you mind if I addressed the first of those topics?"`;
...
showTextbox();
text(() => {
   `Sora stood in front of everyone and held out her arms.`;

});
playSFX({ name: `SE03_02`, a1: 0, volume: 95 });
showTextbox();
text(() => {
   `Suddenly, a holographic window materialized in the air.`;
   `I had no idea how the whole system worked, but I figured that it was the same one they had used at the entrance to the park.`;
...
text(() => {
   ...
   `Next, the emergency alarms began ringing - the cause of this was also unknown.`;
   fadeClearPage();
});
hideTextbox();
showTextbox();
...
showTextbox();
text(() => {
   `At this point, some people panicked and in the confusion opened the emergency corridor to the outside without going through decompression. It is highly probable that they are experiencing serious decompression sickness at this moment.${wait(30)}`;
   `The emergency corridor to the outside was left open for several minutes.`;
   fadeClearPage();
});
hideTextbox();
showTextbox();
...
showTextbox();
text(() => {
   `As a result, the mixture of gas in the complex designed to maintain 6 atmospheres of air pressure escaped.${wait(30)}`;
   `Apparently helium, which is lighter that oxygen or nitrogen, leaked out first. ${wait(30)}`;
   `Air pressure in the complex dropped to 1 atmosphere, the same as the level outside.`;
   fadeClearPage();
});
hideTextbox();
showTextbox();
text(() => {
   `2:39 p.m.${wait(30)}`;
   `The major power source came back on line. LeMMIH, the computer system responsible for overseeing LeMU rebooted and reset the air pressure adjustment mechanism. The air ventilation ducts were closed.${wait(30)}`;
   `However, LeMU was built to saturation diving specifications, meaning that as long as the internal air pressure was the same level or higher than the outside water pressure, it was designed not to collapse.${wait(30)}`;
   `Which meant...`;
   fadeClearPage();
});
hideTextbox();
...
text(() => {
   `3:55 p.m.${wait(30)}`;
   `When the internal air pressure dropped to 1 atmosphere, it became impossible for the external partitions to withstand the external water pressure, causing the glass to crack under the pressure, thus resulting in flooding.${wait(30)}`;
   `Subsequently, to minimize the damage from the flooding, the emergency watertight doors had automatically shut.${wait(30)}`;
...
text(() => {
   `....`;
   Sora(T1B157)`"I would like to be able to gauge the current situation more accurately...however, some monitors and sensors are still not functioning normally."`;
   Sora(T1B158)`"As a result, I can't obtain accurate data... and can only provide an outline of the situation..."`;
   Takeshi`"Hey, sorry to ask you the same question again, but..."`;
...
showTextbox();
text(() => {
   Sora(T1B159)`"Correct. I have requested confirmation from our complex management system, LeMMIH, and it has been confirmed."`;
   Takeshi`"So we can't get outta here."`;
   Sora(T1B160)`"Currently, the top priority is requesting assistance so I am doing my utmost to get the communications system back online. I must request your patience..."`;
...
text(() => {
   ...
   `I didn't want to admit it, but we were in deep trouble.`;
...
showTextbox();
text(() => {
   You(T1B161)`"Well, all we can do for now is just wait for help. Right?"`;
   Takeshi`"You just keep trying to make everyone feel better, don't you?"`;

});
fgload({ id: 1, name: `YU07BDL`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T1B162)`"Oh, I'm sorry. Would you prefer my dark, despondent, we're doomed approach?"`;
...
text(() => {
   ...
   Takeshi`"I just can't get over how cheerful you are, given how totally screwed we are."`;
...
showTextbox();
text(() => {
   You(T1B164)`"I said that's not it at all. I'm like this precisely BECAUSE of the situation."`;
...
showTextbox();
text(() => {
   `You shouldered the massive bottle and took it back inside the shop.`;
   `Carrying it she teetered like a penguin, which was funny because it really didn't suit her.`;
...
text(() => {
   Tsugumi`"........."`;
   `Tsugumi was leaning against the shop wall and staring after You.`;
   `Her face was expressionless.`;
   `I wondered what she was thinking....`;
   `I had no idea.`;
   Takeshi`"Even if we are going to wait for help..."`;
   Takeshi`"We can't just sit on our butts doing nothing. Right?"`;
...
text(() => {
   Tsugumi(T1B168)`"You..."`;
   Tsugumi(T1B169)`"You act like you're all serious, but there's really nothing going on in that head of yours is there?"`;
   Takeshi`"What? That's not true!"`;
   Takeshi`"I'm thinking. I'm always thinking."`;
   Takeshi`"Yeah. I was just thinking of a way to keep us from getting bored..."`;
...
text(() => {
   ...
   `I didn't want her to expect anything from me, but her attitude was frustrating.`;
   Takeshi`"Arrghh..."`;
...
showTextbox();
text(() => {
   Sora(T1B173)`"What's the matter, Takeshi, all of the sudden?"`;
...
text(() => {
   ...
   Takeshi`"We're not gonna accomplish anything just spending time like this, right?"`;
   Takeshi`"So I just thought, why don't we all split up and look around the complex?"`;

});
multifgload2({ id1: 2, id2: 4, name1: `KA03ADS`, name2: `SO07ADS`, x1: 320, x2: 512, useAnim: true });
showTextbox();
text(() => {
   Sora(T1B176)`"Why? Don't you think that staying in one place would be safer?"`;
   Takeshi`"No. I think we should check to see if 'staying in one place' and doing nothing is really the safest thing to do."`;
   Takeshi`"You know, walk around, see what we can find and scope out any dangers..."`;
   Takeshi`"If we find some, we can tell everyone to watch out for them or do something to get rid of them."`;
   Takeshi`"And we can see if there is a safer place...and then we could all gather there."`;
   Sora(T1B177)`"But Takeshi..."`;
   Takeshi`"It's not like the rescue squad is about to burst in the door."`;
   Takeshi`"So if we're going to have to be here in LeMU for half a day or a day or so, then..."`;
   Takeshi`"We should find out what kinda place this is and get to know it like our own house."`;

});
fgload({ id: 4, name: `SO01ADS`, x: 512, useAnim: true });
showTextbox();
text(() => {
   Sora(T1B178)`"In that case, I can provide you with an abundance of information..."`;
   Takeshi`"No that's not what I mean. Listen. Sora, you have to look after the communications network, right?"`;
   Takeshi`"You were just talking about how some sensors or monitors weren't working right and you can't get a full sense of the current situation."`;
...
showTextbox();
text(() => {
   You(T1B180)`"So, while Sora is trying to send an SOS, we should use our own two legs to see what kind of a situation we're in."`;

});
fgload({ id: 1, name: `YU15BDS`, x: 128, useAnim: true });
showTextbox();
text(() => {
   You(T1B181)`"How about it? Sora, that would be easier on you wouldn't it?"`;

});
multifgload2({ id1: 2, id2: 4, name1: `KA01ADS`, name2: `SO13ADS`, x1: 320, x2: 512, useAnim: true });
showTextbox();
text(() => {
   Sora(T1B182)`"Yes...I suppose it would. But...there are still the dangers..."`;
...
text(() => {
   ...
   `It looked like she were laughing, but her lips curled nastily.`;
...
showTextbox();
text(() => {
   Tsugumi(T1B184)`"We are going to split up and check things out, right?"`;
...
showTextbox();
text(() => {
   `Turning around she headed for the entrance to the emergency corridor.`;
...
text(() => {
   ...
   `Her shoes clacked on the metal stairs as she climbed.`;
...
showTextbox();
text(() => {
   `The kid had broken his silence and I was a little surprised.`;
   Kid(T1B188)`"It's like Takeshi says. It doesn't do us any good to just stay here..."`;
   `He continued without pausing.`;
   Kid(T1B189)`"Tsugumi just went to the second floor. I'll bet she is just going to look around there."`;
...
showTextbox();
text(() => {
   Sora(T1B194)`"I guess there is nothing I can do to stop you. Please, be careful everyone."`;
   `Sora finally nodded slightly.`;
   `Once everyone's minds were set, things picked up.`;
...
showTextbox();
text(() => {
   `Sora said she was going back to the Control Room to get data, so went our separate ways.`;
...
showTextbox();
text(() => {
   `We decided to check the normal corridors and the emergency corridors above and below them on the third floor.`;
   `Splitting into pairs where the corridor forked, we agreed to meet back at the fork when we had checked the corridor ahead...`;
...
showTextbox();
text(() => {
   `We walked every corridor that we could walk down.`;
   `I wondered if water was leaking anywhere.`;
   `I figured that the water pressure would send water spurting through any crack it could find.`;

});
bgload({ name: `BG27A1`, transition: 20 });
showTextbox();
text(() => {
   `Also, I thought there might be other people that had been left behind.`;
   `According to Sora, the system had told her that there were six people in the complex. Still, there was no guarantee that was right.`;
   `I thought that if we found somebody else, it might change our situation.`;
...
showTextbox();
text(() => {
   `There could also have been a corridor that the broken sensors weren't picking up.`;
...
showTextbox();
text(() => {
   `While we were out searching, Sora continued to try to get into contact with LeMU's central computer, LeMMIH, and gather more information.`;
...
showTextbox();
text(() => {
   `We returned to in front of the kiosk. Sora had arrived first and was waiting.`;
   `But Tsugumi was nowhere to be seen.`;
   You(T1B195)`"Tsugumi hasn't come back."`;
   Takeshi`"We can't just let her run loose...I wonder where she is."`;
...
showTextbox();
text(() => {
   Sora(T1B197)`"We checked the life reading scan of people inside the complex. Even if Tsugumi were moving around, she should still appear in the results of this scan."`;
...
text(() => {
   `(And if she is alive...)`;
   `I managed to keep that thought from coming out of my mouth.`;
   `It only took a moment for a map of LeMU and data from the sensors to appear.`;
...
showTextbox();
text(() => {
   Sora(T1B205)`"Oh, my. You're right.... I wonder what it could be..."`;

});
bgload({ name: `IT04E`, transition: 20 });
showTextbox();
text(() => {
   `Sora fiddled with the console, but the numbers on the monitor continued to fluctuate.`;
...
showTextbox();
text(() => {
   `But even while the life scan numbers changed, no new lights appeared or disappeared.`;
...
text(() => {
   ...
   Kid(T1B208)`"If the number really is supposed to be '7'..." `;
   You(T1B209)`"That's what it would mean."`;
   Kid(T1B210)`"Don't you think we should go look for that person?"`;

});
fgload({ id: 2, name: `KA04ADM`, x: 512, useAnim: true });
showTextbox();
text(() => {
   Kid(T1B211)`"I mean...they could be in trouble. We have to help them!"`;
...
showTextbox();
text(() => {
   `For a while all of our eyes were glued to the changing numbers.`;
...
text(() => {
   ...
   `The light on the second floor was moving around slowly.`;
   `The five lights on the third floor were all in one room, unmoving.`;
...
showTextbox();
text(() => {
   Sora(T1B212)`"Perhaps it...was just because of a malfunctioning sensor. The cause is unclear. Would you like to see what else we can find out?"`;
   Takeshi`"Nah. Tsugumi's on the second floor and there are five of us here..."`;
   Takeshi`"So that number '6' is probably right. Don't you think?"`;
   Kid(T1B213)`"But..."`;
   Takeshi`"Well, I figure if we go look around a little more, we'll find out soon enough."`;
   Kid`"........."`;
   You(T1B214)`"...Yeah."`;
   Takeshi`"Alright then."`;
   Takeshi`"So, do you all wanna head to the second floor...?"`;
...
showTextbox();
text(() => {
   `We climbed to the top of the long emergency stairs together.`;
   `In the end, we didn't find anybody else on the third floor.`;
   `We didn't see any routes that looked like they might lead out either.`;
   `Sora had told us there was no schedule for the communications system to be back online.`;
   `We could look at the information displayed on some of the LeMMIH terminals, which were set in some attractions and in the corridors, but we couldn't operate them in any way.`;
   `The cause for this was unclear, too.`;
   `The fact that there were no leaks on that floor was our one saving grace.`;
