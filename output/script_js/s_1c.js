...
text(() => {
   Takeshi(S1C004)`"?"`;
   You(S1C005)`"I think this kinda thing is, well, better with just girls."`;
...
showTextbox();
text(() => {
   You(S1C008)`"That way it might be easier to talk to Tsugumi..."`;
...
showTextbox();
text(() => {
   You(S1C011)`"This kinda thing gets messy when there are guys around."`;

});
fgload({ id: 1, name: `SA01ADS`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Sara(S1C012)`"Four against one triggers fear, you know? Fight or flight reactions."`;
...
showTextbox();
text(() => {
   You(S1C014)`"I've gotta hunch that Mayo and I can fix this misunderstanding."`;
...
showTextbox();
text(() => {
   You(S1C016)`"That's what it is, isn't it? We haven't done anything to make her angry, so..."`;
   Kid`"That's true."`;
   Kid`"It might be better to just let the two girls go, instead of going in a group."`;
...
showTextbox();
text(() => {
   `So with that, You and Sara headed to the Security Office.`;
...
text(() => {
   ...
   Kid`"I don't think that would accomplish anything, but..."`;
...
text(() => {
   ...
   Kid`"You, Sara and I walked so much that we just about wore holes in our shoes."`;
...
showTextbox();
text(() => {
   Takeshi(S1C023)`"In that case, why don't we give the merry-go-round a shot?"`;
   Kid`"I don't know. Two guys on the merry-go-round sounds kinda..."`;
...
showTextbox();
text(() => {
   Takeshi(S1C025)`"Well anyway, I've decided to take a look around inside LeMU."`;
   Takeshi(S1C026)`"I'm the kind of guy that just has to see things with his own two eyes."`;
...
text(() => {
   ...
   `We were to meet in front of the Security Office.`;
...
showTextbox();
text(() => {
   Sora(S1C027)`"LeMU has three layers below the ocean's surface."`;
   Sora(S1C028)`"Erste boden, Zweite stock, Dritte stock..."`;
   Sora(S1C029)`"There are 17 meters between each floor. If you go down a floor, then you go 17 meters or 51 feet deeper."`;

});
showTextbox();
text(() => {
   Sora(S1C030)`"Thus, the third floor, Dritte stock, is located at 51 meters or 103 feet depth."`;
   `With all of this time on my hands, I visited Sora in the Control Room.`;
   `Sora politely and in an easy to understand way explained to me about LeMU which I knew almost nothing.`;
   Sora(S1C031)`"Outside of Dritte is a total of 6 atmospheres of pressure, 5 atmospheres water pressure and 1 atmosphere air pressure."`;
   Sora(S1C032)`"Even if hypothetically, you were to suddenly go out into the ocean from Dritte..."`;

});
showTextbox();
text(() => {
   Sora(S1C033)`"Your lungs would be crushed to about one-sixth of their size, and approximately five-sixth of your lungs would be flooded. You would likely die in a matter of minutes."`;
...
text(() => {
   ...
   Kid`"How much pressure exactly is 5 atmospheres of water pressure? It is hard to imagine..."`;
   Sora(S1C035)`"1 atmosphere is one kilogram of weight per square centimeter."`;
   Sora(S1C036)`"The difference in pressure inside and outside of LeMU is 5 atmospheres, or a multiple of five. Please think of it as five kilograms or around 11 pounds of weight per square inch."`;
   Kid`"Five kilograms of weight per square inch..."`;
   Kid`"So for each meter it would be 100 times 100 or..."`;
   Kid`"Fifty tons!?"`;
...
text(() => {
   ...
   Kid`"They can dive to depths of about 90 feet, right?"`;

});
showTextbox();
text(() => {
   Sora(S1C038)`"The current world record for free diving is 150 meters or around 450 feet."`;
   Sora(S1C039)`"With an aqualung and pauses along the way, probably just about anyone could dive around 105 feet."`;
   Sora(S1C040)`"However, the air sent to your lungs would be highly pressurized gas."`;
   Sora(S1C041)`"But with skin diving, they don't stop to breathe along the way. Amateurs can't make it past 65 feet."`;
   Sora(S1C042)`"Any deeper than that requires intensive training."`;
...
text(() => {
   ...
   Sora(S1C044)`"Even if you can withstand the water pressure..."`;
   Sora(S1C045)`"Could you really swim the 167 feet to the surface?"`;
   Kid`"51 meters?"`;
...
text(() => {
   ...
   Sora(S1C047)`"Or five three-story school buildings stacked upon each other."`;
...
showTextbox();
text(() => {
   Sora(S1C048)`"Well, then how about a building with 10 stories?"`;
   Sora(S1C049)`"A depth of 34 meters or just over 100 feet...that is the depth of Zweite stock."`;
   Kid`"34 meters, huh?"`;
...
text(() => {
   ...
   Kid`"So basically, what you're trying to say is that we can't escape by swimming. Right, Sora?"`;
   Sora(S1C051)`"Yes."`;
   Kid`"I guess in the end all we can do is wait for help to arrive."`;
...
showTextbox();
text(() => {
   Sora(S1C053)`"What? You'd have to swim it, you know. This isn't walking or running."`;
   Kid`"But...34 meters or 102 feet...that is like right over there..."`;
   Kid`"Well I would float...actually I think it would be easier than climbing the distance on land."`;

});
fgload({ id: 1, name: `SO07ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Sora(S1C054)`"You don't have any idea how severe water pressure is at 34 meters depth, do you Kid?"`;
   Kid`"Huh? N-now hold on just a minute..."`;
   Kid`"Just a second ago...you were talking about even if one could endure the water pressure."`;

});
fgload({ id: 1, name: `SO05ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Sora(S1C055)`"That type of hypothetical talk is meaningless."`;
   Sora(S1C056)`"You can't discuss this problem without water pressure."`;
...
text(() => {
   ...
   Sora(S1C058)`"You are 102 feet deep...could you swim to the top of a 10 floor building?"`;
   `There was a severe edge to Sora's way of putting it.`;
   `I felt like there was something of a warning contained within her words.`;
   Kid`"...S-Sora, you don't..."`;
   Kid`"You don't really think that I would try to break out of Zweite stock and swim to freedom, do you?"`;
...
text(() => {
   ...
   Kid`"Ha,ha,ha. No way."`;
   Kid`"Why would I do anything that reckless and crazy?"`;
...
text(() => {
   ...
   Kid`"Right now all we can do is patiently wait for help...right?"`;
...
showTextbox();
text(() => {
   `As I was so involved in my chat with Sora, I had missed the appointed meeting time.`;
   `I left the Control Room and headed toward the meeting point ? in front of the Security Office.`;
   `But...`;
...
text(() => {
   ...
   Kid`"Hey! Takeshi!"`;
   `I tried to call out to him, but there was no reply.`;
   `Glancing at the Security Office, I noticed that the door was wide open.`;
...
text(() => {
   ...
   `I figured Sora would be in the Control Room monitoring me.`;
   `But apparently she wasn't...`;
   `There were no sounds from the speakers on the ceiling.`;
...
text(() => {
   `The merry-go-round`;
   `Several dozen dolphins were connected in a circle.`;
   `There were no horses. No carriages. There were no children's voices.`;
   `And the blue ocean was just one paneling of wall away...`;
   `We were all trapped in this place...`;
   `Thinking this, it was hard to believe that the scenery spreading before me was reality.`;
   `(What...what am I doing here...?)`;
   `That thought popped into my mind.`;
   `What I was experiencing right now seemed much more bizarre to me than the fact that I'd lost my memory.`;
   `In other words, my doubts about the past were less than my sense of unease about the present.`;
   `I was overcome by a sense that my existence was floating away.`;
...
showTextbox();
text(() => {
   Kid`"Oh. I talked to Sara and she said that things were no good with Tsugumi."`;
...
showTextbox();
text(() => {
   Kid`"That reminds me, so how were things with Tsugumi?"`;
...
text(() => {
   ...
   You(S1C068)`"We started with light conversation about how old she was, where she lived, if she was hungry. We were biding our time waiting for the right pitch."`;
   You(S1C069)`"Ultimately...Mayo asked her straight out 'Why are you so mad?'..."`;
...
showTextbox();
text(() => {
   You(S1C071)`"It was like we waited and waited for a good pitch. But we didn't get anything so we swung."`;
   Kid`"So it was a big zero?"`;
   You(S1C072)`"I don't know if it was a zero. But we sure didn't hit a home run."`;
   You(S1C073)`"All we can do is wait for her to get careless and throw the right pitch."`;
   Kid`And get her out...`;
...
showTextbox();
text(() => {
   You(S1C075)`"I just wanted to get a sense...to feel what she is all about."`;
   You(S1C076)`"Reasons aside, there is just something not pleasant about being disliked."`;
...
text(() => {
   ...
   `She got on the platform of the merry-go-round and petted the fin of a dolphin.`;
   `I followed after You and jumped on the back of a dolphin.`;
...
text(() => {
   ...
   Kid`"I was looking for everyone. When I went to the Security Office, nobody was there..."`;
   Kid`"What about you, You? What were you doing?"`;
   You(S1C078)`"I was just hanging around this area, near the merry-go-round."`;
...
text(() => {
   ...
   Kid`"Probably because it's not turned on. There should be an operating panel around somewhere."`;
   You(S1C081)`"You think if we turn it on, then the dolphin will move?"`;
   Kid`"Yeah, probably."`;
...
showTextbox();
text(() => {
   You(S1C082)`"And swim in the ocean and catch fish and stuff?"`;
   Kid`"...What?"`;
...
text(() => {
   ...
   You(S1C084)`"Because inside LeMU there are dolphins and whales and fish and clams and octopus. There are even jellyfish and sea anemones, but..."`;
   You(S1C085)`"But none of them are real living creatures."`;
   Kid`"Of course not. They were all made by people..."`;
...
showTextbox();
text(() => {
   You(S1C087)`"For example, deep in a forest it would be harder to find something that is not alive than something that is, right?"`;
   You(S1C088)`"There are trees and grass, birds and bugs, soil and little living creatures inside of it. Everything is alive."`;
...
text(() => {
   ...
   You(S1C090)`"The only thing that is alive in this vast space is us."`;
   You(S1C091)`"And they call this an underwater paradise? A 'Utopia'?"`;
   You(S1C092)`"So in this 'Utopia' living things are outnumbered by nonliving things."`;
   You(S1C093)`"Which in a way means we are..."`;
   You(S1C094)`"We are 'intruders' in this world of the dead."`;
   `You petted the dolphin.`;
   `The dolphin's deformed, plastic smile didn't move at all.`;
...
text(() => {
   ...
   Kid`"But you liked it enough to start working here, right?"`;
...
text(() => {
   ...
   `Then she just clammed up and started wandering around one of the dolphins.`;
   `Finally her feet stopped and You quietly faced me.`;
...
showTextbox();
text(() => {
   You(S1C102)`"Actually, my father worked in the Research and Development Division of LeMU."`;
   Kid`"Research and development?"`;
   You(S1C103)`"I don't know the details..."`;
   You(S1C104)`"It seems like my father made the LeMMIH program."`;
   Kid`"LeMMIH...LeMMIH? Wasn't that LeMU's central computer?"`;
   You(S1C105)`"Yeah."`;
...
text(() => {
   ...
   You(S1C107)`"He was one of the members involved in developing the project."`;
...
showTextbox();
text(() => {
   You(S1C112)`"He has been missing as long as I can remember..."`;
   You(S1C113)`"It was when I was one year old, 17 years ago..."`;
...
text(() => {
   ...
   You(S1C117)`"Everything I just told you I heard from my mother..."`;
...
text(() => {
   ...
   You(S1C120)`"So I thought that if I came here maybe I would find some clue about my father..."`;
   You(S1C121)`"It seems like my mom has already given up, so I can't count on her..."`;
   Kid`"...?"`;
   You(S1C122)`"My mom has convinced herself that my dad is dead..."`;
...
showTextbox();
text(() => {
   You(S1C127)`"My father just went missing...and his remains were never found...!"`;
   `I couldn't find any words.`;
   `I didn't know what to say to her.`;
   `She might have been waiting for me say something like: 'You're right! He's probably alive somewhere!'`;
   `But I couldn't say it.`;
   `I just nodded and couldn't even look back into her eyes.`;
...
showTextbox();
text(() => {
   `Finally...we promised to meet later in the Conference Room and split up.`;
...
text(() => {
   ...
   `Tsugumi was there.`;
   `Her back was to me and she was looking at the entrance.`;
   `I called out to her loudly.`;
   Kid`"Want to ride the gondola?"`;
   `Tsugumi turned to look at me.`;
   `But she immediately turned on her heel and walked away.`;
   Kid`"Wait a minute..."`;
...
text(() => {
   ...
   Tsugumi`"........."`;
   Kid`"Before you said something about 'those guys' or something, right?"`;
...
text(() => {
   ...
   `She narrowed her eyes almost as if appraising me.`;
   `Intimidated by her intense glare, my body stiffened and I swallowed.`;
...
text(() => {
   Tsugumi(S1C135)`"Fine."`;
   Tsugumi(S1C136)`"Well, if you aren't lying...then I'll warn you about one thing."`;
...
text(() => {
   ...
   Kid`"U...using me?"`;
   Kid`"So...so who do you mean when you say those guys?"`;
...
text(() => {
   ...
   Tsugumi(S1C142)`"If something happens, I'm not going to help you..."`;
...
text(() => {
   ...
   `Having no idea what had just happened, I simply stood there.`;
...
text(() => {
   ...
   `(...What's that?)`;
   `The watertight door at the entrance was slightly open.`;
   `I was sure it was closed when I had come by here with You and everyone.`;
   Kid`"Is anyone there?"`;
...
text(() => {
   ...
   `I didn't know if I'd surprised her, but her face seemed to stiffen.`;
...
showTextbox();
text(() => {
   Sara(S1C147)`"In the end, she didn't tell us anything. We were just running in circles...and it wore me out..."`;
   Kid`"I see..."`;
...
showTextbox();
text(() => {
   Sara(S1C148)`"Actually, Nakkyu said that she wanted to be alone, so we just went our separate ways."`;
   Kid`"Hmmm."`;
...
text(() => {
   Sara`"..."`;
   `Sara sighed slightly and held her hands out, palms facing up.`;
   Kid`"I see..."`;
...
showTextbox();
text(() => {
   `Feminine intuition aside, not even the two girls had been able to get through to her. Even though there was no apparent reason for Tsugumi to hold a grudge...`;
   `What could Tsugumi have been so angry with us about?`;
...
text(() => {
   ...
   Sora(S1C150)`"It appears that even LeMMIH is not able to accurately gauge the situation."`;
   Sora(S1C151)`"This is...it is something that would normally be unthinkable."`;
...
text(() => {
   ...
   Kid`"She said her dad was a member of the development project team."`;
...
showTextbox();
text(() => {
   `I turned my eyes to the massive monitor behind Sora.`;
   `A flat map of LeMU's Zweite stock and Dritte stock floors was displayed.`;
   `LeMMIH was monitoring LeMU, wall-to-wall, 24 hours a day.`;
   `If LeMMIH, couldn't survey the situation, then what in the world...?`;
...
showTextbox();
text(() => {
   Sora(S1C158A)`"'Leiblich Medizin:Multiverfahren ${waitVoice}${voice(S1C158B)}Intelligent Hirn System.' ${waitVoice}${voice(S1C158C)}...actually indicates it."`;

});
showTextbox();
text(() => {
   Kid`"Uh...what was that? Can you give it to me one more time?"`;

});
showTextbox();
text(() => {
   Sora(S1C159A)`"'Leiblich Medizin:Multiverfahren ${waitVoice}${voice(S1C159B)}Intelligent Hirn System.' ${waitVoice}${voice(S1C159C)}...actually indicates it."`;
...
showTextbox();
text(() => {
   Sora(S1C161A)`"The first part,${waitVoice}${voice(S1C161B)}Leiblich Medizin, indicates ${waitVoice}${voice(S1C161C)}the name of a pharmaceutical company."`;

});
showTextbox();
text(() => {
   Sora(S1C162)`"The bit after that means something along the lines of 'parallel processing artificial intelligence system.'"`;
   Sora(S1C163)`"The first letter of each word created the acronym 'LeMMIH' so they called the system 'LeMMIH'."`;
   Kid`"Uh-huh.... I see."`;
   Kid`"Hey, there are two things I wanted to ask you..."`;
...
showTextbox();
text(() => {
   Sora(S1C165)`"'Leiblich Medizin'...In Japan it is known as Leiblich Pharmaceuticals."`;
   Kid`"So what is the relationship between Leiblich and LeMU?"`;
   Sora(S1C166)`"The company managing this theme park is called LeMU."`;
   Sora(S1C167)`"And the largest stockholder is Leiblich Medicine."`;
   Kid`"I see..."`;
   Kid`"So essentially I guess that Leiblich has the right to say whatever happens at LeMU."`;

});
showTextbox();
text(() => {
   Sora(S1C168)`"I suppose that is a reasonable interpretation."`;

});
showTextbox();
text(() => {
   Sora(S1C169)`"The origin of the name of this theme park..."`;
   Sora(S1C170)`"The official line is that it was named after the phantom or lost continent Lemuria."`;
   Sora(S1C171)`"But actually I've heard that it's just a combination of the first letters of 'Leiblich Medizin' and 'Utopie.'"`;
   Sora(S1C172)`"'Utopie' means utopia."`;

});
showTextbox();
text(() => {
   Sora(S1C173)`"In other words, Leiblich created this place to be a dream-like utopia..."`;
...
text(() => {
   Sora(S1C176)`"German?"`;
   Kid`"Yeah."`;
   Kid`"You just said that LeMMIH's official name is German, right?"`;
   Kid`"And all around LeMU are these German signs and stuff..."`;
...
showTextbox();
text(() => {
   Sora(S1C177)`"That's because Leiblich Pharmaceutical is a joint venture between a Japanese and a German company."`;
   Sora(S1C178)`"It's headquarters are in Frankfurt and the majority of officials are German."`;
   Kid`"So that's why it's all in German..."`;
   Kid`"So Leiblich Pharmaceutical had a pretty strong relationship with LeMU then?"`;
   Sora`"........."`;
...
text(() => {
   ...
   Kid`"Why did Leiblich Pharmaceutical want to run a theme park anyhow?"`;
   Kid`"I mean, we're talking about Leiblich Pharmaceutical. They make medicine , right? That doesn't seem to have anything to do with a theme park."`;
   Kid`"And, and this is right in the middle of the ocean, right? Why go to all of the trouble of..."`;
...
text(() => {
   ...
   Sora`"........."`;
   Kid`"I can't imagine that a 'kid' like me finding out could cause any damage."`;
   Sora`"........."`;
...
text(() => {
   ...
   Kid`"You have to keep the secret as part of your job, right? There's nothing you can do about it..."`;
   Sora`"........."`;
   Kid`"........."`;
   Sora`"..............."`;
   Kid`"..............."`;
...
showTextbox();
text(() => {
   Sora(S1C187)`"LeMu does not rely on energy provided from the outside, but generates all of its energy in this complex."`;
   Sora(S1C188)`"And directly under us at a depth of 119 meters or 357 feet is the seafloor..."`;

});
fgload({ id: 1, name: `SO05ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Sora(S1C189)`"There is a thermal vent on the surface of the sea floor, where water several hundred degrees is pumped out and heat from that is used to operate generators."`;
...
text(() => {
   ...
   Kid`"And? What does that have to do with what we were just talking about?"`;
...
showTextbox();
text(() => {
   `LeMU was controlled by a Japanese-German joint venture called Leiblich Pharmaceutical...`;
   `Why would they build a theme park here?`;
   `And what could it have to do with the fact that they generated their own energy...?`;
...
text(() => {
   `(Oh...Takeshi!)`;
   `I was surprised upon returning to the Security Office.`;
   `Takeshi was there.`;
   `(I wonder what he is up to...)`;
   `He had both hands on the operating panel and was staring into the monitor intently.`;
   `I was about to call out to him...`;
   `But I hesitated.`;
   `The gaze that Takeshi had leveled on the monitor...`;
   `It was so intense that it made my spine tingle...`;
   `He had the eyes of a hawk scouring the horizon for prey.`;
   Kid`"...Take...shi..."`;
...
showTextbox();
text(() => {
   Takeshi(S1C191)`"Hey, Kid, you finally made it. I'm beat from waiting."`;
   `The look on Takeshi's face was his normal old goofy expression.`;
   `I felt relieved.`;
   Kid`"What were you doing? You looked so intense it was scary."`;
...
showTextbox();
text(() => {
   Takeshi(S1C193)`"That's kind of rude. What's so scary about my face?"`;
...
text(() => {
   ...
   Kid`"Huh? Uh...um..."`;
   Kid`"I think your face was kind of like this...glaring at the monitor..."`;
...
text(() => {
   ...
   Kid`"For me?"`;
   Takeshi(S1C198)`"Because you didn't show up forever. I thought I'd call you on the complex intercom system."`;
   Kid`"Huh?"`;
   Takeshi(S1C199)`"I figured you were probably lost somewhere and crying yourself silly..."`;
   Kid`"What are you talking about? I was about to say the same thing to you!" `;
   Kid`"You weren't here at the time we set up. Where have you been until now?"`;

});
fgload({ id: 1, name: `KB04ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Takeshi(S1C200)`"Stupid! You're the one that wasn't here, right? You're totally late."`;
   Kid`"Oh...sorry..about that. B-but you could have waited a little longer."`;

});
fgload({ id: 1, name: `KB08ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Takeshi(S1C201)`"Hey, I'm a busy guy. I'm not here to look after you."`;
   Kid`"Busy?...You??"`;
   Takeshi(S1C202)`"Yup. I'm horribly busy."`;
   Kid`"Liar. Until a while ago you we were wasting time together."`;
...
text(() => {
   ...
   `That dissolved any tension that was in the atmosphere.`;
   `I didn't get it...`;
   `But at some point I had began to feel comfortable with him.`;
   `I thought there was something about him...something like me maybe...`;

});
fgload({ id: 1, name: `KB01ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Takeshi(S1C208)`"So how's your condition coming along? Any changes?"`;
...
showTextbox();
text(() => {
   Takeshi(S1C210)`"Well, don't force it. It's like Sora said. Memory loss can heal at just the slightest thing."`;
...
showTextbox();
text(() => {
   Takeshi(S1C213)`"Well, for now...why don't you just try to remember things starting with stuff familiar to you?"`;
...
text(() => {
   ...
   Kid`"I thought that if I heard the year then I might be able to remember at least my birthday."`;
   Takeshi(S1C223)`"I see. Come to think of it, you don't even know how old you are, huh?"`;
   Kid`"No..."`;
...
showTextbox();
text(() => {
   Takeshi(S1C224)`"By the looks of it, I'd say you're not a day over 42."`;
   Kid`"What!?"`;
...
text(() => {
   ...
   Takeshi(S1C227)`"You're probably in the neighborhood of 14 or 15."`;
...
showTextbox();
text(() => {
   Takeshi(S1C229)`"Well, I'm getting out of here. Actually, I haven't finished looking around."`;
   Kid`"Oh, hey, Takeshi! It seems like everybody is scattered all over right now..."`;

});
fgload({ id: 1, name: `KB01ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Takeshi(S1C230)`"Yeah? We'll have to arrange to meet somewhere sooner or later."`;
   Kid`"I think the Conference Room would be good."`;
   Takeshi(S1C231)`"Got it. If I see the others, then I'll give em' the word."`;
...
text(() => {
   ...
   `Someone was crossing the corridor where it came to a T up ahead.`;
   `A girl!?`;
   `It was a girl that I had never seen before.`;
   `I followed after her as if I were being pulled in by her.`;
...
text(() => {
   ...
   `It looked like there was another room directly below the infirmary.`;
   `I pushed the button calling the lift and hopped in.`;
...
showTextbox();
text(() => {
   Takeshi(S1C242)`"Hey cut it out, will you? .... You get tired of memory loss and are working on hallucinating now?"`;
...
text(() => {
   ...
   Takeshi(S1C248)`"Alright, alright. I'll listen to the whole story later."`;
   Kid`"But..."`;
...
showTextbox();
text(() => {
   Takeshi(S1C249)`"But nothing! You're going to piss me off if you keep this up!"`;

});
fgload({ id: 1, name: `KB01ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Takeshi(S1C250)`"Everyone is waiting for you...to eat together..."`;
...
text(() => {
   ...
   `There were fried chicken sandwiches and drinks secured from the sandwich shop for everyone.`;
...
text(() => {
   ...
   `I wondered if it was, like Takeshi said - a hallucination.`;
   `If not, then...a ghost?`;
...
text(() => {
   ...
   You(S1C257)`"These cans contain pop made with special gas so that they are made at 6 atmospheres."`;
   You(S1C258)`"But right now we are at 1 atmosphere, right?"`;
   You(S1C259)`"So if you don't hold it down when you open it, the carbonation inside explodes..."`;
...
text(() => {
   ...
   `The people on the floating island should have known that we were all trapped down here.`;
   `So why didn't anyone come?`;
   `Even if they couldn't open the watertight doors, there should be divers that could tap on the window glass or something...`;
...
showTextbox();
text(() => {
   Sora(S1C260)`"Everyone, I think it is best that we go to sleep this evening."`;
...
showTextbox();
text(() => {
   Sora(S1C264)`"In the sectors that were submerged in water, but unfortunately not in the dry areas..."`;

});
fgload({ id: 4, name: `SO01ADS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Sora(S1C265)`"Instead, I have prepared another place for you."`;
...
text(() => {
   ...
   Kid`"You're not saying that four people have to sleep in this cramped space?"`;
...
text(() => {
   ...
   Sora(S1C270)`"This is a decompression room for medical purposes."`;
   Sora(S1C271)`"Here people suffering from decompression sickness, or the bends, are treated."`;
...
text(() => {
   Sora(S1C273)`"Yes."`;
   Sora(S1C274)`"Normally when people leave LeMU they spend an extended period of time going through decompression and adjusting from 6 atmospheres to 1 atmosphere."`;
   Sora(S1C275)`"However, as a result of the accident, everyone has experienced a sudden change in pressure."`;
...
showTextbox();
text(() => {
   Sora(S1C277)`"So, just to be safe, I want to have everyone undergo repressurization in this room..."`;
   Kid`"But...there is nothing wrong with us."`;
   Sora(S1C278)`"In cases of light decompression sickness, you are not necessarily aware of it immediately."`;
   Sora(S1C279)`"There are cases where the pain doesn't start for a day or two."`;

});
fgload({ id: 1, name: `KB08ADM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Takeshi(S1C280)`"After you figure out you're in trouble, it's too late...?"`;
...
text(() => {
   Sora(S1C281)`"Correct."`;
   Sora(S1C282)`"In other words, this is just to be completely safe."`;
...
showTextbox();
text(() => {
   You(S1C283)`"Hey, Sora. What about the...uh...that...thing...in the infirmary?"`;
   You(S1C284)`"There was a device there to diagnose all kind of illnesses, right?"`;
...
showTextbox();
text(() => {
   You(S1C287)`"If you do a scan with that, can't you tell right away if you've got decompression sickness?"`;
...
text(() => {
   You(S1C289)`"Why?"`;
   Sora(S1C290)`"As you saw before, that device is out of order. Discovering the problem and repairing it would take time and energy."`;
...
text(() => {
   Sora(S1C293)`"What?"`;
   Sara(S1C294)`"I want to know more about this decompression sickness..."`;
...
showTextbox();
text(() => {
   Sora(S1C296)`"Decompression sickness occurs when there is a sudden change in the surrounding air pressure and gas bubbles that can't be discharged accrue in the body." `;
   Sora(S1C297)`"Gas becomes air bubbles and these gather in tissues or veins."`;
   Sora(S1C298)`"When gas bubbles remain inside the body, the oxygen respiration efficiency drops dramatically."`;
...
showTextbox();
text(() => {
   Takeshi(S1C299)`"So...no matter how many deep breaths you take it feels like you are suffocating?"`;
...
showTextbox();
text(() => {
   Sora(S1C301)`"So we will seal this room and pump in a high concentration of oxygen, raising the level to approximately 3 atmospheres..."`;
   Sora(S1C302)`"Then we slowly decompress you back down to 1 atmosphere." `;
   Sora(S1C303)`"Using this difference in pressure we dissolve the gas bubbles in your body back into your blood, where you get rid of them naturally by breathing."`;

});
fgload({ id: 1, name: `KB08ADM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Takeshi(S1C304)`"You mean you make us like a can of cola that won't blow up..."`;
...
showTextbox();
text(() => {
   `I wondered where in the world Tsugumi could have gone.`;

});
if (l_know_sora_is_an_ai != 0) goto(lbl_00001d1b);
showTextbox();
text(() => {
   `And shouldn't Sora have been undergoing decompression as well?`;

});
let lbl_00001d1b;
showTextbox();
text(() => {
   `I was so tired that my mind and body felt numb, but strangely sleep didn't come for me.`;
   ...
   `I gradually got annoyed with Takeshi sleeping like a log.`;
   `There were still four hours until the decompression was complete.`;
   `The night was long...`;
