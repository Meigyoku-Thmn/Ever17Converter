...
it impossible to climb up to Zweite stock.`;
   `According to You there were a total of 12 
emergency stairs in LeMU.`;
   `Three of those were closed off, so that 
left nine.`;
   `You and I walked around emergency corridors
...
text(() => {
   `And a dead end...`;
   `Inside the sprawling LeMU complex, there was 
...
showTextbox();
text(() => {
   You(S1A185)`"It looks like the only thing left is to go 
down a floor..."`;
...
up, we could still go down.`;
   `You and I wound around and around the spiral
...
text(() => {
   Kid`"Wa...water..."`;
   `I muttered this without thinking when we 
reached the floor.`;
...
text(() => {
   ...
   `Now that she mentioned it, there was not even a
...
showTextbox();
text(() => {
   You(S1A188)`"This must be from the water that washed us 
away earlier."`;
   You(S1A189)`"I figure the seawater that pooled on Zweite 
stock flowed down here."`;
   You(S1A190)`"Maybe via the emergency stairs, or a vent...
...
the seafloor had risen up.`;
   `As You and I looked around the wide room our 
...
expected.`;
   `But somehow walking in the water in shoes was,
well, unpleasant.`;
...
showTextbox();
text(() => {
   `When we turned in to a corridor, we heard an
unexpected sound.`;
...
text(() => {
   ...
   //??
   Unk(S1A198)`"Anybody?"`;
   `Two girl's voices could be heard from 
within the elevator.`;
...
showTextbox();
text(() => {
   `You placed both of her hands on the door and
pushed left and right.`;
   You(S1A204)`"Uggggh!"`;
   You(S1A205)`"Oh! Why do we keep running into problems like
this?"`;
   Kid`"Won't it open?"`;
...
showTextbox();
text(() => {
   You(S1A206)`"If you were paying attention, you'd be able to
...
showTextbox();
text(() => {
   `I switched places with You and reached out 
...
finger.`;
   `But it was the digit next to that that caught
my eye.`;
...
text(() => {
   ...
   `I suddenly bent my thumb under, hiding 
the scar.`;
   `For some reason I didn't want her to see it.`;
   `You took an adhesive bandage from her pocket
...
showTextbox();
text(() => {
   You(S1A212)`"But it seems there is someone that needs even
...
showTextbox();
text(() => {
   You(S1A216)`"See this? You take it like this... then do
this... around and around and around..."`;
   `As she said this, You screwed the capped 
...
showTextbox();
text(() => {
   `I jabbed my finger into open space gap and 
...
stuck right before arriving at Dritte stock.`;
   `Above the door, jutting out some 20 inches or
...
text(() => {
   ...
   You(S1A221)`"In this type of situation, it is the stronger
...
myself, and stood up all at once.`;
   ...
   `You took the marker and started prying it 
...
text(() => {
   Kid`"Ahhh!"`;
   `I don't know why, but all three of us 
exclaimed at once.`;
...
text(() => {
   ...
   You(S1A229)`"Why'd you fall like that? You could have hurt
someone!"`;
...
down from heaven.`;
   ...
   `I didn't know why...`;
   `It was a bizarre sense of something-like deja
...
vague sense about things.`;
   //??
   Unk(S1A233)`"Huh? Why is the floor all wet? Did a water 
pipe burst?"`;
...
text(() => {
   ...
   `The girl said this as she descended from the
...
showTextbox();
text(() => {
   Mayo(S1A238)`"Whaddya mean? If you'd take a look at my 
outfit you'd know."`;
...
showTextbox();
text(() => {
   You(S1A241)`"Oh. Right...Mayo, you're still a junior, 
yeah?"`;
...
showTextbox();
text(() => {
   Mayo(S1A244)`"Have you forgotten everything about your 
...
text(() => {
   ...
   Mayo(S1A247)`"At Kyumeikan, juniors are supposed to go 
out and volunteer somewhere, right?"`;
   Mayo(S1A248)`"Nakkyu, you just graduated this year so you've
...
showTextbox();
text(() => {
   You(S1A251)`"Well...that was the official name, but it was
really just a glorified field trip."`;
   You(S1A252)`"It's still the same old deal, I bet."`;
   You(S1A253)`"The girls go 'help' out at LeMU for a day, or
...
text(() => {
   ...
   You(S1A255)`"When I was there we went to United Land...
but I guess they changed it to LeMU, huh?"`;
   Mayo(S1A256)`"You didn't see any other students,
did you Nakkyu?"`;
   Mayo(S1A257)`"The whole Kyumeikan junior class 
should be here."`;
...
stuck in.`;
   `I grabbed on to the entrance of the box and
...
text(() => {
   ...
   `You asked me this when I returned to 
the ground.`;
...
showTextbox();
text(() => {
   `You shot the question right back at me and then
looked back at Mayo.`;
...
showTextbox();
text(() => {
   You(S1A263)`"No big deal? You suddenly start doing 
...
showTextbox();
text(() => {
   You(S1A264)`"Now, now...why aren't all youngsters as easy
going as you these days?"`;
   `You shrugged her shoulders in an 
exaggerated way.`;
...
text(() => {
   ...
   You(S1A269)`"We just met a while ago...but, you know, a lot
...
text(() => {
   Kid`"Wow?"`;
   Sara(S1A286)`"That's kind of cool, isn't it? I mean, like,
amnesia."`;
   Sara(S1A287)`"It sounds kind of like an international man of
...
showTextbox();
text(() => {
   Sara(S1A288)`"Like, maybe...you could be being hunted by an
...
showTextbox();
text(() => {
   You(S1A289)`"I keep trying to tell you not to take 
things so seriously."`;
...
text(() => {
   ...
   `It goes without saying, but Sara 
...
showTextbox();
text(() => {
   `While we walked, You brought Sara up to speed 
with the situation, while walking next to her.`;
   `She told her that You herself was working at 
LeMU.`;
   `How I had collapsed in by the kiosk.`;
   `How after falling down, I was hauled to the
infirmary.`;
...
showTextbox();
text(() => {
   You(S1A295)`"And then, you know, suddenly the alarm started
ringing..."`;
   Kid`"Alarm?"`;
...
showTextbox();
text(() => {
   You(S1A297)`"While you were out, they rang the emergency
evacuation alarm."`;
...
showTextbox();
text(() => {
   You(S1A298)`"I don't know the why...but it said: 'Anyway,
...
text(() => {
   Sara(S1A300)`"Yes."`;
   Sara(S1A301)`"Suddenly the elevator stopped...and I got 
stuck inside..."`;
...
showTextbox();
text(() => {
   Sara(S1A302)`"I think it was right after that when 
I heard the alarm."`;
...
showTextbox();
text(() => {
   You(S1A303)`"And then there were three other staffers and
myself in the infirmary..."`;
   You(S1A304)`"The other three said they would go out to 
check what was going on and never came back. 
I waited, but nobody returned."`;
   You(S1A305)`"The only two people left in the room were 
me and you..."`;
...
showTextbox();
text(() => {
   You(S1A307)`"And at that point, I wasn't really even that
worried."`;
   You(S1A308)`"I figured probably some kid had just gone and
...
showTextbox();
text(() => {
   Sara(S1A309)`"I figured, even with a prank, it must be 
...
floating island.`;
   `And of course, You also told Sara about how 
...
text(() => {
   `After that...`;
   `I, You and Sara did a complete check of Dritte
stock's corridors.`;
   `But...`;
...
showTextbox();
text(() => {
   You(S1A315)`"Hmmm. Good question. This is the first 
time I've been here..."`;
...
ten-key display next to the door.`;
   `You should have known that it was a waste of
energy...`;
...
text(() => {
   ...
   `Both You and Sara wore tired expressions as if
...
showTextbox();
text(() => {
   Sara(S1A326)`"Anything else? Hello...you know we are in the
...
showTextbox();
text(() => {
   Sara(S1A327)`"Oh, I see. So you're saying that we use that
...
text(() => {
   ...
   Kid`"Huh? Why not?"`;
   You(S1A329)`"The ducts that go to the outside aren't big
...
text(() => {
   ...
   Sara(S1A330)`"I wish I could at least contact my friends
outside..."`;
...
text(() => {
   ...
   You(S1A335)`"From there we should at least be able to 
...
showTextbox();
text(() => {
   `You did a fantastic heel stomp on the console
in the Control Room.`;
...
that chair!?"`;
   You(S1A339)`"I'm going smash it into this stupid...
machine!"`;
   You(S1A340)`"I'm going to destroy it! I mean smithereens!
Absolutely pulverize it!"`;
   Sara(S1A341)`"Ta-take it easy! Just calm down!"`;
   You(S1A342)`"How do you expect me to stay calm in a 
situation like this?"`;
   You(S1A343)`"How can all of the communication lines 
be down!"`;
   You(S1A344)`"E-mail, too. Even the emergency line won't go
through!"`;
   ...
   `Sara and I restrained You and dragged her 
...
showTextbox();
text(() => {
   You(S1A349)`"It's no use! After we already looked 
everywhere?"`;
...
text(() => {
   Sara(S1A350)`"I see."`;
   Sara(S1A351)`"There might be something like a secret passage
hidden or something..."`;
   You(S1A352)`"There is no way. This isn't a ninja house
you know."`;
...
showTextbox();
text(() => {
   Sara(S1A353)`"Because there might be a helpless maiden 
...
showTextbox();
text(() => {
   `So with that, the three of us, Sara, You and I,
