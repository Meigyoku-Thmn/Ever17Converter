...
text(() => {
   ...
   Tsugumi(T6T003)`"You really like to waste your time, don't you 
Takeshi."`;
...
showTextbox();
text(() => {
   Tsugumi(T6T010)`"I'm sure some kind of circumstances kept him 
from escaping. And circumstances that kept him 
alive..."`;
   Takeshi`"Circumstances?"`;
   Tsugumi(T6T011)`"Do you remember the entry logs we found on 
the terminals?"`;
...
text(() => {
   ...
   Tsugumi(T6T015)`"Maybe he survived because he was thinking 
about his daughter."`;
...
showTextbox();
text(() => {
   Tsugumi(T6T016)`"Well...Coco had been to IBF at least once 
before May 1st."`;
   Tsugumi(T6T017)`"Maybe there was already an outbreak of the 
...
showTextbox();
text(() => {
   Tsugumi(T6T018)`"TB's incubation period is two to seven 
...
showTextbox();
text(() => {
   Tsugumi(T6T019)`"However, everyone at IBF probably didn't 
realize the terrible truth that TB was 
spreading inside the installation."`;
   Tsugumi(T6T020)`"When they found that a few people had become 
...
showTextbox();
text(() => {
   Tsugumi(T6T021)`"As people started dying, the staff here 
...
showTextbox();
text(() => {
   Tsugumi(T6T022)`"Probably one of the terrified staff members, 
forced their way up from IBF to LeMU..."`;
   Tsugumi(T6T023)`"Without following the standard decompression 
...
text(() => {
   ...
   Tsugumi(T6T027)`"Was for the abnormal installation pressure 
...
text(() => {
   ...
   Tsugumi(T6T029)`"If the TB Virus got out to the world 
outside, it would be devastating."`;
   Tsugumi(T6T030)`"So even if there were survivors in here, it 
...
showTextbox();
text(() => {
   Tsugumi(T6T031)`"Leiblich Pharmaceuticals may be even trying 
to hide the fact that there was an accident 
at all."`;
   Tsugumi(T6T032)`"All the while knowing that we're trapped in 
here..."`;
   Takeshi`"............"`;
...
showTextbox();
text(() => {
   Tsugumi(T6T036)`"Heh, heh.... That's more like the Takeshi I 
know."`;
...
showTextbox();
text(() => {
   Tsugumi(T6T055)`"We should go to the examination room, and 
...
showTextbox();
text(() => {
   You(T6T056)`"Tsugumi, Takeshi! The Kid! The Kid's in bad 
shape!"`;
   `Her face changed color as she shouted.`;
   Tsugumi(T6T057)`"The Kid? What's wrong?"`;
   You(T6T058)`"He's in trouble! It'll be faster if you come 
in and look...ah!"`;
...
showTextbox();
text(() => {
   You(T6T061)`"The Kid's been infected with Tief Blau, 
too..."`;
...
text(() => {
   ...
   Tsugumi(T6T066)`"It isn't normal to start spewing blood from 
...
showTextbox();
text(() => {
   Tsugumi(T6T071)`"The results are black...You're infected too, 
Takeshi."`;
...
showTextbox();
text(() => {
   Tsugumi(T6T073)`"Since coming to IBF... No it must've been 
...
showTextbox();
text(() => {
   Kid(T6T077)`"If only we had that serum...the orange 
one...agh."`;
...
showTextbox();
text(() => {
   You(T6T078)`"It's no good. It doesn't look like there's 
any here."`;
...
think her condition will get much worse..."`;
   Tsugumi(T6T088)`"As soon as it's done, let's give Coco a 
shot, too."`;
   Takeshi`"Yeah, okay..."`;
   You`"........."`;
...
showTextbox();
text(() => {
   Tsugumi(T6T117)`"We should probably get the Kid into a pod, 
don't you think?"`;
...
text(() => {
   ...
   Takeshi`"What?!"`;
   Kid(T6T122)`"Forget it, why should I be the only one 
...
text(() => {
   ...
   Kid(T6T124)`"Once I get in the pod, I can't get out for a 
while, right?"`;
...
showTextbox();
text(() => {
   Kid(T6T126)`"I'm not moving from here until we know that 
...
showTextbox();
text(() => {
   You(T6T133)`"You know, Tsugumi...I still haven't given 
you an injection."`;
   Tsugumi`"......"`;
...
showTextbox();
text(() => {
   You(T6T135)`"I had forgotten before; I injected Takeshi 
...
showTextbox();
text(() => {
   You(T6T136)`"So, out of four of the shots, we still have 
one left."`;
...
showTextbox();
text(() => {
   You(T6T139)`"Tsugumi, I want you to get scanned, right 
now."`;
   Tsugumi`"........."`;
...
You nodded.`;
   You(T6T141)`"I found it in LeMU's database... But I'd 
heard about it before, once..."`;
   You(T6T142)`"I never would have imagined you're a carrier 
...
text(() => {
   ...
   Tsugumi(T6T147)`"You're probably thinking that you don't want 
...
showTextbox();
text(() => {
   Tsugumi(T6T152)`"Well, because, I can be here...and I don't 
have to suffer."`;
   Tsugumi(T6T153)`"It could be that I'm just watching all of 
...
showTextbox();
text(() => {
   Kid(T6T156)`"I don't think you're a bad person at all. I 
mean..."`;
...
showTextbox();
text(() => {
   Tsugumi(T6T162)`"She's stuck in that pod, and she's 
suffering..."`;
   Tsugumi(T6T163)`"If I hadn't had the stupid whim to do 
...
showTextbox();
text(() => {
   Tsugumi(T6T167)`"It's the truth...the only one who TB isn't 
affecting is me."`;
   Takeshi`"......Ha......"`;
...
showTextbox();
text(() => {
   Tsugumi(T6T168)`"So how about it Takeshi? Are you ready to 
...
quickly extract the Tief Blau antibodies."`;
   You(T6T183)`"If this can scan for Tief Blau, it can 
...
panel.`;
   ...
   //Mission Control
   Mission_Control(T6T226)`"IBF 3!? I repeat, this is the Maritime 
...
you access the pool in IBF 3?"`;
   ...
   //Mission Control
   Mission_Control(T6T229)`"Do you know how many survivors there are and 
...
mean...?"`;
   //Mission Control
   Mission_Control(T6T235)`"LeMU's partition strength threshold is 
...
window.`;
   ...
   Sora(T6T246)`"The warehouse area has been breached, and 
cracks are beginning to form in the elevator 
shaft. The situation is serious."`;
   Sora(T6T247)`"There is over six inches of flooding in 
almost all of the corridors."`;
   ...
   Sora(T6T250)`"Yes..."`;
   Sora(T6T251)`"Takeshi, I'm going to start decompressing the 
chamber."`;
   ...
   Sora(T6T254)`"If we don't dissolve the nitrogen in your 
blood, you will get decompression sickness."`;
   ...
   Sora(T6T256)`"If we open that door now, due to the rapid 
...
you say I'm going."`;
   Sora(T6T262)`"Alright, Takeshi. It seems that you've made 
up your mind..."`;
   Sora(T6T263)`"I'll stay here in HIMMEL, to keep track of 
the situation at LeMU, and send updates to 
your PDA."`;
   Sora(T6T264)`"I'll do what I can to stop the partitions 
from falling...to see that this place stays 
together, even a little while longer. So—"`;
   Sora(T6T265)`"Promise me...that you'll come back here with 
Tsugumi..."`;
...
forward through the darkness.${wait(30)}`;
...
text(() => {
   ...
   Sora(T6T279)`"I've prepared the chamber for you get inside 
quickly!"`;
...
text(() => {
   ...
   Sora(T6T289)`"There will come a time, when we will meet 
again."`;
   Sora(T6T290)`"If you die, we will never be able to meet 
again."`;
...
text(() => {
   ...
   //Mission Control
   Mission_Control(T6T304)`"A little while ago we got a message from the 
dispatch team that they couldn't find you. 
You had us worried there."`;
   Takeshi`"I'm sorry, I was out for a bit."`;
   //Mission Control
   Mission_Control(T6T305)`"We were able to rescue the other three 
...
text(() => {
   ...
   //Mission Control
   Mission_Control(T6T306)`"We can't say for sure...their conditions are 
serious."`;
   //Mission Control
   Mission_Control(T6T307)`"We're fighting against time. The submersible 
...
them to a floating medical center."`;
   ...
   //Mission Control
   Mission_Control(T6T309)`"Roger. We'll send the team back there as 
soon as we can."`;
   //Mission Control
   Mission_Control(T6T310)`"But there is the possibility that the team 
...
I can call it here by remote control, right?"`;
   //Mission Control
   Mission_Control(T6T311)`"Ah, yeah...I'm sorry to have to ask you to 
use it, but there's nothing else we can do."`;
   //Mission Control
   Mission_Control(T6T312)`"We'll do the best we can. Whatever happens, 
you hang in there."`;
   Takeshi`"Roger."`;
   `*Click*...`;
