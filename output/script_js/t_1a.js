...
text(() => {
   ...
   `Most of doors were locked as if to keep us 
from intruding.`;
...
text(() => {
   ...
   `On the floor, there were scattered a mess of 
...
text(() => {
   ...
   `We chose a corridor, which was open and walked 
slowly down it.`;
...
text(() => {
   ...
   Girl(T1A005)`"We just met, and I don't particularly care 
about you."`;
...
showTextbox();
text(() => {
   `In the room we next went in, ruins were 
awaiting us.`;
   `"Lemurian Ruins..."`;
   `They were filled with silence.`;
   `If it weren't for the paper garbage strewn 
...
showTextbox();
text(() => {
   Girl(T1A007)`"I don't know...there's only one thing for 
sure."`;
   `She said this without changing the expression 
on her face.`;
...
text(() => {
   ...
   `I was exhausted, but I used every ounce of my 
power to push ahead.`;
...
text(() => {
   ...
   `(Anyways, she hasn't lost her breath much 
...
Stay calm. Explain what's going on..."`;
   //Park staff
   Park_staff(T1A020)`"You need to escape...we have had... 
unexpected...trouble."`;
   //Park staff
...
showTextbox();
text(() => {
   `The force of the water and destruction was 
incredible.`;
...
forward with incredible force.`;
   ...
   `And her speed - it felt I had just hopped 
into a car.`;
...
text(() => {
   Girl(T1A028)`"Damn..."`;
   //Park staff
   Park_staff(T1A029)`"This is no good! It's not functioning! Go 
back!"`;
