...
that was embedded in my finger.`;
   ...
   Sara(SBD010)`"Because...this is proof of how you looked 
after me..."`;
   Sara(SBD011)`"I felt like...if this disappeared...then my 
connection to you...would be gone..."`;
   Kid`"Sara..."`;
   Sara(SBD012)`"I'm sorry...I got you...involved in this 
mess."`;
   Kid`"Sara, it's okay."`;
...
${noWait}`;
   `           ${nextPage(0)}The darkness enveloped me, 
${noWait}`;
