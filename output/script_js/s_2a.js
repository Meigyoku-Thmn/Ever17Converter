...
showTextbox();
text(() => {
   `I wondered how much time had passed since the pressurization had started.`;
   `I noticed that the date had already changed.`;
   `I waited on the hard floor for the treatment to finish.`;
...
text(() => {
   ...
   `Takeshi's talking in his sleep echoed throughout the room.`;
   `We were mentally drained and the three of us were in no state to sleep.`;
   `No, it was worse than that. Gradually we had started to go mad.`;
   Kid`"Why don't we just wake him up and tell him?"`;
   You(S2A003)`"It's no use. Snoring and talking in your sleep aren't something that people can control."`;
...
showTextbox();
text(() => {
   Sara(S2A004)`"Or even better, we could drape a wet towel over his face..."`;
...
showTextbox();
text(() => {
   You(S2A006)`"Why is HE the only one that gets to sleep on the bed?"`;
...
showTextbox();
text(() => {
   You(S2A015)`"I'll bet it's something sexual, judging from his stupid expression."`;
   `You reached out toward Takeshi's face and pinched his cheek.`;
   `And then...`;
...
showTextbox();
text(() => {
   You(S2A025)`"Hey, Takeshi! How dare you have dreams about me!"`;
...
showTextbox();
text(() => {
   Takeshi(S2A026)`"...She's got a long name...wants to see her dad...myumyum."`;
...
showTextbox();
text(() => {
   Takeshi(S2A027)`"...and she's way too rough...that's why she can't get a guy...myumyum."`;
...
showTextbox();
text(() => {
   Takeshi(S2A029)`"...and talks and talks...like an old bag that likes to gossip...myumyum."`;
...
showTextbox();
text(() => {
   Takeshi(S2A030)`"...Ow! Idiot! I'll kick you into next week!...myumyum."`;
...
showTextbox();
text(() => {
   Takeshi(S2A031)`"...You...oh, no...please...no more...sssstop...OooOoh that's...myumyum."`;
...
showTextbox();
text(() => {
   Takeshi(S2A032)`"...You...stop...don't eat...that's not food...just stop...myumyum."`;
...
text(() => {
   ...
   `If we didn't stop her, she might have strangled him.`;

});
fgload({ id: 1, name: `SA17ADM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Sara(S2A037)`"Take it easy, Nakkyu. He's just talking in his sleep."`;
   Kid`"She's right. He doesn't mean anything by it...probably not anyway."`;
...
text(() => {
   ...
   `You put her hand in her pocket and pulled out the marker from before.`;

});
playSFX({ name: `SE10_08`, a1: 0, volume: 100 });
showTextbox();
text(() => {
   `She popped the cap off of the pen and prepared to...`;
...
showTextbox();
text(() => {
   `As she said this, You took the pen and started drawing big round eyes - like a girl from a comic - on Takeshi's eyelids. `;
   Takeshi(S2A045)`"Zzzz...zzz..."`;

});
showTextbox();
text(() => {
   You(S2A046)`"He, he, he...what goes around, comes around. Take that."`;
...
showTextbox();
text(() => {
   Kid`"HA, HA, HA, HA! I'm laughing so hard my gut hurts..."`;
   You(S2A050)`"Hey, Kid. Why don't you draw something on this idiot? You'll feel loads better."`;
...
text(() => {
   ...
   `Takeshi had been further transformed into a much-decorated creature, miserable, disfigured and hard-to-describe.`;
...
text(() => {
   ...
   Takeshi(S2A056)`"Ooon...nyum...I'd like a perm...please...nyuma..."`;
...
showTextbox();
text(() => {
   Sara(S2A062)`"No, no. We didn't sleep at all because of this noisy beast."`;
...
showTextbox();
text(() => {
   You(S2A063)`"So Sora, hold off on telling him for a while, alright?"`;

});
fgload({ id: 4, name: `SO07ADS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Sora(S2A064)`"You mean...you want me to pretend that I don't notice?"`;
...
text(() => {
   ...
   Takeshi(S2A066)`"Ooon...nyuum...it's all white...curlies...nyumanya..."`;

});
fgload({ id: 2, name: `YU05BDS`, x: 512, useAnim: true });
showTextbox();
text(() => {
   You(S2A067)`"Enough of that. Sora, what about the decompression...?"`;
...
text(() => {
   ...
   Takeshi(S2A074)`"Ummmh...ummmh...math, social studies, science, English class, music......I can't play that...zzz..."`;
...
showTextbox();
text(() => {
   Sora(S2A075)`"Alright everyone. I would like to have you all gather in the Control Room at once."`;
...
showTextbox();
text(() => {
   Sora(S2A077)`"I will tell you all about it in the Control Room..."`;
...
showTextbox();
text(() => {
   `Sora ducked and left the pressurization chamber.`;
...
showTextbox();
text(() => {
   `We got Takeshi up and made for the Control Room.`;
   `Sara was next to me...`;
   `Ahead You and Takeshi were talking about something as they walked.`;
   `I couldn't quite make out what they were saying.`;
   `Eventually Takeshi slowed down, separated from You and came back to us.`;
   Takeshi(S2A079)`"Hey, you got any idea what You's all miffed about?"`;
...
text(() => {
   ...
   `Clicking his tongue, Takeshi hurried back up ahead to You.`;

});
fgload({ id: 1, name: `SA09ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   `Sara and I laughed as we watched Takeshi and You exchange words.`;
...
showTextbox();
text(() => {
   Sara(S2A089)`"Sora was telling us about when there is a sudden change in air pressure..."`;
...
text(() => {
   ...
   `...it seemed like something about Tsugumi had changed from the day before.`;
   `Maybe it was loneliness, but her attitude and way of talking had been toned down.`;
...
showTextbox();
text(() => {
   Sora(S2A096)`"I'm sorry that I had to have you gather so early. There was no other way."`;
   Sora(S2A097)`"Actually, everyone, there is something I need to tell you right away."`;
...
text(() => {
   ...
   `Sora looked over all five of us...You, Sara, Tsugumi, Takeshi and finally me.`;
...
showTextbox();
text(() => {
   Sora(S2A098)`"Last night, after the four of you, apart from Tsugumi, entered the pressurization chamber..."`;
   Sora(S2A099)`"I was in the Control Room here thinking about ways to escape or contact the outside."`;
...
text(() => {
   Sora(S2A100)`"And..."`;
   Sora(S2A101)`"While I was checking the internal status of LeMU, I discovered something."`;
...
showTextbox();
text(() => {
   Sora(S2A107)`"I discovered the strength of pressure the bulkheads can withstand...I found their limits."`;
...
text(() => {
   ...
   Sora(S2A108)`"I mean LeMU's walls. The partitions between the outer seawater and the inner air."`;
...
showTextbox();
text(() => {
   Sara(S2A109)`"What do you mean...when you say you found the limit?"`;
   Sora(S2A110)`"Like I said yesterday, LeMU is a structure basically constructed on a saturation diving specification design."`;
   Sora(S2A111)`"In other words, the internal air pressure equals or is greater than the external water pressure."`;
   Sora(S2A112)`"However, the complex's internal air pressure is currently at 1 atmosphere..."`;
   Sora(S2A113)`"Therefore..."`;
   You(S2A114)`"LeMU's outer shell is constantly being subjected to severe water pressure."`;
   Sora(S2A115)`"Correct."`;
   You(S2A116)`"But LeMU is not constructed to endure this situation for a long period of time."`;
   You(S2A117)`"Inevitably it will, at some point, reach its limit..."`;
...
showTextbox();
text(() => {
   Sora(S2A122)`"You are well informed. Did you look that up on the Security Office terminal?"`;
   Tsugumi`"........."`;
...
text(() => {
   ...
   Sora(S2A124)`"The estimated time of implosion is approximately 4:30 a.m. on May 7."`;

});
fgload({ id: 2, name: `SA03ADS`, x: 512, useAnim: true });
showTextbox();
text(() => {
   Sora(S2A125)`"Of course, it is only a calculation and there is a margin of error."`;

});
fgload({ id: 1, name: `TU08ADS`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Tsugumi(S2A126)`"Plus or minus 12 hours...is that the margin of error?"`;
...
text(() => {
   ...
   `We knew for sure that we were in serious trouble.`;
   `Sora's words had shaken us a bit.`;
   `But five days sounded like a long time and it really didn't register with me.`;
   `I kept thinking that a rescue team would arrive at anytime...`;
   `So I didn't really feel that it was worth worrying about.`;
   Kid`"Sora."`;
   Kid`"Can I summarize what you said to make sure I got it?"`;
...
text(() => {
   Sora(S2A128)`"?"`;
   Kid`"At 4:30 a.m. on May 7, the walls of LeMU will reach the limit of the pressure that they can handle."`;

});
fgload({ id: 1, name: `TU08ADS`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Kid`"But that might happen at 4:30 p.m. on the sixth or at 4:30 p.m. on the seventh."`;
...
text(() => {
   ...
   Kid`"I mean, at the worst LeMU will be fine until 4:30 p.m. on May 6."`;

});
fgload({ id: 1, name: `TU05ADS`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Kid`"So we're fine until then and have nothing to worry about."`;

});
fgload({ id: 4, name: `SO10ADS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Sora(S2A130)`"We can't be absolutely certain that we will be safe..."`;
   Sora(S2A131)`"But judging from the results of LeMMIH's calculations, that would appear to be the case."`;
...
showTextbox();
text(() => {
   Sara(S2A133)`"So as long as help comes by the sixth, then we are okay?"`;
...
showTextbox();
text(() => {
   You(S2A134)`"I see.... If you had said 'We only have one more day,' or something I might have burst out crying."`;

});
fgload({ id: 4, name: `SO05ADS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(S2A135)`"So we still have lots of time.... Someone will surely come to help us before that."`;
   `The tension in the air broke and sighs of relief could be heard around the room.`;
   `Tsugumi, having gotten the information somewhere before us was smiling to herself, smugly.`;
   `It was 5:50 a.m.`;
...
showTextbox();
text(() => {
   `Sara and I sat cross-legged on a bench in the rest area.`;
...
text(() => {
   ...
   `We had just polished off fried chicken sandwiches that Takeshi had made for us.`;
   `As for the other four...`;
   `Sora was, as usual, cooped up in the Control Room trying to make contact with LeMMIH.`;
   `Tsugumi had vanished without saying where she was going.`;

});
if (l_know_sora_is_an_ai != 0) goto(lbl_00000d7f);
showTextbox();
text(() => {
   `Takeshi had gone to deliver sandwiches to Sora and Tsugumi.`;
...
showTextbox();
text(() => {
   `Takeshi had gone to deliver a sandwich to Tsugumi.`;

});
let lbl_00000d84;
showTextbox();
text(() => {
   `You was changing clothes. Apparently she had spilled something on them while eating.`;
   `Fortunately, her normal clothes were safe in the changing room in the dry area.`;
...
text(() => {
   ...
   Kid`"A game?"`;
   Sara(S2A139)`"Yeah. The Yamanote Line game or a word game..."`;
...
showTextbox();
text(() => {
   Sara(S2A141)`"We play and the winner gets to choose something."`;
...
text(() => {
   ...
   Kid`"I haven't said I'm going to play. And what is that jyan-ken-poi?"`;

});
fgload({ id: 1, name: `SA08ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Sara(S2A145)`"It's what you say when you play rock, paper, scissors."`;

});
fgload({ id: 1, name: `SA05ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Sara(S2A146)`"And as to whether or not you are going to play...you are!"`;
...
showTextbox();
text(() => {
   Sara(S2A160)`"Don't give me a weird one, okay? Please, please."`;
...
showTextbox();
text(() => {
   Sara(S2A163)`"M-I-C...K-E-Y...M-O-U-S-E-Y...Mickey Mousey Mickey Mousey"`;

});
fgload({ id: 1, name: `SA02ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Sara(S2A164)`"Who's the leader of the club That's made for you and me"`;
   Kid`"He, he, he..."`;
...
text(() => {
   ...
   Sara(S2A166)`"I don't think there is anyone who can become him!"`;
   Kid`"Those are the rules."`;
...
text(() => {
   ...
   Sara(S2A170)`"Doth you Hamlet defy you lord? Et tu, my friend, Hamlet? Lend me some ears. Not in my empire!"`;
...
text(() => {
   ...
   Kid`"Kya, ha, ha, ha, ha..."`;
   Kid`"Heeee, my stomach hurts. It really hurts. You are too funny..."`;
...
text(() => {
   ...
   Kid`"That wasn't...Caesar...but a mixed up Hamlet..."`;
   Kid`"Heee, he, he...."`;
...
showTextbox();
text(() => {
   Sara(S2A177)`"I am, You Tanaka! The seventh leader of the Crimson motorcycle gang! The baddest group of Kanto hooligans!"`;
   Kid`"........."`;
   Sara`"........."`;
   Kid`"............"`;
...
text(() => {
   ...
   Sara(S2A179)`"Now she seems to be leading a normal, decent life."`;
   Kid`"I see..."`;
...
text(() => {
   Sara(S2A181)`"Yup."`;
   Kid`"Alright then. Sara Matsunaga...become a spoiled baby!"`;
...
text(() => {
   ...
   Sara(S2A184)`"I won't drink that milk unless you warm it up to body temperature!"`;
   Kid`"........."`;
...
text(() => {
   Sara`"........."`;
   Kid`"Uh..."`;
   Kid`"Sorry, sorry...I can't remember what babies are like, so I don't know if that was close..."`;
...
text(() => {
   ...
   Kid`"Uh...we...um...we're playing rock, paper, scissors charades..."`;

});
fgload({ id: 2, name: `YU02ADM`, x: 512, useAnim: true });
showTextbox();
text(() => {
   You(S2A186)`"You're playin rock, paper, scissors charades? That sounds fun - can I play?"`;
...
showTextbox();
text(() => {
   `The lights illuminating the room started to flicker.`;
...
showTextbox();
text(() => {
   `Listening carefully, I heard a sound like the rumble of thunder far away. `;
...
text(() => {
   ...
   You(S2A193)`"Doesn't that sound a lot like when the water that flooded in yesterday?"`;

});
fgload({ id: 1, name: `SA03ADM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   `The blood appeared to drain from the faces of You and Sara in the flickering light.`;
...
text(() => {
   ...
   `The tremors and sounds stopped, but an eerie silence filled the area.`;
...
showTextbox();
text(() => {
   You(S2A199)`"Anyway, let's go looking for Takeshi and Tsugumi."`;
...
showTextbox();
text(() => {
   You(S2A203)`"I'll tell you later. Looking for those two  is the top priority right now."`;
...
showTextbox();
text(() => {
   You(S2A204)`"Takeshi! Tsugumi! If you are there, then answer!"`;
   `You shouted out into the darkness.`;
   `I wondered why she was only calling out to Takeshi and Tsugumi.`;
...
text(() => {
   ...
   `I imagined she had gotten it somewhere in the Control Room.`;
   `You turned on it...`;
...
showTextbox();
text(() => {
   Sara(S2A205)`"It doesn't seem...like there is anyone here..."`;
...
showTextbox();
text(() => {
   Takeshi(S2A212)`"Geez...Where would Sora go at a time like this?"`;
...
text(() => {
   ...
   `It had been a series of emergencies since the day before...`;
...
showTextbox();
text(() => {
   Sara(S2A216)`"Without Sora, we won't know why there's been this blackout..."`;
...
text(() => {
   ...
   You(S2A223)`"I don't think we'll find Sora, even if we look."`;
...
text(() => {
   ...
   You(S2A227)`"That's something that you should hear from Sora herself..."`;
...
text(() => {
   ...
   You(S2A231)`"You don't have to worry. Sora is just fine."`;
...
showTextbox();
text(() => {
   You(S2A235)`"I think we should try the Generator Room..."`;
...
text(() => {
   ...
   You(S2A237)`"I figure that the cause of this blackout is trouble in the Generator Room."`;
   ...
   `There was a thermal seafloor vent where hot water was pumped out of the seabed and heat from that was used to operate generators.`;
...
showTextbox();
text(() => {
   Takeshi(S2A243)`"Geez. I have no clue what is going on in that girl's head."`;
...
showTextbox();
text(() => {
   Takeshi(S2A247)`"Alright! Let's get a move on. You, can you lead the way?"`;
...
showTextbox();
text(() => {
   You(S2A248)`"Hey Takeshi, where do you think you are going?"`;

});
multifgload2({ id1: 1, id2: 4, name1: `SA08ADS`, name2: `KB07ADS`, x1: 128, x2: 320, useAnim: true });
showTextbox();
text(() => {
   Takeshi(S2A249)`"Where? To the Generator Room of course. It was your idea to start with, right?"`;
...
showTextbox();
text(() => {
   You(S2A252)`"Oh please...you really don't get anything, do you?"`;
...
showTextbox();
text(() => {
   You(S2A255)`"You guys don't remember the map of LeMU we saw yesterday?"`;
...
showTextbox();
text(() => {
   Sara(S2A257)`"Oh...you mean the three story map that had the areas split into two areas?"`;
   Kid`"Oh, that's right..."`;
...
showTextbox();
text(() => {
   Takeshi(S2A259)`"I can't say I remember it exactly... but kinda, yeah."`;
...
text(() => {
   ...
   You(S2A264)`"So?"`;
   Sara(S2A265)`"We can't go directly from the Control Room area to the Generator Room area."`;
...
text(() => {
   ...
   Takeshi(S2A268)`"To get to the Generator Room's area, we have to access the second floor..."`;

});
bgload({ name: `MAP2F_A1`, transition: 30 });
showTextbox();
text(() => {
   Takeshi(S2A269)`"And the only way we can do that is by using the neutral buoyancy elevator."`;
