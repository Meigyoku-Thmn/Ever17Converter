...
showTextbox();
text(() => {
   `I realized there were six things I knew 
for sure.`;
   fadeClearPage();
});
hideTextbox();
showTextbox();
text(() => {
   `1. You's father, Yoichi Tanaka, had apparently 
died 34 years before.`;
   `2. And You's mother, Yukie Tanaka, had died 15 
years before.`;
   `3. You had heard from her mother that Yoichi 
...
showTextbox();
text(() => {
   Sara(Y4A481)`"That's exactly when a guy needs to go to a 
girl and give her a shoulder to cry on."`;
   Kid`"But you went and it didn't help, right?"`;
   Sara(Y4A482)`"We are different. I'm a girl. 
You're a boy...Got it?"`;
...
showTextbox();
text(() => {
   Sara(Y4A489)`"What? Who said that they liked the name 
Prince anyway?"`;
...
showTextbox();
text(() => {
   Sara(Y4A494)`"And I don't have many favorites. So count 
yourself lucky."`;
...
showTextbox();
text(() => {
   `Sara told me where You was and I went to 
find her.`;
   `I spotted You's back from behind the 
merry-go-round.`;
   `She was looking down.`;
   `She was sitting, her hand clutching the ride...`;
   Kid`"You..."`;
   `Calling out to her, I went closer.`;
   `You turned her face toward me and gave me an 
...
text(() => {
   ...
   You(Y4A498)`"Something isn't right with me right 
...
text(() => {
   ...
   `I was no knight in shining armor... 
...
together.`;
   ...
   You(Y4A501)`"But that can't be true! Because...because it 
...
showTextbox();
text(() => {
   You(Y4A503)`"No! There's more. My mom might be already 
dead, too!"`;
   You(Y4A504)`"It can't be! How could it? It doesn't make 
any sense!"`;
   You(Y4A505)`"Fifteen years ago! When I was three! Before 
I was even aware of anything!"`;
   You(Y4A506)`"I saw my mom running around just fine right 
before I came here!" `;
...
text(() => {
   ...
   `Like a dam bursting, You spewed out all of the 
...
judge."`;
   ...
   You(Y4A516)`"The whereabouts of my father have been 
unknown since he disappeared 17 years ago, 
but today he is alive somewhere."`;
   You(Y4A517)`"My mom is alive, too. She is at home waiting 
for me."`;
   You(Y4A518)`"This is the truth! And it's unchangeable! 
...
showTextbox();
text(() => {
   `You turned her eyes away from me, she bit down 
hard on her lip.`;
   `She finally looked down and closed her eyes as 
if she were thinking.`;
   `I could tell that she was trying hard to 
...
showTextbox();
text(() => {
   You(Y4A522)`"You're right...I don't know what was the 
wrong with me."`;
...
text(() => {
   ...
   `You explained that it was a malignant virus 
...
showTextbox();
text(() => {
   `Furthermore, the world was now free of TB, 
...
showTextbox();
text(() => {
   `What You didn't know was when her parents were 
supposed to have died.`;
   `You didn't know what she was to make of this 
...
disappeared 17 years before.`;
   ...
   `3. Yoichi had died 34 years before, but Yukie 
was still alive and well.`;
   `4.Yoichi had died 34 years before and Yukie 15 
years before.`;
   fadeClearPage();
});
hideTextbox();
showTextbox();
text(() => {
   `We didn't know which was truth and which 
fiction.`;
...
showTextbox();
text(() => {
   `These theories were based on information from 
...
of information about Yoichi's death)`;
   `C. What You's mom had told her (The only 
...
indeed a fact.`;
   `We set aside the question of whether she were 
...
showTextbox();
text(() => {
   `We deduced that that would mean that if Yukie 
...
showTextbox();
text(() => {
   You(Y4A530)`"Eh? Are we going to have to make repairs 
again?"`;
...
showTextbox();
text(() => {
   You(Y4A531)`"This time should we have Takeshi fix it 
himself?"`;
...
text(() => {
   You(Y4A532)`"Ah, ha, ha!"`;
   `The light conversation seemed to lift You's 
spirits.`;
   Kid`"Okay then..."`;
   Kid`"...Huh?"`;
...
showTextbox();
text(() => {
   Takeshi(Y4A537)`"Oh, and there's the Kid, too. You two sure 
...
showTextbox();
text(() => {
   You(Y4A542)`"Hee, hee. This will blow your mind, but 
actually..."`;
...
showTextbox();
text(() => {
   Takeshi(Y4A547)`"Okay, I'll stop pretending to be surprised 
now..."`;
...
showTextbox();
text(() => {
   You(Y4A548)`"Hey! Don't interrupt me! I'm supposed to give 
the punch line."`;
   Takeshi(Y4A549)`"I know what's coming next. 'I'm kidding. 
It's a joke.' Right?"`;
...
text(() => {
   You(Y4A550)`"Yup."`;
   Takeshi(Y4A551)`"Alright, enough of that. Let's get back 
on topic."`;
   You(Y4A552)`"Alright..."`;
...
showTextbox();
text(() => {
   Takeshi(Y4A553)`"Uh, I'm going to go make some repairs on the 
...
showTextbox();
text(() => {
   You(Y4A554)`"I don't believe this. Are you saying there's 
...
showTextbox();
text(() => {
   Takeshi(Y4A555)`"No, it's not that serious. But the generator 
...
text(() => {
   Takeshi(Y4A556)`"See?"`;
   Takeshi(Y4A557)`"Well, it's no big deal, but I've got to do 
some maintenance."`;
...
she was fine.`;
   `I thought that if I let her go to make 
...
text(() => {
   ...
   Takeshi(Y4A562)`"But you don't know a thing about machines, 
right?"`;
...
showTextbox();
text(() => {
   Takeshi(S4A102)`"If we have to make repairs again, then we'll 
...
a picnic mood.`;
   `The blanket was from a shop stocking them on 
the same floor. `;
...
showTextbox();
text(() => {
   `I wondered if I were still stuck on those 
words.`;
   fadeClearPage();
});
hideTextbox();
...
showTextbox();
text(() => {
   `Ever since then, Tsugumi had left me mostly 
alone.`;
...
text(() => {
   ...
   `All of the sudden Sara screamed from the 
...
showTextbox();
text(() => {
   `Some of the food in boxes in the kiosk had 
been damaged.`;
...
showTextbox();
text(() => {
   Sora(Y4A568)`"Still, I'm surprised that there are rats...in 
LeMU."`;
   Takeshi`"........."`;
   `Takeshi, our de facto cook, was livid.`;
   `He was so mad he couldn't speak. His face went 
...
text(() => {
   ...
   Takeshi(Y4A573)`"If I catch that rat, I'm gonna feed him to 
the fish outside!"`;
...
showTextbox();
text(() => {
   `So a raging Takeshi set about trying to rig up 
...
him down.`;
   `Somehow I was able to help him, using my one 
...
text(() => {
   ...
   Sara(Y4A576)`"I don't think she is in the infirmary. 
...
showTextbox();
text(() => {
   Sara(Y4A579)`"She said she's going to THE place and you 
should come, too."`;
   Kid`"THE place?"`;
...
text(() => {
   Kid`"What?"`;
   Sara(Y4A582)`"I don't know but you seem to be doing alright 
for yourself."`;
   Sara(Y4A583)`"You're already sneaking dates at night 
and all."`;
...
showTextbox();
text(() => {
   Sara(Y4A585)`"By the way, what trick did you use to calm 
You down?"`;
   Sara(Y4A586)`"She fell for you in the blink of an eye, 
so you must be good."`;
...
showTextbox();
text(() => {
   Sara(Y4A590)`"Or I guess to hear the juicy details you 
...
text(() => {
   Sara(Y4A592)`"And?"`;
   Sara(Y4A593)`"Come on! It's okay! I won't tell anybody 
else."`;
   Kid`"..."`;
...
showTextbox();
text(() => {
   `Ultimately Sara gave up and, since I figured 
