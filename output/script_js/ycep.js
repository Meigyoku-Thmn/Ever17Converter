...
AVL_Mode();
unlockCG($`POST12`);
varop(`(28 0a a4) 0c := (00) 1`);
varop(`(28 0a a4) 19 := (00) 1`);
varop(`(28 0a a3) fe := (00) 1`);
varop(`(28 0a a4) 29 := (00) 1`);
varop(`(28 0a a4) 2a := (00) 1`);
varop(`(28 0a a4) 2b := (00) 1`);
varop(`(28 0a a4) 2c := (00) 1`);
varop(`(28 0a a4) 2d := (00) 1`);
varop(`(28 0a a4) 2e := (00) 1`);
varop(`(28 0a a4) 2f := (00) 1`);
goto(lbl_0000118d).if(var_f2 == 0);
unlockCG($`POST06`);
goto(lbl_000011b2).if(var_1d != 0);
let lbl_0000118d;
unlockCG($`POST11`);
goto(lbl_000011b2).if(var_1d != 0);
let lbl_000011b2;
