...
before me.`;
   ...
   `Above, high above, stretched a clear
blue sky.`;
...
sky as the wind carried it away.`;
   `The wind, full of the smell of the ocean, 
gently blew by me.`;
...
text(() => {
   ...
   `I found out that I had a 16 year old daughter 
and son...`;
   `—It was a dream.`;
   `(Yeah, that's right, I must be dreaming!)`;
   `(If I'm not dreaming, there's no way this 
could be happening!)`;
...
text(() => {
   ...
   Sara(CEP004)`"You know? I've been watching you ever since 
...
text(() => {
   ...
   Takeshi(CEP006)`"I don't really understand, but that's okay, 
daughter of mine!"`;
...
text(() => {
   ...
   `Since I had come this far, I decided there 
was no reason to hold back. `;
   `Besides, all of this was a dream...`;
   `And if I had a daughter this cute, what did 
it matter anyway?`;
...
text(() => {
   ...
   Sara(CEP012)`"I want to go to Ninja Town for fun someday 
soon."`;
...
talking to the two kids.`;
   ...
   `Yes...`;
   `That's why I always kept quiet whenever he 
...
that had passed these long 17 years.`;
   `But for the moment...`;
   `For the moment, watching him innocently 
...
'taxi,' that stupid man.`;
   ...
   `Going outside...wrapped in my '100 percent UV 
...
text(() => {
   ...
   Takeshi(CEP036)`"I suppose that's why they call you 
...
text(() => {
   Tsugumi(CEP039)`"You are such a jerk, Takeshi!"`;
   `Mama let out a yell, and turning 
...
she'd been wearing.`;
   `She'd had on one of the lemur (fox-monkey) 
...
stood back up.`;
   `Mom had already told me about this little 
hamster's ordeal.`;
...
consistent...`;
   `It goes without saying, but I thought to 
myself—'Chami is living each moment to the 
fullest.'`;
   Sara(CEP041)`"Hey? What do you think is going to happen to 
us after this?"`;
...
showTextbox();
text(() => {
   Sara(CEP044)`"You don't think Leiblich will come after us 
do you...?"`;
   //You'haru'
...
text(() => {
   ...
   `And saying that, she took out the newspaper 
...
showTextbox();
text(() => {
   `'Leiblich Pharmaceutical, responsible for 
...
showTextbox();
text(() => {
   `Leiblich Pharmaceutical has for some time been 
...
text(() => {
   //You'haru'
   You_haru_(CEP050)`"Leiblich has a lot of influence, even 
political clout at the national level.. so 
laying the groundwork for this was really 
tough, but..."`;
   `Ms. Tanaka took out an old marker, and 
scratched it against her cheek.`;
   Hokuto(CEP051)`"So...the whistleblower mentioned in this 
article is..."`;
...
text(() => {
   ...
   //You'haru'
   You_haru_(CEP053)`"Actually, I leaked this to the police and 
the press quite a long time ago."`;
   //You'haru'
   You_haru_(CEP054)`"But, there was a lot of behind the scenes 
maneuvering..."`;
   //You'haru'
   You_haru_(CEP055)`"So I told them, 'What ever happens, DON'T 
move before May 7th!'"`;
   Sara(CEP056)`"You mean in order to rescue dad, and that 
girl Coco?"`;
...
text(() => {
   ...
   Sara(CEP058)`"Well...uh..."`;
   Sara(CEP059)`"That means they won't come after us! And 
we're free!"`;
...
text(() => {
   //You'aki'
   You_aki_(CEP062)`"'There's nothing to worry about'? How can 
you say that?"`;
   //You'aki'
...
text(() => {
   //You'aki'
   You_aki_(CEP065)`"Do you have any idea how...how hard a time 
...
showTextbox();
text(() => {
   `And saying that, my daughter tugged firmly on 
...
text(() => {
   ...
   //You'aki'
   You_aki_(CEP070)`"In 2025, you started working at LeMU. To 
conduct research into the third eye..."`;
   //You'aki'
   You_aki_(CEP071)`"I mean, in order to save the real Takeshi 
Kuranari, and that girl called Coco..."`;
   ...
   //You'aki'
   You_aki_(CEP073)`"If you were working at LeMU, you could have 
found a way to rescue Mayo, who's been locked 
up at Leiblich's facility all this time."`;
   //You'aki'
   You_aki_(CEP074)`"You could have reunited Tsugumi and her kids, 
right?"`;
...
in 2017...`;
   //You'aki'
   You_aki_(CEP077)`"So...you aren't going to tell me anything, 
are you?"`;
   //You'aki'
   You_aki_(CEP078)`"It's always like this.... You always decide 
everything..."`;
   //You'haru'
   You_haru_(CEP079)`"Even if you couldn't trust me enough to 
...
text(() => {
   //You'aki'
   You_aki_(CEP082)`"So, I don't want you to lie to me...or hide 
anything...I want to know everything..."`;
   //You'aki'
   You_aki_(CEP083)`"There are still things you haven't told me 
yet, right?"`;
   //You'aki'
...
text(() => {
   `——May 6, 2017`;
   `Because Coco was sick, we had all headed to 
the IBF research lab.`;
   `While Takeshi, the young Kaburaki and Tsugumi 
were searching around the research facility, 
I stayed behind in the examination room.`;
   `Coco and the researcher were lying in the 
capsule pods.`;
   `The researcher, who was fighting to stay 
conscious as the virus consumed his body, 
told me this - `;
   Researcher(CEP086)`"...You...I never dreamed...that we would meet 
again...in a place like this..."`;
   `That's right, he was my father - Y.T. - Yoichi 
Tanaka.`;
...
TB Virus.`;
   `TB is a potent virus, which has an 
...
car accident.'`;
   ...
   `'Your husband is missing, after a highly 
tragic accident.`;
...
text(() => {
   ...
   You_aki_`"............"`;
   //You'haru'
   You_haru_(CEP087)`"Because of that accident, the TB virus broke 
out, causing terrible suffering all over the 
world..."`;
   //You'haru'
   You_haru_(CEP088)`"But...Leiblich Pharmaceutical, concealed 
...
text(() => {
   ...
   `It was 15 years ago, that my mother caught 
...
showTextbox();
text(() => {
   `I infiltrated LeMU, and at the same time 
...
Ryogo Kaburaki.`;
   `We have spent every moment for the last 17 
years preparing for this.`;
   `Yes...it was the only thing that I've lived 
for up until now.`;
   fadeClearPage();
});
hideTextbox();
...
looked up at the sky`;
   //You'haru'
   You_haru_(CEP089)`"See, look at that face....I knew you wouldn't 
believe me."`;
...
text(() => {
   ...
   //You'haru'
   You_haru_(CEP091)`"But...it doesn't change the fact that it's 
the truth..."`;
   `I reached out to stroke her hair.`;
   `She stared at me blankly...`;
   `Looking just like I did 17 years ago...`;
   `Reckless, full of fire, pure - to the point of 
...
embarrassed by that fact.`;
   ...
   `'There's no need for you to say anything' - I 
...
text(() => {
   ...
   You_aki_(CEP092)`"Mom..."`;
   //You'aki'
   You_aki_(CEP093)`"I...understand what you're trying to tell 
me..."`;
...
was the only mother I had.`;
   ...
   `At that moment it occurred to me? I only 
...
mysteries....`;
   `I thought I had dismissed all of these things 
as girlish fantasy...`;
   `But something...had now changed slightly.`;
   `I mean, my existence itself was something 
hard to explain...`;
...
Winkle, The Lemurian Civilization...`;
   `All of these seemed like normal, everyday 
things.`;
   `Even the 'Third Eye'...`;
   `................`;
...
showTextbox();
text(() => {
   `And while those thoughts drifted through my 
...
showTextbox();
text(() => {
   Hokuto(CEP099)`"Oh, hey, You...you been here all along? I've 
...
showTextbox();
text(() => {
   Hokuto(CEP100)`"Actually, there was something that I wanted 
to ask you..."`;
   //You'aki'
...
showTextbox();
text(() => {
   Hokuto(CEP102)`"I've been thinking I want to study 
...
text(() => {
   ...
   Hokuto(CEP104)`"Well, because I want to study more about the 
third eye."`;
   `You was silent.`;
...
guard by her reply.`;
   ...
   Hokuto(CEP107)`"I've already made up my mind that I'm going 
to study archaeology, but..."`;
   Hokuto(CEP108)`"Still...I don't really know that much about 
it..."`;
   Hokuto(CEP109)`"Like what kinds of things I should do to 
prepare, or if there are any books you know 
that are good primers on the subject."`;
   Hokuto(CEP110)`"So I was hoping that you could give me some 
advice..."`;
...
text(() => {
   //You'aki'
   You_aki_(CEP111)`"Well, I don't know what kind of advice I can 
give."`;
   //You'aki'
   You_aki_(CEP112)`"I only just started college, and I've only 
...
text(() => {
   ...
   //You'aki'
   You_aki_(CEP115)`"In order to major in archaeology, you've got 
to be a junior."`;
   Hokuto(CEP116)`"Oh..."`;
   //You'aki'
   You_aki_(CEP117)`"I'm sorry but I really can't tell you 
anything..."`;
   //You'aki'
...
text(() => {
   ...
   //You'aki'
   You_aki_(CEP121)`"Archaeology is WAY more boring than you are 
probably thinking."`;
   //You'aki'
   You_aki_(CEP122)`"It's a lot different than what they show in 
the movies."`;
...
text(() => {
   ...
   //You'aki'
   You_aki_(CEP124)`"If you want to study about the third eye, 
you are better off attacking it from the 
direction of philosophy or psychology."`;
   //You'aki'
   You_aki_(CEP125)`"Besides, archaeology is a subject that 
studies HUMAN history."`;
   Hokuto(CEP126)`"But...it's okay! I've already made up my 
mind!"`;
   Hokuto(CEP127)`"I've been thinking I could approach the 
...
text(() => {
   ...
   //You'aki'
   You_aki_(CEP129)`"I think the real reason you want to study 
...
text(() => {
   ...
   Hokuto(CEP141)`"So I'm pretty sure that in this time, you 
...
text(() => {
   //You'aki'
   You_aki_(CEP142)`"H-h-h-hey, wait a second Kid! You're getting 
ahead of yourself here!"`;
   //You'aki'
   You_aki_(CEP143)`"I don't know much about fate but...things 
...
forgotten my name, Ryogo Kaburaki.`;
   `I was 15 years old —all I wanted at that 
time was stability.`;
...
smile that helped thaw my frozen heart.`;
   ...
   `All I had to do was see her smile, that's all 
...
world around me.`;
   ...
   `I suppose that I might have been grasping for 
...
artifice.`;
   `From that point on - for six days - she was in my 
...
save Coco and Takeshi."`;
   `'So please...help me?' —that was what You 
asked of me.`;
...
even ridiculed, none of that mattered to me.`;
   `I...just wanted...to see...Coco's smile 
again...`;
...
save the woman that he loved.'`;
   `For a 15-year-old like me, Takeshi was a role 
model.`;
   `I swore that I would save Coco and Takeshi, 
no matter what it took.`;
   `..................................`;
   `17 years later—`;
   `For 17 years, You and I had spent every 
minute, every second putting our plan in 
motion.`;
   `Yes...I had lived for this day.`;
   `Just six days....Coco and I had only spent 
six days together. `;
   `But in those 17 years, not a moment went by 
...
showTextbox();
text(() => {
   Coco(CEP151)`"Hey! What are you doing here all by 
yourself!?"`;
   `Coco rapped me on the head, and peeked around 
at my face.`;
...
showTextbox();
text(() => {
   Coco(CEP152)`"Come on and join everyone! It's no fun by 
yourself, right?"`;
   Kaburaki(CEP153)`"I..."`;
...
showTextbox();
text(() => {
   Coco(CEP154)`"Huh? You're not...worried about something are 
you?"`;
   Kaburaki`"........."`;
...
showTextbox();
text(() => {
   Coco(CEP155)`"Are you feeling bad that you lied to 
everyone?"`;
   Kaburaki`"........."`;
...
showTextbox();
text(() => {
   Coco(CEP157)`"Besides, if you hadn't been able to trick 
...
here right now."`;
   ...
   Coco(CEP160)`"We're all grateful to you. Nobody here blames 
you."`;
...
text(() => {
   ...
   Sora(CEP170)`"...Huh?...Um, what were you talking about 
again?"`;
...
text(() => {
   ...
   Takeshi(CEP172)`"He stopped moving all of a sudden. I just 
thought maybe you could take a look at him."`;
   `Takeshi lifted up Pipi, and stuck him out in 
front of me.`;
   Sora(CEP173)`"All of a sudden you say? Any reason you can 
think of...?"`;
...
showTextbox();
text(() => {
   Takeshi(CEP175)`"Tsugumi? She started thrashing around in the 
cabin, and..."`;
   Takeshi(CEP176)`"I tried to pin her down, but she threw me 
off...."`;
   Takeshi(CEP177)`"And when I went down, this little guy 
happened to be there, and..."`;
   Sora(CEP178)`"I landed right on top of him. Maybe that's 
what could've caused it?"`;
   Takeshi(CEP179)`"Yup. After that, he stopped moving..."`;
   Sora(CEP180)`"Let me take a look."`;
   `I took Pipi from Takeshi, and started a 
diagnostic on him.`;
   Sora(CEP181)`"That's strange...I don't see anything wrong 
with him."`;
...
text(() => {
   ...
   Takeshi(CEP184)`"If they thought I'd broken him, Coco, You, 
...
continued...`;
   ...
   Sora(CEP187)`"I don't even think 'fond' describes it. You 
might say Pipi and I are connected on a 
deeper level."`;
   Sora(CEP188)`"17 years ago..."`;
   Sora(CEP189)`"If Pipi hadn't picked up my terabyte disk, I 
wouldn't be here right now."`;
   Sora(CEP190)`"And after Pipi got to the surface, 
You...Yubiseiharukana, that is..."`;
   Sora(CEP191)`"Took the data off the disk, and copied it to 
the body you see now..."`;
   Sora(CEP192)`"That is the reason I was able to maintain the 
records of what happened to all of you, 17 
years ago."`;
   Sora(CEP193)`"After that, You took in Pipi...and from that 
time on he's been a member of the Tanaka 
family."`;
   Sora(CEP194)`"In other words, Pipi is an irreplaceable 
...
showTextbox();
text(() => {
   Takeshi(CEP196)`"Uh, yeah, that's right, now that you mention 
it..."`;
   Takeshi(CEP197)`"But come on, you don't have to get so 
serious about it."`;
...
showTextbox();
text(() => {
   Takeshi(CEP198)`"Besides, Pipi isn't broken...so what's the 
big deal?"`;
...
showTextbox();
text(() => {
   Takeshi(CEP201)`"I hope you don't think it's rude of me to 
ask this, but..."`;
...
text(() => {
   Takeshi(CEP205)`"Yeah..."`;
   Takeshi(CEP206)`"As far as I can tell, you look totally 
human, your skin..."`;
   Takeshi(CEP207)`"The way you move, your appearance, 
everything, is so natural..."`;
   Sora(CEP208)`"Ha, ha, ha, that isn't rude at all."`;
   Sora(CEP209)`"Actually, that's a compliment, isn't it? 
Thank you."`;
   Sora(CEP210)`"And...was that your question?"`;
   Takeshi(CEP211)`"Uh, no...I mean...I was wondering how your 
...
text(() => {
   ...
   `As he said that, Takeshi put his hand on my 
cheek.`;
...
other...)`;
   `I had waited these 17 years for just this 
moment.`;
...
showTextbox();
text(() => {
   Takeshi(CEP217)`"W-what's wrong Sora? Have you been drinking 
or something? Your face is all red?"`;
   Sora(CEP218)`"Professor Kuranari..."`;
   Takeshi(CEP219)`"Wh-what is it Ms. Akanegasaki..."`;
   Sora(CEP220)`"There are so many strange things in this 
world, don't you think?"`;
   Takeshi(CEP221)`"?"`;
   Sora(CEP222)`"You asked about my body, didn't you 
professor?"`;
   Sora(CEP223)`"You wondered how I came to have this body, 
didn't you?"`;
...
text(() => {
   ...
   `Takeshi looked straight into my eyes and 
blinked.`;
...
text(() => {
   ...
   Sora(CEP233)`"Yes...But it looks like Pipi ran out of 
batteries."`;
...
text(() => {
   ...
   `Coco held Pipi between both her hands and 
...
showTextbox();
text(() => {
   `I exclaimed this without thinking as I 
realized something .`;
...
text(() => {
   ...
   Sora(CEP244)`"Don't mention it. All I did was push a 
button."`;
   `Just then...`;
...
nodded.`;
   `The world is full of strange and wonderful 
things.`;
   `Isn't it?`;
   `"The discussion about Pygmalion... and 'keep 
it simple'..."`;
...
text(() => {
   ...
   `And wagging his tail fitfully, he raced 
across the deck.`;
...
text(() => {
   ...
   `The deck was overflowing with quiet sunlight 
...
stretching out in all directions.`;
   ...
   Coco(CEP249)`"Piipiii! Hey you, wait a second you 
little...!"`;
...
text(() => {
   ...
   `Right in front of my eyes floated the outline 
of my brother, who I loved dearly.`;
   `Well, it wasn't something I HAD seen...rather 
I'm seeing it right now.`;
   `Right now at this moment, Coco is looking at 
you.`;
   `She cries out suddenly with an elated 
expression.`;
...
Tsugumi.`;
   ...
   `Coco points at you.`;
   `She wanted to tell everyone that you've 
arrived.`;
   `Tsugumi takes off her hat, and squints her 
...
text(() => {
   ...
   `${voice(CEP266)}'And please, let me meet with him again, 
someday...'`;
   `Right then—`;
...
was sure of it...`;
   `If the moon is only there because of your 
belief that it will be there when you look 
for it...`;
   `Then it was possible that I am here, and they 
