...
text(() => {
   ...
   Takeshi`"I'm sleepy..."`;
   `The lack of sleep made the echo of the shoes scraping the ground seem louder than usual.`;
   `As I walked down the emergency corridor, I stretched.`;
   `You was next to me.`;
   `Coco and the Kid trailed a little way behind us.`;
...
text(() => {
   ...
   Takeshi`"Yeah, but what time do you think it is right now?"`;
   You(T2A001)`"5:30 a.m."`;
   Takeshi`"That's right. So that means that I only slept four and a half hours."`;
...
text(() => {
   ...
   You(T2A003)`"I don't know how you could sleep like that given our situation..."`;
   Takeshi`"It's because it is this kinda situation that we've gotta sleep."`;
   Takeshi`"Our minds have to be sharp. We have to be ready for anything, right?"`;
...
showTextbox();
text(() => {
   Takeshi`"Well, I'm still a bit sleep deprived, so not all my pistons are firing..."`;
   Takeshi`"But I think I'm doing about as good as the next guy..."`;
   Takeshi`"Huh?"`;
   `The next thing I noticed, You was no longer next to me.`;
...
showTextbox();
text(() => {
   `I saw the kid and Coco disappearing down a side pathway to the right.`;
...
text(() => {
   ...
   `You spoke to me sarcastically once I'd caught up.`;
   Takeshi`"I just told you. I'm not running at full power."`;
...
text(() => {
   You(T2A006)`"*sigh*..."`;
   `You let out an exasperated sigh and shrugged her shoulders.`;
...
text(() => {
   You(T2A007)`"Takeshi..."`;
   You(T2A008)`"You know, I think you'd better take a look in the mirror."`;
   Takeshi`"Huh? Mirror?"`;
...
showTextbox();
text(() => {
   `We entered the emergency stairs from the emergency corridor.`;
   `We had just been rousted from sleep by Sora and the four of us shuffled to the Control Room on the third floor, Dritte stock.`;
   `We seemed to have passed through the decompression process without a hitch as no one had any complaints.`;
   `Even Coco who had seemed to be having such a rough time was...`;
...
showTextbox();
text(() => {
   `The water on the corridor floor splashed and sprayed as we walked.`;
   `You walking next to me had clammed up.`;
   `(I wonder what she is peeved about...?)`;
   `I slowed down my pace to walk with the kid.`;
   Takeshi`"Hey, you got any idea what You's all miffed about?"`;
...
text(() => {
   ...
   Takeshi`"Hey, what're you laughing about? Do you know something that I don't?"`;

});
fgload({ id: 1, name: `KA07ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Kid(T2A014)`"You sure you don't have any ideas what it could be?"`;
...
showTextbox();
text(() => {
   `The Kid kept glancing at my face and trying not to smile.`;
   `(My face...?)`;
...
showTextbox();
text(() => {
   `The faucet was broken and the sink was overflowing with water.`;
...
text(() => {
   ...
   `The mirror in front of me was shattered into so many shards it was useless.`;
   `But most of the black had come off of my hands, so I thought my face was probably alright.`;
   Takeshi`"That girl..."`;
   `I said it disgustedly and hurried out of the bathroom.`;
...
text(() => {
   You(T2A019)`"Huh?"`;
   Takeshi`"While I was asleep you scribbled all over my face, didn't you?"`;
   You(T2A020)`"Scribble?"`;
...
text(() => {
   ...
   You(T2A024)`"Are you sure your ears aren't playing tricks on you? I'm pretty sure you are still half asleep."`;
   Takeshi`"Then what's this?"`;
   `I showed her my shirt collar where I had wiped the ink.`;
...
text(() => {
   ...
   You(T2A026)`"Well..."`;
   `Suddenly she grabbed my hand and stared at my palm intently.`;

});
fgload({ id: 1, name: `YU06BDL`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T2A027)`"Oh! Your palm has an interesting future for you."`;
...
showTextbox();
text(() => {
   You(T2A028)`"Your palm tells me that your fate diverges into two distinctly different futures."`;
   You(T2A029)`"It's kind of an all or nothing outcome."`;
   You(T2A030)`"You will either acquire or lose everything..."`;
   Takeshi`"........."`;
   You(T2A031)`"One path will put you on the road to riches, a good job, an encounter with a beautiful woman and bless you with a strong home and offspring."`;
   You(T2A032)`"And you will be as healthy as possible..."`;
   You(T2A033)`"You will live to a ripe old age that will make those around you jealous."`;
   You(T2A034)`"HOWEVER! HOWEVER!"`;
   You(T2A035)`"If you take the other path...you will be in dire straits."`;
   Takeshi`"D-dire...?"`;
...
text(() => {
   ...
   You(T2A037)`"You should take a good look at the middle of your lifeline."`;
   You(T2A038)`"Because that is where the answer can be found."`;
...
text(() => {
   ...
   `There was still black ink in the creases of my hand.`;
   `Black ink...`;
   `Black ink...`;
   `Black ink!?`;
   `I remembered what I was angry about. Forget fortune telling!`;
   Takeshi`"Y-you! You're trying to trick me..."`;
   Takeshi`"...What? Hey -"`;
   `The next thing I knew, You was no longer beside me.`;
   `I stopped and looked back.`;
...
showTextbox();
text(() => {
   `I saw the Kid and Coco vanish into a small side corridor.`;
...
showTextbox();
text(() => {
   `I wondered where she could have run off to the day before...but decided not to ask.`;
   `I decided to shower her with the cheeriest greeting I could muster.`;
...
text(() => {
   ...
   Takeshi`"How are you feeling? If you aren't feeling good, you should probably get to the decompression chamber!"`;
   Tsugumi`"........."`;
   `Tsugumi didn't budge.`;
   `She stood there with her mouth half open only blinking her eyes a couple of times.`;
   Takeshi`"What's the matter? You tired? Low blood pressure?"`;
   Takeshi`"Well, I didn't exactly sleep like a baby either. That damn room was so small I ended up sitting on the floor all night..."`;
   `I yawned and rubbed my eyes with both hands as I spoke.`;

});
fgload({ id: 1, name: `TU08ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   `But then Tsugumi's eyes narrowed into slits and she leveled a steely glare at me.`;
...
text(() => {
   ...
   `I was curious where she had gone off to the day before...`;
...
text(() => {
   ...
   Takeshi`"Did you get a good sleep last night? I didn't. That damn room was so small I ended up sitting on the floor all night..."`;
   `I yawned and rubbed my eyes with both hands as I spoke.`;
...
showTextbox();
text(() => {
   `Tsugumi shook her head as if she were fed up with me and vanished inside the Control Room.`;
   `(...A-absolute worst?)`;
...
text(() => {
   ...
   `The expression on her face appeared more stressed than the day before.`;
   `It seemed as if her face said...that something serious were unfolding...`;
...
showTextbox();
text(() => {
   Sora(T2A050)`"I'm sorry that I had to have you gather so early. There was no other way."`;
   Sora(T2A051)`"Actually, everyone, there is something I need to tell you right away."`;
   `Sora paused for a second.`;
   `Sora looked over all five of us...You, Coco, the Kid, Tsugumi, and finally me.`;
   `The cooling fan whirred away in the silence.`;
   `Occasionally the sound of metal on metal would ring through the room.`;
   `The five of us waited on Sora's next words.`;
   Sora(T2A052)`"Last night, after the four of you, apart from Tsugumi, entered the pressurization chamber..."`;
   Sora(T2A053)`"I was in the Control Room here thinking about ways to escape or contact the outside."`;
   Sora(T2A054)`"And..."`;
   Sora(T2A055)`"While I was checking the internal status of LeMU I discovered something."`;
...
showTextbox();
text(() => {
   Sora(T2A061)`"I discovered the strength of pressure the bulkheads can withstand...I found their limits."`;

});
removeFG({ id: 1, useAnim: true });
showTextbox();
text(() => {
   `Saying that, Sora turned her eyes to the side of the console.`;

});
bgload({ name: `BG16A3`, transition: 20 });
showTextbox();
text(() => {
   `In the darkness, a three-dimensional image of LeMU sprung up.`;
...
text(() => {
   ...
   Sora(T2A063)`"I mean LeMU's walls. The partitions between the outer seawater and the inner air."`;
   Kid(T2A064)`"What do you mean...when you say you found the limit?"`;
   Sora(T2A065)`"Like I said yesterday, LeMU is a structure basically constructed on a saturation diving specification design."`;
   Sora(T2A066)`"In other words, the internal air pressure equals or is greater than the external water pressure."`;
   Sora(T2A067)`"However, the complex's internal air pressure is currently at 1 atmosphere..."`;
   Sora(T2A068)`"Therefore..."`;
   You(T2A069)`"LeMU's outer shell is constantly being subjected to severe water pressure."`;
   Sora(T2A070)`"Correct."`;
   You(T2A071)`"But LeMU is not constructed to endure this situation for a long period of time."`;

});
showTextbox();
text(() => {
   You(T2A072)`"Inevitably it will, at some point, reach its limit..."`;
   Sora(T2A073)`"Well put, You."`;
   Takeshi`"So...when is this limit...?"`;
   Sora(T2A074)`"According to LeMMIH's calculations, 119 hours from now..."`;
   Tsugumi(T2A075)`"119 hours..."`;
   Tsugumi(T2A076)`"Five days, huh?"`;
   Sora(T2A077)`"The estimated time of implosion is approximately May 7 at 4:30 a.m."`;
   Sora(T2A078)`"Of course, it is only a calculation and there is a margin of error."`;
   Tsugumi(T2A079)`"What is the margin of error?"`;
   Sora(T2A080)`"Plus or minus 12 hours."`;
   Takeshi`"Hmmm..."`;
   `Everyone went silent, lost in thought.`;
   `Sora's talk had made it clear that we were in a crisis.`;
   `But I still didn't know what to make of it.`;
   `I didn't know if five days was a long time, or a short one.`;
   `We didn't have a schedule...but if we could find a way out, I didn't figure we'd be sticking around five days.`;
   `Even if we didn't call anyone, a rescue team might be on its way anyway...`;
...
text(() => {
   ...
   Coco(T2A082)`"I'm not very smart so I'm not sure I understand.... What does all that mean?"`;
...
text(() => {
   Sora(T2A083)`"?"`;
   Coco(T2A084)`"Does that mean at 4:30 a.m. on May 7 LeMU will get squashed like a pancake?"`;
   Coco(T2A085)`"But that might happen at around 4:30 p.m., on the sixth or at 4:30 p.m. on the seventh."`;
   Coco(T2A086)`"Is that good so far?"`;
   Sora(T2A087)`"Yes..."`;
   Coco(T2A088)`"So doesn't that mean the opposite is also true?"`;
   Coco(T2A089)`"I mean, at the worst LeMU will last until 4:30 p.m. on May 6."`;

});
fgload({ id: 2, name: `CO12ADM`, x: 512, useAnim: true });
showTextbox();
text(() => {
   Coco(T2A090)`"So we're fine until then. There's nothing to worry about. Hooray!"`;
...
text(() => {
   ...
   Sora(T2A092)`"We can't be absolutely certain that we will be safe..."`;
   Sora(T2A093)`"But judging from the results of LeMMIH's calculations, that would appear to be the case."`;
   Coco(T2A094)`"Oh, goodie. Then no problem."`;
   Coco(T2A095)`"Ms. Sora, you looked all serious and so I got kind of scared."`;
   Pipi(PIPI_28)`"Bow-wow! Wooooooof!"`;
   Coco(T2A096)`"'Geez, don't scare me, babe.' I think that's what Pipi's trying to say."`;
   Pipi(PIPI_01)`"Woof!"`;
...
showTextbox();
text(() => {
   You(T2A097)`"I see.... If you had said 'We only have one more day,' or something I might have burst out crying."`;
   You(T2A098)`"So we still have lots of time.... Someone will surely come to help us before that."`;
...
text(() => {
   ...
   `He nodded rhythmically as if answering a question.`;

});
multiremoveFG({ id1: 1, id2: 2, id3: 0, useAnim: true });
showTextbox();
text(() => {
   `The tension in the air gave way and smiles returned to the faces around the room.`;

});
fgload({ id: 1, name: `TU11ADS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   `Even Tsugumi, who didn't smile, looked relieved.`;
...
text(() => {
   ...
   `I was in the narrow space of the chicken sandwich stand where the cooking equipment was.`;
   `I was wrapping and placing the freshly made breakfast sandwiches on a tray.`;
   Takeshi`"Why is it that I have to make breakfast for everyone?"`;
   `Complaining, I took the tray in both hands and opened the small door of the stand.`;

});
fgload({ id: 1, name: `YU07BDM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T2A099)`"That's the way it goes. We decided it democratically, you know."`;
   `You was waiting in front of the shop and snatched a sandwich from the tray.`;
   `She peeled back the wrapping and opened up her mouth.`;
...
text(() => {
   ...
   `You said it flatly as she munched on her sandwich.`;
   You(T2A101)`"It is a reflection of the majority of the people's will."`;
   `It was true that it had been an overwhelming vote.`;
   `I had only been appointed breakfast chief minutes before....`;
   `I hadn't even run for the office.`;
   Takeshi`"I know that you're the one in the shadows running this conspiracy."`;
...
showTextbox();
text(() => {
   You(T2A103)`"I'm pretty sure it's just because everyone sincerely thought that you would be the best cook."`;
...
text(() => {
   You(T2A107)`"Hey..."`;
   You(T2A108)`"Come on. Be a pal and make me one more.... Pretty pleeeeeeease!"`;
...
text(() => {
   ...
   `I took the remaining four sandwiches over to the rest area to hand them out.`;
...
showTextbox();
text(() => {
   `Coco came running and splashing toward me. Pipi the dog paddled along behind her.`;
...
text(() => {
   ...
   Kid(T2A112)`"She said there was still stuff she had to look into..."`;
...
showTextbox();
text(() => {
   `I turned my eyes to the three chicken sandwiches left on the tray.`;
   `(What to do...)`;
...
text(() => {
   ...
   `I took their sandwiches in hand and left the room.`;
...
text(() => {
   ...
   `Tsugumi wasn't really doing anything. She just stood in front of the door.`;
...
text(() => {
   ...
   Takeshi`"If you said you didn't want it, I don't know what I'd..."`;
...
text(() => {
   ...
   `She shook my hand off of her shoulder effortlessly.`;
...
text(() => {
   ...
   `Tsugumi said it in a low voice without turning around.`;
   `My shrugged off hand floated in the air with nowhere to go.`;
...
showTextbox();
text(() => {
   `Tsugumi repeated the same words again and silently started walking away.`;
   `Down the water covered floor of the corridor...`;
   `Rings rippled out slowly from where Tsugumi stepped as she walked away.`;
...
showTextbox();
text(() => {
   `Just then, the lights in the corridor began to flicker uneasily.`;
...
text(() => {
   ...
   `The walls and ceiling trembled slightly. Metal screeched on metal.`;
...
showTextbox();
text(() => {
   `The lights clicked and flickered. Tsugumi turned and looked back at me.`;
...
text(() => {
   ...
   `The vibrations and sound died away. Only an eerie silence enveloped us.`;
...
text(() => {
   ...
   Tsugumi`"........."`;
   Takeshi`"I know! First we should go to where everyone is."`;
...
showTextbox();
text(() => {
   `We cut through a nearby door and came out in front of the kiosk.`;
   `You wasn't there.`;
...
showTextbox();
text(() => {
   `I sprinted to the room next door. There was no sign of anyone there either.`;
   `I scanned the area.`;
   `My eyes weren't used to the darkness yet and I couldn't see into the corners of the room.`;
   ...
   `On top of the tray I'd left there was one chicken sandwich remaining.`;
   `I still had one of the sandwiches in my hand....`;
   `The emergency didn't seem to faze Tsugumi who was stuffing her face with the sandwich I'd given her.`;
...
text(() => {
   ...
   Takeshi`"Hey, how do you open this? Does the electricity have to be on?" `;
   You(T2A133)`"Oh, there is an emergency mechanism for opening the door near the bottom of it..."`;
...
text(() => {
   ...
   `I'd gone as far as the corner before I realized that I didn't know the route.`;
...
text(() => {
   ...
   Takeshi`"Hey, Sora! Open up! I brought you food! Time to eat!"`;

});
playSFX({ name: `SE04_00`, a1: 0, volume: 100 });
showTextbox();
text(() => {
   `I shouted into the interphone as I pushed the button to talk.`;
   Sora(T2A134)`"Eat?"`;
   `She replied to me through the speaker.`;
   Sora(T2A135)`"Thanks for going to the trouble, but I don't need any food...?"`;
   Takeshi`"You don't? Don't say that."`;
   Takeshi`"Sora, have you been eating okay?"`;
   Takeshi`"You have to eat or you're not going to have any energy."`;
   Sora`"........."`;
   Sora(T2A136)`"I'm sorry, but I'm occupied at the moment."`;
   `I remembered that we had had the same exchange the day before.`;
   Takeshi`"Hurry it up. These sandwiches are gonna get cold."`;
   Takeshi`"Besides, I made them special, for you..."`;
   Takeshi`"Listen...I just wanna give these to you, so will you open the door?"`;
   Sora(T2A137)`"I really can't..."`;
   Takeshi`"C'mon. Please, just open the door, Sora."`;
   Takeshi`"...I'll throw in a coupon for a beer if you want."`;
   Sora(T2A138)`"I'm sorry..."`;
   `We kept arguing through the speaker.`;
   Takeshi`"........."`;
   Takeshi`"Alright then! I'm only going to wait out here for one more minute!"`;
   Sora(T2A139)`"One more minute? You're giving me a hard time..."`;
...
text(() => {
   `Just then, the lights in the corridor began to flicker uneasily.`;
   `I instinctively glanced up at the ceiling.`;
   `I strained to hear as a dull growl-like sound shook the floor....`;
...
text(() => {
   ...
   `Tiny waves formed in the water pooled on the floor.`;
   `The walls and ceiling trembled slightly. Metal screeched on metal.`;
   `As if they were trying to say something to me...`;
...
text(() => {
   `Bang, bang!`;
   `I pounded the door.`;
   `I thought she might not be able to hear me inside....`;
...
text(() => {
   ...
   `(Oh...I wonder if the interphone needs electricity to work...)`;
   `I had no clue what was happening on the other side of the door.`;
   `(I figured the only thing I could do was get the door open...)`;
   `I heard footsteps approaching from the darkened corridor.`;
   Takeshi`"Who's there?"`;
   `In the far darkness I could just make out four familiar outlines.`;
...
text(() => {
   ...
   Takeshi`"No, but she was inside here until just a bit ago. But now she won't answer. And it seems like the door is locked..."`;
   You(T2A144)`"What happened?"`;
   Takeshi`"I dunno. Anyway, let's get inside. How do we get this open?"`;
   You(T2A145)`"Oh, there is an emergency mechanism for opening the door near the bottom of it..."`;
...
showTextbox();
text(() => {
   `Pulling on the lever I pushed the door over to the side.`;
   `The door opened just wide enough for a person to squeeze through.`;
...
showTextbox();
text(() => {
   `I gave the Kid the sandwich and took the flashlight.`;
...
text(() => {
   ...
   `I swung the light left and right and shined it in the corners of the room.`;
...
text(() => {
   ...
   `It had been one crisis after another since the day before....`;
   `I guess we were already used to the situation because nobody had lost it.`;
   You(T2A147)`"I can't believe Sora would take off without saying anything first."`;
...
text(() => {
   ...
   You(T2A150)`"I had one change of clothes in the changing room. These are my everyday clothes."`;
   Takeshi`"Hmmm. I see...so you had a change of clothes."`;
   Takeshi`"Spilling sauce on your uniform? That's pretty clumsy."`;
   You(T2A151)`"Ha, ha, ha..."`;
...
text(() => {
   ...
   Coco(T2A154)`"Without Sora around we won't know why there was the blackout or anything..."`;
   Kid(T2A155)`"Yeah. Sora knows more about LeMU than anyone."`;
   Takeshi`"Hmmm.... Alright, let's do this."`;
   Takeshi`"You and the Kid, you guys check this floor. Tsugumi, Coco and I will hit the second floor..."`;
   Takeshi`"Okay?"`;
...
showTextbox();
text(() => {
   `We searched everything - even the Jellyfish Gondola...`;

});
bgload({ name: `BG08A2`, transition: 20 });
showTextbox();
text(() => {
   `Then we retraced our way back to in front of the infirmary.`;
   `And then...`;
...
showTextbox();
text(() => {
   `Coco was shaking the flashlight and signaling to me.`;
   `I had handed it to her before we started searching.`;
...
showTextbox();
text(() => {
   Coco(T2A162)`"She went that way...toward the entrance to EI the egg elevator."`;
...
text(() => {
   ...
   `Something big?`;
   `It sounded like Tsugumi was up to something solo again....`;
...
text(() => {
   ...
   `As expected, it was Tsugumi. She held out the palms of her hands as she stood up.`;
...
showTextbox();
text(() => {
   `Coco hurried to turn off the flashlight and rushed over by Tsugumi.`;
...
text(() => {
   ...
   Tsugumi(T2A175)`"Yes..."`;
   Coco(T2A176)`"What do you need this big thing to investigate for?"`;
   `Coco pointed down by Tsugumi's feet.`;
   `There lay a massive plastic case.`;
   `I was sure I'd seen it...in the warehouse the day before.`;
...
text(() => {
   ...
   Tsugumi(T2A178)`"Right now I'm just checking the status of the elevator."`;
   Tsugumi(T2A179)`"Whether it'll move or the doors open manually..."`;
   `Tsugumi was loads more talkative than usual.`;
   `Her attitude toward Coco was much nicer than the one she had toward me.`;
   `It seemed to me that Coco's unique personality kept even Tsugumi off balance.`;
   Coco(T2A180)`"Hmmm..."`;
   Coco(T2A181)`"So how about it? Does it look like the elevator will move?"`;
...
text(() => {
   ...
   Coco(T2A183)`"Hey, but what good would using the elevator do you?"`;
...
text(() => {
   ...
   Coco(T2A185)`"Third floor? Why don't we just use the emergency stairs like we always do?"`;
   Tsugumi(T2A186)`"Because those stairs won't get us where we need to go."`;
...
text(() => {
   ...
   `She'd said that the facility pumped up hot water from a thermal seafloor vent using heat from it to operate the power generator....`;
...
text(() => {
   ...
   Tsugumi(T2A194)`"I think the cause of the blackout is the generator."`;
...
text(() => {
   ...
   Takeshi`"Huh? Me?"`;
   `Without thinking, I shot a question back at her.`;

});
fgload({ id: 1, name: `CO06ADM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   `Her question was pretty sudden and caught me off balance.`;
   `Besides, I thought that it was the first time that she had called me by my name.`;
   Takeshi`"First there is one thing that I want to ask you..."`;
   Tsugumi(T2A201)`"What?"`;
   Takeshi`"You just said something about the emergency stairs not leading to the Generator Room, right?"`;
   Takeshi`"Yeah...so what?"`;
   Tsugumi(T2A202)`"Don't you remember the map of LeMU that we saw yesterday?"`;
   Takeshi`"Map? Map...map..."`;
...
showTextbox();
text(() => {
   Tsugumi(T2A203)`"The map of the third floor was divided into two areas."`;
   Tsugumi(T2A204)`"Do you remember?"`;
   Takeshi`"I can't say I remember it exactly... but kinda, yeah."`;
   ...
   Takeshi`"The two areas are divided by a block which is now under water...?"`;
...
showTextbox();
text(() => {
   Takeshi`"We can't move directly from the Control Room area to the Generator Room area."`;
   Tsugumi(T2A209)`"So?"`;
   Takeshi`"Oh, I see..."`;
   Takeshi`"To get to the Generator Room's area, we have to access the second floor..."`;
...
showTextbox();
text(() => {
   Takeshi`"And the only way we can do that is by using the neutral buoyancy elevator."`;
   Tsugumi(T2A210)`"Could you...help me out?"`;
   Takeshi`"But do you think it's alright? I mean, we haven't asked Sora's opinion..."`;
   Takeshi`"And we don't know if the cause of the blackout is really the generator..."`;
...
showTextbox();
text(() => {
   Tsugumi(T2A214)`"The Control Room computer is going to be down."`;
   Tsugumi(T2A215)`"Even if Sora were around, she wouldn't be able to contact LeMMIH."`;
   Tsugumi(T2A216)`"So the only thing that we can do is go check out the generator...right?"`;
...
text(() => {
   ...
   `'I really...need...you...'`;
   `They were not words that I ever expected to hear from Tsugumi's mouth.`;
...
text(() => {
   ...
   Tsugumi(T2A225)`"I want you to tell You and the Kid what I just told you."`;
   Tsugumi(T2A226)`"I mean, tell them that Takeshi and I are going to the Generator Room..."`;
   Coco(T2A227)`"Oh, that."`;
...
text(() => {
   ...
   `Coco clicked her heals together and gave a kind of salute.`;
...
text(() => {
   ...
   Takeshi`"We've got to look for Sora first. This isn't a time to be acting selfishly."`;
...
text(() => {
   ...
   Tsugumi(T2A232)`"But I don't think it is possible with just you alone."`;
...
text(() => {
   ...
   Tsugumi(T2A235)`"I want you to tell You and the Kid that I'm going to the Generator Room."`;

});
fgload({ id: 2, name: `TU10ADM`, x: 512, useAnim: true });
showTextbox();
text(() => {
   Tsugumi(T2A236)`"And...that Takeshi put me in a difficult spot because he was scared and wouldn't come along with me..."`;
...
showTextbox();
text(() => {
   Tsugumi(T2A237)`"'No. I don't want to go' That sounds pretty scared to me."`;
   Takeshi`"Hey! Who do you think you're calling scared? I just think that we should do something else first."`;

});
fgload({ id: 1, name: `CO17ADM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Tsugumi(T2A238)`"See what I mean. Something happens and you start whining like a baby..."`;
...
text(() => {
   ...
   Tsugumi(T2A241)`"Coco, hurry and get You and the Kid. Takeshi isn't going to be any use."`;
...
text(() => {
   ...
   `Without hesitating, Tsugumi shot the question right back at me. `;
   Takeshi`"........."`;
   `For one moment I thought I'd grab her by her collar and show her.`;
   `But I dropped my hand....`;
   Takeshi`"Okay, okay. Fine. I'll go with you."`;
   Takeshi`"I'll go with you because you are too scared to go alone."`;
...
showTextbox();
text(() => {
   Tsugumi(T2A245)`"...Just tell You that I am going to the Generator Room."`;
