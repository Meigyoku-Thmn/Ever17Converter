...
text(() => {
   ...
   Sora(T6L313)`"The door behind you...is locked...you are 
shut in."`;
   Takeshi`"Thanks..."`;
   Sora(T6L314)`"In order to delay the destruction of LeMU, 
I'm releasing all the watertight doors at 
Dritte stock."`;
   Sora(T6L315)`"Dritte stock has been flooded entirely. Its 
...
showTextbox();
text(() => {
   Sora(T7L005)`"It seems that we have lost all way to tell 
the time, haven't we?"`;
   Takeshi`"Yeah."`;
   Sora(T7L006)`"The connection between myself and the 
...
LeMU itself are no longer operational..."`;
   Sora(T7L007)`"But according to my previous calculations, 
...
showTextbox();
text(() => {
   Sora(T7L009)`"Oh, some good news arrived while you were 
sleeping, Takeshi."`;
   Takeshi`"Good news?"`;
   Sora(T7L010)`"I discovered that communications were still 
operational in IBF, so I analysed the weak 
signals going through the outer wall of LeMU."`;
   Sora(T7L011)`"According to my results, everyone on IBF was 
...
the emergency lights.`;
   ...
   Sora(T7L013)`"Would you tell me the real reason one more 
time?"`;
...
showTextbox();
text(() => {
   Sora(T7L016)`"Yes, but none of the functions related to 
...
the disk.`;
   ...
   Sora(T7L020)`"No, we students did it voluntarily. Would you 
please listen?"`;
   Takeshi`"Yes, of course. Fire away."`;
   Sora(T7L021)`"I..."`;
   Sora(T7L022)`"I realized..."`;
   Sora(T7L023)`"The reason why I was born."`;
   Sora(T7L024)`"I was meant to be just like any other 
human..."`;
   ...
   Sora(T7L029)`"It doesn't matter if your method is 
primitive."`;
   Sora(T7L030)`"It isn't necessary seek a meaning for it or 
an objective."`;
   Sora(T7L031)`"The only thing you need to do is to love - 
just that and nothing else."`;
   ...
   Sora(T7L040)`"Whatever I'm going through, all it takes is 
...
showTextbox();
text(() => {
   Sora(T7L046)`"And, if I could, I'd like to go on a date 
with you."`;
   Sora(T7L047)`"I would go out with you for about two or 
...
showTextbox();
text(() => {
   Sora(T7L053)`"I suppose that what we just talked about 
