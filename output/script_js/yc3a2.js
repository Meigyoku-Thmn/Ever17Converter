...
showTextbox();
text(() => {
   Sara(C3A171)`"Sora's in the Control Room. Nakkyu's in the 
Security Office."`;
   Sara(C3A172)`"As for Takeshi, I saw him riding the 
merry-go-round, goofing off by himself."`;
   Sara(C3A173)`"And as for Tsugumi, MIA, as usual."`;
   Sara(C3A174)`"Now that the repairs on the warehouse are 
finished, I guess everybody's taking a 
breather."`;
   Kid`"Hmm..."`;
   Kid`"So what do you have planned next, Sara?"`;
   Sara(C3A175)`"Nothing special really."`;
   Sara(C3A176)`"Maybe I'll just sit here and wait to be 
...
showTextbox();
text(() => {
   Sara(C3A178)`"Last night, after we carried you to the 
infirmary, we all took turns watching you."`;
   Sara(C3A179)`"We were worried you might suddenly go on a 
rampage or something...so we took every 
precaution."`;
   Sara(C3A180)`"And until a minute ago, it was my turn to 
watch."`;
   Sara(C3A181)`"Except in the split second I turned my back 
and you up and disappeared... "`;
   Sara(C3A182)`"I wondered what was going on, and left the 
...
showTextbox();
text(() => {
   Sara(C3A186)`"Might be good to show your face around. 
...
showTextbox();
text(() => {
   Sara(C3A161)`"I would think that you'd just be relieved to 
...
on information."`;
   ...
   You(S3A311)`"An accident 17 years ago shrouded in 
mystery."`;
   You(S3A312)`"And my father that disappeared 17 years 
ago."`;
...
showTextbox();
text(() => {
   You(S3A317)`"But since I started working I haven't had 
...
showTextbox();
text(() => {
   You(S3A324)`"Well, I suppose it has also given me a chance 
to live on the edge...?"`;
...
above it."`;
   ...
   You(S3A481)`"The empty fall sky...A single cuckoo calls 
out...Brings a chill to me."`;
...
text(() => {
   `Tap, tap, tap...`;
   You(S3A483)`"The empty fall sky...A single cuckoo calls 
...
showTextbox();
text(() => {
   Sara(C3A191)`"Do you mind waiting until I'm through with my 
lettuce?"`;
...
showTextbox();
text(() => {
   Sara(C3A194)`"Huh? Didn't you believe me when I told 
you...?"`;
...
showTextbox();
text(() => {
   Sara(C3A199)`"Beats me...I have no idea about things like 
that..."`;
   Kid`"Sara?"`;
...
showTextbox();
text(() => {
   Sara(C3A202)`"You can't expect me to remember all the 
details."`;
...
showTextbox();
text(() => {
   Sara(C3A205)`"Hey? What is it THIS time? I have had no clue 
...
text(() => {
   ...
   Kid`"What?"`;
   Sara(C3A208)`"No really, I'm tired of putting up with 
your..."`;
...
showTextbox();
text(() => {
   Sara(C3A209)`"That's exactly what I want to ask you. What 
are you talking about?"`;
   Kid`"........."`;
   Sara(C3A210)`"First you knew my name. Then you predict the 
future..."`;
   Sara(C3A211)`"And you see little girls who aren't there?"`;
   Sara(C3A212)`"And when you look in the mirror, you think 
you're a different person?"`;
   Sara(C3A213)`"And now you're hearing sounds that aren't 
there..."`;
   Sara(C3A214)`"I'm sorry but I just can't keep putting up 
with this..."`;
...
showTextbox();
text(() => {
   Sara(C3A218)`"I was just wondering what's beyond that door, 
that's all."`;
   Kid`"Are you serious?"`;
...
showTextbox();
text(() => {
   Sara(C3A220)`"If there was a place on a map you'd never 
been to, wouldn't you want to go there?"`;
   Sara(C3A221)`"If there was an unopened treasure box, 
wouldn't you want to open it?"`;
   Sara(C3A222)`"If there was a person in the town that you 
...
text(() => {
   ...
   Sara(C3A235)`"When Nakkyu tried to open the door to the 
