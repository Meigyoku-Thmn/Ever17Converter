...
text(() => {
   ...
   `The Kid and Tsugumi went back to the examination room where Coco was.`;
   `Trading places, You left the room, and Tsugumi took her place at the console, watching her vital signs.`;

});
fgload({ id: 1, name: `YU17ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   `You and I talked in the corridor, about what course of action we should take.`;
...
text(() => {
   ...
   You(T6L004)`"You never know when to quit.... Ahhh, I'm sorry, I didn't mean it in a bad way."`;
   You(T6L005)`"You always try to be positive... I just have to admire that."`;
   You(T6L006)`"I mean it."`;
   Takeshi`"Really? You think so?"`;
   Takeshi`"I wouldn't say I was positive, as I probably just don't notice the really dangerous things."`;
...
text(() => {
   You`"........."`;
   Takeshi`"And because I'm not so smart, I've got to think really hard about everything."`;
   Takeshi`"But you know what? I think we're going to be okay. I mean, we got this far, didn't we?"`;
...
showTextbox();
text(() => {
   `A sound roared in the distance. It was probably being transmitted through the water to IBF, where we were.`;
   `Was it...the sound of the thermal vents?`;
   `I wondered if LeMU was still hanging in there...`;
   `Although the situation we were in didn't look great, there were still various options available to us.`;
...
showTextbox();
text(() => {
   You(T6L010)`"The researcher...? In the end we couldn't save him..."`;
...
showTextbox();
text(() => {
   You(T6L014)`"I'm sure some kind of circumstances kept him from escaping. And circumstances that kept him alive..."`;
...
showTextbox();
text(() => {
   You(T6L019)`"He got TB, and wandered around IBF half-dead..."`;
   You(T6L020)`"But he was worried about LeMU the whole time..."`;
   You(T6L021)`"Before coming to IBF, he said that he'd been involved with the project to develop LeMU's system."`;
   You(T6L022)`"He was one of the staff that engineered LeMU's management software."`;
...
showTextbox();
text(() => {
   You(T6L023)`"HIMMEL, LeMMIH, and...Sora. Everything he left behind is here in LeMU."`;
   You(T6L024)`"For a programmer—"`;
   You(T6L025)`"The system here at LeMU was like his own child."`;
   Takeshi`"Meaning...he was worried about his 'children?'"`;
...
showTextbox();
text(() => {
   `Leaning against the wall we looked as waves calmly lapped in the pool.`;

});
fgload({ id: 1, name: `YU01ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T6L028)`"Oh yeah. There was one other thing I heard from him that I was able to check up on."`;
   You(T6L029)`"I wasn't sure about it when I found it on the terminal in the Security Office..."`;
   Takeshi`"What's that?"`;
...
showTextbox();
text(() => {
   You(T6L030)`"Well, I had partially bypassed LeMMIH's security...and that's when I found it."`;
...
text(() => {
   ...
   Takeshi`"What??"`;
   Takeshi`"I mean...can you tell me that in simpler language?"`;
   Takeshi`"So that someone, even dumb like me, can understand?"`;
...
text(() => {
   ...
   Takeshi`"......."`;
   `More than one Sora.`;
   `Multiple copies...clones...present everywhere...that's what she meant.`;
...
text(() => {
   ...
   You(T6L043)`"So what's the only thing that separates the Sora we know, from other Soras?"`;
   Takeshi`"Separates..."`;
   `Separates...`;
   `Differences...`;
   `Truth...`;
...
text(() => {
   ...
   You(T6L045)`"Memory."`;
   You(T6L046)`"The only thing that we and the Sora here share is..."`;
...
text(() => {
   ...
   `There was only one Sora Akanegasaki that I knew.`;
   Takeshi`"Meaning..."`;
...
showTextbox();
text(() => {
   `I kicked a dirty old bottle that was at my feet.`;
...
text(() => {
   You(T6L050)`"Takeshi..."`;
   Takeshi`"........."`;
   You(T6L051)`"I'm sorry, I didn't mean to confuse you earlier..."`;
...
showTextbox();
text(() => {
   `Even if we were able to get out of LeMU safely...`;
   `The Sora up at Insel null wouldn't be the Sora that we knew.`;
   `She would have the same thought processes, and look the same, but would be a different Sora.`;
   `That Sora wouldn't be the one who loved flowerbeds, and who had made it rain.`;
   `It wouldn't be the Sora who looked at me from the other side of the glass window.`;
   `The Sora who...`;
   `Who told a hopeless guy like me that she loved me...`;
...
text(() => {
   ...
   `I looked up, and wiped under my nose, as I replied.`;
...
text(() => {
   ...
   Takeshi`"Look, I told you, right? I really wasn't thinking anything perverted, okay?...huuuh....huuuh..."`;
...
showTextbox();
text(() => {
   `Blood flew not only from my nose, but also from my mouth in large amounts.`;
...
text(() => {
   ...
   You(T6L069)`"We should go to the examination room, and take a look at you at once."`;
...
text(() => {
   ...
   `With You supporting me, I walked down the corridor.`;
   `Just then a door flew open in front of us.`;
   `It was the examination room. Out of it flew Tsugumi.`;

});
fgload({ id: 1, name: `TU04ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Tsugumi(T6L070)`"You, Takeshi! The Kid! The Kid's in bad shape!"`;
   `With eyes that showed the gravity of the situation, she yelled at us.`;
...
showTextbox();
text(() => {
   Tsugumi(T6L072)`"He's in trouble! It'll be faster if you come in and look...ah!"`;
...
text(() => {
   ...
   `Tsugumi noticed the shape I was in and opened her eyes in shock.`;
...
showTextbox();
text(() => {
   Tsugumi(T6L075)`"The Kid's been infected with Tief Blau, too..."`;
...
text(() => {
   ...
   You(T6L080)`"It isn't normal to start spewing blood from your nose and mouth, okay?"`;
...
showTextbox();
text(() => {
   Tsugumi(T6L086)`"The results are black.... You're infected too, Takeshi."`;
...
showTextbox();
text(() => {
   Kid(T6L089)`"If only we had that serum...the orange one...agh."`;
...
text(() => {
   ...
   `His breathing was ragged. He had lines of pain etched on his face.`;
...
showTextbox();
text(() => {
   You(T6L090)`"It's no good. It doesn't look like there's any here."`;
...
showTextbox();
text(() => {
   Tsugumi(T6L098)`"She's still undergoing the oxygen treatment. So we can't open the pod."`;
   Tsugumi(T6L099)`"It looks like the treatment is progressing normally. As long as she's in there, I don't think her condition will get much worse..."`;
   Takeshi`"Yeah, okay..."`;
   Takeshi`"By the way, what about you Tsugumi...are you okay?"`;
...
showTextbox();
text(() => {
   Tsugumi(T6L101)`"I'm okay for now. But maybe I just don't have any symptoms."`;
...
showTextbox();
text(() => {
   `You opened up another of the containers and gave Tsugumi a shot.`;
...
text(() => {
   ...
   `Small droplets of red stained the bed's white sheets.`;
   `..............`;
   `.........`;
...
showTextbox();
text(() => {
   `After that You got scanned on the L-MRI. As suspected had come down with TB.`;
   `We didn't have room to mess around anymore.`;
   `In the end You wouldn't let me do it, so she ended up giving herself the shot.`;
   `Complaining the whole time, with tears in her eyes...`;
...
text(() => {
   ...
   You(T6L104)`"But someone has put a lock on the communications protocol, and we can't make contact with the surface."`;
   You(T6L105)`"But, every once in a while, I've found some communication data that crosses through."`;
   You(T6L106)`"If I can release that lock, or...well anyway, we just might be able to get through somehow."`;

});
fgload({ id: 1, name: `YU01ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T6L107)`"At least it is better than LeMU, where we had no way of making contact."`;
...
text(() => {
   ...
   `The Kid snored next to Coco's pod, frowning slightly`;
   `I couldn't say that his condition looked good.`;
   `I could only pray that he would hang on a little longer.`;
...
text(() => {
   `............`;
   `................................`;
   `For a little while after that, my attention wandered.`;
   `I don't know how much time passed.`;
   `I was not sure whether things were real or a dream.`;
   `Was I alive?`;
   `Was I dead?`;
   `I didn't know.`;
   ...
   `Was I sleeping?`;
   `Which was it?`;
   `And where was the me that was thinking about everything?`;
...
text(() => {
   `That's right...`;
   `Just a little more...`;
   `Just have to stay alive for a little bit more...`;
   `........................`;
   `......`;
...
text(() => {
   ...
   //??
   Anon(T6T225)`"We are under the direction of Insel null."`;
   `Was I actually hearing someone's voice over the speaker!?`;
...
text(() => {
   ...
   //Mission Control
   Mission_Control(T6T239)`"We're heading there, no matter what! So, please hang on a little longer!" ${noWait}`;
   Append`*Click* ...`;
   ...
   `I began reading through the manual on the side of communication terminal.`;
...
text(() => {
   ...
   Takeshi`"Yeah. Tsugumi, there's a rescue team on the way. They said it would take about an hour...I want you to wait for them in the examination room!"`;
   Tsugumi(T6L118)`"Rescue?"`;
   Takeshi`"They said they were from the Maritime Defense Force."`;
   Takeshi`"You was able to open up a communication line up to Insel null."`;
...
showTextbox();
text(() => {
   Tsugumi(T6L120)`"Yeah...that serum seems to be working. I'm fine."`;
   Takeshi`"Okay, then I want you to get back to the examination room right away. Everyone else is in bad shape. I want you to look after them."`;
...
text(() => {
   ...
   Takeshi`"Up. To LeMU."`;
   Takeshi`"We've still got an hour. I'm going to go get Sora!"`;
...
text(() => {
   ...
   `Tsugumi called out at me in a tearful voice, as she lay sprawled on the floor.`;
...
text(() => {
   ...
   Sora(T6L134)`"The warehouse area has been breached, and cracks are beginning to form in the elevator shaft. The situation is serious."`;
   Sora(T6L135)`"There is over six inches of flooding in almost all of the corridors."`;
   Takeshi`"That's pretty bad..."`;
   Sora`"........."`;
   Takeshi`"What about Dritte stock?"`;
   Sora(T6L136)`"Water is coming in from the upper floors via ducts."`;
   ...
   Takeshi`"Well, don't worry about it, I'll be right back."`;
   Sora(T6L139)`"No!"`;
   `Sora's eyes flashed from the other side of the glass.`;
   Sora(T6L140)`"Let's decompress the chamber, and follow the proper entrance protocol."`;
   Takeshi`"Decompression? Are you telling me to just wait here?"`;
   Sora(T6L141)`"Yes. It is a rule. If you won't...I'm going to have to ask you to go back to IBF."`;
   ...
   Sora(T6L144)`"If we don't dissolve the nitrogen in your blood, you will get decompression sickness."`;
   Takeshi`"I don't care! Open that door now!"`;
   Sora(T6L145)`"I can't do that...!"`;
   Takeshi`"Just open it now, please!"`;
   Sora(T6L146)`"Why!?"`;
   Sora(T6L147)`"If we open that door now, due to the rapid decompression, the nitrogen in your bloodstream will form bubbles, causing blood clots, and in the worst case..."`;
...
text(() => {
   ...
   `The muscles in my limbs began to jerk and spasm.`;
...
text(() => {
   ...
   `But fish brought quickly up from the sea depths to sea level die instantly, because the pressure difference causes their organs to burst.`;
...
text(() => {
   ...
   `Repelled by my eardrums, the voice converter flew out of my ears.`;
...
text(() => {
   Sora(T6L150)`"Takeshi...!!"`;
   `Sora ran over to me with a painful expression on her face.`;
...
text(() => {
   ...
   `Even though she couldn't touch me, she was trying to help me up.`;
...
text(() => {
   ...
   Sora(T6L153)`"Go back to IBF this instant! It's too dangerous here!"`;
   `And although she was crying, her face reddened with anger.`;
   Takeshi`"I'm not going back."`;
   Takeshi`"I came here knowing how dangerous it would be."`;
...
showTextbox();
text(() => {
   Sora(T6L157)`"Flooding, I, go back, Takeshi, please, If I don't save, danger..."`;
...
text(() => {
   ...
   Takeshi`"I knew that LeMU was dangerous so I couldn't just stay there at IBF, where it is safe."`;
...
showTextbox();
text(() => {
   Sora(T6L166)`"Because, because, if you stay here...Takeshi, you'll..."`;
...
text(() => {
   ...
   Takeshi`"I keep telling you not to rush to conclusions, Sora."`;
   Takeshi`"I came here to get you."`;
   Takeshi`"I know a way to help you."`;
   Takeshi`"Well, I'm not sure about it yet, but..."`;
   Takeshi`"If I've got a little time, I can get you to IBF with me..."`;
...
showTextbox();
text(() => {
   Sora(T6L171)`"The elevator leading to IBF was destroyed with that tremor."`;
   `The elevator...?`;
   `Was destroyed...?`;
...
showTextbox();
text(() => {
   `The ruin of LeMU was happening faster than I had expected.`;
...
text(() => {
   ...
   Takeshi`"Uh...well..."`;
   Takeshi`"Well, that throws a bit of a wrench in our plans...but, hey, that's okay, right?"`;
   `I laughed sheepishly and scratched the tip of my nose.`;
   `There really wasn't anything to do but to laugh.`;
...
showTextbox();
text(() => {
   `I sprang to the HIMMEL console, checking once more the damage shown there.`;
   `The IBF elevator wasn't moving due to a break in the shaft.`;
   `Thankfully, no one was in the elevator when the accident happened.`;
   `It seemed that in the IBF case, we had escaped damage again...`;
...
text(() => {
   ...
   `Sora stopped crying.`;
   `Suddenly tightening her expression, she stood at attention.`;
...
text(() => {
   ...
   Sora(T6L177)`"In any case, I'll think of a way to help Takeshi get out."`;
...
text(() => {
   Sora(T6L179)`"Yes."`;
   `She nodded calmly.`;
   Sora(T6L180)`"I will definitely get you to the ground level."`;
   Sora(T6L181)`"It's the function that was given to me, it is my task."`;
...
showTextbox();
text(() => {
   Sora(T6L183)`"I'm...Sora Akanegasaki, Artificial Intelligence of LeMMIH's System."`;
...
text(() => {
   ...
   Sora(T6L184)`"There is a huge cylinder that cuts through LeMU."`;
   Sora(T6L185)`"The elevator shaft that rises in the middle of that..."`;
   Sora(T6L186)`"If you can get through this, you can emerge on the surface of the sea."`;
   Takeshi`"What are you talking about...?"`;
   Takeshi`"Didn't the central elevator get sunk in the first flood?"`;
   Sora(T6L187)`"Yes."`;
   Sora(T6L188)`"But the tube itself is thankfully still fine."`;
   Sora(T6L189)`"The ocean water only came through the cracks in another area..."`;
   Takeshi`"Really? Still...even so..."`;
   Takeshi`"That tube is 103 feet high."`;
   Takeshi`"That huge pipe is completely full of pressurized sea water!"`;
   ...
   Sora(T6L192)`"First, we close off all the flood hatches around the tube, so that no water can get in."`;
   Sora(T6L193)`"After we take care of that, we open the doors on the lowest part of the tube and let all the water that has built up inside flow over to Dritte stock."`;
...
showTextbox();
text(() => {
   Takeshi`"Okay. Let's say something like that were possible ? "`;
   Takeshi`"How could I climb up that ridiculously high tube?"`;
   Takeshi`"There's no ladders or anything in that tube, is there?"`;
   Sora(T6L194)`"It is as you say."`;
   Sora(T6L195)`"That is why I said we would drain it 'first'."`;
   Takeshi`"?"`;
   Sora(T6L196)`"After the drainage has completely finished, we open door A."`;
   Sora(T6L197)`"At that point, you will go to Zweite stock's elevator tube."`;
   Sora(T6L198)`"If you do that, as the water level rises, you will just float right up to Insel null."`;
...
showTextbox();
text(() => {
   Sora(T6L199)`"At first, all the water pressure will make the level of the water swell up violently, but as you approach sea level, it will slow down."`;
   Takeshi`"Hey, Sora?  Can we go back to our first conversation?"`;
   Sora(T6L200)`"Yes, certainly."`;
   Takeshi`"You said before that we would move the water to Dritte stock."`;
   Takeshi`"So you mean, in other words, that we would entirely flood Dritte stock?"`;
   Sora(T6L201)`"Yes."`;
   Takeshi`"What do you mean, yes?"`;
   Takeshi`"If we flood Dritte stock, the HIMMEL computer room will be flooded too."`;
   Sora(T6L202)`"Yes."`;
   Sora(T6L203)`"But you don't need to worry about me."`;
   Sora(T6L204)`"My brain is in Insel null."`;
   Sora(T6L205)`"So even if all the computers inside LeMU go down, it won't extinguish me."`;
...
showTextbox();
text(() => {
   Sora(T6L206)`"Do you need me to explain this plan again to you?"`;
   Takeshi`"No, I've got it. It's okay."`;
   Takeshi`"The water rises up the elevator tube. I just zoom up and out with it, and I escape."`;
...
text(() => {
   ...
   Takeshi`"Your memory, your recollections...aren't they all here?"`;
...
text(() => {
   ...
   Takeshi`"No, no..."`;
   Takeshi`"No way am I going to let you take this kind of 'suicidal' act, Sora!"`;
...
text(() => {
   Sora(T6L208)`"Takeshi..."`;
   Sora(T6L209)`"We don't have any more time. Please, do as I say."`;
   `She said this without emotion.`;
   `Furrowing her eyebrows, Sora glared at me.`;
   Sora(T6L210)`"I fiddled around a bit with the RSD laser levels..."`;
   Sora(T6L211)`"And so I seared your eye..."`;
   Takeshi`"Wha, what!?!"`;
   Sora(T6L212)`"Actually, it's not something I should be able to do..."`;
   Sora(T6L213)`"But right now I just did it somehow. It's like the limiter has been turned off..."`;
   `She stared at me.`;
...
text(() => {
   ...
   Sora(T6L215)`"Takeshi..."`;
   Sora(T6L216)`"If I make even a tiny mistake with the laser levels, next time I really might hurt your eyes."`;
   Takeshi`"......"`;
...
text(() => {
   ...
   Sora(T6L219)`"Takeshi, you will go to the predetermined place in Zweite stock and wait there."`;
   Sora(T6L220)`"I'll let you know the timing of when to get into the tube."`;
   Sora(T6L221)`"Until then...I'll stay at HIMMEL and keep watch on LeMU."`;
   Sora(T6L222)`"I'll control the drainage duct and try to stop the fall...I'll try to keep the whole place going for as long as I can, even a minute, no, even a second longer. So - "`;
   Sora(T6L223)`"Please, Takeshi. You have to get out alive - please promise me."`;
   Takeshi`"I promise."`;
...
showTextbox();
text(() => {
   `It showed a map of LeMU and my escape route......`;
   `Just a little bit ago, I had installed a data-linking program from HIMMEL's console that linked my PDA to LeMU's center. `;
...
text(() => {
   ...
   Takeshi`"Sora, I've come to the second floor. What should I do?"`;
   Sora(T6L224)`"Got it, Takeshi. I've checked your current location and your direction."`;
   `I couldn't see her, but I could hear her voice in my ear.`;
   Sora(T6L225)`"Please wait there for a minute. I'm going to re-close the flood hatches to the central area."`;
   Takeshi`"Ok."`;
...
showTextbox();
text(() => {
   `Presumably she had blocked off the flood hatches in the flooded area.`;
   Sora(T6L226)`"I've finished closing the hatches. The Zweite elevator tube is sealed..."`;
   Sora(T6L227)`"Now then, please go into the Dolphin Carousel room and wait for your next instructions.  Do you know where it is?"`;
   Takeshi`"Yeah, I know the Dolphin Carousel reeeeaaally well."`;
   Takeshi`"That's where you and I rode dolphins together."`;
   Takeshi`"That's where you showed me the art of my other self..."`;
   Sora`"........."`;
   Sora(T6L228)`"Please hurry, Takeshi."`;
   Sora(T6L229)`"Go straight down that hall and turn left at the end. If you can't figure it out, check your PDA map."`;
...
showTextbox();
text(() => {
   `Defying Sora's directions, I turned left down at a nearby corner and headed toward a certain corridor.`;
   Sora(T6L230)`"What are you doing!? It's not that way!!"`;
   Takeshi`"Sorry Sora, I remembered that I had forgotten something."`;
   Sora(T6L231)`"There's no time! Please stick to the plan!"`;
   `Sora's voice grew shrill.`;
   Takeshi`"It will only take a minute. It won't make a difference."`;
...
text(() => {
   ...
   `Phew...`;
   `It hadn't flooded yet in there and the machines were still going.`;
   `I looked at the terminal monitor.`;
   `The window that was open showed a message confirming the last entered password.`;
...
text(() => {
   ...
   `The manager-exclusive maintenance mode was in operation.`;
   `In other words, we had cleared all of LeMMIH's security.`;
   `'The terminal in the Security Office...'`;
   `'I finally figured out the password...'`;
   `You's voice, which I had heard through my stupor, had been right.`;
   `You...had made it in the nick of time...`;
   Takeshi`"Next time I see her, I'm buying her a fantastic dinner."`;
   `Alone, I began quickly searching for a way to back up the data.`;
...
showTextbox();
text(() => {
   `The corridor outside the room had been drained and the flood hatches had been closed again.`;
...
showTextbox();
text(() => {
   `I turned around to see that the corridor on the other side was open.`;
   Takeshi`"This way?"`;
   Sora(T6L237)`"Yes. Six minutes left. Take the corridor and get to the right position."`;
   Takeshi`"......"`;
...
text(() => {
   ...
   Sora(T6L239)`"I'm going to drain the water from the central area into Dritte."`;
   `No.`;
   `I didn't make it in time...`;
   Sora(T6L240)`"Five minutes until the tube is operational. Please be ready to move at any time."`;
   `Sora spoke coldly, still invisible.`;
   `I was in front of the dolphins.`;
   `The dolphins had been so pleasant and smiling before...now, they were hateful.`;
   Takeshi`"Sora..."`;
   Takeshi`"Sora, won't you come over here?"`;
   Takeshi`"You like dolphins, right?"`;
   Sora(T6L241)`"I can't. If I don't...concentrate...I might make a mistake."`;
   Takeshi`"Don't say that, come on..."`;
   Takeshi`"Don't you want to ride the dolphins again together, one last time?"`;
   Sora(T6L242)`"Please don't speak to me, you'll distract me."`;
   Takeshi`"........."`;
   Sora`"..............."`;
   Takeshi`"....................."`;
   Sora(T6L243)`"Even after Dritte stock is flooded, HIMMEL should be all right for a little while."`;
   Sora(T6L244)`"I'll make sure that we definitely - no, absolutely - hang on until you make it to the top."`;
   Takeshi`".................."`;
   Sora`".................."`;
   Takeshi`"............"`;
...
text(() => {
   ...
   `It would have been better for us to throw our bodies from a cliff.`;
   `.............................................`;
   Sora(T6L246)`"Takeshi ? "`;
   Sora(T6L247)`"I'm sorry, Takeshi..."`;
   `What...?`;
   `Even with my eyes closed, she was definitely there.`;
...
showTextbox();
text(() => {
   Takeshi`"What's the matter, Sora? The five minutes should be up."`;
   ...
   Takeshi`"What?"`;
   Sora(T6L250)`"The central area's flood hatches aren't receiving the 'open' signal. Something's been disconnected."`;
   Takeshi`"Disconnected!?"`;
   Sora(T6L251)`"Yes. But I've found the damaged section."`;
   Sora(T6L252)`"I'm so sorry...but Takeshi, will you go fix it?"`;
...
text(() => {
   `Down, down.`;
   `Run, run, run.`;
   `In reality, my body was probably wracked with decompression sickness, and riddled with TB...`;
   `But it wasn't something I was aware of.`;
   `More importantly I had to move, faster, faster......`;
   `Hurry there!`;
   `Falling again and again, covered in bruises, slipping down the stairs, I headed for the third floor.`;
...
text(() => {
   ...
   Takeshi`"Hey wait, what about tools? Can I fix it with just my hands?"`;
   Sora(T6L255)`"There are some simple tools in the Control Room. The main repair room is under the floor of the hallway you are in."`;
   Takeshi`"Under the floor?"`;
   Sora(T6L256)`"In any case, let's hurry."`;
   Sora(T6L257)`"I'm going to apply pressure and blast out the floor panel. For now, hide in the Control Room."`;
   Takeshi`"What??"`;
...
showTextbox();
text(() => {
   `I wrenched open the Control Room door and sprang inside in the nick of time.`;
   `As I flew through the air, a blue-white light beamed through the entire corridor behind me.`;
   ...
   Takeshi`"Okay...you don't have to feel so bad. I'm fine. You just scared the crap out of me, that's all."`;
   Takeshi`"I'm all right. I'm fine. Look, see, I'm alive and everything."`;
   Sora(T6L264)`"Al-alright..."`;
   Takeshi`"You can't kill me off that easy. I've still got things to do!"`;
   Sora(T6L265)`"Yes."`;
   ...
   `Next to the console there was a small toolbox. It held radio pincers, nippers, and a screwdriver.`;
   `I wondered if it would be enough.`;
   `I looked around a little more...`;
   `I caught sight of a polycarbonate disc in a square case.`;
...
showTextbox();
text(() => {
   Takeshi`"Sora, there's something wrong with the lights."`;
   Sora(T6L267)`"It does seem that way."`;
   Takeshi`"It seems.... What are you...?"`;
   Takeshi`"Hey! Damn, I'm back in the hall, but you aren't going to blast me again, are you?"`;
   `Suddenly remembering, I hopped around the corridor.`;
   Sora(T6L268)`"It's alright. I blocked the underground circuits to that section."`;
   Sora(T6L269)`"That's probably why the ceiling lights are acting strange."`;
   Takeshi`"Got it..."`;
   `I was relieved to hear that.`;
   Takeshi`"So, where do I need to fix?"`;
   Sora(T6L270)`"Nearby, there should be a place where the floorboards have come up. The blast succeeded at that."  `;
   Takeshi`"Which way? Which way from my perspective?"`;
   Sora(T6L271)`"I-I'm sorry. That's the thing..."`;
   Takeshi`"Sora? What's wrong?"`;
   Sora(T6L272)`"The bio sensor is down. I am unable to tell where you are. The camera isn't functioning, either."`;
   Takeshi`"Because you do crazy stuff like short out high-voltage..."`;
   Sora(T6L273)`"I'm sorry."`;
   `I heard her sigh.`;
   `I sighed along with her.`;
   Sora(T6L274)`"The place is 51 feet away from the door of the Control Room, to the left."`;
...
text(() => {
   ...
   `Surely I could find one stupid, lousy floorboard.`;

});
playSFX({ name: `SE02_04`, a1: 0, volume: 100 });
showTextbox();
text(() => {
   `I took the toolbox to the hole in the floor and crouched down.`;
   `Pushing aside the nearby water, I searched with my hand under the floor for wiring.`;
   `A cable about the size of a water pipe hose was attached to the connector.`;
   `The cable was twisted in places, and I could tell the connector was bent.`;
   `I cut it with my nippers, dug out the copper wire with my pliers, replaced the connector, and reattached the cable.`;
   Takeshi`"I think I fixed it. What do you think, Sora, will it go through?"`;
   Sora(T6L275)`"Yes, probably."`;
   Takeshi`"That's good."`;
   Sora(T6L276)`"Well, Takeshi?"`;
   Sora(T6L277)`"I'll begin operations for your escape. Please go back to Zweite stock."`;
   Takeshi`"Okay. Right away."`;
   Sora(T6L278)`"Yes...I'll be praying for your safety and a successful escape."`;
...
text(() => {
   ...
   Sora(T6L283)`"Where did you go from the corridor in Dritte stock?"`;
   Sora(T6L284)`"I can't see any trace of you on the emergency stairs."`;
...
showTextbox();
text(() => {
   Takeshi`"Sora, you really need to learn more about hide-and-seek..."`;
   `I tried to say it lightly.`;
   Takeshi`"When we played kick the can, you hid in a place where you'd get found right away!"`;
   Sora(T6L287)`"What are you talking about?"`;
   Takeshi`"Even if you can't monitor me with the bio scan, you could just listen to the sounds."`;
   Takeshi`"That is, if you wanted to find out where I was, right?"`;
...
text(() => {
   Sora`"..............."`;
   Takeshi`"Well, you made it easy for me come back here without being discovered."`;
   Takeshi`"I didn't know what I'd do if you wouldn't let me in the room."`;
...
text(() => {
   ...
   `She yelled.`;
   Sora(T6L289)`"We've only got one shot at this escape plan! And LeMU is reaching its limit..."`;
...
text(() => {
   ...
   Takeshi`"No."`;
   Takeshi`"Open all the flood gates in Dritte stock's passageways."`;
...
text(() => {
   ...
   Sora(T6L295)`"I can't. If I open the doors, Dritte stock will be completely flooded."`;
   Sora(T6L296)`"Everything outside of HIMMEL will be covered in seawater."`;
   Sora(T6L297)`"If I do that, you'll never again be able to..."`;

});
removeFG({ id: 1, useAnim: true });
showTextbox();
text(() => {
   Takeshi`"If you won't open them, I'll open them by hand."`;
...
showTextbox();
text(() => {
   Sora(T6L298)`"Forget it. You can't control things from there."`;
   Takeshi`"That's a lie..."`;
   Takeshi`"You're lying."`;
   Sora`"............"`;
   Takeshi`"Right now LeMMIH is in system-administrator only maintenance mode."`;
   Takeshi`"From the big terminal you can control all of LeMU."`;
   Takeshi`"Sora Akanegasaki can't override the sys-admin's authority."`;
...
text(() => {
   ...
   `I didn't know how to operate it, but something came up that looked about right.`;
...
text(() => {
   ...
   `She glared at me.`;
   Sora(T6L300)`"If you don't hurry, The central area will collapse! You have to get out of here!"`;
...
text(() => {
   ...
   Sora(T6L302)`"Takeshi, if you do any more...this time, I swear, I'll use this laser and burn your retinas off!"`;
   `I...`;
   `I covered both of my eyes with the palm of one hand...`;
