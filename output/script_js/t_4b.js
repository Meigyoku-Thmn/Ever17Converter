...
showTextbox();
text(() => {
   `It is really hard to wake up after you've gone back to sleep.`;
   `And when I couldn't get up, I'd get irritated.`;
   `The reason I couldn't sleep was beyond me.`;
   `'I probably can't sleep because I'm so caught up in not being able to sleep?'`;
   `A vicious cycle.`;
   `(Man, this is really bad...)`;
   `I was still groggy, but thankfully I wasn't so sleepy it was driving me crazy.`;
   `I opened and closed my hand.`;
   `My body seemed to be in pretty good shape...`;
   `I shook my head a little.`;
   `I slapped my cheeks.`;
   `Then I breathed in a deep rush of cold air, breathed it out, and gradually cleared my head.`;
   `Mustering up my strength, I jumped out of bed.`;
   `I put the voice alternator back in my ears.`;
   Takeshi`"'Bout time I started cooking breakfast for you all!"`;
...
text(() => {
   ...
   `The Kid, Coco, and Pipi were sitting and waiting.`;
...
showTextbox();
text(() => {
   You(T4B005)`"Look, if my belly actually sticks to my spine, I'm holding you personally responsible..."`;
...
showTextbox();
text(() => {
   You(T4B007)`"Remember me when I waste away to almost nothing and am blown by the wind across the Pacific!"`;
   Takeshi`"You're worried about being blown away by the WIND?"`;
   Takeshi`"I think it'd probably take a hurricane to carry you off."`;
...
text(() => {
   ...
   `Red, black, green - everything was splattered with a mysterious fluid.`;
   `The sandwich buns were colorful and sticky.`;
   `The lettuce that normally went into the chicken sandwiches had been diced.`;
...
text(() => {
   ...
   Takeshi`"Sort of?"`;
   Kid(T4B017)`"I don't exactly know if it'll taste GOOD, but..."`;
...
text(() => {
   ...
   `I had safely finished eating...but my stomach was still growling.`;
   `Would I be okay?`;
   `Doing the dishes was an unpleasant job, but with everyone's cooperation we got the ordeal over and done with.`;
...
text(() => {
   ...
   `Before I tackled the clean up, I had picked out some decent sandwiches and had Coco take them over.`;
   `Whether the still-recovering Tsugumi would actually eat them was another story...`;
...
showTextbox();
text(() => {
   Coco(T4B024)`"Yeah, she said she was really hungry. I think she ate three."`;
   Takeshi`"Hm. Well, I guess she's gotten well enough to eat then."`;
   Coco(T4B025)`"She's getting better pretty fast, don't you think?"`;
   Takeshi`"Yeah..."`;
...
text(() => {
   `That Tsugumi...`;
   `The night before, she'd said she wanted to die. `;

});
if (l_tsugumi_flag == 0) goto(lbl_000003b4);
showTextbox();
text(() => {
   `The fact that she was eating meant that at least her body was determined to live.`;
   `If she would just continue this tendency and get well, I thought there'd be no more problems...`;
...
showTextbox();
text(() => {
   `"All the things that keep us alive -- the things that drive us -- are filthy."`;
   `"There is no such thing as a life of purity."`;
   `The appetites necessary to sustain life are evil.`;
   `But then...`;
   `After all, she demolished three whole sandwiches without even flinching?`;
   `Well, then again, I was the one who told Coco to take the sandwiches down, because 'It'll be bad if she doesn't eat something...'`;
   `So I was contradicting my earlier stance too, but...`;
   `Something strange was going on!`;
   `What's the deal?`;
   `The word 'hypocrite' came to mind...`;
   `Who was the hypocrite now, Tsugumi!?`;
   `Tsugumi...what were you thinking!!`;
   `I couldn't help but feel resentment rising in my chest.`;
...
text(() => {
   ...
   `I didn't even want to be thinking about her anymore.`;
...
text(() => {
   Coco(T4B028)`"Oh, good—"`;
   Coco(T4B029)`"I thought maybe those sandwiches had given you a tummy ache!"`;
   Takeshi`"Why! Did you put something in there that would make me sick?"`;
...
text(() => {
   ...
   Takeshi`"......"`;
   Takeshi`"No, stop! Don't tell me, I don't want to know."`;
   `Just imagining the possibilities was making my stomach hurt...`;
...
showTextbox();
text(() => {
   `Tsugumi, was probably always just pretending to be tough.`;
   `Distancing people by saying awful things was one of her bad habits.`;
   `If she were eating properly...it must be proof that she wanted to live.`;
   `As long as she recovered completely, there would be no more problems.`;
...
showTextbox();
text(() => {
   Coco(T4B032)`"You just got a happy look on your face, Takepyon."`;
   Takeshi`"Oh, really?"`;
   Coco(T4B033)`"You were really worrying about Tsugumi, huh...?"`;
   `Feeling so transparent made me want to conceal the truth.`;
   Takeshi`"No, no, it's not that."`;
   Takeshi`"I was just thinking that those sandwiches were pretty good after all."`;
...
text(() => {
   Coco(T4B035)`"Oh, good!"`;
   Coco(T4B036)`"Actually, I made your sandwich all by my very own self!"`;
...
showTextbox();
text(() => {
   Coco(T4B040)`"And then some salt and pepper, and a dab of soy sauce, and lots of butter..."`;
   Coco(T4B041)`"Then when it was done, cinnamon and cardamon and turmeric and nutmeg and vanilla, all shaken together and poured!"`;
...
showTextbox();
text(() => {
   Coco(T4B043)`"Allspice, and curry, and hot sauce...and some tube of something Pipi found, we used lots of that..."`;
...
showTextbox();
text(() => {
   Coco(T4B046)`"Well, if I hadn't tasted it, I might have been scared off..."`;
...
text(() => {
   ...
   Takeshi`"......"`;
   Takeshi`"Nah, you don't have to do that.  I'll keep doing the cooking..."  `;
...
showTextbox();
text(() => {
   `Gathering my wits, I went to the bench where You and the Kid were sitting.`;
...
text(() => {
   ...
   You(T4B050)`"She went to go look again to see if she can find some clue to help us escape."`;
   You(T4B051)`"From what she said, the sensors on the third floor are working a little bit better..."`;
   Kid(T4B052)`"Hmmm..."`;
...
showTextbox();
text(() => {
   You(T4B053)`"Huh? Oh yeah, for a minute, before you came to the kiosk."`;
   Takeshi`"I see...did Sora say anything else? Did she seem different somehow?"`;
...
text(() => {
   ...
   You(T4B056)`"You're acting pretty suspicious. Why'd you say, 'well that's good...'?"`;
   You(T4B057)`"Not that I'm the type to hound you with questions or anything."`;
   Takeshi`"......"`;
   You`"......"`;
...
text(() => {
   ...
   Takeshi`"I don't care what happens, I'm not talking to you."`;
...
showTextbox();
text(() => {
   Kid(T4B062)`"Apparently Takeshi sneaked out of his room in the middle of the night."`;
...
showTextbox();
text(() => {
   Kid(T4B066)`"I went to sleep right after that, but it's been bothering me."`;

});
fgload({ id: 1, name: `YU02BDM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   You(T4B067)`"What do you have to say for yourself, Mr. Takeshi?"`;

});
fgload({ id: 2, name: `KA01ADM`, x: 512, useAnim: true });
showTextbox();
text(() => {
   Kid(T4B068)`"If you don't want to talk about it, don't worry..."`;
   Coco(T4B069)`"Huh? Wha-what? Are you talking about something fun?"`;
...
text(() => {
   ...
   `Bathed in their attention, there was no way for me to escape the mike.`;
   Takeshi`"...*sigh*"`;
...
text(() => {
   You(T4B070)`"Tsugumi?"`;
   Takeshi`"I was going to take a walk when Sora came up and told me that Tsugumi had woken up."`;
   Takeshi`"I didn't want her to start wandering around and hurt herself.  So I rushed right over to the infirmary..."`;
...
text(() => {
   ...
   You(T4B072)`"Actually, I guess I did heard pretty much the same thing from Sora. How Tsugumi woke up."`;
   Takeshi`"What, so you knew all along?"`;
   You(T4B073)`"Sorry, just thought I'd give you a hard time..."`;
   Takeshi`"Man..."`;
   Kid(T4B074)`"But you should have called us, too."`;
   Takeshi`"Hm? You're right, I wasn't thinking."`;
   Takeshi`"Well, I don't know about you, Kid, but You was dead to the world.  I didn't figure it'd be any good to try to wake you guys up."`;
...
text(() => {
   You(T4B076)`"Oho."`;
   Takeshi`"Well, I went for a walk and ran into her. I was awake, so we jogged to Zweite stock together." `;
   Kid(T4B077)`"It didn't sound like jogging. More like you were RUNNING."`;
   Kid(T4B078)`"The sound really echoed."`;
   Takeshi`"Well, you know Sora, she can run so fast, I had to hurry just to keep up."`;
...
text(() => {
   Kid`"......"`;
   Takeshi`"The one in the back. The color, the shape, the way it feels when you sit down..."`;
   Kid`"......"`;
...
text(() => {
   ...
   Takeshi`"Listen You, you're the one that started this, with your whole reporter act."`;
...
showTextbox();
text(() => {
   `No one seemed inclined to question me further, so that solved that. Everyone milled around the rest area.`;
   `I felt the energy drain out of me. I wasn't tense.  But I wasn't relaxed either.`;
   `Maybe I was just tired.`;
   `I sat quietly, thinking...`;
   `When I couldn't sleep, I had been pondering all sorts of things.`;
   `About Tsugumi...`;
   `And Sora...`;
...
showTextbox();
text(() => {
   `Sora made me think about all kinds of questions.`;
   `What was love?`;
   `What were people?`;
   `What was the meaning of life?`;
   `What was she herself...?`;
   `She was more worried about things than I was.`;
   `I didn't know the answers. The stress of so many unknowns was starting to get to me.`;
...
text(() => {
   ...
   `She always smiled and said she didn't mind, but...`;
...
showTextbox();
text(() => {
   You(T4B088)`"So many Greek myths have been handed down to us."`;
   `You was standing in the middle of the room, apparently giving a lecture.`;
...
showTextbox();
text(() => {
   `The Kid, Coco and Pipi were sitting on benches, listening obediently.`;
...
showTextbox();
text(() => {
   You(T4B089)`"You see that statue over there? It's rather a lovely piece..."`;
...
showTextbox();
text(() => {
   You(T4B090)`"The beautiful statue and the sculptor who loved her...I'll tell you their story."`;
...
showTextbox();
text(() => {
   `Then she turned back to the group and began gesturing and talking.`;

});
fgload({ id: 1, name: `YU15BDS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B092)`"Once upon a time, in a place called Cyprus, there was a young sculptor."`;
   You(T4B093)`"His name was Pygmalion. He's been called the King of Cyprus..."`;

});
fgload({ id: 1, name: `YU17BDS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B094)`"But in these myths they tend to call anyone a king or a god, so we won't go there for a bit...."`;

});
fgload({ id: 1, name: `YU02BDS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B095)`"Anyway, there was an excellent sculptor named Pygmalion. And then...um..."`;

});
fgload({ id: 1, name: `YU01BDS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B096)`"His statues were incredible. They were so vital and full of life, they looked as though they might come to life at any moment."`;
   You(T4B097)`"But Pygmalion couldn't seem to get interested in ladies."`;

});
fgload({ id: 1, name: `YU05BDS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B098)`"The people around him wondered, why a brilliant sculptor like him couldn't land a wife."`;

});
fgload({ id: 1, name: `YU11BDS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B099)`"But Pygmalion seemed only to care about making his statues."`;
   You(T4B100)`"Then one day, he finished the nude figure of a woman."`;

});
fgload({ id: 1, name: `YU01BDS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B101)`"It was a wonderful piece, absolutely charming, and even he himself thought it might be his ultimate masterpiece."`;
   You(T4B102)`"But..."`;
...
showTextbox();
text(() => {
   You(T4B103)`"As he looked on her beautiful, almost living, face..."`;

});
fgload({ id: 1, name: `YU03BDS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B104)`"He realized that she was naked, and became embarrassed..."`;
...
text(() => {
   ...
   You(T4B106)`"And when it got dark, he was so besotted with her that..."`;

});
fgload({ id: 1, name: `YU15BDS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B107)`"He brought her food to eat, talked to her and even slept next to her..."`;
   You(T4B108)`"It was the first time he had ever experienced true love."`;
   You(T4B109)`"Love for the statue he himself had created..."`;
   You(T4B110)`"He poured all the love that he had into her. He believed that one day, she would speak to him..."`;
...
showTextbox();
text(() => {
   You(T4B111)`"But in the meantime, he neglected his work, he forgot to eat and sleep...and Pygmalion began to waste away."`;
   You(T4B112)`"People began to worry that he would die...so they prayed to the gods."`;
...
showTextbox();
text(() => {
   You(T4B114)`"He was so sad to see her unable to speak, or eat, or sleep..."`;

});
fgload({ id: 1, name: `YU13BDM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B115)`"He thought that when he himself became old and went to heaven..."`;
   You(T4B116)`"She would have to continue standing there, just waiting to decay..."`;
...
showTextbox();
text(() => {
   You(T4B118)`"If he couldn't be bound to her, it would be better to throw himself off a cliff."`;

});
fgload({ id: 1, name: `YU13BDL`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B119)`"If only she was a real woman, with blood running through her veins..."`;
...
showTextbox();
text(() => {
   You(T4B121)`"Until his prayers reached Aphrodite, the goddess of love."`;
   You(T4B122)`"Aphrodite came down to him and told him to kiss his beloved statue."`;
...
showTextbox();
text(() => {
   You(T4B124)`"Her skin flushed pink, her eyes opened and she turned into a living woman."`;

});
fgload({ id: 1, name: `YU02BDM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B125)`"A woman as beautiful as the statue had been..."`;
...
showTextbox();
text(() => {
   You(T4B127)`"He kept making even more beautiful sculptures for temples around the world, and they lived..."`;
...
showTextbox();
text(() => {
   `Finally finished with her long story, You pinched her skirt and curtsied.`;
...
text(() => {
   ...
   `She raised a finger in front of her face, looking demure.`;
...
text(() => {
   ...
   `But I kept quiet and watched the faces of everyone.`;
   `With her finger still extended in front of her face, You spoke confidently.  `;
...
text(() => {
   You(T4B134)`"Why not?"`;
   Takeshi`"Pygmalion just had an obsession with his sculpture..."`;
   Takeshi`"He didn't work, he stayed inside talking to her..."`;
   Takeshi`"Thinking, 'Oh, if only my statue was a real, beautiful woman'..."`;
   Takeshi`"What a dark, depressing story...Pygmalion..."`;
   Takeshi`"I don't see anything happy about that."`;
   Takeshi`"He just happened to have his selfish request granted by a goddess. The end."`;
...
text(() => {
   ...
   You(T4B138)`"Shows that if you hope and ask and persevere, your wish will come true."`;

});
fgload({ id: 1, name: `YU15BDM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B139)`"His longing was answered because he put his heart into his sculpture, and then loved her, believing that she would speak to him one day..."`;
...
showTextbox();
text(() => {
   You(T4B142)`"Okay, this is a little different, but this guy named Rosenthal wrote about something called the 'Pygmalion effect'."`;
   `She was acting like a professor on a soapbox.`;
   `It seemed like she was overdoing the whole thing.`;
   `But her ridiculous expressions were so amusing, I got drawn in.`;
   You(T4B143)`"It's not quite the same as the placebo effect."`;
   You(T4B144)`"But both of them involve believing in something."`;
   You(T4B145)`"So they both have to do with our chances of survival."`;
   You(T4B146)`"Just because the sushi in the display case is made of plastic, doesn't mean the sushi inside is cheap!!"`;
   Kid(T4B147)`"Whoa?!"`;
   Coco(T4B148)`"Wow..."`;
...
showTextbox();
text(() => {
   `Her talk seemed to have been derailed like a nasty train wreck. I had no idea what she meant.`;
...
showTextbox();
text(() => {
   `We all headed up the emergency stairs to the second floor.`;
...
text(() => {
   ...
   Takeshi`"Well, worrying about her won't make her better any faster."`;
   Kid(T4B153)`"Sora would let us know if anything had happened to her, right?"`;

});
fgload({ id: 1, name: `YU15BDM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   You(T4B154)`"Yeah. And LeMMIH's always guarding the data in the infirmary's medical computer."`;
   You(T4B155)`"So since LeMMIH hasn't come to us with any news, it means that Tsugumi is probably sleeping peacefully."`;
...
text(() => {
   ...
   Coco(T4B161)`"Whoah! Obstinate stubbornness! Geezers going swimming in the winter!"`;
...
showTextbox();
text(() => {
   You(T4B163)`"Takeshi, didn't you already see Tsugumi when she woke up last night?"`;
   Takeshi`"Well, yeah."`;
   `Being asked forced me to remember the night before.`;
   `Tsugumi saying "I want to die..."`;
   `But then she'd eaten three sandwiches...`;
   `If she would just recover...`;
   Takeshi`"Wait up, You! You knew that I'd seen Tsugumi?"`;
...
text(() => {
   You(T4B164)`"Yup."`;
   You(T4B165)`"I heard from Sora this morning. About Tsugumi's condition, and your panicked running."`;
   You(T4B166)`"That midnight emergency staircase dash the Kid was talking about...it was Tsugumi, right?"`;
   Takeshi`"Alright, you listen here!"`;
   Takeshi`"A minute ago you were pretending to be a reporter, trying to get me to tell you."`;
   Takeshi`"Why do you ask about something you already know?"`;

});
fgload({ id: 1, name: `YU12BDM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B167)`"It's your fault for trying to be so mysterious! Hee hee..."`;
   Takeshi`"Y-y-you little...."`;
   `I hated to admit it, but she had taken me for a ride.`;
   `And I had no comeback.`;
   Takeshi`"So, uh, how do you think Tsugumi's doing? Aren't you worried about her?"`;
...
text(() => {
   ...
   Takeshi`"Shut up. If you know something, say it already."`;

});
fgload({ id: 1, name: `YU01BDM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B169)`"Well, LeMMIH is always guarding the infirmary's medical computer data..."`;
   You(T4B170)`"Since LeMMIH hasn't come to us with any news, it must mean that Tsugumi's sleeping peacefully, right?"`;
...
text(() => {
   ...
   Takeshi`"Hey, Tsugumi!"`;
   Takeshi`"You alive?"`;
   Takeshi`"I had to force them, but I dragged everyone along to see you!"`;
...
text(() => {
   ...
   Takeshi`"You know, joke around, cheer her up a little bit..."`;
...
text(() => {
   ...
   Takeshi`"What the matter, Kid?  You discover a new species of something?"`;
   Kid`"......"`;
...
text(() => {
   ...
   `But the IV tube and the heart monitor had been torn up and scattered around.`;
   Takeshi`"What the...why didn't LeMMIH pick up on this?"`;
   Takeshi`"LeMMIH was monitoring Tsugumi's data, right You?  What happened?"`;
...
text(() => {
   Takeshi`"!?"`;
   `The cord was torn off the medical computer, and the monitor had been smashed to pieces. `;
   `There had been an electrical short, and there was a burning stench around the area.`;
...
text(() => {
   ...
   `Under the computer console, there were some bandages and a long, skinny case of some sort. `;
   `A white, hard case...`;
...
text(() => {
   ...
   Takeshi`"Tsugumi."`;
   Takeshi`"She took off her own brace and smashed up the computer."`;
   Takeshi`"She got out of bed, smashed the computer and then left the room..."`;
...
text(() => {
   Coco(T4B188)`"Really!?"`;
   Coco(T4B189)`"But when I brought her the sandwiches, she still looked like she was in pain, in bed..."`;
...
text(() => {
   ...
   You(T4B194)`"It was a serious injury! It should take over two months to heal!"`;

});
fgload({ id: 1, name: `YU14BDM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B195)`"In fact, in her condition, she shouldn't even be able to get out of bed..."`;

});
fgload({ id: 1, name: `YU13BDM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   You(T4B196)`"And it's strange that LeMMIH didn't respond, even if the computer is broken..."`;
...
showTextbox();
text(() => {
   You(T4B198)`"The sensor on the ceiling should have picked it up..."`;
...
text(() => {
   ...
   `All of the color had drained from You's face, as she absorbed the enormity of what had happened.`;
   `She was holding her chest, looking up at the ceiling, in a cold sweat.`;
   You(T4B207)`"Uuugh..."`;
...
showTextbox();
text(() => {
   `But the question was what to do about the...situation.`;
   `What to do?`;
...
showTextbox();
text(() => {
   `We rushed over to the LeMMIH terminal in the corner of the room.`;
   `Standing in front of the console, You began operating the panel.`;
   You(T4B211)`"If LeMMIH hasn't realized it yet, that may mean that Sora doesn't know yet either..."`;
   Takeshi`"But call her anyway. It's faster to ask her than to go on a blind search."`;
   You(T4B212)`"You're right."`;
   `Before long, there was a change in the terminal.`;
...
text(() => {
   ...
   Sora(T4B213)`"Yes?"`;
   You(T4B214)`"Sora, something terrible has happened.  Tsugumi is missing..."`;
   Sora(T4B215)`"What!? Are you sure??"`;
   Sora(T4B216)`"I thought something had happened to the monitor in the room, but..."`;
   You(T4B217)`"What!? Why didn't you tell us!?"`;
   Sora(T4B218)`"I am terribly sorry. There has been terrible jamming, and...it had delayed me."`;
...
showTextbox();
text(() => {
   Sora(T4B226)`"Am I standing in the right place? Can you see me all right?"`;
   `Sora looked worried.`;
...
showTextbox();
text(() => {
   Sora(T4B227)`"It is getting better, but there is still something wrong."`;
   Sora(T4B228)`"I can tell approximately where you are standing, but not which way you are facing..."`;
   `She was talking to a spot just next to me.`;
   You(T4B229)`"Sora, Tsugumi's not in the infirmary. Can you search the other rooms?"`;

});
fgload({ id: 1, name: `SO03ADM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Sora(T4B230)`"Let me try...I'll do a bio scan on the entire building."`;
...
showTextbox();
text(() => {
   Kid(T4B233)`"Sora wasn't able to see us, and sometimes we couldn't see her, so..."`;
   Kid(T4B234)`"Does that mean the ceiling sensors from the bed, over to the elevator are all temporarily broken?"`;
...
text(() => {
   ...
   Takeshi`"Yeah. But she Tsugumi was kind enough to leave candles burning for us."`;
   `When we had found the emergency flares in the elevator, I was completely shocked.`;
...
showTextbox();
text(() => {
   Sora(T4B237)`"Sorry to keep you waiting. I have the results of the bio scan."`;
   ...
   Sora(T4B238)`"An EI has gone down to Dritte stock.  Tsugumi is slowly moving past the isolated sector."`;
   Takeshi`"EI..?  Oh, 'EI' - the neutral buoyancy elevator!"`;
...
text(() => {
   ...
   You(T4B241)`"You can only enter and exit that sector using EI, so if you just wait a little..."`;

});
if (l_tsugumi_flag == 0) goto(lbl_0000135f);
showTextbox();
text(() => {
   Takeshi`"We can't just let her be! What if her injury gets worse!?"`;
   Takeshi`"And besides, I want to hear a good explanation for why she ran off like this!"`;
...
showTextbox();
text(() => {
   Takeshi`"We can't let her be out there. What if her injury gets worse?"`;
...
showTextbox();
text(() => {
   `I pushed the down button and called the elevator.`;
...
text(() => {
   ...
   `(If she doesn't use EI, she can't get up here...)`;
   `(Until I get there, she definitely can't leave the sector...)`;
   `(Alright...)`;
...
showTextbox();
text(() => {
   `Tsugumi had pushed herself, despite her injury, and gone off all alone...`;
...
text(() => {
   ...
   `She'd gone so far that she probably couldn't get back even if she wanted to.`;
   `Maybe she was regretting it...?`;
   `What I really wanted to do was get in a couple good wisecracks, to pay her back for all the hard times she'd given me...`;
...
text(() => {
   `The doors opened.`;
   `The stale air of the isolated sector on the third floor flowed into my lungs.`;
   `Next to the elevator I had ridden in, another elevator was still stopped.`;
   `An elevator with a hole blasted in it...`;
   `You couldn't even smell the stench of acetone anymore.`;
   `I walked toward the end of the hallway, marshalling my wits.`;
...
text(() => {
   `(What's that?...)`;
   `I realized that there was a room on the left side of the corridor that I hadn't seen during the power outage.`;
   `Thinking to explore a little, I set my foot inside.`;
...
text(() => {
   ...
   `Apparently that was the name of this attraction.`;
   `I couldn't tell from a quick glance exactly what the attraction was.`;
...
showTextbox();
text(() => {
   `The facility was giving off a steady but low hum, and seemed to be working fine.`;
   `For better or for worse, in LeMU we didn't have to worry about the electricity.`;
   `I looked around, but there was no trace of Tsugumi.`;
...
showTextbox();
text(() => {
   `Past the Generator Room, the corridor was completely blocked off by a partition.`;
...
text(() => {
   ...
   `There was no sign on the door, but I supposed it would be called something like a 'pressure regulation room,' or something.`;
   `I assumed that the pipes must be connected to the boilers and turbines in the Generator Room.`;
   `Come to think of it, Tsugumi had done the repairs in there...`;

});
fgload({ id: 1, name: `TU13ADS`, x: 320, useAnim: true });
showTextbox();
text(() => {
   `I remembered her closing a valve right with her tools spread around her...`;
...
text(() => {
   ...
   `She didn't have any tools. She wasn't closing off a valve.`;
   `Instead, craning her neck, she seemed to be looking over at the other side of the pipes.`;
...
showTextbox();
text(() => {
   `It wouldn't do to lose my temper right off the bat.`;
   `I suppressed the urge to shout. She was injured, after all...`;
...
text(() => {
   ...
   `She stepped back as if she were keeping watch over me.`;
...
text(() => {
   ...
   `With her back to me, she looked further back into the room.`;
...
text(() => {
   ...
   `But I didn't let up and fired a question back at her.`;
   Takeshi`"What are you doing here? Are you looking for something?"`;
...
text(() => {
   Tsugumi`"........."`;
   Takeshi`"You won't answer stupid questions, is that it?"`;
...
text(() => {
   ...
   Takeshi`"Because I heard that you came here on your own."`;
...
text(() => {
   ...
   Takeshi`"Because my hurt friend suddenly went missing that's why!"`;
...
text(() => {
   ...
   Takeshi`"It's not like everyone's happy about the way you keep doing things."`;
   Takeshi`"Because my injured friend suddenly went missing that's why!"`;
   Takeshi`"Of course I came looking for you."`;
...
text(() => {
   ...
   Tsugumi(T4B261)`"I didn't ask you to come, and there's no reason for you to be here."`;
...
text(() => {
   ...
   `I thought about pretending to raise my fist, but didn't do it.`;
   Tsugumi`"........."`;
...
showTextbox();
text(() => {
   Takeshi`"Believe me, I don't want to be friends with someone like you."`;
   Takeshi`"But we don't have a choice."`;
   Takeshi`"We all want to get out of here!"`;
   Takeshi`"Don't you want to get our of here as soon as possible?"`;
   Takeshi`"As long as we're in the same boat, we're friends."`;
...
showTextbox();
text(() => {
   Tsugumi(T4B267)`"That kind of tired, hypocritical crap makes me sick."`;
   Takeshi`"......"`;
...
showTextbox();
text(() => {
   Tsugumi(T4B272)`"I don't care if you are from Germany, America or Japan."`;
...
showTextbox();
text(() => {
   `Giving me a glance, she moved toward the door dragging her foot.`;
...
text(() => {
   Tsugumi`"........."`;
   Takeshi`"The leg you hurt the other day...was your right leg, wasn't it?"`;
...
text(() => {
   ...
   `The sound of her footfalls grew faint. As did her shadow, disappearing down the hallway.`;
...
showTextbox();
text(() => {
   `Sora readied a compress for me back in the infirmary.`;
...
showTextbox();
text(() => {
   Sora(T4B282)`"It seems that Tsugumi will come back to this floor in a little while."`;
   Sora(T4B283)`"But..."`;
...
showTextbox();
text(() => {
   Sora(T4B284)`"But if we do find her, try not to get mad or yell at her."`;
   Takeshi`"Huh?"`;
...
showTextbox();
text(() => {
   Sora(T4B285)`"For a little while, I think it is best if we let her do as she wants."`;
   Takeshi`"But...why?"`;
   `I pressed the compress to my cheek.`;
   `It started to hurt right about the time I had forgotten about it...`;
   Sora(T4B286)`"Don't you think she might be quite nervous right now?"`;
   Sora(T4B287)`"She's thinking about things..."`;
   Sora(T4B288)`"She's pondering all sorts of things in her heart..."`;
   Sora(T4B289)`"Everyone's words will fall on deaf ears..."`;
   Sora(T4B290)`"She's not able yet to just listen. Of course..."`;

});
fgload({ id: 1, name: `SO09ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Sora(T4B291)`"You're worried about her injuries, but for a little while, let's leave her alone."`;
   Sora(T4B292)`"If she is in any serious danger, I will let you know right away."`;
   Sora(T4B293)`"So for just a little while....please, Takeshi."`;
...
showTextbox();
text(() => {
   Sora(T4B294)`"I don't think it is an accident that she came to be here."`;
   `Sora continued speaking right next to me.`;
   Takeshi`"Not an accident?"`;
   Sora(T4B295)`"I do not know the details."`;
   Sora(T4B296)`"This is the first time for me to encounter a case like her's. I don't have any data for this..."`;
   Sora(T4B297)`"But it seems to me that she has her reasons."`;
   Sora(T4B298)`"Reasons that are difficult to explain..."`;
   Sora(T4B299)`"Something that is hard for others to understand..."`;
   Sora(T4B300)`"Something that compelled her to act even if it made her injuries worse..."`;
...
text(() => {
   ...
   Takeshi`"You was?"`;
   Sora(T4B303)`"Yes..."`;
   Sora(T4B304)`"That we shouldn't probe. That until she wants to tell us, we shouldn't press for information..."`;
   Takeshi`"I see..."`;
   `Maybe I had gotten a little too close to her boundaries.`;
   `Boundaries she didn't want invaded.`;
   `Whatever feelings and reasons she didn't want us to know about.`;
   `Was that why I was warned, harassed and pummeled...?`;
   `If I thought about it that way, it made more sense.`;
   Takeshi`"Well...maybe so. Maybe I came down too hard..."`;
...
text(() => {
   ...
   `I had heard from Sora that You and the Kid were holed up in the Central Control Room because she wanted to figure something out.`;
   `She said that Coco and Pipi had gone off somewhere on a walk.`;
...
text(() => {
   ...
   `Study time...`;
   `Sora turned over the observation of LeMU to the automatic LeMMIH control system for a few hours.`;
   `That would ensure Tsugumi and You some privacy...`;
   `And give Sora a break, too.`;
   `So, there she sat, in a chair in the Conference Room, looking at the white board.`;
   `I stood at the whiteboard, dry marker in hand, playing professor.`;
   `A private lesson, one-on-one.`;
   `The reason that we started that was....`;
   `'Coco and the Kid were giving rave reviews of You's speech...'`;
   `'What was it like? I asked her, but she wouldn't tell me.'`;
   `'Takeshi, do you know?'`;
   `'Well, yeah, but...it's not like I have the whole thing memorized...'`;
   `'I know, I'll give you a lecture just as good...no, better than You's!'`;
   `—and that's how it started.`;
   `The title of my lecture was 'The Psychology of Love'...`;
...
showTextbox();
text(() => {
   Sora(T4B309)`"Development of LeMMIH started on September 16, 1992."`;
   Sora(T4B310)`"The prototype was finished in October of 2000."`;
   Sora(T4B311)`"Actual operation of the 'Sora' RSD System began in April, 11 years later."`;
   Sora(T4B312)`"Which means that I was born on April 2, 2011."`;
   Takeshi`"2011?"`;
   Takeshi`"Oh my, oh my, what a very young student you are."`;
...
text(() => {
   ...
   Sora(T4B315)`"This year and last, even three and four years ago, I've been 24."`;
   ...
   `I have to admit it would have been strange to hear her say "I'm 41," looking the way she did.`;
   `They must have predicted that such a time would come, and fixed her eternally at 24.`;
   Takeshi`"Okay, okay..."`;
   Takeshi`"I see. Then I shall accept that you are 24, Ms. Akanegasaki."`;
   Takeshi`"In that case, I think that you should learn the appropriate behavior for a someone your age."`;
...
showTextbox();
text(() => {
   Sora(T4B323)`"Are you saying that my face should be more shiny?"`;
...
text(() => {
   ...
   Takeshi`"You become friends with someone at 24, then date for a few years, and marry around 26 or 27."`;
   ...
   Takeshi`"I'll take all questions at the end. All right?"`;
...
text(() => {
   ...
   Takeshi`"It's the gleam in your eyes as you frantically search for the object of your affection - all, of course, as a preamble to getting married."`;
   Takeshi`"That is what I am speaking of."`;
   Takeshi`"Until 23, you choose a man who will be an appropriate boyfriend."`;
   Takeshi`"After 24, you choose a man who will be an appropriate husband."`;
   Takeshi`"You might think that an appropriate husband would be one who promises a bright future..."`;
   Takeshi`"But to borrow the words of the ancients, it all comes down to the three 'heights.'"`;
   Takeshi`"High education, high salary, high in stature."`;
   Takeshi`"That would be the ideal individual..."`;
   Takeshi`"You think there's really guys like that out there?"`;
   Takeshi`"If you're feeling greedy, you might also look for someone who's kind and handsome, and cares more about his family than his job."`;
   Takeshi`"Ah...in other words..."`;
   Takeshi`"What!!! You could search the whole world and never find a guy like that!!!"`;
   Sora`"......"`;
...
text(() => {
   ...
   Takeshi`"So because of all that, the 24-year-old women can be a very severe creatures."`;
   Takeshi`"Clever and calculating."`;
   Takeshi`"And in order to bring down her prey, she must have the social skills of a little devil."`;
...
text(() => {
   `She cocked her head.`;
   `I wanted to sigh, but I pulled myself together to make a declaration.`;
   Takeshi`"Well, perhaps it is better if you put this theory into practice."`;
...
text(() => {
   ...
   Takeshi`"Professor."`;
   Sora(T4B329)`"Yes, Professor Takeshi. I will try my very best."`;
   Takeshi`"No, no, no, no..."`;
...
showTextbox();
text(() => {
   Sora(T4B331)`"The hell!? 'ssif I can do som'n like that right away!? I'll kill you, you bastard! Bwa, bwa, bwaawkk."`;
...
showTextbox();
text(() => {
   Sora(T4B332)`"Professor, this is bit too difficult for me to start with."`;
   Takeshi`"Really."`;
   Sora(T4B333)`"Yes."`;
   Takeshi`"Alright then, how about you start by not speaking so formally?"`;

});
fgload({ id: 1, name: `SO01ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Sora(T4B334)`"Yes, something like that will be better. Something easier."`;
   Takeshi`"Using the same example..."`;
   Takeshi`"Yes, I will try my very best."`;
   Takeshi`"In casual conversation, this would be 'Sure, I'll give it a try.'"`;
...
showTextbox();
text(() => {
   Takeshi`"Alright! The time has come to see the fruits of your labor!"`;
...
showTextbox();
text(() => {
   `Coco and Pipi were jumping up and down in the rest area.`;
...
showTextbox();
text(() => {
   Sora(T4B341)`"Annywayz, Coco, don'tcha know any cute guys you could hook me up with?"`;
   Sora(T4B342)`"The guys at this party last week were, were like, such losers..."`;
   Coco(T4B343)`".....So-Sora???"`;
...
showTextbox();
text(() => {
   Sora(T4B344)`"I was like, I'm sicka eldest sons, man! I want something fresh!"`;
...
text(() => {
   ...
   Sora(T4B352)`"I haven't heard from you for, like, forever, girl. What, are you like busy like a bee or something?"`;
...
text(() => {
   ...
   Sora(T4B356)`"Really, how NOT cool. Hurry up and put an end to your work then..."`;

});
fgload({ id: 1, name: `SO16ADM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Sora(T4B357)`"You wanna go clubbing or something? Don't you just wanna stay out ALL night?"`;
...
text(() => {
   `So.......`;
   `Due to the general outcry, Sora went back to talking like her original self...`;
