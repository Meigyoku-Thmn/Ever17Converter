...
text(() => {
   `${voice(C5A330)}${noWait}`;
   Append(C5A331)`"My baby!"${wait}
${noWait}`;
   Append(C5A332)`"You are my sister."${wait}
${noWait}`;
...
text(() => {
   ...
   You(C5A340)`"I know I'll never be forgiven, and will 
...
text(() => {
   ...
   Takeshi`"........."`;
   You(C5A344)`"I'll never forget the moment that new life 
was created."`;
   You(C5A345)`"It was...such an unbelievably happy 
moment...."`;
   You(C5A346)`"The first time she said, 'Mama... Mama....'"`;
   You(C5A347)`"I...I can't explain it...."`;
   You(C5A348)`"It was more than a precious feeling, or 
love, or that good fortune had come my 
way...I felt as if I were wrapped in light...."`;
   You(C5A349)`"I don't care if I burn in hell."`;
   You(C5A350)`"I don't care if I burn in the fires of hell 
for thousands, millions of years...."`;
   You(C5A351)`"But...I knew I wanted to protect...my 
daughter....no matter what."`;
   ...
   You(C5A358)`"She was welcomed to this world...just like 
any other soul born who comes here."`;
   You(C5A359)`"But at the same time...the moment I gave 
birth to her...I died."`;
   You(C5A360)`"It was as if I no longer existed...."`;
   You(C5A361)`"You see...."`;
   You(C5A362)`"I gave all my life, my existence, to my 
child...."`;
...
text(() => {
   ...
   You(C5A365)`"You can't possibly have forgotten what year 
it is?"`;
...
text(() => {
   ...
   `You laughed.`;
   You(C5A368)`"Well, I can understand why you might make 
that mistake...."`;
   You(C5A369)`"Do you see?"`;
   You(C5A370)`"The date on that mail was written in the 
German style."`;
   You(C5A371)`"Not the Japanese order of year/month/day, but 
month/day/year."`;
...
was probably too much for Sara to believe.`;
   Sara(C5A379)`"Well, are you going to say anything? Could 
you hurry up...?"`;
...
showTextbox();
text(() => {
   Sara(C5A381)`"W-wait just a minute! What are you talking 
about?"`;
...
cheeks.`;
   ...
   Tsugumi(C5A401)`"I'm terrible...And I don't expect you to be 
able to forgive me...."`;
...
showTextbox();
text(() => {
   Takeshi(C5A422)`"Look I don't have any clue what you're 
talking about...?"`;
   Kid`"Don't play dumb!"`;
...
world!"`;
   Takeshi(C5A425)`"Other world? What the heck's that supposed 
to mean?"`;
...
text(() => {
   ...
   Takeshi(C5A430)`"So, how could you possibly know what 
happened in 2017?"`;
...
text(() => {
   ...
   Takeshi(C5A433)`"For instance, if I was repeating the 
incident in 2017,"`;
   Takeshi(C5A434)`"How could I possibly trick you who were born 
in 2018?"`;
   Takeshi(C5A435)`"Practically speaking, it is impossible to 
...
showTextbox();
text(() => {
   Takeshi(C5A437)`"Besides, how could you tell it was the same 
incident?"`;
   Takeshi(C5A438)`"How could you tell that I'm using the same 
phrase?"`;
   Takeshi(C5A439)`"How could you know the history before you 
were even born!?"`;
...
showTextbox();
text(() => {
   Takeshi(C5A442)`"Oh, I see, when it comes to your story, you 
clam up, huh...?"`;
