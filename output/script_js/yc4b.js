...
text(() => {
   ...
   You(C4A428)`"That doesn't mean that Rip Van Winkle 
actually existed, does it?"`;
   You(C4A429)`"Besides, even if the tale of Rip Van Winkle 
...
text(() => {
   ...
   You(C4A431)`"I'm saying even if someone could actually 
...
showTextbox();
text(() => {
   You(C4A434)`"I'm sorry...but I've got far more serious, 
urgent problems."`;
   You(C4A435)`"I've got tons of things to think about."`;
   You(C4A436)`"You know what I'm talking about, Kid?"`;
   Kid`"........."`;
   You(C4A437)`"I don't know what the reason is, but you can 
predict the future."`;
   You(C4A438)`"So what...?"`;
   You(C4A439)`"It's not like it's a bad ability to have. As 
...
text(() => {
   ...
   You(C4A442)`"And as far as your amnesia, I'm sure you'll 
regain your memories in time!"`;
   You(C4A443)`"You're already beginning to remember things, 
right?"`;
   You(C4A444)`"I mean, you've actually remembered most 
...
showTextbox();
text(() => {
   You(C4A447)`"You're Mayo's brother, right? You did 
...
text(() => {
   ...
   `You raised her voice and pointed her finger 
at me.`;
   You(C4A451)`"Oh, that reminds me - I keep forgetting to 
...
showTextbox();
text(() => {
   `You shook her head, looked up at the ceiling, 
...
showTextbox();
text(() => {
   `She clenched her fist, went to shake it into 
the air, then rethought it and pulled it back 
down.`;
   `You then proceeded to stomp around in a puddle 
of water.`;
   `She crouched down and hopped up swiftly.`;
   `She took a deep breath.`;
   `I thought she was going to blow it out, but 
...
showTextbox();
text(() => {
   `Her voice was so loud it shook LeMU like an 
earthquake.`;
   `"I was a bit frightened that it would tear the 
partition walls."`;
   You(C4A458)`"That's the first thing you should ask her 
...
text(() => {
   ...
   You(C4A460)`"It's YOUR own name. Aren't you curious to 
know?"`;
...
showTextbox();
text(() => {
   `Splashing water, You walked down the long 
straight corridor ...`;
...
showTextbox();
text(() => {
   You(C4A467)`"Don't you want to regain your full memory? 
...
showTextbox();
text(() => {
   You(C4A468)`"Well then, instead of talking about stupid, 
outrageous things like seeing the future or 
time travel..."`;
   You(C4A469)`"Don't you think it'd just be faster to ask 
Mayo?"`;
   `I thought back briefly to the sight of myself 
in that mirror.`;
   `I had been so confused at that time because 
'my face' didn't look like 'my face.' `;
   `If the same thing happened when Sara told me 
my name...`;
   `I was afraid that I might feel like 'my name' 
...
text(() => {
   ...
   `I couldn't tell whether she was listening to 
...
showTextbox();
text(() => {
   You(C4A472)`"I've been thinking about what you were just 
saying..."`;
   Kid`"?"`;
...
text(() => {
   ...
   You(C4A474)`"You know, I've had a complex about my name 
...
text(() => {
   ...
   You(C4A478)`"People introduce themselves to one another 
when they meet, right?"`;
   You(C4A479)`"Every time a new year at school would start 
I would just cringe..."`;
   Kid`"Oh."`;
...
showTextbox();
text(() => {
   You(C4A481)`"Something to do with it? ... that IS WHY I 
don't like it."`;
...
text(() => {
   Kid`"What ...?"`;
   You(C4A489)`"It means 'gentle', 'beautiful', 'pure', 
...
showTextbox();
text(() => {
   `All the sudden, it was as if I felt a heavy 
thud in the bottom of my heart.`;
   ...
   `Wait...but...I've never heard it from You 
directly...`;
   `What is going on!?`;
...
showTextbox();
text(() => {
   You(C4A491)`"Look, I don't think I'd say my own name 
incorrectly."`;
   You(C4A492)`"Well, 'haru' or 'aki', either one is fine 
with me."`;
   You(C4A493)`"But on the birth certificate, it says 
'aki'..."`;
   Kid`"No!"`;
...
text(() => {
   ...
   You(C4A498)`"My real name is...oh, was it Ling Ling? No 
wait, maybe it was Lang Lang?"`;
   Kid`"........."`;
   You(C4A499)`"Kid, listen up."`;
   You(C4A500)`"My name is Yubiseiakikana."`;
   You(C4A501)`"It's been that way since I was born, and it 
will be that way as long as I live."`;
   You(C4A502)`"You got it?"`;
   You(C4A503)`"It's neither, haru, or natsu, or fuyu, but 
aki."`;
   ...
   You(C4A512)`"So, my name is 'akikana' - 'aki', as in 
autumn - you got that?"`;
   `I was already starting to lose my sense of 
reality.`;
   `A bottomless fear crept up from the bit of my 
...
showTextbox();
text(() => {
   `Splashing water in all directions, Sara came 
toward us.`;
...
text(() => {
   ...
   `Sara stood in front of us, tilting her head 
quizzically.`;
   ...
   `I knew her hand was touching my shoulder, but 
I couldn't feel it.`;
   `I was dizzy and about to faint.`;
   `I thought to myself 'This'll probably be a lot 
easier if I just faint.'`;
   `But both my feet stood soundly on the floor 
and I braced myself.`;
   `I looked at Sara.`;
...
text(() => {
   ...
   `I saw Sara's lips were moving, but I couldn't 
...
text(() => {
   ...
   `All I could hear was just the sound of my 
blood flowing through my ears...`;
   `In that moment, my sight crashed into pieces.`;
   `The scenery before me was stripped of all 
color...`;
   `A voice...a voice ...`;
   `A voice...`;
...
text(() => {
   ...
   You(C4A524)`"Now that you mention it, he does look kind 
...
text(() => {
   ...
   `(Is this me who's looking at my palm? Or is it 
somebody that isn't me?)`;
   `(Is Hokuto really me? Or is it me who's not 
Hokuto?)`;
   Kid`"Hokuto...Hokuto...Hokuto..."`;
   Kid`"Is it really...?"`;
...
text(() => {
   ...
   `I tried to keep a straight face...but the 
...
like she meant it.`;
   ...
   `Tsugumi said it in a whisper without looking 
at my face.`;
...
text(() => {
   ...
   `Since we were in the area with the Generator 
Room, we had to take one of the egg-like 
elevators to get back.`;
   `I felt excited, maybe from the feeling of 
accomplishment of rescuing Chami.`;
   `But...my feet were heavy. My body just 
couldn't keep up.`;
   `I was exhausted.`;
   `Five hours earlier, I had been running with 
You on my back, who had started suffering 
from something all of a sudden.`;
   `And with this to rescue Chami, I swam 
...
text(() => {
   ...
   `Tsugumi must have noticed my slow steps, and 
...
anything, did it?"`;
   ...
   `She quickly flipped up her skirt with her 
hands.`;
   Takeshi`"C-cut it out!"`;
   `In shock, I slapped Tsugumi's hand and 
stopped her.`;
...
text(() => {
   ...
   `After resting for about an hour in the 
infirmary, You regained a surprising amount 
of her strength. `;
   `'But why did you start suffering like that 
all the sudden?'`;
   `I asked You, but she changed the subject and 
didn't tell me anything.`;
   `I also asked Sora, but her answer was the same.`;
   `Sora must have known something, since she had 
...
showTextbox();
text(() => {
   `It was still such that only one person at a 
time could ride the egg.`;
   `Tsugumi went up first.`;
   `I rode up shortly after. `;
   `The egg zipped upward, quickly arriving at 
Zweite stock.`;
...
text(() => {
   ...
   `It tickled so much that I couldn't help but 
wriggle my body.`;
   Tsugumi(C4A539)`"Ha, ha, ha."`;
   `Chami looked hesitant when he got to the end, 
which was the tip of my hand.`;
   `I held Chami gently in my palm and looked at 
him closely.`;
   Takeshi`"Chami, huh...?"`;
...
text(() => {
   ...
   `As I asked Tsugumi, I passed Chami back into 
her hand.`;
   `Tsugumi picked up Chami, and told me.`;
   Tsugumi(C4A545)`"'Satellite of the earth' and 'where we are 
at.'"`;
   Takeshi`"Huh?"`;
   ...
   Tsugumi(C4A549)`"Yup."`;
   Tsugumi(C4A550)`"In Japanese you write it 'moon' and then 
...
text(() => {
   `After a while...`;
   `Tsugumi and I had begged Coco 'not to call us 
daddy or mommy.'`;
   `It took us about three hours to finally 
convince her. `;
   `It was three times more exhausting to 
convince Coco than to dash with You on my 
back, AND swim underwater 102 meters.`;
   `By the way, Coco's reason for calling Tsugumi 
'mommy' was...`;
   Coco(C4A556)`"A girl who doesn't have a mommy can call 
somebody who reminds her of mommy 'mommy.'"`;
   Coco(C4A557)`"It's written in the Naacal Tablet, wasn't it?"`;
   `... So she said.`;
   `Needless to say, Coco already had a real 
mother.`;
...
showTextbox();
text(() => {
   `After finally convincing Coco, I went to see 
You.`;
   `Even before I had gone to rescue Chami, You 
had seemed to be recovering her strength.`;
   `But the way she looked when she had first 
started feeling pain, didn't seem normal.`;
   `I was still concerned about her even though 
she looked better.`;
   `So I decided to make sure You was alright.`;
   `Sora told me I could find You in the Security 
Office.`;
...
text(() => {
   ...
   `You was sitting in front of the console, 
staring blankly at the screen.`;
   Takeshi`"Hi."`;
   `I called out a greeting as I sat down in the 
seat next to her.`;
   `You grabbed a coffee cup, took big a gulp, and 
said...`;
   You(C4A558)`"Thank you."`;
   Takeshi`"Huh?"`;
   You(C4A559)`"I didn't have a chance to say it earlier, 
right?"`;
...
showTextbox();
text(() => {
   `When I asked, she turned the seat halfway and 
stood up.`;
...
showTextbox();
text(() => {
   You(C4A563)`"Hey Takeshi? Do you remember why I came to 
LeMU?"`;
   `You changed the subject all of the sudden.`;
   `I didn't understand why she was asking the 
...
right?"`;
   `I remembered the story You told me in front 
...
showTextbox();
text(() => {
   You(S1C122)`"My mom seems to think my dad is already 
dead..."`;
   ...
   You(S1C127)`"He just went missing. They never found his 
body."`;
...
text(() => {
   ...
   You(C4A566)`"If he's alive, of course I want to see 
him..."`;
   You(C4A567)`"And if he's dead, I wanted to find some kind 
of evidence."`;
...
showTextbox();
text(() => {
   You(C4A568)`"Otherwise I won't give up...I just can't 
accept it."`;
...
showTextbox();
text(() => {
   `Just like that time, I didn't know what to 
say to her.`;
   `The story of the 800-year-old nun came to my 
mind.`;
   `You believed that 'the 800 year-old nun' 
actually existed.`;
   `How in the story, the sound of the bell had 
stopped one day, but nobody actually found 
her body. `;
   `When I came to think of it then, I realized 
that was probably You's wish.`;
   `She was probably mixing her feelings about her 
father's situation with the story of the nun.`;
   `It occurred to me that way.`;
   You(C4A569)`"And so that's what I was researching just 
now."`;
...
text(() => {
   ...
   `She was wrapped in a hazy blue light from the 
display.`;
   `I picked up the cup from the table and sipped 
some of You's leftover coffee.`;
   `It was cold.`;
   Takeshi`"It's alright."`;
   Takeshi`"I know you'll...see him again..."`;
   `I looked down into the cup.`;
   `The black coffee hid the bottom of the 
cup from my view.`;
   You(C4A572)`"Thank you..."`;
   You(C4A573)`"But...I don't think I'll ever see him 
again..."`;
   Takeshi`"What?"`;
   `I looked up in surprise.`;
   `You was forcing herself to smile.`;
   `She squinted her eyes and looked off into the 
distance. `;
   You(C4A574)`"I came here because I thought I wanted to 
find out about my dad..."`;
   You(C4A575)`"But...I realize actually that wasn't it at 
all ... "`;
   Takeshi`"...... ?"`;
...
text(() => {
   ...
   `(She doesn't think she'll ever see him 
again...?)`;
   `'It happens all the time.'`;
   `(She'd been suffering with her hand on her 
chest.)`;
   `No, it can't be ...`;
...
text(() => {
   ...
   You(C4A582)`"If I start telling you now, I might talk 
...
text(() => {
   ...
   You(C4A584)`"Have you ever...done something wrong or 
sinned, Takeshi?"`;
   Takeshi`"Sinned?"`;
   You(C4A585)`"Yes..."`;
   You(C4A586)`"A massive sin..."`;
   You(C4A587)`"I don't care whether you believe in god or 
not."`;
   You(C4A588)`"I'm asking you if you ever committed a sin 
...
someone else, and beg for pity and compassion."`;
   ...
   You(C4A593)`"If I tell you now, it would just be an 
excuse..."`;
   Takeshi`"........."`;
   You(C4A594)`"I crossed a line that should've never been 
crossed."`;
...
text(() => {
   ...
   You(C4A601)`"I crossed a line that should've never been 
crossed. "`;
   You(C4A602)`"I turned my back on god..."`;
   You(C4A603)`"That's why I can't tell you."`;
   You(C4A604)`"If I tell you now, it would just be an 
excuse..."`;
   Takeshi`"........."`;
...
text(() => {
   ...
   You(C4A606)`"I could never escape from it, and I don't 
intend to."`;
   You(C4A607)`"As long as I live..."`;
   You(C4A608)`"Yes, as long as I live, I must carry this 
sin with me."`;
   You(C4A609)`"But you know what...?"`;
   You(C4A610)`"You might think I'm horrible, but I don't 
regret anything."`;
   You(C4A611)`"It is probably better this way..."`;
   You(C4A612)`"Because this way I'm the only one who has 
sinned..."`;
   You(C4A613)`"That means I'm the only one who will be 
punished..."`;
...
showTextbox();
text(() => {
   `You didn't say anything and took the cup from 
my hand.`;
   `She sipped the cold coffee. `;
   `For some reason, You suddenly tilted the cup. `;
   `The black liquid, overtaken by the force of 
...
text(() => {
   ...
   `All the emotion had gone from her face and I 
couldn't read what she was thinking.`;
   `Her eyes were dark, dull, and without a 
