...
text(() => {
   Kid`"You!"`;
   Kid`"Hey! You!"`;
   `It was strange...I thought that maybe she 
wasn't on that floor.`;
   `Just then, Sora's voice came to me from the 
voice converter.`;
...
text(() => {
   ...
   Sora(S3A277)`"I don't know. You contacted me about with her 
whereabouts."`;
   Kid`"I got it. Well, I'll go to the warehouse as 
well then."`;
   Sora(S3A278)`"No, that will not be necessary."`;
   Kid`"Why not?"`;
   Sora(S3A279)`"Fortunately, to the extent that I have been 
able to investigate, there was no major 
damage."`;
   `Sora added that there were enough people to do 
the required work.`;
   Sora(S3A280)`"It would be better for you to go to You's 
location."`;
   Kid`"To where You is?"`;
   Sora(S3A281)`"Yes...Something is strange there."`;
   Kid`"Strange?"`;
   Sora(S3A282)`"I can't say for sure...but I sense something."`;
   Sora(S3A283)`"So I think that someone should go 
investigate."`;
   Kid`"Wouldn't it be better if you went instead of 
me?"`;
   `If something were strange, I didn't know what 
I could do.`;
   Sora(S3A284)`"I'm sorry. Unfortunately, now I must go to 
the Control Room."`;
   Kid`"Control Room? Is something else wrong?"`;
   Sora(S3A285)`"Uh...no...I have to do a little maintenance 
on LeMMIH..."`;
   Kid`"I see."`;
   Sora(S3A286)`"I'm sorry...but do you think you can manage 
it for me?"`;
...
showTextbox();
text(() => {
   `I climbed to the second floor via the 
emergency stairs.`;
...
showTextbox();
text(() => {
   `I called to You via the intercom on the side 
...
text(() => {
   ...
   `Sora was right. Strange might have been the 
word for it.`;
...
that she wanted me to take a look..."`;
   `I couldn't think of a better way to put it and 
blurted out the truth.`;
   You`"........."`;
   Kid`"Uh, is this a bad time?"`;
   `You slumped her shoulders as if defeated and 
heaved out a sigh.`;
...
text(() => {
   ...
   You(S3A292)`"If you think about it, Sora has ears 
everywhere."`;
   Kid`"........."`;
...
text(() => {
   ...
   `In a corner of the room was an ancient siphon 
...
text(() => {
   ...
   `She turned back toward me with a white cup in 
each hand.`;
   `She handed one to me.`;
   You(S3A297)`"It's hot so be careful."`;
   Kid`"Oh, thanks..."`;
   `A white cup. White steam. Only the liquid 
inside was black.`;
...
text(() => {
   ...
   `You sat down next to me and took a sip of her 
coffee.`;
...
showTextbox();
text(() => {
   You(S3A299)`"I told you before, right? About why I got 
this job at LeMU..."`;
   You(S3A300)`"I'm looking for clues about my father, who 
disappeared."`;
   `I nodded.`;
   You(S3A301)`"He went missing 17 years ago and I came 
...
text(() => {
   ...
   You(S3A307)`"Even looking at old news clippings, I wasn't 
able to gather much information."`;
   Kid`"What do you mean?"`;
   You(S3A308)`"The cause of the accident, specific damage, 
what happened afterward...all the coverage was 
vague..."`;
   You(S3A309)`"I figure that the media didn't really know 
...
showTextbox();
text(() => {
   You(S3A310)`"Somebody or something powerful clamped down 
on information."`;
   ...
   You(S3A313)`"He worked here until right before the 
accident."`;
   You(S3A314)`"I can guess about some of what happened from 
...
showTextbox();
text(() => {
   You(S3A316)`"I thought that here...that in LeMMIH, there 
...
showTextbox();
text(() => {
   You(S3A317)`"But since I started working I haven't had any 
...
showTextbox();
text(() => {
   You(S3A318)`"I couldn't even get close to LeMMIH's 
database."`;
...
showTextbox();
text(() => {
   You(S3A320)`"But...but...you know what? Opportunity 
knocked."`;
   Kid`"Opportunity..."`;
   ...
   You(S3A323)`"Thanks to the accident, I have been able to 
...
showTextbox();
text(() => {
   You(S3A324)`"Well, I suppose it has also put my life in 
danger, but..."`;
...
text(() => {
   ...
   You(S3A326)`"I mean, I work here, but I don't have any 
authority. It's just a part-time gig..."`;
   You(S3A327)`"Taking advantage of this accident to gain 
...
showTextbox();
text(() => {
   You(S3A329)`"That's right. Stealing information. It's a 
pretty decent crime."`;
...
showTextbox();
text(() => {
   You(S3A330)`"But I suppose there was no way I could have 
kept it hidden."`;
   You(S3A331)`"Sora knows everything that goes on relating 
to LeMMIH."`;
...
text(() => {
   ...
   You(S3A345)`"It's not that I haven't...I haven't been able 
...
text(() => {
   `Tap, tap, tap...`;
   `After a second's pause, You was back tapping 
on the keyboard.`;
   `There was nothing for me to do. I just sat 
...
text(() => {
   ...
   `The digits she typed in were blocked out by *, 
...
text(() => {
   ...
   `So You immediately tapped in another line of 
letters.`;
...
relative or something?"`;
   ...
   You(S3A349)`"Works. She is working here. As in the present 
tense."`;
...
think."`;
   ...
   `You answered, her eyes still glued to the 
computer.`;
...
text(() => {
   ...
   `You fired the question at me as she continued 
...
parks, right?"`;
   ...
   You(S3A354)`"But I figure that LeMU could probably offer 
...
research?"`;
   ...
   Kid`"?"`;
   You(S3A356)`"It seems like they are doing a survey related 
...
text(() => {
   ...
   `That reminded me, Sora had said the LeMU had 
been named after a continent called Lemuria.`;
   `On Dritte stock there was an attraction called 
'The Ruins of Lemuria'... `;
   You(S2B190)`"Lemuria is this phantom continent that was 
said to have existed between 200 million to 50 
million years B.C."`;
   You(S2B191)`"On it thrived an advanced civilization that 
was more advanced that what we have today. But 
overnight it just slipped down to the bottom 
of the ocean."`;
   `You spoke as if she were reading from a 
textbook.`;
   You(S2B192)`"There are some scholars that contend that 
this continent was the origin of mankind."`;
   You(S2B193)`"Geez. They should open their eyes. There is 
no way that could even be possible."`;
   Kid`"You don't believe it?"`;
   You(S2B194)`"Of course not. Archaeologically and 
geologically the idea has no basis."`;
   You(S2B195)`"The more real research is conducted, the more 
...
longer a legitimate field of study."`;
   ...
   Kid`"Oh, you are...?"`;
   `You and archaeology...somehow the two just did 
...
showTextbox();
text(() => {
   You(S3A358)`"Near the end of the 20th century, some 
oceanic ruins were discovered near Okinawa, 
right?"`;
   You(S3A359)`"Leiblich Pharmaceutical spread rumors that 
these ruins somehow were evidence of the 
existence of Lemuria."`;
   You(S3A360)`"They have poured loads of cash into the 
archaeological survey of the seafloor."`;
   ...
   You(S3A364)`"I think she's just taking the money and 
...
text(() => {
   ...
   You(S3A369)`"Even if they dug up all the ocean floors of 
the world, there is still no way they would 
find the ruins of the Lemurian continent."`;
   You(S3A370)`"Everybody knows that it is a complete waste 
of time."`;
   You(S3A371)`"Even the higher-ups at Leiblich 
Pharmaceutical probably know."`;
   You(S3A372)`"But they still have to go about pretending to 
do research."`;
   Kid`"I wonder why? It sounds like a waste to me."`;
   You(S3A373)`"Who knows? But it's a company were talking 
about, so I'll bet it has to do with money."`;
   You(S3A374)`"But there is no way for us to know and I 
don't really care."`;
...
the third eye?"`;
   ...
   You(S3A376)`"Any dimension 'n' may only be understood in 
...
text(() => {
   ...
   `What did she mean?`;
   You(S3A377)`"Essentially, only by gaining a sense of the 
4th dimension can we really fully sense the 
whole of what is going on around us."`;
   Kid`"???"`;
   `I had no idea what she was talking about.`;
   You(S3A378)`"Like when the third eye has opened up or 
something."`;
...
showTextbox();
text(() => {
   `You's hands stopped typing there for an 
instant and she popped her neck loudly.`;
   `She reached out for her cup and took a sip of 
coffee.`;
...
showTextbox();
text(() => {
   You(S3A379)`"The third eye I'm talking about is the 
...
showTextbox();
text(() => {
   You(S3A381)`"Like the third eye on the forehead of the 
...
the Aagya Chakra, or third eye Chakra..."`;
   ...
   You(S3A902)`"...or like in esoteric Buddhism with the 
famous monk Kobo Daishi's ascetic training 
and invoking of the Kokuzo deity of space 
through the Kokuzo gumonjiho..."`;
   You(S3A383)`"Like the All Knowing Eye in Tibetan Tantric 
Buddhism."`;
   Kid`"Uh...uh..."`;
   `I felt like I was being bombarded with exotic 
words.`;
   `The conversation had completely left me behind.`;
   You(S2B229)`"Clairvoyance, telescopic vision, ghost sense, 
the gift of the prophet, the power of seeing 
the past or future..."`;
   You(S2B230)`"There are a lot of explanations behind it. 
...
showTextbox();
text(() => {
   You(S2B231)`"They all have something to do with 
...
showTextbox();
text(() => {
   You(S3A384)`"Please don't say 'I wish I had that!' Please, 
please don't."`;
   Kid`"Wh-why..."`;
...
text(() => {
   ...
   You(S3A386)`"No matter how much you want it, I don't want 
...
showTextbox();
text(() => {
   You(S3A388)`"So the third eye in terms of human anatomical 
...
point or focusing on something.`;
   `But what would it be like if we really used to 
have three eyes?`;
   fadeClearPage();
});
hideTextbox();
...
eyes.`;
   ...
   `Like the tuatara lizard that still has a third 
...
text(() => {
   `The third eye...`;
   `${noWait}`;
   `The organ has a similar function to the 
eyeball and lies on the top of the head.`;
   `This organ would be sensitive to the light of 
...
showTextbox();
text(() => {
   `This had functioned in the brain for eons and 
...
showTextbox();
text(() => {
   You(S3A392)`"I mean, no matter how much knowledge you 
have, it can't make you happy, right?"`;
   You(S3A393)`"It just makes you feel so 
ignorant...scholarship is a pretty empty 
pursuit."`;
   Kid`"..."`;
   You(S2B253)`"But even so, I still can't give it up."`;
   You(S2B254)`"Maybe it has completely rooted itself into my 
brain."`;
...
showTextbox();
text(() => {
   You(S2B259)`"Anyway, when I was little, instead of 
...
text(() => {
   ...
   You(S2B261)`"But one day I just woke up and found myself 
...
showTextbox();
text(() => {
   You(S3A395)`"It's here and it's called the third eye and 
...
text(() => {
   ...
   You(S3A398)`"When the third eye opens, true wisdom is 
...
text(() => {
   ...
   You(S3A401)`"Well, to hear my mom tell it, the third eye 
...
dimension..."`;
   ...
   `The whole concept seemed to be beyond my 
understanding.`;
...
text(() => {
   `Tap, tap, tap...`;
   `You started working again without answering my 
question.`;
   Kid`"Hey, You."`;
   You(S3A403)`"Sorry, let's make that the end of today's 
lecture."`;
   You(S3A404)`"The explanation from here is pretty hard."`;
   You(S3A405)`"And it's pretty obvious I'm busy, right?"`;
   You(S3A406)`"If you really wanna know, next time I'll 
explain it in an easy to swallow way."`;
   ...
   `I figured not drinking it would be a waste so 
I drank it down.`;
   `Gulp.`;
...
text(() => {
   ...
   `Actually, she hadn't even gotten past the 
authorization screen.`;
   `'Access denied. Invalid name or password.'`;
   `That message had been displayed again and 
...
showTextbox();
text(() => {
   You(S3A411)`"I know that. I tried all the things I could 
think of."`;
   You(S3A412)`"I tried them backwards and as an anagram and 
...
text(() => {
   ...
   You(S3A414)`"I'm just a normal person when it comes to 
computers."`;
...
showTextbox();
text(() => {
   You(S3A415)`"I'm no hacker or cracker. I don't have any 
illegal programs and can't just type one out 
right now."`;
   `You stuck her hands up in the air, signaling 
her surrender.`;
...
text(() => {
   ...
   `I thought that maybe she was still concerned 
...
text(() => {
   ...
   Kid`"I suppose..."`;
   `But at this rate, You probably wouldn't find a 
...
text(() => {
   ...
   `You took a piece of paper from atop the 
console.`;
   Kid`"What's that?"`;
...
text(() => {
   `${voice(S3A422)}${noWait}`;
   Append(S3A423)`${nextPage(0)}I sneaked into her research room before coming 
here.${nextPage(1)}${waitVoice}
${noWait}`;
   `${voice(S3A424)}${nextPage(0)}I was looking for clues about my father of 
course.${nextPage(1)}${waitVoice}
${noWait}`;
   `${voice(S3A425)}${nextPage(0)}When I went in, I saw that her computer was on.${nextPage(1)}${waitVoice}
${noWait}`;
   `${voice(S3A426)}${nextPage(0)}Looking at it I saw that there was a text file 
entitled 'Password.'${nextPage(1)}${waitVoice}
${noWait}`;
   `${voice(S3A427)}${nextPage(0)}When I opened it, it was only one line...${nextPage(1)}${waitVoice}
${noWait}`;
   `${nextPage(0)}There was some Japanese sentence typed inside 
it.${nextPage(1)}`;
   fadeClearPage();
});
hideTextbox();
...
text(() => {
   `${voice(S3A431)}${noWait}`;
   Append(S3A432)`${nextPage(0)}I tried to take a note of it before I was 
found out.${nextPage(1)}${waitVoice}${noWait}`;
   `${voice(S3A433)}${nextPage(0)}But I didn't see a pen or anything around.${nextPage(1)}${waitVoice}
${noWait}`;
   `${nextPage(0)}And there were no disks or anything that I 
could copy it to.${nextPage(1)}`;
   fadeClearPage();
});
hideTextbox();
hideTextbox();
...
showTextbox();
text(() => {
   You(S3A434)`"Thinking about it now, I should have sent it 
to myself by e-mail..."`;
...
text(() => {
   `${voice(S3A435)}${noWait}`;
   Append(S3A436)`${nextPage(0)}But I was in a rush and didn't think about it 
then.${nextPage(1)}${waitVoice}
${noWait}`;
   `${voice(S3A437)}${nextPage(0)}Suddenly, I thought that I'd try to print it 
out...${nextPage(1)}${waitVoice}
${noWait}`;
   `${voice(S3A438)}${nextPage(0)}As soon it stopped printing my mom came back.${nextPage(1)}${waitVoice}
${noWait}`;
   `${nextPage(0)}I snatched the paper that was in the tray and 
jammed it in my pocket.${nextPage(1)}`;
   fadeClearPage();
});
hideTextbox();
hideTextbox();
...
text(() => {
   Kid`"A barcode?"`;
   You(S3A439)`"It looks like it, but it seems different than 
normal barcodes."`;
...
password?"`;
   ...
   You(S3A442)`"I don't remember very well. Maybe 10 
characters give or take."`;
   Kid`"Was it all written in Japanese? Any numbers?"`;
   You(S3A443)`"I'm pretty sure it was just Japanese. I don't 
...
showTextbox();
text(() => {
   You(S3A447)`"If I don't know the answer, how can I give 
you a hint?"`;
...
text(() => {
   ...
   You(S3A450)`"And phone number. And birthday. And my social 
security number. And..."`;
...
showTextbox();
text(() => {
   `I looked again at the paper we thought 
contained the password.`;
   `I was obsessed with solving the puzzle we had 
found.`;
   `It was frustrating.`;
   `'Now who is forgetting the important things?'`;
   `...What could I say to that?`;
   `(It's not like I wanted to lose my memory!)`;
   `(Watch this! I'll remember everything just to 
show you!)`;
   `But first...I had to figure this out.`;
   `I had my mind set on it.`;
   `I almost felt like solving this was a rite of 
...
showTextbox();
text(() => {
   `I thought that if I turned it over I might be 
able to read something.`;
   `I turned the paper over and held it up to the 
light.`;
...
text(() => {
   Kid`"........."`;
   `It was no good. Turning it over showed nothing 
new.`;
...
showTextbox();
text(() => {
   `I thought maybe I could read something if I 
...
text(() => {
   Kid`"........."`;
   `It was no good. Turning the paper upside down 
showed nothing new.`;
   You(S3A453)`"So? Did you figure it out?"`;
   Kid`"Yup. I figured out that I can't read it this 
way."`;
...
showTextbox();
text(() => {
   `I thought maybe if I heated it with a flame, I 
could read it.`;
   Kid`"Hey, you don't have a lighter, do you?"`;
   You(S3A456)`"Huh? A lighter?"`;
   You(S3A457)`"Don't tell me you want to calm your nerves 
with a smoke."`;
   You(S3A458)`"You're too young to smoke!"`;
   Kid`"I know that..."`;
   Kid`"I wanted to use it on the paper..."`;
   You(S3A459)`"You want to burn it? Playing with fire is 
dangerous!"`;
   You(S3A460)`"Besides, this paper is the only clue I've 
...
flame, something might appear..." `;
   ...
   `I figured out that I couldn't read it 
that way.`;
   `(Hmmmm. Let's see.)`;
...
showTextbox();
text(() => {
   `I thought that if I folded it in half maybe I 
...
showTextbox();
text(() => {
   `I thought that if I tilted it a little I might 
...
text(() => {
   Kid`"........."`;
   `It didn't help. Changing the angle showed 
nothing new.`;
...
text(() => {
   Kid`"........."`;
   `It was no good. Rolling it up showed nothing 
new.`;
   You(S3A453)`"So? Did you figure it out?"`;
   Kid`"Yup. I figured out that I can't read it this 
way."`;
...
things, I think we'll figure it out."`;
   `(Huh?)`;
   `(By changing the way we look...we'll figure it 
out?)`;
   `Something about my words triggered something 
in my mind.`;
...
text(() => {
   ...
   Kid`"Be quiet."`;
   You(S3A465)`"And somebody that can't even understand the 
difference between two dimensions and three 
dimensions."`;
   Kid`"Huh?"`;
   You(S3A466)`"See? The characters on the paper are 
two-dimensional and we are three-dimensional."`;
   You(S3A467)`"Basically, the worlds that we live in are 
different."`;
   You(S3A468)`"So if you really want to understand what this 
barcode has to say, then you have to think 
two-dimensionally."`;
   Kid`"........."`;
   You(S3A469)`"So? Whaddya think?"`;
   `(The stuff on the paper is two-dimensional...
And we are three dimensional.)`;
   `I had to think two-dimensionally.`;
   `(What do I have to do to think 
two-dimensionally...?)`;
...
text(() => {
   ...
   `Then she copied me and set the paper sideways 
in the same way.`;
...
wash away all my irritation and fatigue.`;
   ...
   `It was like the winter frost melting away 
...
showTextbox();
text(() => {
   You(S3A474)`"I get it now. You can't see it from right 
above it."`;
...
text(() => {
   ...
   Kid`"..."`;
   You(S3A485)`"I told you it was impossible to figure out 
from the start."`;
   Kid`"........."`;
...
haven't tried?"`;
   You(S3A487)`"Yup. But I thought it wouldn't work, so I 
...
text(() => {
   `Tap, tap, tap...`;
   You(S3A493)`"On Dasher and Dancer, and Prancer and 
Vixen...come on!!"`;
...
text(() => {
   `Beeeeeeeep!`;
   `Of course, none of these phrases got her 
access to the C Level information.`;
   `I didn't see why she had to shout all of them 
out either.`;
   `I was already at my wit's end and incapable of 
speech.`;
...
showTextbox();
text(() => {
   You(S3A495)`"I don't know but it looks like it 
...
showTextbox();
text(() => {
   You(S3A497)`"Maybe I entered the wrong password too many 
...
showTextbox();
text(() => {
   You(S3A498)`"In other words, LeMMIH has completely denied 
...
showTextbox();
text(() => {
   You(S3A499)`"So we'll have to give up for the time being, 
I guess."`;
...
showTextbox();
text(() => {
   You(S3A500)`"And you went to so much trouble to read this 
for me, Kid..."`;
   You(S3A501)`"But from the start there was no guarantee 
...
showTextbox();
text(() => {
   You(S3A502)`"It would make more sense if this were some 
kind of hint that my mom uses to remember the 
password."`;
   You(S3A503)`"It wouldn't make much sense to call the file 
...
showTextbox();
text(() => {
   `I wondered why You's mom would choose this 
poem.`;
   `I wondered what was hidden in the 17 syllables 
of this poem.`;
...
showTextbox();
text(() => {
   `And what was the password that should have 
been printed on that paper correctly?`;
   `A Japanese phrase of around 10 syllables.`;
   `It bothered me to no end, and was totally 
...
showTextbox();
text(() => {
   `A while after that, we heard from Takeshi that 
