...
text(() => {
   ...
   `Everyone was already fast asleep. Some were snoring.`;
   `For us, the situation wasn't getting any better; but at least it wasn't getting any worse.`;
   `It was better that we just sleep to prepare for what might come....`;
   `...If only I could...`;
...
text(() => {
   ...
   `How could I be so tired but not be able to sleep?`;
...
showTextbox();
text(() => {
   `Only the sound of my damp shoes echoed through the night.`;
   `I didn't encounter a soul as I walked down the corridor.`;
   `Nobody had come to get us...`;
   `...but I decide not to let it get me down.`;
   `We were still alive. We had survived up until now, and we would live for the foreseeable future.`;
   `I thought to myself that anyone who had made it this far would survive.`;
   `(Yeah...)`;
   `(We'll make it...)`;
...
text(() => {
   `Was this a dead end?`;
   `It seemed like I had reached the end of the floor. `;
   `I turned around and headed back along the passageway.`;
...
showTextbox();
text(() => {
   Sora(T4A000)`"Oh good! There you are, Takeshi! I was looking for you."`;
   Takeshi`"........."`;
...
text(() => {
   ...
   `Because the moment Sora had appeared around that corner, she and I had been face-to-face.`;
   `We were so close, it seemed like our noses overlapped.`;
...
showTextbox();
text(() => {
   Sora(T4A004)`"Oh, I'm so sorry. I didn't mean to get so close to you."`;
   `Sora's cheeks turned a soft red.`;
   Sora(T4A005)`"Oh, did I look strange...? I..."`;
   Takeshi`"No, no. Don't worry about it. You're beautiful, as always."`;
   Sora(T4A006)`"Oh, well, thank you."`;
   Sora(T4A007)`"It is just...I'm a little embarrassed."`;
   `Huh? I felt like I'd just blurted out something ridiculous...?`;
   `But Sora had smiled when I said it, so maybe it was okay.`;
...
showTextbox();
text(() => {
   Sora(T4A008)`"Well, anyway. Everyone is still sound asleep, so I haven't told anyone but..."`;
   `As she said that her face suddenly changed.`;
   Takeshi`"Huh? What?"`;
   Sora(T4A009)`"A little while ago, Tsugumi was tossing and turning in bed. So I dispatched the medical wagon to keep her still."`;
   Takeshi`"...Really?"`;
...
showTextbox();
text(() => {
   Sora(T4A010)`"Yes, I was surprised. She was seriously hurt, you know...And still..."`;
   Takeshi`"Hey, she should wake up soon, don't you think?"`;
   Sora(T4A011)`"Yes, I think she may soon regain consciousness..."`;
   Takeshi`"Well, she shouldn't be tossing and turning like that. She'll reopen her wounds."`;
...
showTextbox();
text(() => {
   `I flew up the stairs as fast as I could and sprinted down the corridor.`;
...
showTextbox();
text(() => {
   `I arrived in front of the infirmary on the second floor.`;
...
text(() => {
   ...
   `Tsugumi was lying there on a bed in the back of the room.`;
   `I walked slowly over to her...`;
   `...and sat down on the bed next to hers.`;
   `I could hear a computer working over at the other end of the room, collecting data on her pulse and blood pressure.`;
   `The data told us the most important thing— she was still alive.`;
   `However...`;
...
text(() => {
   ...
   Takeshi`"I'm just asking. Tell me how you're feeling."`;
   Tsugumi(T4A017)`"Awful. My whole body...hurts."`;
   Tsugumi(T4A018)`"I feel terrible."`;
   Takeshi`"Oh..."`;
   `Tsugumi lifted her hand up to her face, opening and closing it slowly.`;
   `She still couldn't move much.`;
   Takeshi`"How's the injury? Does it hurt? You may still be under a bit of anesthesia."`;
   ...
   Tsugumi`"........."`;
   Takeshi`"........."`;
   `Tsugumi tried to get up, but, noticing the various IV cords snaking up her arm, she frowned.`;
   `She was alive.`;
   `She was injured, but still breathing.`;
   `Her life had been saved, and for that I was grateful.`;
   `But...it was my fault...I was the one who caused her injury...`;
...
text(() => {
   ...
   Takeshi`"Because I was careless, you ended up getting hurt..."`;
...
text(() => {
   ...
   Tsugumi(T4A025)`"I was injured, but it wasn't because I sacrificed myself for Coco's safety."`;
...
text(() => {
   ...
   `I then bowed my head. There was nothing else I could do.`;
   Tsugumi(T4A026)`"...What?"`;
...
text(() => {
   ...
   Takeshi`"You!"`;
   Takeshi`"What do you mean, 'You could have finally died!?'"`;
   Tsugumi(T4A037)`"That's what I said, right?"`;
   Tsugumi(T4A038)`"I...I wanted to die."`;
   `Tsugumi gazed at me, narrowing her eyes. She was quiet.`;
   `I gazed back.`;
   `I could tell by the look in her eye that she wasn't joking.`;
...
text(() => {
   ...
   Takeshi`"When you die, it's game over. You understand that, right?"`;
   Takeshi`"Have you forgotten about us? What we're facing here?"`;
   `Now it was me glaring at Tsugumi.`;
   `It wasn't as if she had actually done something wrong.`;
   `But that didn't mean I could forgive her for saying that.`;
   Tsugumi`"........."`;
...
text(() => {
   ...
   Takeshi`"Life! It's the most important thing in this world!"`;
   ...
   Tsugumi(T4A045)`"...Continuing infinitely...this phenomenon called 'life' is no miracle."`;
   Tsugumi(T4A046)`"It's unnatural."`;
   Tsugumi(T4A047)`"And it's an accident that we awoke in this disgusting world."`;
   ...
   Tsugumi(T4A052)`"We kill cows, pigs, birds, fish and plants..."`;
   Tsugumi(T4A053)`"...and if we don't, we die."`;
   Tsugumi(T4A054)`"Our appetites are whetted by the slaughtering of others."`;
   Tsugumi(T4A055)`"Our desire for sleep only proves our laziness."`;
   Tsugumi(T4A056)`"Our sexual desires are expressed through obscenity and sin."`;
   Tsugumi(T4A057)`"All the things that keep us alive—the things that drive us—are filthy."`;
   ...
   Tsugumi(T4A061)`"...from the moment we are born, we are already corrupted."`;
   Takeshi`"And that is why you want to die?"`;
   Tsugumi(T4A062)`"Yes."`;
   `I became quiet, contemplating what Tsugumi just said.`;
   Takeshi`"...Heh."`;
   `This time is was me laughing.`;
   Takeshi`"I thought you were smarter than that...but I guess I overrated you."`;
   Tsugumi`"........."`;
   Takeshi`"You do have a point, and I think you are partly right."`;
   Takeshi`"I'll admit it."`;
   Takeshi`"In order for us to live, it's true that we must commit some atrocities."`;
   Takeshi`"Sometimes people do terrible, despicable things."`;
   Takeshi`"But do you really think 'living' is a sin?"`;
   Takeshi`"Thinking life is a sin, is the result of arrogant values."`;
   Takeshi`"You don't really think it's a crime for a bird to snatch fruit from a tree, do you?"`;
   Takeshi`"Does a tiger feel guilt for eating its prey?"`;
   Takeshi`"Is it really a terrible thing to join together and create new life?"`;
   Takeshi`"Everything that is necessary to continue living, is not only right, I believe it is sacred."`;
   Takeshi`"The birds, the tigers, the ants, even the grass..."`;
   Takeshi`"...they all work so hard to live. It's a beautiful thing."`;
   Tsugumi`"........."`;
   Takeshi`"And to love the lives of others, is just as important as loving yourself."`;
...
text(() => {
   ...
   Tsugumi`"........."`;
   Takeshi`"I don't know exactly what happened back there, but I do know that you are avoiding the truth."`;
   Takeshi`"You are desperately trying to deny life."`;
   Takeshi`"Everyone's desires are born out of life, you only want to believe they are wrong to prove your selfish point."`;
   Takeshi`"You are holding on obstinately, living while all you want to do is die..."`;
   ...
   Takeshi`"We've known each other for what? Just three days."`;
   Takeshi`"I don't know a THING about you..."`;
   Takeshi`"...but I know for sure that what I'm saying is 100 percent true."`;
   Takeshi`"So..."`;
...
text(() => {
   ...
   `I had told Tsugumi exactly how I felt. No holding back, no regrets.`;
...
text(() => {
   ...
   `What, had I finally gotten through to her?...I couldn't help but smile.`;
...
text(() => {
   ...
   Takeshi`"It's unfortunate, but she didn't get what she wanted. Death."`;
...
text(() => {
   ...
   Takeshi`"You know, I should have never even helped save..."`;
...
text(() => {
   ...
   Takeshi`"I'm heading back to bed, even though I know I can't sleep."`;
...
showTextbox();
text(() => {
   `Sora stood by the entrance to the medical room, frozen, without movement.`;
...
text(() => {
   ...
   Takeshi`"Well then, Tsugumi, how come you helped Coco?"`;
   Takeshi`"No, better yet, how come you went to repair the warehouse?"`;
...
text(() => {
   ...
   Takeshi`"Well, then you didn't really have to worry about us, now did you?"`;
   Takeshi`"You shouldn't have cared at all if we'd all died...?"`;
...
text(() => {
   ...
   Takeshi`"I'm no doctor, but I think she'll be back on her feet soon enough."`;
   Takeshi`"Besides, she doesn't look like she's dying... I think we can all relax."`;
...
text(() => {
   ...
   Takeshi`"Huh?"`;
   Sora(T4A081)`"Tsugumi is very hurt, Takeshi. She needs to rest more than anything, you know?"`;
   Takeshi`"Ah, uh...was that right?"`;
   `I had almost forgotten.`;
   `No matter how badly she had treated me, Tsugumi would still be bedridden for months recovering.`;
   Takeshi`"You're right. I'm sorry. That came out a little harsh."`;
...
text(() => {
   ...
   Takeshi`"Yeah..."`;
   `There was no way I could tell Sora that what Tsugumi had just said to me.`;
   `I still couldn't accept that she would say such a thing.`;
   Takeshi`"Ah, never mind. Just forget it."`;
   Takeshi`"It's just that, I guess I'm still upset at myself. It was my fault Tsugumi got hurt."`;
   Takeshi`"You know, I just don't know what to say...she can...she can be...Ahh, dammit!"`;
...
showTextbox();
text(() => {
   Sora(T4A085)`"It was no one's fault that Tsugumi got injured."`;
   Sora(T4A086)`"The situation here at LeMU is not anyone's fault."`;
...
text(() => {
   ...
   Sora(T4A089)`"Tsugumi's wound will be fine. She just needs time to heal."`;

});
let lbl_00000635;
showTextbox();
text(() => {
   Sora(T4A090)`"Takeshi, I am not sure what Tsugumi told you..."`;

});
fgload({ id: 1, name: `SO02ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Sora(T4A091)`"...all I know is that you saved her. And for that, I am grateful..."`;
   Sora(T4A092)`"...I am just...so happy...that she was saved."`;
   `Sora produced a bright smile.`;
   Takeshi`"Ahhh...yeah, I suppose. I suppose I should be happy, huh?"`;
   ...
   Takeshi`"You know, Tsugumi was in a really bad mood for some reason."`;
   ...
   `Even if it wasn't that...I didn't want this to drag on forever.`;
   `I had helped Tsugumi, and she was recovering. It was simple as that.`;
...
showTextbox();
text(() => {
   Sora(T4A094)`"Takeshi, are you sure you do not need more rest?"`;
   Takeshi`"No, I'm fine. I already tried to sleep but I couldn't, which why I went for a walk."`;
   Takeshi`"Let's make our way over to the Dolphin Carousel. We can talk."`;
...
showTextbox();
text(() => {
   `...we were off, riding the dolphins on the merry-go-round.`;
   `Sora turned on the power to the merry-go-round, and got on before quickly taking off.`;
   `I rode on the dolphin next to her.`;
   `The ride pulsated with vibrant colors as it revolved around the space.`;
   `I hadn't ridden a carousel since my childhood, but I didn't feel strange about it.`;
   `In fact, it was fun.`;
...
showTextbox();
text(() => {
   Sora(T4A098)`"No, no, I...I should be the one thanking you. You have helped me so much."`;
   Sora(T4A099)`"Tsugumi, Tanaka, Coco, the Kid...I am in debt to everyone."`;
   Takeshi`"In debt?"`;
   Sora(T4A100)`"Lately, I have been..."`;
   Sora(T4A101)`"I feel like I've gained an new perspective on human life."`;
   Sora(T4A102)`"Everyone holds their ground. They fight and try to figure out ways to survive."`;
   Sora(T4A103)`"In all the time that I have spent here at LeMU, I had not ever really been with people."`;
   Takeshi`"Yeah..."`;
...
text(() => {
   Sora(T4A104)`"It was..."`;
   Sora(T4A105)`"...this microcosm, day after day of the same scenery. Nothing changed, nothing happened."`;
   Sora(T4A106)`"I did not care what happened to the people here."`;
   Sora(T4A107)`"But now I am grateful I have met with this opportunity."`;
   Sora(T4A108)`"And I am happy that even at this moment..."`;
   Sora(T4A109)`"Despite what happened and this dour situation, people are still striving to live."`;
   Sora(T4A110)`"Come on everybody! Believe in tomorrow, so you can live today..."`;
   Takeshi`"Yeah...."`;
...
text(() => {
   ...
   Sora(T4A112)`"I am always saying things I should not. I didn't mean to gush..."`;
   Sora(T4A113)`"I'm sorry. Really. It was really lacking refinement...I..."`;
   ...
   Takeshi`"From the time you came to LeMU and started working, there have always been people." `;
   Takeshi`"It's natural that there were things you didn't know, that you had doubts, and made mistakes..."`;
   Sora(T4A114)`"I suppose you are right...."`;
   Takeshi`"So don't worry about it."`;
   Sora(T4A115)`"It would be great if we could ensure that everybody has an escape route, but even the communications are still..."`;
   Takeshi`"That's alright. I know it's difficult. We're not expecting the impossible."`;
   Takeshi`"We haven't even found a safe route out of here..." `;
   Takeshi`"Rather than us looking for an escape route haphazardly, I think it would be best to wait for help."`;
...
showTextbox();
text(() => {
   Sora(T4A117)`"So Takeshi, if you do make it out of here, what it is that you want to do first?"`;
   Takeshi`"Hmmm..."`;
   Takeshi`"Well, I know that I want to eat something other than a kiosk sandwich."`;
   Takeshi`"There's a great restaurant close to my home."`;
   Takeshi`"It's run by a nice old lady. She gets along with everybody."`;
   Takeshi`"She's got a round face kind of like a  classic car..."`;
   Sora(T4A118)`"A classic car...?"`;
   Sora(T4A119)`"Do you mean like a VW Beetle?"`;
   Takeshi`"Right, right. Just like that Beetle."`;
   Takeshi`"That Ms. Beetle makes a mean bowl of miso ramen."`;
   Takeshi`"I wonder how she's doing right now..."`;
   Sora(T4A120)`"Ha, ha, ha... You are funny."`;
   Sora(T4A121)`"You get out of this place and the first person you want to see is an old woman."`;
...
text(() => {
   ...
   Sora(T4A123)`"Isn't there a girl waiting for you back home?"`;
...
text(() => {
   ...
   Takeshi`"But being trapped here makes that all seems like another time, another place."`;
   Takeshi`"More like a dream than reality."`;
   Takeshi`"My reality here is consumed by how to survive this whole mess."`;
...
showTextbox();
text(() => {
   Takeshi`"So yeah...to answer your question - no one is waiting for me out there."`;
   Takeshi`"We broke up a long time ago."`;
   Takeshi`"And it was a clean break if you know what I mean."`;
...
text(() => {
   ...
   Takeshi`"Hmmm...well, our relationship wasn't your perfect love story..."`;
...
text(() => {
   ...
   Takeshi`"Hey, stop teasing me. You're making me embarrassed."`;
   Sora(T4A126)`"But it's really fantastic!"`;
   Takeshi`"........."`;
   `I'm pretty sure my face was as red as a boiled crab by then.`;
   `And imagining it only made it worse that's for sure...`;
...
text(() => {
   ...
   Sora(T4A133)`"Tell me its how, its method, its meaning, its purpose..."`;
   Sora(T4A134)`"Why do you love?"`;
   Sora(T4A135)`"How does one go about loving?"`;
   `Sora was firing off one question after another..`;
   `And they didn't seem to me like easy questions to answer.`;
   Sora(T4A136)`"Takeshi, you are someone who has loved."`;
   `Uh, here it comes...`;
   Sora(T4A137)`"What is love..."`;
   Sora(T4A138)`"What is love. Can you explain it and help me understand it?"`;
...
text(() => {
   ...
   Takeshi`"Okay! What definitions does your database give for love?"`;

});
bgload({ name: `EV_SO01B`, transition: 20 });
showTextbox();
text(() => {
   Sora(T4A139)`"You better not be preparing a punch line about tennis..." `;
   Takeshi`"What? Am I that transparent?"`;
   Sora(T4A140)`"Yes. That's about as much of a cliche as you can get.."`;
   ...
   Sora(T4A142)`"Yes. That's about as much of a cliche as you can get.."`;
...
text(() => {
   Sora(T4A145)`"Hmmm..."`;
   Sora(T4A146)`"Those are all of the definitions that I have in my database."`;

});
bgload({ name: `EV_SO01A`, transition: 20 });
showTextbox();
text(() => {
   Sora(T4A147)`"Takeshi, can you please answer my original question?"`;
   Takeshi`"Okay. There's one more meaning for love. Give me a second to explain it."`;
...
text(() => {
   ...
   Takeshi`"No, no. I need ten minutes. Please? No, no. I need more time. Much more time!"`;
   `There was just no simple way to explain it to her.`;
...
text(() => {
   ...
   `Love.`;
   `What was love?`;
   `I've never really thought that seriously about it.`;
   `Wasn't there some other way I could describe it?`;
...
text(() => {
   ...
   `What was love?`;
   Takeshi`"Wellllllll......"`;
   `How could I explain love to someone that has never experienced it?`;
   `Love...`;
   `What is love...?`;
...
showTextbox();
text(() => {
   Sora(T4A154)`"Don't try too hard, Takeshi. You're falling apart."`;
...
showTextbox();
text(() => {
   Sora(T4A155)`"Alright. I will try to answer my own question."`;
   ...
   Sora(T4A160)`"At least from the perspective of human beings, flowers don't act in any way that can be viewed as love."`;
   Sora(T4A161)`"What about animals? Do they love?"`;
   Sora(T4A162)`"They may love, they may not. "`;
   Sora(T4A163)`"Some animals seem to act out of love. We have observed this to an extent."`;
   Sora(T4A164)`"But perhaps animals do not understand the true meaning of love."`;
   Sora(T4A165)`"It's unclear whether it is the same as the human definition of love."`;
   Sora(T4A166)`"Do humans love?"`;
   Sora(T4A167)`"Yes, I believe so."`;
   Sora(T4A168)`"Love is...."`;
   Sora(T4A169)`"Love is one of those mysterious things that people are programmed to do."`;
   Sora(T4A170)`"One of its functions is reproduction..."`;
   Sora(T4A171)`"...but that appears to be a function independent of love."`;
   Takeshi`"Stop!"`;
...
text(() => {
   ...
   Sora`"........."`;
   `It somehow felt as if something were there, but then again, maybe it was my imagination.`;
   `I felt, trying to see if there were some sort of warm feeling.`;
   ...
   Takeshi`"It's not something you try to explain through logic."`;
   Takeshi`"It's something that is planted in the depths of your heart and steadily blossoms into something beautiful."`;
   Takeshi`"If something goes wrong, the flower might wilt and die.."`;
   Takeshi`"But if the love is true, it may bear amazing fruit."`;
   Takeshi`"There is no rhyme nor reason to the process of love."`;
   Takeshi`"Even if you do find reason in it, love isn't an emotion that you can control easily."`;
   Takeshi`"Love is something that visits like wakefulness after a slumber."`;
   Takeshi`"Just as we awake in the morning to begin our day..."`;
   Takeshi`"...we are put on this earth for the purpose of love."`;
   Takeshi`"To live is to love."`;
   Takeshi`"To ask what is the meaning of love, is to ask what is the meaning of life."`;
...
text(() => {
   ...
   Takeshi`"I might have borrowed bits and pieces from elsewhere, but I don't think it is all wrong."`;
...
text(() => {
   ...
   `A smile appeared on her lips.`;
   Sora(T4A177)`"However, even if a rose is born to bloom, I don't believe that a rose knows this."`;
   Sora(T4A178)`"And I don't believe a canary believes its purpose to sing."`;

});
bgload({ name: `EV_SO01A`, transition: 20 });
showTextbox();
text(() => {
   Sora(T4A179)`"But from the eyes of a human, it might appear that the only purpose of a rose is to blossom."`;
   Sora(T4A180)`"Similarly, from the eyes of a human, it might appear that the only purpose of a canary is to sing."`;

});
bgload({ name: `EV_SO01C`, transition: 20 });
showTextbox();
text(() => {
   Sora(T4A181)`"It would appear that humans are probably the same."`;
   Sora(T4A182)`"I imagine that many people don't believe that they are living for the purpose of loving."`;
   Sora(T4A183)`"But from my perspective..."`;
   Sora(T4A184)`"...I believe they are mistaken. It would seem to me that people only live to love."`;
   Sora(T4A185)`"It could be that is how things are."`;
   `The movements of the dolphins gradually began to slow.`;
   `The music faded to a stop as the Dolphin Carousel continued to slow.`;
...
text(() => {
   ...
   Takeshi`"I wish we could've ridden just a little bit longer..."`;
   Takeshi`"But that was fun. Let's come ride these dolphins again sometime."`;
   Takeshi`"That was a pretty deep conversation we just had...Sora?"`;
   Sora`"........."`;
...
showTextbox();
text(() => {
   `But there was nothing in the air where she was looking.`;
   `Only the sprawling, dome-line ceiling of the Dolphin Carousel extending in all directions.`;
   Takeshi`"Sora...?"`;
   ...
   `Different colored lights played off of the merry-go-round.`;
   `The light reflected a hint of sadness off of Sora's face.`;
   Takeshi`"........."`;
...
showTextbox();
text(() => {
   `Sora laughed as if nothing had happened, got off her dolphin and came and stood next to me.`;
   `I didn't know what to say.`;
   `What was her purpose?`;
   `At that point, I just couldn't find an answer to that question.`;
   `All I could do was turn my back to the dolphins and head toward the dark exit...`;
