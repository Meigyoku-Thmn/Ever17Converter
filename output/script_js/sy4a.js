...
showTextbox();
text(() => {
   You(Y4A000)`"Oh, so this is where you are. I was looking 
for you."`;
...
showTextbox();
text(() => {
   You(Y4A003)`"Hey, what are you doing with that LeMU 
hologram?"`;
   Kid`"Just looking."`;
   You(Y4A004)`"You aren't trying to think of a way out, are 
you?"`;
...
text(() => {
   ...
   You(Y4A007)`"Besides, there are lots of things I wanna 
think about..."`;
...
text(() => {
   ...
   You(Y4A011)`"Yeah. Well in order to think, you've gotta be 
...
text(() => {
   ...
   You(Y4A018)`"There is no meaning to that or connection 
at all."`;
   You(Y4A019)`"I just thought that if I said that, then 
you'd come along with me."`;
   Kid`".........."`;
   You(Y4A020)`"Thinking about things all by myself doesn't 
...
text(() => {
   ...
   You(Y4A024)`"I told you about how my mom was doing her own 
research while pretending to study the 
Lemurian continent, right?"`;
   You(Y4A025)`"It seems like she was completely hooked on 
researching the third eye."`;
   You(Y4A026)`"Do you know why?"`;
   Kid`"Because she was conducting research in the 
name of Lemuria?"`;
   You(Y4A027)`"Yeah. So my mom wanted to study the third 
...
conclude...'`;
   ...
   You(Y4A029)`"She even wrote trumped up papers on the 
topic."`;
   You(Y4A030)`"Even though they really are totally 
unrelated."`;
...
explanation of the place.`;
   You(Y4A036)`"Members of our research staff here at LeMU 
...
Lemuria worshipped the sun..."`;
   ...
   You(Y4A038)`"A Sun Temple...at the bottom of the 
...
the ocean.`;
   ...
   You(Y4A043)`"If we could just get that high pressure 
...
text(() => {
   ...
   You(Y4A046)`"I mean, I don't think what happened this 
time was just and accident."`;
   You(Y4A047)`"I think that somebody trapped us here on 
purpose."`;
   Kid`"........."`;
...
text(() => {
   ...
   You(Y4A050)`"Mayo's friends, Takeshi's friends and my 
coworkers should all know that we are trapped 
here, right?"`;
   You(Y4A051)`"So why doesn't anyone come?"`;
   You(Y4A052)`"Even if there is some reason that they can't 
get inside, divers should at least be knocking 
on the windows!"`;
   You(Y4A053)`"Besides, we still have power, only the 
communication system to the outside is down."`;
   You(Y4A054)`"We still don't have any idea what caused the 
alarm before the accident and the blackout..."`;
   You(Y4A055)`"And we don't know why the high pressure input 
fan stopped working either."`;
   You(Y4A056)`"It's almost like everything was set up to 
trap us here."`;
   Kid`"............"`;
...
showTextbox();
text(() => {
   You(Y4A060)`"Is that a premonition? Or just an optimistic 
guess?"`;
...
text(() => {
   ...
   You(Y4A063)`"For sure? There's not even a 1 percent chance 
you're wrong?"`;
...
showTextbox();
text(() => {
   You(Y4A064)`"Talk about promising more than you can 
deliver..."`;
...
showTextbox();
text(() => {
   You(Y4A067)`"I could...enter by cracking the system open 
...
showTextbox();
text(() => {
   You(Y4A069)`"It might be a lot to ask, but I'll ask Mayo 
for her help."`;
   Kid`"Good."`;
...
showTextbox();
text(() => {
   Sara(Y4A071)`"I'm exhausted so cut me some slack. 
...
showTextbox();
text(() => {
   Sara(Y4A080)`"I mean it's to help Nakkyu, right? I can't 
very well say no."`;
   Kid`"Th...thanks!"`;
...
did...actually jump.`;
   ...
   Sara(Y4A081)`"H-hey, hey, wait...Kid, what are you so happy 
about?"`;
   Kid`"Huh?"`;
...
showTextbox();
text(() => {
   Sara(Y4A082)`"All I said was that I'd help Nakkyu. This 
...
showTextbox();
text(() => {
   Sara(Y4A090)`"But since it's you that she's gone for, 
I'll let it go."`;
...
text(() => {
   ...
   Sara(Y4A099)`"In this kind of OS the file should be saved 
here, but..."`;
...
text(() => {
   ...
   Kid`"What's that?"`;
   Sara(Y4A101)`"It's an unchangeable string of letters or 
numbers created by a mathematical function 
when a user sets a password."`;
   Kid`"W-what?"`;
   Sara(Y4A102)`"If you can find the hash, then it's easy to 
get a password."`;
   Sara(Y4A103)`"For example, if you save a large number of 
...
showTextbox();
text(() => {
   Sara(Y4A104)`"Alright. It's basically like the password's 
fingerprint."`;
...
showTextbox();
text(() => {
   Sara(Y4A105)`"While you can't create a person from a 
fingerprint, you can identify one, right?"`;
   Sara(Y4A901)`"It's the same as a fingerprint. The hash 
always reflects the characteristics of the 
original.`;
   Sara(Y4A902)`And the modulation pattern is always 
...
from Sara.`;
   ...
   Sara(Y4A107)`"I wonder...it might be that there is a file 
that only the root authority can access..."`;
   Sara(Y4A108)`"Even if I did find it, it could be randomly 
sequenced..."`;
...
like a contest."`;
   You(Y4A111)`"Look, the contest Mayo won wasn't just any 
contest."`;
   You(Y4A112)`"The code she decrypted was a 68 bit strong 
code."`;
   Kid`"...I'm not really sure how incredible 
that is."`;
   You(Y4A113)`"The strength of a code depends on how long 
...
showTextbox();
text(() => {
   You(Y4A115)`"You still don't quite get it? Well, how 
...
showTextbox();
text(() => {
   You(Y4A116)`"So if a 1 bit password is encrypted, it can 
come out in one of two ways."`;
   You(Y4A117)`"For example, say that 'E' is the letter. 
That can either be encrypted as a 0 or a 1 
with a 1 bit key."`;
   You(Y4A118)`"So when this becomes a two bit key, the 
possibilities are double the code, or four."`;
   You(Y4A119)`"So for the example of 'E,' it would 
...
showTextbox();
text(() => {
   You(Y4A124)`"So a 3 bit key for the letter 'E' could be 
000, 001, 010, 011, 100, 101, 110, 111. 
A total of eight combinations."`;
   You(Y4A125)`"So every time the code key increases by one 
bit, the number of code patterns increases 
exponentially." `;
   You(Y4A126)`"So for a 4 bit key there would be 16 
...
Office calculator.`;
   You(Y4A129)`"So the number of code patterns would be 
possible is roughly 2.951479052 x 10 to 
the 20th power."`;
   You(Y4A130)`"Or 2 sextillion 9514 quadrillion 7905 
trillion 179 billion 352 million 825,856 
different ways."`;
   Kid`"......"`;
   You(Y4A131)`"It's like looking for a hair on the whole of 
the planet Earth - including the oceans."`;
   You(Y4A132)`"That's the code that Mayo decrypted."`;
   You(Y4A133)`"But you know what? What's so incredible 
about it is not that Mayo was able to do it, 
but the method she used to do it."`;
   Kid`"The method?"`;
   You(Y4A134)`"Yeah. There are two ways of finding a 
password. One involves difficult mathematical 
calculations..."`;
   You(Y4A135)`"The other is a method that has to do with 
trying every key."`;
   You(Y4A136)`"It seems like she couldn't find an algorithm 
to work for the first method..."`;
   You(Y4A137)`"So a normal person would opt for the second 
option."`;
   You(Y4A138)`"And that's using all of the computers around 
...
tens of thousands of years."`;
   ...
   You(Y4A141)`"Mayo put together her own algorithm and did 
it using difficult mathematical calculations."`;
   You(Y4A142)`"And just seven days after the competition 
...
showTextbox();
text(() => {
   Sara(Y4A144)`"Obviously not! Stop asking me about every 
little thing!"`;
   Kid`"........."`;
...
showTextbox();
text(() => {
   You(Y4A146)`"Hey, why don't we take a break? I made some 
coffee."`;
...
the ceiling.`;
   ...
   You(Y4A156)`"Wow, this is even tough for you Mayo, this 
...
showTextbox();
text(() => {
   Sara(Y4A157)`"To tell you the truth, the security here is 
way above normal."`;
   Sara(Y4A158)`"I don't think that they are using just a 
...
showTextbox();
text(() => {
   Sara(Y4A159)`"A firewall is a way of protecting a network 
from unknown intruders."`;
   Sara(Y4A160)`"Daemons reside on the OS in the memory. 
...
showTextbox();
text(() => {
   You(Y4A162)`"Well, when it gets that complicated, that's 
pretty much my limit..."`;
   You(Y4A163)`"I'm getting more and more suspicious about 
this database."`;
   You(Y4A164)`"I wonder what Leiblich is trying to hide with 
all this security?"`;
   Sara(Y4A165)`"Yeah...it's really strange. This isn't your 
...
showTextbox();
text(() => {
   You(Y4A166)`"Hey. Can't you use the program that worked 
to win that decoding contest, Mayo?"`;
   Kid`"Oh, that's an idea."`;
   You(Y4A167)`"And if we could figure out the root authority 
password..."`;
   Sara(Y4A168)`"That's impossible."`;
   You(Y4A169)`"Why?"`;
   Sara(Y4A170)`"I did a check on the code strength. Guess 
what it was."`;
   Kid`"What?"`;
   Sara(Y4A171)`"136 bit."`;
   Kid`"What?"`;
...
showTextbox();
text(() => {
   Sara(Y4A174)`"Even if you had what it took to get the 
...
showTextbox();
text(() => {
   Sara(Y4A178)`"Everything I tried up until has been cracking 
...
cracking, is there...?"`;
   ...
   Sara(Y4A180)`"Is what is a kind of cracking that doesn't 
...
showTextbox();
text(() => {
   Sara(Y4A182)`"Simply put, it is using social behavior to 
get information...For example..."`;
   `Sara stopped as if it were hard to say.`;
   Sara(Y4A183)`"For example, finding a person that works for 
...
text(() => {
   ...
   Sara(Y4A185)`"Of course, it's not something I want to do 
either."`;
   Sara(Y4A186)`"From Sora's perspective, she can't very well 
leak company information..."`;
   ...
   Sara(Y4A189)`"But if you are set on getting that 
...
to deceive someone to get information.`;
   ...
   You(Y4A191)`"A system's biggest bug is the people 
who use it...."`;
...
text(() => {
   ...
   You(Y4A193)`"In that way, maybe we are all bugs 
in LeMMIH's system." `;
   ...
   You(Y4A197)`"Even if I lose the chance to find out what 
happened to my dad."`;
   You(Y4A198)`"Mayo, I'm sorry for asking for such a 
...
showTextbox();
text(() => {
   Sara(Y4A200)`"Don't worry. No matter how stubborn the 
...
text(() => {
   ...
   Sora(Y4A202)`"There was some abnormal traffic on LeMMIH so 
...
than the Sora we were used to?`;
   ...
   Sara(Y4A205)`"Can't you tell by looking? We're trying to 
crack LeMMIH."`;
   `Sara answered coolly.`;
   Sora(Y4A206)`"Do you all know the meaning of what you are 
doing?"`;
...
her dad. She is looking for the truth."`;
   ...
   You(Y4A208)`"We aren't asking for your help. But please, 
...
do?"`;
   Sara(Y4A222)`"If Sora follows her current program, 
then she'll have to get in our way."`;
   Sara(Y4A223)`"But Sora doesn't want that."`;
   Sara(Y4A224)`"So I should just rewrite the program so 
...
text(() => {
   ...
   You(Y4A231)`"I don't want my selfishness to cause any more 
...
text(() => {
   ...
   Sara(Y4A233)`"This has something to do with everyone, 
not just you."`;
   You`"........."`;
...
showTextbox();
text(() => {
   Sora(S2C091)`"That you are not like everyone else, but 
wished you were."`;
...
text(() => {
   ...
   Sara(Y4A240)`"Alright then. Sorry, Sora, but I'm going 
...
text(() => {
   ...
   Sora(Y4A246)`"Unauthorized access to the autonomic nervous 
system confirmed."`;
   Kid`"Wh-what happened?"`;
   You(Y4A247)`"How am I supposed to know?"`;
   Sara(Y4A248)`"Dang. That sucks...it looks like I got 
snagged by the scan..."`;
   Kid`"What's that mean?"`;
   Sara(Y4A249)`"That the surveillance program that is 
...
text(() => {
   ...
   Sora(Y4A259)`"I will now implement elimination of the 
intruder."`;
...
text(() => {
   ...
   Sora(Y4A265)`"Sound is also being emitted from the room's 
speakers."`;
...
showTextbox();
text(() => {
   Sora(Y4A269)`"I am warning you. Remove yourself 
from LeMMIH."`;
...
text(() => {
   ...
   Sara(Y4A274)`"I have to do this...for Sora...for 
...
showTextbox();
text(() => {
   Sora(Y4A276)`"This is your final warning. Desist 
immediately."`;
   Sora(Y4A277)`"If you persist in your efforts, I can not 
guarantee your safety."`;
   Sara(Y4A278)`"There has to be a hole someplace in the 
security...!"`;
...
text(() => {
   Sora(Y4A279)`"S-Sara...!"`;
   Sara(Y4A280)`"Wh...what? I'm not giving up...no matter 
what...!"`;
   Sora(Y4A281)`"There is no...I will from now...release one 
segment of my security."`;
   Sora(Y4A282)`"Please aim for it...by sending in a massive 
load of data."`;
   Sara(Y4A283)`"You mean...cause an overload...?"`;
   Sora(Y4A284)`"Yes...that should...make my system out of 
control."`;
   Sora(Y4A285)`"I can't guarantee...the outcome...but it 
might create a gap long enough for you to 
rewrite the system."`;
   Sara(Y4A286)`"Okay...please do it!"`;
   Sora(Y4A287)`"With my power...I can only free it up for 
...
text(() => {
   ...
   Sora(Y4A305)`"Division by zero will be initiated according 
...
text(() => {
   ...
   Sora(Y4A308)`"I am...I am Sora Akanegasaki...a system
...
text(() => {
   ...
   Sora(Y4A309)`"I...will be your guide today during you visit 
to LeMU."`;
   Sora(Y4A310)`"I...guarantee your safety and the safety of 
everyone on LeMU."`;
...
text(() => {
   ...
   Sara(Y4A315)`"Don't lose yourself! You are Sora! You are
...
text(() => {
   ...
   Sora(Y4A318)`"Unanticipated orders are attempting to be 
implemented."`;
...
overloading LeMMIH.`;
   ...
   Sora(Y4A322)`"Do it now! If you strike now, you can 
rewrite the system!"`;
   Sora(Y4A323)`"A fatal...system error...has occurred..."`;
   Sora(Y4A324)`"Data may 
be...damaged...Immediately... 
initiate...rebuilding..."`;
   Sora(Y4A325)`"In 30 seconds...the emergency reset...will 
initiate."`;
   Sora(Y4A326)`"Hurry! LeMMIH is resetting the system 
to rebuild it."`;
...
text(() => {
   ...
   Sora(Y4A342)`"And Takeshi and Tsugumi, although they of 
...
text(() => {
   Sora(Y4A344)`"Yes."`;
   Sara(Y4A345)`"Hey, Sora. I would like to investigate 
...
text(() => {
   ...
   Sara(Y4A348)`"I just added a patch that changes the 
priority duties."`;
   Sora(Y4A349)`"That is correct. My processing routine 
has not been altered."`;
   Sora(Y4A350)`"However, now my duty to serve you is higher 
...
stop us?"`;
   ...
   Sora(Y4A352)`"And if it will be of use to you, then 
...
showTextbox();
text(() => {
   Sara(Y4A353)`"Now then, shall we jump right into the 
search?"`;
...
text(() => {
   ...
   Sara(Y4A358)`"You can't choose what you have to do to get 
...
text(() => {
   ...
   You(Y4A362)`"What are you talking about? You are the one 
that persuaded Sara to help, right?"`;
   Sora(Y4A363)`"And my decision was based on your words of 
wisdom."`;
   `'You told me that you all hoped for the same 
thing.'`;
   Sora(Y4A364)`"It was your advice that helped me to make 
up my mind."`;
...
showTextbox();
text(() => {
   Sora(Y4A368)`"I can only tell you what I was able to learn, 
but..."`;
...
suitable for light talk or jokes.`;
   ...
   Sora(Y4A376)`"That your father, Yoichi Tanaka, has already 
died."`;
...
text(() => {
   ...
   You(Y4A383)`"How could anything as ridiculous as my father 
dying 34 years ago...?"`;
...
match the facts."`;
   ...
   Sora(Y4A386)`"I am merely saying that there is the 
possibility."`;
...
text(() => {
   You`"........."`;
   Sora(Y4A387)`"First I tried to search for information on 
You's father."`;
   Sora(Y4A388)`"However, there were no files pertaining to 
Yoichi Tanaka recorded in LeMU's database."`;
   Sora(Y4A389)`"In other words, there are no records that 
anyone by that name existed."`;
   Kid`"So are you saying...that You's father wasn't 
here?"`;
   You(Y4A390)`"It...it can't be..."`;
   Sara(Y4A391)`"But that is only based on limited information 
...
text(() => {
   ...
   Sora(Y4A394)`"I am not permitted to access high-security 
data."`;
   Sara(Y4A395)`"So records about Yoichi Tanaka might be 
there."`;
   `Sora continued, responding to Sara's question.`;
   Sora(Y4A396)`"That is a possibility that I can't deny."`;
   Sora(Y4A397)`"However, there is no such name on company 
name lists, accounting records or any of the 
message logs exchanged on the local area 
network..."`;
   Sora(Y4A398)`"As far as these are concerned, no record of 
...
text(() => {
   ...
   You(Y4A402)`"Even if he wasn't here...that doesn't mean 
...
text(() => {
   `Bang!`;
   You(Y4A404)`"No it's not 'correct!' Tell me why you 
reached that theory!"`;
...
getting carried away by her emotions.`;
   ...
   You(Y4A408)`"?"`;
   Sora(Y4A409)`"This may sound rude, but...where did you hear 
...
text(() => {
   You(Y4A410)`"I..."`;
   Sora(Y4A411)`"That your father disappeared when you were a 
one-year-old."`;
   Sora(Y4A412)`"If that is a fact, then you should have no 
memories of your father..."`;
   ...
   You(Y4A416)`"I don't remember playing together, or him 
holding me..."`;
...
showTextbox();
text(() => {
   You(Y4A417)`"But I'm sure that he as around until 
I was one."`;
   You(Y4A418)`"There are pictures and films of that time. 
...
text(() => {
   ...
   You(Y4A427)`"It might be difficult...but you have 
...
text(() => {
   ...
   Sora(Y4A439)`"I will display the detailed documents on the 
screen."`;
...
text(() => {
   ...
   Sora(Y4A446)`"As I said before, when I searched the 
database for the name Yoichi Tanaka, the data 
which I can access had no records."`;
   Sora(Y4A447)`"However, the chat log that appears to be 
15 years old..."`;
   Sora(Y4A448)`"It seems to indicate that Yukie Tanaka had a 
husband named Yöichi."`;
   Sora(Y4A449)`"Judging from the context of the document...I 
...
any of the other data. Why is it only here?"`;
   Sora(Y4A450)`"I can only speculate from my limited 
knowledge..."`;
   Sora(Y4A451)`"All records related to Yoichi Tanaka were 
erased for a reason."`;
   Sora(Y4A452)`"Please read the 14th and 15th line of this 
log one more time."`;
   `-A > What? Oh, you mean you didn't know?`;
   `-B > Is that so?`;
   Kid`"The flow of the conversation seems unnatural."`;
   Sora(Y4A453)`"Yes."`;
   Sora(Y4A454)`"Originally there seems to have been some text 
between these lines."`;
...
they were in English."`;
   ...
   Kid`"What?"`;
   Sora(Y4A457)`"The person that did the search would not 
be so foolish."`;
   Sora(Y4A458)`"It would appear that the name 'Yoichi' in 
English was also searched for and erased."`;
   Kid`"But what about this one?"`;
   Sora(Y4A459)`"Kid, look very closely at B's comments."`;
   Sora(Y4A460)`"Didn't she use a way of rendering the name 
that is uncommon."`;
   `- B > But Yöichi died 19 years ago, right?`;
   Kid`"Oh! The...'o' has a 'ö' in it...?"`;
   Sora(Y4A461)`"Yes. This is called an umlaut and is used 
mainly in German..."`;
   Sora(Y4A462)`"When a 'a', 'u' or 'o' vowel is followed by 
...
erasing all of them."`;
   Sora(Y4A463)`"However, B's comments were overlooked for 
some reason."`;
...
text(() => {
   Sora(Y4A464)`"Correct."`;
   Sora(Y4A465)`"So I tried to look for other similar comments 
by B."`;
   Sora(Y4A466)`"It appears that Ms. B had a habit of using of 
using abbreviated words ..."`;
   Sora(Y4A467)`"...and spelling words in her own way in her 
communications with friends."`;
   Kid`"It seems to be a style particular to her."`;
   Sora(Y4A468)`"There are numerous examples of her writing 
...
kinda worried about her."`;
   Sora(Y4A470)`"I wonder if I shouldn't have told her 
after all..."`;
...
showTextbox();
text(() => {
   Sora(Y4A472)`"Don't you think you best go see how she is 
doing?"`;
   Kid`"Yeah. I will."`;
   Sora(Y4A473)`"And I will get back to the work that I was 
in the middle of."`;
...
showTextbox();
text(() => {
   Sora(Y4A476)`"If that makes everyone happy, then I know no 
greater joy."`;
