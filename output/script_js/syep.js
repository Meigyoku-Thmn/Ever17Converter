...
showTextbox();
text(() => {
   marker; sound(`YEP050`); appendText; 
   //Dr. Tanaka
   Dr_Tanaka`"I can say this for certain now..."`;
   waitForClick; clearText; marker; sound(`YEP051`); appendText; 
   //Dr. Tanaka
   Dr_Tanaka`"I am...your..."`;
   waitForClick; clearText; marker; sound(`YEP052`); appendText; 
   //Dr. Tanaka
...
fadeOutMonoColorOverlay();
unSkippableDelay(3);
varop(`(28 0a a4) 14 := (00) 1`);
unlockCG($`POST08`);
unlockCG($`POST13`);
varop(`(28 0a a4) 25 := (00) 1`);
goto(lbl_00000381).if(var_17 == 0);
unlockCG($`POST02`);
let lbl_00000381;
