...
text(() => {
   ...
   `No matter how many times I checked, the number stayed the same.`;
   `It was probably like You said - the sensor was just malfunctioning.`;

});
fgload({ id: 2, name: `KB08ADM`, x: 512, useAnim: true });
showTextbox();
text(() => {
   Takeshi(C1S114)`"Well, either way, it is something we can check by walking around the complex, right?"`;
...
showTextbox();
text(() => {
   Sora(C1S133)`"Actually your disbelief is really quite a compliment."`;
...
showTextbox();
text(() => {
   `Looking scared, Sara reached her right hand out toward Sora.`;
   `Her arm met no resistance as it plunged into Sora's body.`;
...
showTextbox();
text(() => {
   `Takeshi and Sara froze, immobile like they were cutout pictures.`;
   Kid`"Hey. You got it, right?"`;
   Kid`"So Sora isn't detected by the bio scan sensors."`;
...
text(() => {
   ...
   You(C1S139)`"Sora shouldn't be counted by the bio scan sensors so this number... '6' can't be the right number."`;
   Kid`"I told you so."`;
   Kid`"So that means that somebody else is here besides us."`;
...
text(() => {
   ...
   Kid`"???"`;
   You(C1S142)`"By 'can't be the right number,' I mean that there is some kind of malfunction."`;
...
showTextbox();
text(() => {
   You(C1S145)`"The first time we looked, it was saying seven, too."`;
   You(C1S146)`"Then it would jump between five, and six and seven."`;
...
showTextbox();
text(() => {
   You(C1S148)`"Even if, like you say, there were other people that didn't get out of here in time..."`;
...
text(() => {
   You(C1S150)`"See."`;
   Kid`"But if somebody else were here, what would you do?"`;
   Kid`"Why don't we just search, and if we don't find anyone then we can call it quits."`;
   Kid`"I don't see any reason that you could have against searching."`;
...
text(() => {
   ...
   You(C1S152)`"But this is just a computer glitch and I don't think we should let it go controlling us and making us all upset."`;
...
text(() => {
   ...
   You(C1S155)`"Alright, shall we go search for this 'someone'?"`;
   `I gave a big nod.`;
...
showTextbox();
text(() => {
   You(C1S158)`"The reason we all came here was to find out where Tsugumi went."`;
...
text(() => {
   Sora(C1S159)`"Correct."`;
   Sora(C1S160)`"So wouldn't it be logical to search LeMU while we determine the location of Tsugumi?"`;
...
text(() => {
   ...
   `I imagined they still couldn't quite swallow the idea that Sora was an image.`;
   `The two were frozen stiff with their eyes completely absorbed by Sora.`;
   Kid`"What are you doing? Hurry up! Let's get going!"`;
   `I tugged Sara and Takeshi by the arm, leading them from the control room.`;
...
showTextbox();
text(() => {
   `We climbed the emergency stairs, aiming for the floor that Tsugumi was on.`;
   `Only Sora remained in the control room, thinking of ways to escape, establishing communications, rechecking the complex and trying to get the malfunctioning systems back on-line.`;
...
showTextbox();
text(() => {
   Takeshi(C1S165)`"Hey, that surprised the heck outta me... Sora being AI."`;
   Sara(C1S166)`"I know, it's crazy to think that she's only an image."`;
   Sara(C1S167)`"I mean...she said something about a laser projected on to the retina or something..."`;
   `Takeshi and Sara were as excited as two kids experiencing Halloween for the first time.`;

});
fgload({ id: 2, name: `KB01ADM`, x: 512, useAnim: true });
showTextbox();
text(() => {
   Takeshi(C1S168)`"But You knew, right? That Sora is RSD-generated."`;
...
showTextbox();
text(() => {
   You(C1S173)`"Sora herself didn't say anything about being AI or RSD, right?"`;
   You(C1S174)`"The fact that she has been quiet about it tells me she probably wanted to keep it a secret from everybody."`;

});
fgload({ id: 1, name: `YU05BDM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   You(C1S175)`"If she didn't, than she would have told you all about it long ago. Don't you think?"`;
...
showTextbox();
text(() => {
   You(C1S177)`"I didn't think I should be the one to tell you."`;
...
text(() => {
   You(C1S180)`"What?"`;
   Kid`"You said that Sora wanted to keep all of the AI and RSD stuff a secret, right?"`;
...
showTextbox();
text(() => {
   Sora(C1S183)`"It is something that I thought that I needed to tell you..."`;

});
fgload({ id: 1, name: `YU07BDM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Sora(C1S184)`"Besides, it is not something that I was desperately trying to hide."`;
...
showTextbox();
text(() => {
   Sara(C1S187)`"So how did the Kid know about Sora's identity?"`;
...
text(() => {
   Kid`"...Uh...I...?"`;
   Sora(C1S188)`"Kid, you should not have any memories from before you fell into the pond, correct?"`;
   Kid`"Uh, yeah..."`;
...
showTextbox();
text(() => {
   Takeshi(C1S189)`"So that means that somebody must've told you about Sora after that."`;
   Kid`"No one...told...me..."`;
...
text(() => {
   `(Not again...)`;
   `I thought about it.`;
   `It was the same as the time I had blurted out Sara's name.`;
   `I knew something that there was no way I could know.`;
   `The fact that Sora was an RSD image.`;
   `When, where, why, from whom and how could I have heard that...?`;
   `It was like one memory had broken free from the frozen iceberg of my past...`;
...
text(() => {
   ...
   Sara(C1S192)`"And it's not just this...the Kid knew my name, too."`;
...
showTextbox();
text(() => {
   Sara(C1S195)`"What was it he had? Life amnesia or something?"`;

});
fgload({ id: 1, name: `SA05ADM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Sara(C1S196)`"That has to do only with the loss of memories that are directly related to the person, right?"`;
...
showTextbox();
text(() => {
   Takeshi(C1S200)`"But...maybe it's just the opposite. Maybe he needs it."`;
   Takeshi(C1S201)`"I mean...he found the cut-off point of his memory."`;
   Takeshi(C1S202)`"Maybe if he doesn't try to pull stuff back from the other side it'll disappear for good."`;
...
text(() => {
   ...
   Sora(C1S206)`"There is no one here with specialty knowledge of this disorder nor capable of counseling."`;

});
fgload({ id: 1, name: `SO03ADM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Sora(C1S207)`"In other words...if the Kid's condition were to worsen, there is nothing we could do to help him."`;
...
text(() => {
   ...
   You(C1S209)`"He can still get his memory back after we get out of here."`;
   `Sara and Takeshi didn't looked satisfied.`;
   `Maybe I had gotten used to this kind of thing. My head didn't hurt and I didn't feel confused.`;
   `But I was terribly tired.`;
   `I was absolutely beat and there was no way I was getting any closer to my memory.`;
   `My memory was like a lone island shrouded in a fog.`;
...
showTextbox();
text(() => {
   Sara(C1S210)`"Well, if that's what you think... then that's fine."`;

});
fgload({ id: 1, name: `SA05ADM`, x: 128, useAnim: true });
showTextbox();
text(() => {
   Sara(C1S211)`"Besides...we've got things to find before his memory."`;
...
showTextbox();
text(() => {
   Tsugumi(C1S218)`"I was trying to find out what you are plotting."`;
...
text(() => {
   ...
   You(C1S222)`"Then she'll realize that we are not scheming anything."`;
   Tsugumi`"........."`;
...
showTextbox();
text(() => {
   Sara(C1S223)`"Tsugumi, what is it you are so suspicious about?"`;
...
text(() => {
   ...
   Tsugumi(C1S235)`"You came here on a field trip or something, right?"`;
...
showTextbox();
text(() => {
   Sora(C1S237)`"It would also seem that You, Takeshi, the Kid, and everyone also failed to escape 'by chance.'"`;
...
showTextbox();
text(() => {
   Tsugumi(C1S239)`"There is no way that something like this could occur by chance."`;
...
text(() => {
   ...
   Tsugumi(C1S240)`"Everything! Everything that is happening here!"`;
   Kid`"So, you're saying that the accident and all didn't happen by chance?"`;
...
showTextbox();
text(() => {
   You(C1S251)`"Nobody knows the Kid's age...but he's definitely younger than me."`;
   You(C1S252)`"You think the three of us could cause this kind of massive accident?"`;
...
showTextbox();
text(() => {
   Tsugumi(C1S253)`"Well, with just the three of you it might be impossible."`;
   Tsugumi(C1S254)`"But..."`;
...
text(() => {
   ...
   Tsugumi(C1S260)`"The only one that could do whatever they wanted with the LeMU system is you, Sora."`;
...
showTextbox();
text(() => {
   Tsugumi(C1S263)`"I've already told you, I'm not saying this has anything to do with you Sara."`;
   Sara(C1S264)`"Of course it has to do with me!"`;
   Sara(C1S265)`"Everybody that is here right now is working together to get out of here!"`;
...
showTextbox();
text(() => {
   Sara(C1S268)`"Anyway, I want you to quit spouting out these crazy ideas to everyone."`;
...
text(() => {
   ...
   `Everyone scanned each other's faces trying to gauge what the others were thinking.`;
...
showTextbox();
text(() => {
   `Tsugumi left the Security Office with her eyes down.`;
...
showTextbox();
text(() => {
   `You and Sara dashed out of the room after Tsugumi.`;
   `That left Sora, Takeshi and I.`;
   `Again silence enveloped us.`;
   `We tried to get rid of the awkwardness by staring at the monitors, picking our nails and fiddling with the lint on our clothes.`;
...
text(() => {
   ...
   Sora(C1S274)`"As soon as I learn anything, I will contact everyone..."`;

});
removeFG({ id: 1, useAnim: true });
showTextbox();
text(() => {
   `Sora left Takeshi and I, leaving us with those words.`;
...
text(() => {
   ...
   Kid`"I think the same thing would just happen again..."`;
...
text(() => {
   ...
   Kid`"Yeah. We still haven't figured out the problem with the life scan number."`;
   Takeshi(C1S280)`"You mean that mystery somebody, the one who didn't escape?"`;
   Kid`"Yeah. So let's check around LeMU one more time..."`;
...
text(() => {
   ...
   Takeshi(C1S282)`"I could take the bottom floor and you could take Zweite stock..."`;
   Kid`"Sounds good."`;
...
text(() => {
   ...
   `Glancing at the door of the Security Office, I saw that it was open.`;
...
text(() => {
   ...
   `I was betting that Sora might be monitoring me from the Control Room.`;
   `But it didn't pan out...`;
   `The speakers in the ceiling remained painfully silent.`;
