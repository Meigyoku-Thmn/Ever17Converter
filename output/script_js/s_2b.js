...
tools.`;
   `When the four of us ascended from Zweite stock 
we stopped by the warehouse first.`;
   `Fortunately, we found the tools we needed 
right away.`;
   `Pliers, a spanner, a screwdriver, hammer, 
...
showTextbox();
text(() => {
   `You pulled the operating lever next to the 
door.`;
   Kid`"........."`;
   Takeshi`"........."`;
   Sara`"..."`;
...
showTextbox();
text(() => {
   You(S2B002)`"No. The EI elevator is a neutral buoyancy 
elevator so it basically doesn't require 
outside power."`;
   You(S2B003)`"But it does need power for the intake and 
...
showTextbox();
text(() => {
   Takeshi(S2B006)`"Oh, great. So that means we can't move this 
thing at all then!"`;
...
showTextbox();
text(() => {
   You(S2B007)`"Stupid. That's wrong. And you're supposed to 
...
showTextbox();
text(() => {
   Takeshi(S2B008)`"Well, excuse me! So put it in terms I can 
understand."`;
...
showTextbox();
text(() => {
   Sara(S2B011)`"In order to use buoyancy to rise or sink, 
...
showTextbox();
text(() => {
   You(S2B015)`"Well, the Kid's lost his memory so it's to be 
expected."`;
...
showTextbox();
text(() => {
   Sara(S2B018)`"Archimedes principle states that the buoyant 
force on a submerged object is equal to the 
weight of the liquid displaced by the object."`;
   Sara(S2B019)`"That means that right now the buoyancy of the 
elevator is exactly balanced with the 
elevator's weight."`;
   Sara(S2B020)`"So if we make the elevator heavier, it will 
...
showTextbox();
text(() => {
   `We split up and went in search of thing we 
...
text(() => {
   ...
   Sara(S2B032)`"I guess it probably washed out from the 
...
bulkhead appeared to move further away upward.`;
   ...
   You(S2B034)`"Hey, wasn't catching dolphins for food banned 
under some international treaty?"`;
   `It seemed that You was having trouble with the 
...
showTextbox();
text(() => {
   `Dritte stock Sector 7 was another area sealed 
...
showTextbox();
text(() => {
   You(S2B035)`"No problem. There is one more EI. I checked 
...
showTextbox();
text(() => {
   Takeshi(S2B036)`"HA,HA,HA.... If there wasn't another one, 
...
showTextbox();
text(() => {
   Sara(S2B037)`"You sure? You seemed pretty petrified with 
fear yourself." `;
...
showTextbox();
text(() => {
   You(S2B039)`"Alright, alright...enough of that. Let's get 
going."`;
...
showTextbox();
text(() => {
   You(S2B041)`"What are you doing? Hurry up. No dawdling or 
we'll leave you behind."`;
   Takeshi(S2B042)`"I'll show you dawdling! This toolbox weighs 
a ton!"`;
...
showTextbox();
text(() => {
   Takeshi(S2B045)`"Whew! Thanks. I thought my arms would fall 
...
showTextbox();
text(() => {
   Takeshi(S2B047)`"Whew. That surprised the bejeezers outta 
me... I just about fell down..."`;
   Takeshi(S2B048)`"Glad you noticed that, Kid. It being so dark 
...
showTextbox();
text(() => {
   Takeshi(S2B050)`"What is it that causes that? Lack of vitamin 
...
showTextbox();
text(() => {
   `Finally as we caught up with You and Sara we 
...
text(() => {
   ...
   `I took my hand from You's arm and searched 
for words.`;
   `At that moment...`;
...
text(() => {
   ...
   Sara(S2B059)`"If a pipe carrying hot water burst, then the 
...
me feel out of place in my own skin.`;
   Sara(S2B063)`"Anyway, with things as they stand, there's no 
going inside."`;
...
text(() => {
   You(S2B065)`"I'll say..."`;
   You(S2B066)`"First off let's close off all valves for 
pipes sending hot water to the Generator Room."`;
   You(S2B067)`"If we stop the flow of hot water, then steam 
...
showTextbox();
text(() => {
   You(S2B069)`"In the room next door. Down one more corridor 
that way."`;
   You(S2B070)`"It won't require that many people...just me 
...
showTextbox();
text(() => {
   You(S2B074)`"It's just...that if we were alone I'm afraid 
you'll do something."`;
...
showTextbox();
text(() => {
   Takeshi(S2B079)`"Okay. In that case, Sara and I will hold down 
the fort here."`;
...
showTextbox();
text(() => {
   Takeshi(S2B083)`"You think so? That's a pretty generous 
interpretation, I'd say."`;
   Takeshi(S2B084)`"Oh well. In that case, I guess Sara and 
...
showTextbox();
text(() => {
   Sara(S2B089)`"It means, if you value your life, you'd 
better stay back!"`;
...
text(() => {
   ...
   You(S2B092)`"Yesterday? You mean the seventh survivor you 
said you saw?"`;
   Kid`"Yeah."`;
...
showTextbox();
text(() => {
   You(S2B093)`"You're sure your eyes weren't playing tricks 
on you?"`;
...
showTextbox();
text(() => {
   You(S2B095)`"I'm kidding...it's a joke. Why do you always 
...
showTextbox();
text(() => {
   You(S2B096)`"Alright, alright.... I'll listen to your 
...
text(() => {
   ...
   You(S2B101)`"Oh well...then I'll have to make do with 
Takeshi."`;
...
showTextbox();
text(() => {
   Takeshi(S2B102)`"Geez. You're a piece of work. Can't you let 
...
showTextbox();
text(() => {
   You(S2B103)`"Don't be getting any strange ideas. You do 
...
showTextbox();
text(() => {
   Takeshi(S2B104)`"...Take it easy. There's no way I'd try 
...
showTextbox();
text(() => {
   Sara(S2B106)`"I don't know, I think they make a pretty good 
couple, don't you?"`;
   Kid`"Think so?"`;
   Sara(S2B107)`"Yeah. Nakkyu is the kind of person who tells 
...
showTextbox();
text(() => {
   Sara(S2B109)`"Where did that come from...? I thought 
I told you?"`;
...
showTextbox();
text(() => {
   Sara(S2B110)`"I'm a junior. I'm 16 and was born January 21. 
...
showTextbox();
text(() => {
   Sara(S2B115)`"Well, maybe it was something that you wanted 
to forget about......"`;
   Kid`"........."`;
...
showTextbox();
text(() => {
   Sara(S2B118)`"I know. Maybe if I chopped you down, we'd 
find out how old you are."`;
   Kid`"Huh?"`;
   Sara(S2B119)`"You know, maybe you've got rings like a tree 
stump."`;
...
showTextbox();
text(() => {
   `With this we would be able to shut off the 
...
opened the door.`;
   `It was like opening the door to a steam bath - 
...
text(() => {
   ...
   You(S2B127)`"Stop pointing out the obvious! Talking about 
...
showTextbox();
text(() => {
   Sara(S2B128)`"Nakkyu...let's just do what we have to do and 
get out of here."`;
...
showTextbox();
text(() => {
   You(S2B129)`"Alright. Let's divide up what we have to do 
...
showTextbox();
text(() => {
   You(S2B130)`"I'll be here. Takeshi, can I get you to go 
...
valves as instructed.`;
   `After this and that, we succeeded in repairing 
the generator.`;
...
side of the generator.`;
   `You was doing battle with the machine and 
depending on my flashlight wielding skills. `;
   `With nothing much to do, my mind started 
wandering.`;
...
showTextbox();
text(() => {
   `You gave me a fed up look, shook her head and 
went back to work.`;
...
sudden."`;
   ...
   You(S2B135)`"No."`;
   You(S2B136)`"If you were talking about something serious, 
I would take you serious."`;
   You(S2B137)`"But I'm not listening seriously to something 
like this. Stupidity is contagious."`;
   You(S2B138)`"It's like multiplication of plusses and 
minuses..."`;
   You(S2B139)`"A plus times a plus is a plus."`;
   You(S2B140)`"But a minus times a plus is a minus..."`;
   You(S2B141)`"So, pass me that minus-like screwdriver, 
would you?"`;
...
showTextbox();
text(() => {
   You(S2B144)`"Alright, then. I'll listen to the stupid 
...
screwing in these screws."`;
   ...
   You(S2B146)`"Hold on. Now, do you really believe in 
ghosts?"`;
   Kid`"I wouldn't say believe. But believe in the 
possibility..."`;
   You(S2B147)`"Zero. That is what possibility there is. 
...
text(() => {
   ...
   You(S2B148)`"Listen. Ghost stories now and forever are 
almost all made up."`;
   You(S2B149)`"They are just fiction with the goal of 
entertaining people."`;
...
behind..."`;
   ...
   You(S2B153)`"A product of an overzealous mind. An illusion 
spawned by the mental state of the person."`;
   ...
   You(S2B155)`"UFOs and goblins are the same thing. People 
like to imagine stuff."`;
   You(S2B156)`"Thanks to the power of imagination, people 
have been able to evolve to where we are, but 
it's kind of a curse, too."`;
   You(S2B157)`"Taken to extremes, there is no distinguishing 
between reality and illusions."`;
   Kid`"........."`;
   You(S2B158)`"When you turn on the lights, the ghost is 
only a shirt on a chair."`;
   You(S2B159)`"People who want to be scared see what they 
want."`;
   You(S2B160)`"If you really want to believe that something 
exists, even if it doesn't, then you still 
feel that it does."`;
   You(S2B161)`"If you are scared of something, you'll scare 
...
that?"`;
   ...
   You(S2B163)`"They probably can't move because somebody 
tied them up when they were asleep."`;
   Kid`"Who?"`;
   You(S2B164)`"Some S&M freak."`;
   Kid`"As if that could happen!"`;
   You(S2B165)`"I'm kidding..."`;
   You(S2B166)`"You're talking about when your body is still 
asleep, but your mind is awake."`;
   You(S2B167)`"So that even though you're conscious, your 
body won't move."`;
   Kid`"What about the people that say they wake up 
and saw a ghost on top of them?"`;
   You(S2B168)`"They think their eyes are open, but it's 
really just a dream."`;
   You(S2B169)`"Because the brain is fully awake and the 
body won't do what it's told, a person feels 
fear. These two things happen at the same 
time..."`;
   You(S2B170)`"So even the most incredible dream seems like 
reality."`;
   Kid`"........."`;
   You(S2B171)`"I just told you, right? If you really, really 
...
text(() => {
   ...
   You(S2B173)`"Don't go telling me you have special powers 
...
text(() => {
   ...
   You(S2B176)`"But no spinning your head around 360 degrees 
or spewing out ectoplasmic goo. Alright?"`;
   You(S2B177)`"And no supernatural tricks or channeling 
spirits either."`;
   You(S2B178)`"Because if a poltergeist gets loose around 
here, the screws I just put in could fall out."`;
   Kid`"For not believing this stuff, you sure know a 
lot about it."`;
   You(S2B179)`"It's because I don't believe in it, that 
I know a lot."`;
   You(S2B180)`"My knowledge is not for defensive purposes."`;
   You(S2B181)`"It's for offensive ones."`;
   Kid`"Huh?"`;
   You(S2B182)`"I mean, there are those people that swear by 
ghosts, the supernatural, UFOs and that occult 
stuff. They're completely loony."`;
   You(S2B183)`"My knowledge is so I can take them down, when 
I meet them."`;
   You(S2B184)`"I've stocked up on enemy information for 
my verbal assaults."`;
...
stuff, right?"`;
   ...
   You(S2B187)`"I'm not doing anything that big. I'm still a 
freshmen so I'm only taking basic stuff."`;
   You(S2B188)`"I just listen to professors lecture and go on 
...
name."`;
   You(S2B189)`"Have I heard of it?.... I know so much about 
it that it makes me nuts."`;
   Kid`"??"`;
   You(S2B190)`"Lemuria is the phantom continent that is said 
...
the bottom of the ocean."`;
   `You recited it off so fluently that it 
...
this continent was the origin of mankind."`;
   You(S2B193)`"But what could they be talking about? 
...
text(() => {
   ...
   You(S2B197)`"Religion is like that, too. Any and all those 
mysterious things that people get all worked 
up about. They're mostly all make believe."`;
   You(S2B198)`"'They're all impossible to prove, so who 
...
showTextbox();
text(() => {
   You(S2B200)`"Ohhhh. I'm beat...my shoulders are stiff and 
everything."`;
   `You twisted and stretched. Her back popped 
loudly.`;
...
showTextbox();
text(() => {
   You(S2B202)`"Kid...you're not one of those people that get 
...
showTextbox();
text(() => {
   You(S2B204)`"This is bad. DANGER, DANGER! I'm putting 
...
showTextbox();
text(() => {
   You(S2B207)`"Okay, okay. I see what you're saying. You are 
saying that it was like the Tower of Babel, 
right?"`;
   Kid`"Tower of Babel?"`;
   You(S2B208)`"In the old testament, in Genesis there is 
this story about this tower."`;
   You(S2B209)`"In it, people are so proud of their 
...
reached to heaven."`;
   ...
   You(S2B211)`"God said, 'I will bring down their pride 
together with the trickery of their hands. 
They are impudent.'"`;
   You(S2B212)`"So God took it upon himself to destroy the 
...
showTextbox();
text(() => {
   You(S2B214)`"That would have to be the work of a God like 
Shiva."`;
   Kid`"Shiva?"`;
   You(S2B215)`"The God of destruction and creation."`;
   You(S2B216)`"One of the main three Hindu gods. He has 
more than a thousand names, four arms, four 
faces and three eyes."`;
   You(S2B217)`"He destroys the world for purposes of 
creation..."`;
   You(S2B218)`"The destruction is so thorough that in it is 
...
text(() => {
   ...
   You(S2B220)`"So if Lemuria had pissed off a god enough to 
...
showTextbox();
text(() => {
   You(S2B221)`"Look! You're slowing down. Hurry up and 
finish up."`;
...
showTextbox();
text(() => {
   `When You pointed the flashlight near me, I saw 
...
text(() => {
   ...
   You(S2B225)`"The light from that third eye burns all in 
...
showTextbox();
text(() => {
   You(S2B226)`"You'd have to buy another lens so the 
...
showTextbox();
text(() => {
   You(S2B228)`"But the idea of a third eye is not limited to 
...
text(() => {
   ...
   `You lifted up her bangs and placed her 
...
text(() => {
   ...
   You(S2B242)`"Who else would take that completely 
...
showTextbox();
text(() => {
   You(S2B243)`"Sorry! Oh, I'm sorry! But you keep saying one 
...
showTextbox();
text(() => {
   You(S2B244)`"Besides...what I said wasn't really a lie 
anyway."`;
...
text(() => {
   `Actually...`;
   `The animal ancestors of vertebrates had 
three eyes.`;
   `Early species of primitive reptiles...`;
   `Like the tuatara lizard that still has a 
...
showTextbox();
text(() => {
   `...that was essentially the rundown that You 
gave me as I was tightening the bolts.`;
   You(S2B245)`"So the third eye in terms of human anatomical 
science is really no big deal."`;
   You(S2B246)`"It's just an organ we lost through 
evolution..."`;
...
showTextbox();
text(() => {
   You(S2B251)`"Well...it's not really for offensive or 
defensive use."`;
...
text(() => {
   ...
   You(S2B258)`"Apparently she's an expert in the ancient 
...
text(() => {
   ...
   `You's shoulders slumped and she let go a deep 
sigh again.`;
...
showTextbox();
text(() => {
   Takeshi(S2B276)`"Hey! What're you doing? We still have 34 
seconds to go!"`;
   Kid`"Nobody wants to wait 34 seconds. Somebody had 
to push it!"`;
   Takeshi(S2B277)`"You guys can't even wait a little more than 
a simple 30 seconds?"`;
...
showTextbox();
text(() => {
   Takeshi(S2B279)`"This...this is kind of like, 
...
text(() => {
   Takeshi(S2B281)`"What?"`;
   Sara(S2B282)`"The lights came on with 17 seconds left in 
the countdown."`;
...
showTextbox();
text(() => {
   Sara(S2B284)`"You don't understand? The power came back on 
...
showTextbox();
text(() => {
   You(S2B293)`"Why do we keep running into problem after 
problem..."`;
...
showTextbox();
text(() => {
   Takeshi(S2B295)`"Sora! Where have you been? We looked 
everywhere for you!"`;
   Sora(S2B296)`"I'm terribly sorry. Please accept 
my apologies."`;
...
showTextbox();
text(() => {
   Takeshi(S2B301)`"I think you know this, but we are in this 
egg...uh, this EI..."`;
...
text(() => {
   ...
   Sora(S2B306)`"It is likely the result of a decrease in 
...
text(() => {
   Sora(S2B308)`"Correct."`;
   Sora(S2B309)`"There are a number of feasible methods for 
making it rise, but..."`;
...
text(() => {
   Tsugumi`"........."`;
   `I noticed that when Tsugumi saw You cradling 
...
showTextbox();
text(() => {
   You(S2B314)`"Of course. It's food after all. Waste not, 
want not, right?"`;
...
showTextbox();
text(() => {
   Sora(S2B315)`"Forget that for now...more 
importantly...Takeshi..."`;
...
showTextbox();
text(() => {
   Sora(S2B316)`"This is all my fault.... Oh my gosh! 
What can I do?"`;
...
showTextbox();
text(() => {
   Takeshi(S2B319)`"I think the question is more what should I 
do."`;
