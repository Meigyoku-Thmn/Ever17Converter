...
text(() => {
   ...
   Kid`"I'd wake up even if I were asleep with you shaking me that hard."`;
...
showTextbox();
text(() => {
   Kid`"Last night you seemed like you were sleeping FINE!"`;
   Takeshi(C2S257)`"But I'm all alone in this tiny little cramped space."`;
   Takeshi(C2S258)`"It's like being cooped up in a coffin. It makes me feel..."`;
   Kid`"It's the same place you were snoring away last night!"`;
   Kid`"You could sleep in a coffin. You could sleep in a cup of coffee."`;
...
text(() => {
   ...
   Takeshi(C2S261)`"'Coffee has caffeine in it. That wakes you up.'"`;
   Takeshi(C2S262)`"'So there's no way a normal person could catch a wink in a cup of coffee...'"`;
   Takeshi(C2S263)`"'But...caffeine wouldn't phase a big lunk like that Takeshi. He'd sleep like a baby.'"`;
   Takeshi(C2S264)`"Is that what you are trying to say with that almost rhyme of yours?"`;
   Kid`"Stupid."`;
...
text(() => {
   ...
   `She sat upright, a strange light emanating from her.`;
...
showTextbox();
text(() => {
   `I walked out of the room with Takeshi's hand pushing me from behind.`;
...
showTextbox();
text(() => {
   Takeshi(C2S275)`"Hey, for now...why don't we hit the kiosk and get some beers." `;
...
text(() => {
   ...
   Takeshi(C2S276)`"Uh, I don't think it was for sale, but it was stashed in the back of the fridge."`;
...
text(() => {
   ...
   Kid`"Underage means you can't drink alcohol. It's the law."`;

});
fgload({ id: 1, name: `KB08ADM`, x: 320, useAnim: true });
showTextbox();
text(() => {
   Takeshi(C2S280)`"So, what are you saying, you don't want to 'go break any laws there' boy scout?"`;
   Kid`"Y-yeah..."`;
   Takeshi(C2S281)`"But you ate sandwiches and cola, right? And you didn't pay a cent."`;
...
showTextbox();
text(() => {
   Takeshi(C2S283)`"I bet you're the kind of kid that'll nark on the kid next to you in class if he's passing notes to his friends."`;
   Kid`"I...I am not..."`;
...
showTextbox();
text(() => {
   Takeshi(C2S284)`"You don't know if you are or not, 'cause you don't got any memory."`;
   Kid`"........."`;
...
text(() => {
   ...
   Takeshi(C2S289)`"Sixteen...old enough to lead a whole gang of snot-nosed brats on your own."`;
   Kid`"Stop it."`;
   Kid`"Sixteen is still underage, but I'm not a kid anymore."`;
   Kid`"I'm still not an adult, but I'm not a kid anymore...that's what I am."`;
...
text(() => {
   ...
   Takeshi(C2S293)`"Right, right! Because you're a BIG boy... all grown up...nya, nya, nya..."`;
   Kid`"..."`;
...
text(() => {
   Kid`"I...I dunno...why..."`;
   `As I mumbled I unconsciously held open the palm of my right hand.`;
   `I stared absently at the palm of my hand.`;
   `I still didn't have any idea what had happened to my finger.`;
   `There was no doubt that I had said I was 16.`;
   `But I couldn't be sure I was right.`;
   `I wondered if I was really that age - if I could believe my words.`;
...
text(() => {
   ...
   Takeshi(C2S298)`"Anyway, it's good that you remembered your age..."`;
   Takeshi(C2S299)`"Proof that you're slowly getting your memory back."`;
   Kid`"........."`;
...
showTextbox();
text(() => {
   Takeshi(C2S302)`"Yesterday I guessed, right? I said you were around 14 or 15."`;
   Takeshi(C2S303)`"I suppose someone like you could be 16.... Could be possible enough..."`;
...
text(() => {
   ...
   `I looked at my arms, my legs and my whole body as if to check.`;
...
text(() => {
   `Bam!`;
   `My leg caught on the bench and I crashed to the floor.`;
...
showTextbox();
text(() => {
   `For some reason, all of the sudden I felt scared. I squeezed my eyes shut and looked down.`;
   `I willed my legs to stand me up.`;
   `My knees shook. I stumbled two or three steps.`;
   `I put my hand on the locker to keep myself from falling. I tried to walk...`;
   `It was as if the mirror were sucking me...toward it...`;
...
showTextbox();
text(() => {
   `Both of my eyes were slightly open, but I wasn't able to raise my face yet.`;
   `I was facing me and both of us had our hands facing each other.`;
   `I could only see his body.`;
   `His legs quivered. His palms shook. The mirror rattled as it shook.`;
   `I took a breath.`;
...
text(() => {
   ...
   `A bench lay knocked over...and clothing was scattered everywhere...`;
   `Someone was standing on the other side of the open door.`;
...
showTextbox();
text(() => {
   `'The face of some kid' who I didn't know was staring back at me.`;
   Kid`"Ah...aaaahh...."`;
   `He screamed as if it were the end of the world.`;
   `His face contorted in a way that chilled my spine. He clutched at his hair.`;
   ...
   Kid`"No...no...no..."`;
   Kid`"No...no...no...no...no...... no...no...no...no..."`;
   ...
   `I didn't know who the 'me' was in the other side of the mirror.`;
   `It wasn't the face of the Kid that I knew.`;
   `It wasn't the sick color of his skin, or his bloodshot eyes or the way his tongue hung limply.`;
   `His whole appearance was completely different than anything I had in my memory of myself.`;
   `He wasn't me.`;
   `No...I wasn't him.`;
   `Who was he...?`;
   `Who in the world was I...?`;
   `The me that was standing there didn't know who I was....`;
...
showTextbox();
text(() => {
   `My eyes clouded over and I couldn't see clearly.`;
...
text(() => {
   ...
   `But it wasn't me or him floating but both me and him.`;
   `I lost sight of where I ended and the world began.`;
   `I had lost all sense of everything. I had no way to confirm my existence.`;
   `I just let myself drift.`;
   `Like a baby floating in the womb...`;
   `Dissolving...`;
   `Dissolving...dissolving...dissolving...`;
   `I dissolved into pure white darkness, the pure white darkness becoming me.`;
   `I was nowhere.`;
...
showTextbox();
text(() => {
   `And the whispering voice disappeared, swallowed by the dark light.`;
