...
shock to my brain.`;
   ...
   `I thought I had (probably) repeated this 
...
showTextbox();
text(() => {
   Takeshi(S3A002)`"I'm alright. I just need to wake up is all. 
See ya."`;
...
showTextbox();
text(() => {
   `Sara and You were waiting in the Conference 
Room.`;
...
showTextbox();
text(() => {
   You(S3A005)`"Hey, Kid. You don't seem very good? You 
...
text(() => {
   You(S3A006)`"You sure?"`;
   Sara(S3A007)`"I know. He's not a morning person or maybe 
...
showTextbox();
text(() => {
   Sara(S3A008)`"I know all about it. I hate mornings. They 
...
showTextbox();
text(() => {
   You(S3A009)`"Mayo is always in the worst mood in the 
...
text(() => {
   ...
   You(S3A013)`"That's true...but they'll probably show up 
eventually."`;
...
showTextbox();
text(() => {
   Takeshi(S3A018)`"Well, I found a few in the back of 
...
text(() => {
   ...
   Takeshi(S3A022)`"The stuff. The hotdog stuff. The sausages 
...
showTextbox();
text(() => {
   Takeshi(S3A024)`"No. They were here when I checked last night. 
...
showTextbox();
text(() => {
   You(S3A027)`"Calm down. We're not out of food. We'll just 
...
showTextbox();
text(() => {
   You(S3A029)`"Just forget about it and start cookiiiing. 
I'm starviiiing."`;
...
showTextbox();
text(() => {
   Sara(S3A031)`"Hey, Nakkyu. Do you remember Mr. Konishi, 
that teacher at our school."`;

});
showTextbox();
text(() => {
   You(S3A032)`"Konishi? Oh, you mean Konnie? The music 
...
showTextbox();
text(() => {
   Sara(S3A035)`"You know what? The other day he bought a 
robotic dog."`;
...
showTextbox();
text(() => {
   Sara(S3A037)`"Yeah. But his pets kept dying on him. And 
...
showTextbox();
text(() => {
   You(S3A038)`"When I was still going to that school, he was 
trying to bring one of his pets back through 
cloning."`;
   Sara(S3A039)`"But that clone got sick and died, too. I 
swear he's cursed."`;
   You(S3A040)`"But really, that Konnie...I tell you, that 
...
showTextbox();
text(() => {
   You(S3A042)`"Yup, sure do. Actually, it's my mom's 
though..."`;
...
showTextbox();
text(() => {
   You(S3A043)`"I think it's one of those really old types, 
...
showTextbox();
text(() => {
   You(S3A044)`"Thinking back on it, Mayo, you never came 
...
showTextbox();
text(() => {
   You(S3A046)`"You can come over anytime. We're friends, 
right?"`;
...
text(() => {
   You(S3A049)`"Eh? What?"`;
   Takeshi(S3A050)`"You two seem to be close, but how do you know 
each other?"`;
...
showTextbox();
text(() => {
   `And when You was a senior, Sara entered the 
...
showTextbox();
text(() => {
   Takeshi(S3A054)`"Do...do you mean one of those people that 
...
showTextbox();
text(() => {
   You(S3A055)`"You always have such a twisted take on 
everything."`;
...
showTextbox();
text(() => {
   Takeshi(S3A056)`"No I don't! I'm not half as mean-spirited as 
you."`;
...
showTextbox();
text(() => {
   Sara(S3A057)`"Due to my situation at home, I never really 
...
showTextbox();
text(() => {
   Sara(S3A058)`"But the principal of Kyumeikan was a friend 
...
showTextbox();
text(() => {
   You(S3A060)`"He didn't want her unpolished genius to go to 
waste."`;
   `It sounded like Sara was a bit of a protege 
and sort of famous.`;
   Takeshi(S3A061)`"Whoa."`;
   Kid`"S-Sara's amazing."`;
   `This and the information from the day before 
...
showTextbox();
text(() => {
   Takeshi(S3A064)`"So you went to the same school but were in 
different classes?"`;
   Takeshi(S3A065)`"Were you on a team or in a club together or 
something?"`;
   You(S3A066)`"Yup."`;
...
showTextbox();
text(() => {
   Sara(S3A067)`"Nakkyu was leader of the school club I joined 
as a freshman." `;
   `After eating the sandwiches, Sara held the pop 
...
new surroundings. `;
   `All of the sudden, from among the din of 
...
me, she nodded smiling.`;
   ...
   `What was it with this person? I wondered if 
...
bobbed haircut tried to explain herself.`;
   //??
   Unk(S3A075)`"Don't get me wrong. I'm not trying to...I 
simply wanted to..."`;
   //??
   Unk(S3A076)`"I was just wandering if you would like to 
join our club."`;
...
had asked me the same question.`;
   ...
   //??
   Unk(S3A078)`"Oh really? Have you already decided to join 
somewhere?"`;
   Sara(S3A079)`"No."`;
   //??
   ...
   //??
   Unk(S3A082)`"Oh, don't say that...won't you just come take 
a look at our club room?"`;
   Sara(S3A083)`"No thank you."`;
   //??
   Unk(S3A084)`"I'll bet you are wondering what our club is 
all about."`;
   Sara(S3A085)`"Not in the least."`;
   //??
   Unk(S3A086)`"Okay, okay. Just come take a look. We don't 
bite."`;
   Sara(S3A087)`"I said..."`;
   //??
   Unk(S3A088)`"Listen! Stop talking, shut up and come with 
me!"`;
...
showTextbox();
text(() => {
   Takeshi(S3A090)`"She hasn't changed a bit. I mean you're 
...
showTextbox();
text(() => {
   You(S3A091)`"Be quiet. I was desperate then. There was 
...
showTextbox();
text(() => {
   You(S3A092)`"It...it was a matter of life or death for the 
club."`;
...
showTextbox();
text(() => {
   Sara(S3A094)`"She means they were short on members and were 
about to fold."`;
...
showTextbox();
text(() => {
   Sara(S3A096)`"I mean, including Nakkyu there were only 
three members."`;
   Takeshi(S3A097)`"Ha, ha, ha! That's pretty grim."`;
   You(S3A098)`"I was going to graduate that year so we had 
to get new members or we would have had to 
close."`;
   You(S3A099)`"I just couldn't stand by and watch the club 
...
showTextbox();
text(() => {
   You(S3A101)`"So, it was the only choice I had if our club 
...
showTextbox();
text(() => {
   You(S3A102)`"We were a robust model of an intelligent 
...
showTextbox();
text(() => {
   You(S3A107)`"Geez! That's gross...you spewed cola 
everywhere!"`;
...
showTextbox();
text(() => {
   Takeshi(S3A108)`"Stupid! Hacking is not robust and certainly 
isn't in 'the public interest'!"`;
   You(S3A109)`"What are you talking about?"`;
   Takeshi(S3A110)`"It's a crime, that's why."`;
   You(S3A111)`"You don't know what you're talking about! 
Hacking isn't crime!"`;
...
showTextbox();
text(() => {
   You(S3A115)`"Well...anyway, you get it now. There is 
...
showTextbox();
text(() => {
   You(S3A116)`"Geez...Mayo, explain it so that this idiot 
can understand it."`;
...
explanation face and started speaking.`;
   Sara(S3A118)`"Originally hacking as a word meant the 
rhythmical manipulation of a computer."`;
   Sara(S3A119)`"People that could do this were called 
hackers. That evolved into the word hacker for 
technicians and research computer experts."`;
...
showTextbox();
text(() => {
   Sara(S3A120)`"Probably what you're thinking about is the 
hacking they talk about on the news meaning a 
crime committed using a computer..."`;
   Sara(S3A121)`"Like when somebody steals secret information, 
or destroys data via computer..."`;
...
showTextbox();
text(() => {
   Sara(S3A123)`"That kind of thing is called 'cracking.' It's 
completely different."`;
   Sara(S3A124)`"And the people that do this are known as 
crackers. You need to make a distinction 
between them."`;
...
showTextbox();
text(() => {
   You(S3A126)`"Got it? There is really no connection 
...
showTextbox();
text(() => {
   You(S3A127)`"It was an intelligent gathering for us to 
...
showTextbox();
text(() => {
   You(S3A129)`"Oh, I was doing all kinds of things. All 
...
showTextbox();
text(() => {
   You(S3A132)`"She didn't join the club without a fight. 
Mayo is Mayo after all."`;
   `With that ambiguous comment, You got a distant 
...
showTextbox();
text(() => {
   You(S3A133)`"That day I could have taken Mayo to our club 
room..."`;
   You(S3A134)`"But...but..."`;
...
text(() => {
   ...
   Matsunaga`"..."`;
   You(S3A136)`"Huh? What's the matter? It's kind of cramped, 
but ahead."`;
...
the floor.`;
   `If Mayo had been a clean freak, we would have 
...
two braids.`;
   ...
   You(S3A144)`"That's right. We just barely avoided having 
our club fold..."`;
   `So as I answered her I hopped from one open 
inch of floor space to the next and into the 
room.`;
   Matsunaga(S3A145)`"Um, I, uh, haven't decided to join yet..."`;
   `Sara was still contemplating how best to enter 
the room.`;
   You(S3A146)`"So where is your partner?"`;
   //Club President
   Club_President(S3A147)`"Out with a cold."`;
   You(S3A148)`"I heard one is going around. You gotta be 
careful."`;
   Matsunaga(S3A149)`"Hanging out in a place like this it'd be even 
more strange if you didn't get ill..."`;
   `Sara gingerly entered the room as if searching 
...
pay any attention to it.`;
   You(S3A150)`"Okay. Now is your chance to get a sense of 
...
gestured to Sara to sit.`;
   ...
   You(S3A152)`"Alright, alright. If you still have doubts, 
...
just tapped nonstop.`;
   ...
   `When she had finished typing, Sara opened a 
...
all of the faces stuck out their tongues at us.`;
   ...
   //Club President
   Club_President(S3A175)`"What's going on? I can't get this computer to 
listen to me...!?"`;
   `The next instant...`;
...
once.`;
   ...
   //Club President
   Club_President(S3A183)`"That's not it...it's plugged in, but it won't 
start up."`;
   You(S3A184)`"Huh...?"`;
...
state.`;
   ...
   You(S3A186)`"Could she have cracked the whole system that 
quickly?"`;
   `Looking down there was a stuffed animal 
...
text(() => {
   ...
   Sara(S3A190)`"Well Nakkyu was so persistent it was 
annoying!"`;
...
showTextbox();
text(() => {
   You(S3A192)`"No. You've got it backwards. I didn't say she 
didn't join, did I?"`;
...
showTextbox();
text(() => {
   Sara(S3A193)`"After that Nakkyu came bothering me, like 
every day."`;
...
on Sara.`;
   `Finally, Sara was overwhelmed by You's 
...
showTextbox();
text(() => {
   Takeshi(S3A197)`"Well, we finished eating. Whaddya say? Should 
...
showTextbox();
text(() => {
   You(S3A201)`"Hey you keep poking your nose into a girl's 
...
showTextbox();
text(() => {
   `You shot the dejected Sara a smile as she 
headed quickly toward the door.`;
   Takeshi(S3A206)`"Hey I don't care where you go, but if 
something happens you come right back!"`;
   `You shot Takeshi a thumbs-up on the way out 
the door.`;
...
showTextbox();
text(() => {
   Takeshi(S3A210)`"Don't worry about it. If something's up, Sora 
...
text(() => {
   ...
   Takeshi(S3A218)`"I thought everyone was sick of chicken 
...
hotdog without a care.`;
   Sara(S3A219)`"I think that's pretty selfish of you to keep 
...
text(() => {
   ...
   Takeshi(S3A221)`"I hope you get fat like a whale and drown in 
...
showTextbox();
text(() => {
   Tsugumi(S3A223)`"I'm not sure what you're talking about. This 
is the only one I ate."`;

});
showTextbox();
text(() => {
   Takeshi(S3A224)`"What? When I looked there was enough for 
everyone."`;
   Takeshi(S3A225)`"And now they're all gone. In that soon-to-be 
...
showTextbox();
text(() => {
   Tsugumi(S3A226)`"Well...I didn't really count how many there 
were."`;
...
showTextbox();
text(() => {
   Tsugumi(S3A229)`"I'll ask you one more time. Why are you so 
mad?"`;

});
showTextbox();
text(() => {
   Takeshi(S3A230)`"I told you! It's because you ate everyone's 
food."`;
...
text(() => {
   ...
   Tsugumi(S3A233)`"Are you sure that is the real reason that you 
are angry?"`;
...
showTextbox();
text(() => {
   Tsugumi(S3A235)`"You sure it wasn't just because it threw off 
your schedule?"`;
...
showTextbox();
text(() => {
   Takeshi(S3A236)`"We-well yeah! Because the hotdogs that I 
...
text(() => {
   ...
   Kid`"Uh, I don't know..."`;
   Takeshi(S3A240)`"Hey, this doesn't have anything to do 
...
showTextbox();
text(() => {
   `Sora appeared into the air out of nowhere and 
...
showTextbox();
text(() => {
   Sora(T3A068)`"One of the shafts that supports this floor 
has started to warp."`;
...
text(() => {
   ...
   Sora(T3A070)`"Yes, well, it wasn't in my calculations. 
...
showTextbox();
text(() => {
   Sora(T3A071)`"Well it should be within the margin of error, 
...
showTextbox();
text(() => {
   Sora(T3A072)`"There is an anomaly in one the of 
...
showTextbox();
text(() => {
   Sora(T3A073)`"These pipelines are responsible for adjusting 
the pressure inside the multi-layered 
bulkheads comprising LeMU."`;
   Sora(T3A074)`"If any of them should rupture, for whatever 
reason, I am incapable of repairing them."`;
   Sora(T3A075)`"The anomaly is only slight, so you shouldn't 
...
text(() => {
   ...
   Tsugumi(S3A251)`"What? You got a problem with me tagging 
along?"`;
...
showTextbox();
text(() => {
   Tsugumi(S3A253)`"Don't get me wrong. We've got a situation on 
our hands, so you and I will call a truce."`;
   Tsugumi(S3A254)`"Well, if we're going to fix something, 
...
showTextbox();
text(() => {
   Takeshi(S3A258)`"So what happened with You anyway? She's not 
back yet?"`;
...
showTextbox();
text(() => {
   Sora(S3A260)`"I'm sorry. Unfortunately, right now some 
...
showTextbox();
text(() => {
   Sara(S3A264)`"But if something happened to her during that 
shaking..."`;
...
text(() => {
   ...
   Sora(S3A266)`"Currently, there appears to be no direct 
damage inside LeMU."`;
   Sora(S3A267)`"As for You's whereabouts, the sensors should 
be online in a moment and then I will be able 
to detect her."`;
   Takeshi(S3A268)`"Alright. We'll forget about You for now. 
...
leave Sara.`;
   Tsugumi(S3A271)`"What are you doing? You're gonna get left 
behind."`;
...
showTextbox();
text(() => {
   Sora(S3A273)`"If something should happen, use LeMMIH to 
contact me."`;
