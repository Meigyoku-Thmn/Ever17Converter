...
the power had gone back online.`;
   ...
   `Takeshi, Tsugumi, Sora, You, Sara and I ? all 
...
showTextbox();
text(() => {
   Sara(S2C005)`"Oh. In that case, can you bring me back 
something to drink?"`;
   Kid`"Huh?"`;
...
showTextbox();
text(() => {
   Sara(S2C006)`"I'm thirsty...I think there was juice in 
the kiosk, right?"`;
   Kid`"I think so."`;
...
showTextbox();
text(() => {
   Sara(S2C011)`"Listen. Kid, you've got some kind of memory 
...
text(() => {
   Sara(S2C015)`"Really?"`;
   `I gave up.`;
   `I was sure that Takeshi and You would side 
with Sara.`;
...
text(() => {
   ...
   `I figured these were probably sandwiches that 
Takeshi had made and taken to Tsugumi and Sora.`;
   `I bet that during the blackout they had been 
forgotten.`;
...
survive for days.`;
   `The only food there was chicken sandwiches and 
...
back enough for everyone."`;
   ...
   `Sara took two of the two cans and handed 
one to You.`;
...
showTextbox();
text(() => {
   You(S2C020)`"Hey, Kid. That was sure thoughtful 
of you!"`;
...
showTextbox();
text(() => {
   `You took the cola from Sara and popped 
open the tab.`;
...
showTextbox();
text(() => {
   `Like a pro, she held the fizz down so it 
wouldn't explode.`;
   `She didn't go getting herself all drenched 
in soda.`;
...
showTextbox();
text(() => {
   Sara(S2C023)`"Oh, I'll bet it went with your memory. 
...
uneasy about my lost memory than I was.`;
   ...
   `I remembered the sandwiches and holding the 
...
showTextbox();
text(() => {
   Takeshi(S2C026)`"Oh, yeah. It's the one that I forgot to 
...
text(() => {
   ...
   `You rushed over and violently mussed up my 
hair.`;
...
showTextbox();
text(() => {
   Takeshi(S2C031)`"Don't be polite. I made this...I'm sure it 
tastes good."`;
...
showTextbox();
text(() => {
   Takeshi(S2C035)`"Then what is it? Eat too much yesterday? 
Or are you on a diet?"`;
   Sora(T2C069)`"No, but...I..."`;
   Takeshi(S2C036)`"No. You have to eat or you'll get weak. Here! 
Take it!"`;
...
showTextbox();
text(() => {
   `He tossed a cola and chicken sandwich 
toward Sora.`;
...
text(() => {
   ...
   Takeshi(S2C040)`"I meant to toss them as if I were handing 
...
showTextbox();
text(() => {
   Takeshi(S2C041)`"B-but! The cola blew up and...is your 
clothing alright?"`;
   Sora(T2C073)`"Yes."`;
...
showTextbox();
text(() => {
   Takeshi(S2C042)`"But you're...stepping on the sandwich...your 
...
showTextbox();
text(() => {
   `A strange expression floated on to Sara's 
...
showTextbox();
text(() => {
   Tsugumi(S2C047)`"I can't watch anymore of this...it's 
ridiculous."`;
...
showTextbox();
text(() => {
   Sora(T2C092)`"I have been programmed as one part 
of the LeMMIH system."`;
   Sora(T2C093)`"If you call me from any nearby terminal, 
...
showTextbox();
text(() => {
   Sara(S2C052)`"So that's why Sora disappeared during the 
blackout?"`;
...
showTextbox();
text(() => {
   Sara(S2C053)`"And it is supporting such an advanced 
personality."`;
   `The surprising thing was Sara seemed to be 
...
showTextbox();
text(() => {
   Sora(S2C055)`"Yes, but it is much smaller that it would 
...
showTextbox();
text(() => {
   Sara(S2C059)`"Well, this is a bit of a different question, 
but does Sora's personality change based on 
her memories...?"${waitVoice}${noWait}`;
...
showTextbox();
text(() => {
   `You puffed out her cheeks as if pouting. It 
...
showTextbox();
text(() => {
   You(S2C063)`"Yeah. How should I explain this...I guess 
...
showTextbox();
text(() => {
   You(S2C064)`"Anyway, she knows everything about computers. 
...
showTextbox();
text(() => {
   You(S2C065)`"She writes programs for kicks. Just the 
...
showTextbox();
text(() => {
   You(S2C066)`"A contest to break codes. Just so you know, 
it's not illegal."`;
   You(S2C067)`"It was sponsored by some company with code 
technology. It was legal cracking to test the 
security of its technology..."`;
   You(S2C068)`"The company has hackers attack their 
algorithms."`;
   Kid`"Uh,uh..."`;
...
showTextbox();
text(() => {
   You(S2C069)`"Just think of it as a decryption game 
contest."`;
...
showTextbox();
text(() => {
   You(S2C072)`"Just the other day she got first place in 
...
showTextbox();
text(() => {
   You(S2C073)`"A contest to break codes. Just so you know, 
it's not illegal."`;
   You(S2C074)`"It was sponsored by some company with code 
technology. It was legal cracking to test the 
security of its technology..."`;
   You(S2C075)`"The company has hackers attack their 
algorithms."`;
...
showTextbox();
text(() => {
   You(S2C077)`"Just because you call it a game, 
...
showTextbox();
text(() => {
   You(S2C078)`"There were engineers participating from all 
over the world."`;
   You(S2C079)`"Winning it means that you are one of the 
...
text(() => {
   ...
   `But deep in the ocean, our sense of time was 
disappearing.`;
   `Checking my watch was the only way that 
I knew it was the evening.`;
   `Nothing changed in LeMU.`;
   `No one had come to pay us a visit.`;
   `But things hadn't gotten worse. Right now, 
there was no sign of flooding or impending 
collapse.`;
   `We had just been passing the time as we saw 
fit.`;
   `For now, we had all forgotten about not 
...
blooming flowers without really seeing them.`;
   ...
   `We were going to meet again at 7:00. Until 
...
other than that was beyond me.`;
   ...
   `The lights in the ceiling were reflected 
in the water.`;
...
the light.`;
   `But...`;
   `I could only grab a little seawater... 
I couldn't touch the light.`;
   `I tried again and again, but I couldn't get my 
hand on the moon.`;
...
showTextbox();
text(() => {
   Sora(S2C087)`"What did you just say...I'm Sora. So I am 
what I am."`;
   Sora(S2C088)`"For example, by explaining about what 
I am...it is a way for you to better 
understand me."`;
   Kid`"........."`;
   `I squeezed my hand shut.`;
   `Of course, I wasn't holding anything.`;
   Sora(S2C089)`"Actually, I just explained all of this to 
Takeshi."`;
   Kid`"Huh? To Takeshi?"`;
...
showTextbox();
text(() => {
   Sora(S2C091)`"I am different from everyone else, 
but I want to be the same."`;
   Sora(S2C092)`"That...that is why I want everyone to know 
about me."`;
...
showTextbox();
text(() => {
   Sora(S2C093)`"Well, shall I start...with an explanation 
of RSD?"`;
...
semiconductor laser output devices."`;
   Sora(S2C100)`"So the image is being directly reflected on 
your retina."`;
   Kid`"Image?"`;
...
showTextbox();
text(() => {
   Sora(S2C103)`"To answer my own question, most people hear 
...
showTextbox();
text(() => {
   Sora(T2C172)`"But the sound is not actually 
...
converters!"`;
   `I still had both of them in my ears. I removed 
...
location of the voice converters."`;
   Sora(S2C104)`"So wherever you stand and whichever 
direction you face..."`;
   Sora(S2C105)`"LeMMIH is constantly using sensors around 
...
text(() => {
   ...
   Sora(S2C107)`"My voice will sound as if I am exactly 60 
feet behind you."`;
   Sora(S2C108)`"When I am to the right, it sounds to the 
...
showTextbox();
text(() => {
   Sora(S2C111)`"Just a moment ago I said that LeMMIH is 
constantly monitoring your position and 
direction you are facing..."`;
   Sora(S2C112)`"At the same time, LeMMIH is also 
monitoring the position of your eyeballs."`;
   Sora(S2C113)`"So that even if you move, I still appear 
in the same place."`;
   Sora(T2C188)`"This means that LeMMIH scans the image on 
...
text(() => {
   ...
   Sora(T2C218)`"The policy of my designer was to create me as 
...
showTextbox();
text(() => {
   Sora(T2C219)`"That reminds me, I have heard the same 
...
showTextbox();
text(() => {
   Sora(T2C230)`"For example, if the five of you 
