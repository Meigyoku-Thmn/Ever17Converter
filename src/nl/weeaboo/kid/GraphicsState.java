...
public class GraphicsState {
	...
	public GraphicsState(Dim screen, ImageInsets ii, ResourcesUsed used,
			Collection<String> opaque)
	{
		screenSize = screen;
		imageInsets = ii;
		resUsed = used;
		opaqueSprites = new HashSet<String>(opaque);
		
		background = "special/black.jpg";
		backgroundFadeFrames = -1;
		sprites = new LinkedHashMap<Integer, Sprite>();
	}
