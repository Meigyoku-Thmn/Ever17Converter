...
public class ImageConverter {
   ...
   private final Dimension targetScreenSize = new Dimension(256, 192);
   private final Dimension srcScreenSize = new Dimension(800, 600); //Matters for sprites only
   ...
   public File dumpLog(String filename) throws IOException {
      ...
      try (PrintWriter out = new PrintWriter(new FileWriter(file))) {
         out.println("----------------------------------------");
         out.println("----------------------------------------");
         for (var entry : getLogs().entrySet()) {
            out.println();
   ...
   public Dimension getTargetScreenSize() {
      return new Dimension(targetScreenSize);
   }

   public Dimension getSourceScreenSize() {
      return new Dimension(srcScreenSize);
   }
   ...
   // Setters
   public void setMode(ConvertType mode) {
      this.mode = mode;
   }

   public void setScalingType(ScalingType s) {
      this.scaling = s;
   }
   ...
   public void setSourceScreenSize(int w, int h) {
      srcScreenSize.width = w;
      srcScreenSize.height = h;
   }

   public void setTargetScreenSize(int w, int h) {
      targetScreenSize.width = w;
      targetScreenSize.height = h;
   }
   ...
   public void setDitheringType(DitheringType dithering) {
