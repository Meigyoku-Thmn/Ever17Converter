...
public class SoundConverter {
   ...
   public void setVorbisQuality(int quality) {
      this.vorbis_quality = quality;
   }

   public void setAacQuality(int quality) {
      this.aac_quality = quality;
   }
   ...
   public void setConvertNameToUpperCase(boolean nameToUpperCase) {
